[AWTK](../README.md) / [Exports](../modules.md) / TListItem
...
- [constructor](TListItem.md#constructor)

### Properties

- [nativeObj](TListItem.md#nativeobj)

### Accessors

- [animation](TListItem.md#animation)
- [autoAdjustSize](TListItem.md#autoadjustsize)
- [dirtyRectTolerance](TListItem.md#dirtyrecttolerance)
- [enable](TListItem.md#enable)
- [feedback](TListItem.md#feedback)
- [floating](TListItem.md#floating)
- [focusable](TListItem.md#focusable)
- [h](TListItem.md#h)
- [name](TListItem.md#name)
- [opacity](TListItem.md#opacity)
- [parent](TListItem.md#parent)
- [pointerCursor](TListItem.md#pointercursor)
- [sensitive](TListItem.md#sensitive)
- [style](TListItem.md#style)
- [trText](TListItem.md#trtext)
- [visible](TListItem.md#visible)
- [w](TListItem.md#w)
- [withFocusState](TListItem.md#withfocusstate)
- [x](TListItem.md#x)
- [y](TListItem.md#y)

### Methods

- [addChild](TListItem.md#addchild)
- [addChildDefault](TListItem.md#addchilddefault)
- [addValue](TListItem.md#addvalue)
- [addValueInt](TListItem.md#addvalueint)
- [animateValueTo](TListItem.md#animatevalueto)
- [back](TListItem.md#back)
- [backToHome](TListItem.md#backtohome)
- [child](TListItem.md#child)
- [clone](TListItem.md#clone)
- [closeWindow](TListItem.md#closewindow)
- [closeWindowForce](TListItem.md#closewindowforce)
- [countChildren](TListItem.md#countchildren)
- [createAnimator](TListItem.md#createanimator)
- [destroy](TListItem.md#destroy)
- [destroyAnimator](TListItem.md#destroyanimator)
- [destroyAsync](TListItem.md#destroyasync)
- [destroyChildren](TListItem.md#destroychildren)
- [dispatchToKeyTarget](TListItem.md#dispatchtokeytarget)
- [dispatchToTarget](TListItem.md#dispatchtotarget)
- [equal](TListItem.md#equal)
- [fillBgRect](TListItem.md#fillbgrect)
- [fillFgRect](TListItem.md#fillfgrect)
- [findParentByName](TListItem.md#findparentbyname)
- [findParentByType](TListItem.md#findparentbytype)
- [focusNext](TListItem.md#focusnext)
- [focusPrev](TListItem.md#focusprev)
- [foreach](TListItem.md#foreach)
- [getAutoAdjustSize](TListItem.md#getautoadjustsize)
- [getChild](TListItem.md#getchild)
- [getEnable](TListItem.md#getenable)
- [getFeedback](TListItem.md#getfeedback)
- [getFloating](TListItem.md#getfloating)
- [getFocusable](TListItem.md#getfocusable)
- [getFocusedWidget](TListItem.md#getfocusedwidget)
- [getNativeWindow](TListItem.md#getnativewindow)
- [getPropBool](TListItem.md#getpropbool)
- [getPropFloat](TListItem.md#getpropfloat)
- [getPropInt](TListItem.md#getpropint)
- [getPropPointer](TListItem.md#getproppointer)
- [getPropStr](TListItem.md#getpropstr)
- [getSensitive](TListItem.md#getsensitive)
- [getStateForStyle](TListItem.md#getstateforstyle)
- [getStyleType](TListItem.md#getstyletype)
- [getText](TListItem.md#gettext)
- [getThemeName](TListItem.md#getthemename)
- [getType](TListItem.md#gettype)
- [getValue](TListItem.md#getvalue)
- [getValueInt](TListItem.md#getvalueint)
- [getVisible](TListItem.md#getvisible)
- [getWindow](TListItem.md#getwindow)
- [getWindowManager](TListItem.md#getwindowmanager)
- [getWithFocusState](TListItem.md#getwithfocusstate)
- [indexOf](TListItem.md#indexof)
- [insertChild](TListItem.md#insertchild)
- [invalidateForce](TListItem.md#invalidateforce)
- [isDesigningWindow](TListItem.md#isdesigningwindow)
- [isDialog](TListItem.md#isdialog)
- [isDirectParentOf](TListItem.md#isdirectparentof)
- [isKeyboard](TListItem.md#iskeyboard)
- [isNormalWindow](TListItem.md#isnormalwindow)
- [isOpenedDialog](TListItem.md#isopeneddialog)
- [isOpenedPopup](TListItem.md#isopenedpopup)
- [isOverlay](TListItem.md#isoverlay)
- [isParentOf](TListItem.md#isparentof)
- [isPopup](TListItem.md#ispopup)
- [isStyleExist](TListItem.md#isstyleexist)
- [isSystemBar](TListItem.md#issystembar)
- [isWindow](TListItem.md#iswindow)
- [isWindowCreated](TListItem.md#iswindowcreated)
- [isWindowManager](TListItem.md#iswindowmanager)
- [isWindowOpened](TListItem.md#iswindowopened)
- [layout](TListItem.md#layout)
- [lookup](TListItem.md#lookup)
- [lookupByType](TListItem.md#lookupbytype)
- [move](TListItem.md#move)
- [moveResize](TListItem.md#moveresize)
- [moveResizeEx](TListItem.md#moveresizeex)
- [moveToCenter](TListItem.md#movetocenter)
- [off](TListItem.md#off)
- [on](TListItem.md#on)
- [pauseAnimator](TListItem.md#pauseanimator)
- [removeChild](TListItem.md#removechild)
- [resize](TListItem.md#resize)
- [restack](TListItem.md#restack)
- [setAnimation](TListItem.md#setanimation)
- [setAnimatorTimeScale](TListItem.md#setanimatortimescale)
- [setAsKeyTarget](TListItem.md#setaskeytarget)
- [setAutoAdjustSize](TListItem.md#setautoadjustsize)
- [setChildText](TListItem.md#setchildtext)
- [setChildTextWithDouble](TListItem.md#setchildtextwithdouble)
- [setChildTextWithInt](TListItem.md#setchildtextwithint)
- [setChildrenLayout](TListItem.md#setchildrenlayout)
- [setDirtyRectTolerance](TListItem.md#setdirtyrecttolerance)
- [setEnable](TListItem.md#setenable)
- [setFeedback](TListItem.md#setfeedback)
- [setFloating](TListItem.md#setfloating)
- [setFocusable](TListItem.md#setfocusable)
- [setFocused](TListItem.md#setfocused)
- [setName](TListItem.md#setname)
- [setOpacity](TListItem.md#setopacity)
- [setPointerCursor](TListItem.md#setpointercursor)
- [setPropBool](TListItem.md#setpropbool)
- [setPropFloat](TListItem.md#setpropfloat)
- [setPropInt](TListItem.md#setpropint)
- [setPropPointer](TListItem.md#setproppointer)
- [setPropStr](TListItem.md#setpropstr)
- [setProps](TListItem.md#setprops)
- [setSelfLayout](TListItem.md#setselflayout)
- [setSelfLayoutParams](TListItem.md#setselflayoutparams)
- [setSensitive](TListItem.md#setsensitive)
- [setState](TListItem.md#setstate)
- [setStyleColor](TListItem.md#setstylecolor)
- [setStyleInt](TListItem.md#setstyleint)
- [setStyleStr](TListItem.md#setstylestr)
- [setText](TListItem.md#settext)
- [setTextEx](TListItem.md#settextex)
- [setTheme](TListItem.md#settheme)
- [setTrText](TListItem.md#settrtext)
- [setValue](TListItem.md#setvalue)
- [setValueInt](TListItem.md#setvalueint)
- [setVisible](TListItem.md#setvisible)
- [setVisibleOnly](TListItem.md#setvisibleonly)
- [startAnimator](TListItem.md#startanimator)
- [stopAnimator](TListItem.md#stopanimator)
- [strokeBorderRect](TListItem.md#strokeborderrect)
- [unref](TListItem.md#unref)
- [updateStyle](TListItem.md#updatestyle)
- [updateStyleRecursive](TListItem.md#updatestylerecursive)
- [useStyle](TListItem.md#usestyle)
- [cast](TListItem.md#cast)
- [create](TListItem.md#create)

## Constructors

### constructor

• **new TListItem**(`nativeObj`)
...
[awtk.ts:19612](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L19612)
...
[awtk.ts:19611](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L19611)
...
▸ `Static` **cast**(`widget`): [`TListItem`](TListItem.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | list_item对象。 |
...
[awtk.ts:19640](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L19640)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TListItem`](TListItem.md)
...
[awtk.ts:19628](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L19628)
