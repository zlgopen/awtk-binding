[AWTK](../README.md) / [Exports](../modules.md) / TAppBar
...
- [constructor](TAppBar.md#constructor)

### Properties

- [nativeObj](TAppBar.md#nativeobj)

### Accessors

- [animation](TAppBar.md#animation)
- [autoAdjustSize](TAppBar.md#autoadjustsize)
- [dirtyRectTolerance](TAppBar.md#dirtyrecttolerance)
- [enable](TAppBar.md#enable)
- [feedback](TAppBar.md#feedback)
- [floating](TAppBar.md#floating)
- [focusable](TAppBar.md#focusable)
- [h](TAppBar.md#h)
- [name](TAppBar.md#name)
- [opacity](TAppBar.md#opacity)
- [parent](TAppBar.md#parent)
- [pointerCursor](TAppBar.md#pointercursor)
- [sensitive](TAppBar.md#sensitive)
- [style](TAppBar.md#style)
- [trText](TAppBar.md#trtext)
- [visible](TAppBar.md#visible)
- [w](TAppBar.md#w)
- [withFocusState](TAppBar.md#withfocusstate)
- [x](TAppBar.md#x)
- [y](TAppBar.md#y)

### Methods

- [addChild](TAppBar.md#addchild)
- [addChildDefault](TAppBar.md#addchilddefault)
- [addValue](TAppBar.md#addvalue)
- [addValueInt](TAppBar.md#addvalueint)
- [animateValueTo](TAppBar.md#animatevalueto)
- [back](TAppBar.md#back)
- [backToHome](TAppBar.md#backtohome)
- [child](TAppBar.md#child)
- [clone](TAppBar.md#clone)
- [closeWindow](TAppBar.md#closewindow)
- [closeWindowForce](TAppBar.md#closewindowforce)
- [countChildren](TAppBar.md#countchildren)
- [createAnimator](TAppBar.md#createanimator)
- [destroy](TAppBar.md#destroy)
- [destroyAnimator](TAppBar.md#destroyanimator)
- [destroyAsync](TAppBar.md#destroyasync)
- [destroyChildren](TAppBar.md#destroychildren)
- [dispatchToKeyTarget](TAppBar.md#dispatchtokeytarget)
- [dispatchToTarget](TAppBar.md#dispatchtotarget)
- [equal](TAppBar.md#equal)
- [fillBgRect](TAppBar.md#fillbgrect)
- [fillFgRect](TAppBar.md#fillfgrect)
- [findParentByName](TAppBar.md#findparentbyname)
- [findParentByType](TAppBar.md#findparentbytype)
- [focusNext](TAppBar.md#focusnext)
- [focusPrev](TAppBar.md#focusprev)
- [foreach](TAppBar.md#foreach)
- [getAutoAdjustSize](TAppBar.md#getautoadjustsize)
- [getChild](TAppBar.md#getchild)
- [getEnable](TAppBar.md#getenable)
- [getFeedback](TAppBar.md#getfeedback)
- [getFloating](TAppBar.md#getfloating)
- [getFocusable](TAppBar.md#getfocusable)
- [getFocusedWidget](TAppBar.md#getfocusedwidget)
- [getNativeWindow](TAppBar.md#getnativewindow)
- [getPropBool](TAppBar.md#getpropbool)
- [getPropFloat](TAppBar.md#getpropfloat)
- [getPropInt](TAppBar.md#getpropint)
- [getPropPointer](TAppBar.md#getproppointer)
- [getPropStr](TAppBar.md#getpropstr)
- [getSensitive](TAppBar.md#getsensitive)
- [getStateForStyle](TAppBar.md#getstateforstyle)
- [getStyleType](TAppBar.md#getstyletype)
- [getText](TAppBar.md#gettext)
- [getThemeName](TAppBar.md#getthemename)
- [getType](TAppBar.md#gettype)
- [getValue](TAppBar.md#getvalue)
- [getValueInt](TAppBar.md#getvalueint)
- [getVisible](TAppBar.md#getvisible)
- [getWindow](TAppBar.md#getwindow)
- [getWindowManager](TAppBar.md#getwindowmanager)
- [getWithFocusState](TAppBar.md#getwithfocusstate)
- [indexOf](TAppBar.md#indexof)
- [insertChild](TAppBar.md#insertchild)
- [invalidateForce](TAppBar.md#invalidateforce)
- [isDesigningWindow](TAppBar.md#isdesigningwindow)
- [isDialog](TAppBar.md#isdialog)
- [isDirectParentOf](TAppBar.md#isdirectparentof)
- [isKeyboard](TAppBar.md#iskeyboard)
- [isNormalWindow](TAppBar.md#isnormalwindow)
- [isOpenedDialog](TAppBar.md#isopeneddialog)
- [isOpenedPopup](TAppBar.md#isopenedpopup)
- [isOverlay](TAppBar.md#isoverlay)
- [isParentOf](TAppBar.md#isparentof)
- [isPopup](TAppBar.md#ispopup)
- [isStyleExist](TAppBar.md#isstyleexist)
- [isSystemBar](TAppBar.md#issystembar)
- [isWindow](TAppBar.md#iswindow)
- [isWindowCreated](TAppBar.md#iswindowcreated)
- [isWindowManager](TAppBar.md#iswindowmanager)
- [isWindowOpened](TAppBar.md#iswindowopened)
- [layout](TAppBar.md#layout)
- [lookup](TAppBar.md#lookup)
- [lookupByType](TAppBar.md#lookupbytype)
- [move](TAppBar.md#move)
- [moveResize](TAppBar.md#moveresize)
- [moveResizeEx](TAppBar.md#moveresizeex)
- [moveToCenter](TAppBar.md#movetocenter)
- [off](TAppBar.md#off)
- [on](TAppBar.md#on)
- [pauseAnimator](TAppBar.md#pauseanimator)
- [removeChild](TAppBar.md#removechild)
- [resize](TAppBar.md#resize)
- [restack](TAppBar.md#restack)
- [setAnimation](TAppBar.md#setanimation)
- [setAnimatorTimeScale](TAppBar.md#setanimatortimescale)
- [setAsKeyTarget](TAppBar.md#setaskeytarget)
- [setAutoAdjustSize](TAppBar.md#setautoadjustsize)
- [setChildText](TAppBar.md#setchildtext)
- [setChildTextWithDouble](TAppBar.md#setchildtextwithdouble)
- [setChildTextWithInt](TAppBar.md#setchildtextwithint)
- [setChildrenLayout](TAppBar.md#setchildrenlayout)
- [setDirtyRectTolerance](TAppBar.md#setdirtyrecttolerance)
- [setEnable](TAppBar.md#setenable)
- [setFeedback](TAppBar.md#setfeedback)
- [setFloating](TAppBar.md#setfloating)
- [setFocusable](TAppBar.md#setfocusable)
- [setFocused](TAppBar.md#setfocused)
- [setName](TAppBar.md#setname)
- [setOpacity](TAppBar.md#setopacity)
- [setPointerCursor](TAppBar.md#setpointercursor)
- [setPropBool](TAppBar.md#setpropbool)
- [setPropFloat](TAppBar.md#setpropfloat)
- [setPropInt](TAppBar.md#setpropint)
- [setPropPointer](TAppBar.md#setproppointer)
- [setPropStr](TAppBar.md#setpropstr)
- [setProps](TAppBar.md#setprops)
- [setSelfLayout](TAppBar.md#setselflayout)
- [setSelfLayoutParams](TAppBar.md#setselflayoutparams)
- [setSensitive](TAppBar.md#setsensitive)
- [setState](TAppBar.md#setstate)
- [setStyleColor](TAppBar.md#setstylecolor)
- [setStyleInt](TAppBar.md#setstyleint)
- [setStyleStr](TAppBar.md#setstylestr)
- [setText](TAppBar.md#settext)
- [setTextEx](TAppBar.md#settextex)
- [setTheme](TAppBar.md#settheme)
- [setTrText](TAppBar.md#settrtext)
- [setValue](TAppBar.md#setvalue)
- [setValueInt](TAppBar.md#setvalueint)
- [setVisible](TAppBar.md#setvisible)
- [setVisibleOnly](TAppBar.md#setvisibleonly)
- [startAnimator](TAppBar.md#startanimator)
- [stopAnimator](TAppBar.md#stopanimator)
- [strokeBorderRect](TAppBar.md#strokeborderrect)
- [unref](TAppBar.md#unref)
- [updateStyle](TAppBar.md#updatestyle)
- [updateStyleRecursive](TAppBar.md#updatestylerecursive)
- [useStyle](TAppBar.md#usestyle)
- [cast](TAppBar.md#cast)
- [create](TAppBar.md#create)

## Constructors

### constructor

• **new TAppBar**(`nativeObj`)
...
[awtk.ts:23075](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23075)
...
[awtk.ts:23074](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23074)
...
▸ `Static` **cast**(`widget`): [`TAppBar`](TAppBar.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | app_bar对象。 |
...
[awtk.ts:23103](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23103)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TAppBar`](TAppBar.md)
...
[awtk.ts:23091](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23091)
