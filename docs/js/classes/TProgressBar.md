[AWTK](../README.md) / [Exports](../modules.md) / TProgressBar
...
- [constructor](TProgressBar.md#constructor)

### Properties

- [nativeObj](TProgressBar.md#nativeobj)

### Accessors

- [animation](TProgressBar.md#animation)
- [autoAdjustSize](TProgressBar.md#autoadjustsize)
- [dirtyRectTolerance](TProgressBar.md#dirtyrecttolerance)
- [enable](TProgressBar.md#enable)
- [feedback](TProgressBar.md#feedback)
- [floating](TProgressBar.md#floating)
- [focusable](TProgressBar.md#focusable)
- [format](TProgressBar.md#format)
- [h](TProgressBar.md#h)
- [max](TProgressBar.md#max)
- [name](TProgressBar.md#name)
- [opacity](TProgressBar.md#opacity)
- [parent](TProgressBar.md#parent)
- [pointerCursor](TProgressBar.md#pointercursor)
- [reverse](TProgressBar.md#reverse)
- [sensitive](TProgressBar.md#sensitive)
- [showText](TProgressBar.md#showtext)
- [style](TProgressBar.md#style)
- [trText](TProgressBar.md#trtext)
- [value](TProgressBar.md#value)
- [vertical](TProgressBar.md#vertical)
- [visible](TProgressBar.md#visible)
- [w](TProgressBar.md#w)
- [withFocusState](TProgressBar.md#withfocusstate)
- [x](TProgressBar.md#x)
- [y](TProgressBar.md#y)

### Methods

- [addChild](TProgressBar.md#addchild)
- [addChildDefault](TProgressBar.md#addchilddefault)
- [addValue](TProgressBar.md#addvalue)
- [addValueInt](TProgressBar.md#addvalueint)
- [animateValueTo](TProgressBar.md#animatevalueto)
- [back](TProgressBar.md#back)
- [backToHome](TProgressBar.md#backtohome)
- [child](TProgressBar.md#child)
- [clone](TProgressBar.md#clone)
- [closeWindow](TProgressBar.md#closewindow)
- [closeWindowForce](TProgressBar.md#closewindowforce)
- [countChildren](TProgressBar.md#countchildren)
- [createAnimator](TProgressBar.md#createanimator)
- [destroy](TProgressBar.md#destroy)
- [destroyAnimator](TProgressBar.md#destroyanimator)
- [destroyAsync](TProgressBar.md#destroyasync)
- [destroyChildren](TProgressBar.md#destroychildren)
- [dispatchToKeyTarget](TProgressBar.md#dispatchtokeytarget)
- [dispatchToTarget](TProgressBar.md#dispatchtotarget)
- [equal](TProgressBar.md#equal)
- [fillBgRect](TProgressBar.md#fillbgrect)
- [fillFgRect](TProgressBar.md#fillfgrect)
- [findParentByName](TProgressBar.md#findparentbyname)
- [findParentByType](TProgressBar.md#findparentbytype)
- [focusNext](TProgressBar.md#focusnext)
- [focusPrev](TProgressBar.md#focusprev)
- [foreach](TProgressBar.md#foreach)
- [getAutoAdjustSize](TProgressBar.md#getautoadjustsize)
- [getChild](TProgressBar.md#getchild)
- [getEnable](TProgressBar.md#getenable)
- [getFeedback](TProgressBar.md#getfeedback)
- [getFloating](TProgressBar.md#getfloating)
- [getFocusable](TProgressBar.md#getfocusable)
- [getFocusedWidget](TProgressBar.md#getfocusedwidget)
- [getNativeWindow](TProgressBar.md#getnativewindow)
- [getPercent](TProgressBar.md#getpercent)
- [getPropBool](TProgressBar.md#getpropbool)
- [getPropFloat](TProgressBar.md#getpropfloat)
- [getPropInt](TProgressBar.md#getpropint)
- [getPropPointer](TProgressBar.md#getproppointer)
- [getPropStr](TProgressBar.md#getpropstr)
- [getSensitive](TProgressBar.md#getsensitive)
- [getStateForStyle](TProgressBar.md#getstateforstyle)
- [getStyleType](TProgressBar.md#getstyletype)
- [getText](TProgressBar.md#gettext)
- [getThemeName](TProgressBar.md#getthemename)
- [getType](TProgressBar.md#gettype)
- [getValue](TProgressBar.md#getvalue)
- [getValueInt](TProgressBar.md#getvalueint)
- [getVisible](TProgressBar.md#getvisible)
- [getWindow](TProgressBar.md#getwindow)
- [getWindowManager](TProgressBar.md#getwindowmanager)
- [getWithFocusState](TProgressBar.md#getwithfocusstate)
- [indexOf](TProgressBar.md#indexof)
- [insertChild](TProgressBar.md#insertchild)
- [invalidateForce](TProgressBar.md#invalidateforce)
- [isDesigningWindow](TProgressBar.md#isdesigningwindow)
- [isDialog](TProgressBar.md#isdialog)
- [isDirectParentOf](TProgressBar.md#isdirectparentof)
- [isKeyboard](TProgressBar.md#iskeyboard)
- [isNormalWindow](TProgressBar.md#isnormalwindow)
- [isOpenedDialog](TProgressBar.md#isopeneddialog)
- [isOpenedPopup](TProgressBar.md#isopenedpopup)
- [isOverlay](TProgressBar.md#isoverlay)
- [isParentOf](TProgressBar.md#isparentof)
- [isPopup](TProgressBar.md#ispopup)
- [isStyleExist](TProgressBar.md#isstyleexist)
- [isSystemBar](TProgressBar.md#issystembar)
- [isWindow](TProgressBar.md#iswindow)
- [isWindowCreated](TProgressBar.md#iswindowcreated)
- [isWindowManager](TProgressBar.md#iswindowmanager)
- [isWindowOpened](TProgressBar.md#iswindowopened)
- [layout](TProgressBar.md#layout)
- [lookup](TProgressBar.md#lookup)
- [lookupByType](TProgressBar.md#lookupbytype)
- [move](TProgressBar.md#move)
- [moveResize](TProgressBar.md#moveresize)
- [moveResizeEx](TProgressBar.md#moveresizeex)
- [moveToCenter](TProgressBar.md#movetocenter)
- [off](TProgressBar.md#off)
- [on](TProgressBar.md#on)
- [pauseAnimator](TProgressBar.md#pauseanimator)
- [removeChild](TProgressBar.md#removechild)
- [resize](TProgressBar.md#resize)
- [restack](TProgressBar.md#restack)
- [setAnimation](TProgressBar.md#setanimation)
- [setAnimatorTimeScale](TProgressBar.md#setanimatortimescale)
- [setAsKeyTarget](TProgressBar.md#setaskeytarget)
- [setAutoAdjustSize](TProgressBar.md#setautoadjustsize)
- [setChildText](TProgressBar.md#setchildtext)
- [setChildTextWithDouble](TProgressBar.md#setchildtextwithdouble)
- [setChildTextWithInt](TProgressBar.md#setchildtextwithint)
- [setChildrenLayout](TProgressBar.md#setchildrenlayout)
- [setDirtyRectTolerance](TProgressBar.md#setdirtyrecttolerance)
- [setEnable](TProgressBar.md#setenable)
- [setFeedback](TProgressBar.md#setfeedback)
- [setFloating](TProgressBar.md#setfloating)
- [setFocusable](TProgressBar.md#setfocusable)
- [setFocused](TProgressBar.md#setfocused)
- [setFormat](TProgressBar.md#setformat)
- [setMax](TProgressBar.md#setmax)
- [setName](TProgressBar.md#setname)
- [setOpacity](TProgressBar.md#setopacity)
- [setPointerCursor](TProgressBar.md#setpointercursor)
- [setPropBool](TProgressBar.md#setpropbool)
- [setPropFloat](TProgressBar.md#setpropfloat)
- [setPropInt](TProgressBar.md#setpropint)
- [setPropPointer](TProgressBar.md#setproppointer)
- [setPropStr](TProgressBar.md#setpropstr)
- [setProps](TProgressBar.md#setprops)
- [setReverse](TProgressBar.md#setreverse)
- [setSelfLayout](TProgressBar.md#setselflayout)
- [setSelfLayoutParams](TProgressBar.md#setselflayoutparams)
- [setSensitive](TProgressBar.md#setsensitive)
- [setShowText](TProgressBar.md#setshowtext)
- [setState](TProgressBar.md#setstate)
- [setStyleColor](TProgressBar.md#setstylecolor)
- [setStyleInt](TProgressBar.md#setstyleint)
- [setStyleStr](TProgressBar.md#setstylestr)
- [setText](TProgressBar.md#settext)
- [setTextEx](TProgressBar.md#settextex)
- [setTheme](TProgressBar.md#settheme)
- [setTrText](TProgressBar.md#settrtext)
- [setValue](TProgressBar.md#setvalue)
- [setValueInt](TProgressBar.md#setvalueint)
- [setVertical](TProgressBar.md#setvertical)
- [setVisible](TProgressBar.md#setvisible)
- [setVisibleOnly](TProgressBar.md#setvisibleonly)
- [startAnimator](TProgressBar.md#startanimator)
- [stopAnimator](TProgressBar.md#stopanimator)
- [strokeBorderRect](TProgressBar.md#strokeborderrect)
- [unref](TProgressBar.md#unref)
- [updateStyle](TProgressBar.md#updatestyle)
- [updateStyleRecursive](TProgressBar.md#updatestylerecursive)
- [useStyle](TProgressBar.md#usestyle)
- [cast](TProgressBar.md#cast)
- [create](TProgressBar.md#create)

## Constructors

### constructor

• **new TProgressBar**(`nativeObj`)
...
[awtk.ts:25416](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25416)
...
[awtk.ts:25415](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25415)
...
[awtk.ts:25564](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25564)
...
[awtk.ts:25568](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25568)
...
[awtk.ts:25551](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25551)
...
[awtk.ts:25555](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25555)
...
[awtk.ts:25603](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25603)
...
[awtk.ts:25607](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25607)
...
[awtk.ts:25590](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25590)
...
[awtk.ts:25594](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25594)
...
[awtk.ts:25538](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25538)
...
[awtk.ts:25542](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25542)
...
[awtk.ts:25577](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25577)
...
[awtk.ts:25581](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25581)
...
[awtk.ts:25529](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25529)
...
[awtk.ts:25480](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25480)
...
[awtk.ts:25468](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25468)
...
[awtk.ts:25516](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25516)
...
[awtk.ts:25504](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25504)
...
[awtk.ts:25456](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25456)
...
[awtk.ts:25492](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25492)
...
▸ `Static` **cast**(`widget`): [`TProgressBar`](TProgressBar.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | progress_bar对象。 |
...
[awtk.ts:25444](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25444)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TProgressBar`](TProgressBar.md)
...
[awtk.ts:25432](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L25432)
