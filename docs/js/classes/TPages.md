[AWTK](../README.md) / [Exports](../modules.md) / TPages
...
- [constructor](TPages.md#constructor)

### Properties

- [nativeObj](TPages.md#nativeobj)

### Accessors

- [active](TPages.md#active)
- [animation](TPages.md#animation)
- [autoAdjustSize](TPages.md#autoadjustsize)
- [autoFocused](TPages.md#autofocused)
- [dirtyRectTolerance](TPages.md#dirtyrecttolerance)
- [enable](TPages.md#enable)
- [feedback](TPages.md#feedback)
- [floating](TPages.md#floating)
- [focusable](TPages.md#focusable)
- [h](TPages.md#h)
- [name](TPages.md#name)
- [opacity](TPages.md#opacity)
- [parent](TPages.md#parent)
- [pointerCursor](TPages.md#pointercursor)
- [sensitive](TPages.md#sensitive)
- [style](TPages.md#style)
- [trText](TPages.md#trtext)
- [visible](TPages.md#visible)
- [w](TPages.md#w)
- [withFocusState](TPages.md#withfocusstate)
- [x](TPages.md#x)
- [y](TPages.md#y)

### Methods

- [addChild](TPages.md#addchild)
- [addChildDefault](TPages.md#addchilddefault)
- [addValue](TPages.md#addvalue)
- [addValueInt](TPages.md#addvalueint)
- [animateValueTo](TPages.md#animatevalueto)
- [back](TPages.md#back)
- [backToHome](TPages.md#backtohome)
- [child](TPages.md#child)
- [clone](TPages.md#clone)
- [closeWindow](TPages.md#closewindow)
- [closeWindowForce](TPages.md#closewindowforce)
- [countChildren](TPages.md#countchildren)
- [createAnimator](TPages.md#createanimator)
- [destroy](TPages.md#destroy)
- [destroyAnimator](TPages.md#destroyanimator)
- [destroyAsync](TPages.md#destroyasync)
- [destroyChildren](TPages.md#destroychildren)
- [dispatchToKeyTarget](TPages.md#dispatchtokeytarget)
- [dispatchToTarget](TPages.md#dispatchtotarget)
- [equal](TPages.md#equal)
- [fillBgRect](TPages.md#fillbgrect)
- [fillFgRect](TPages.md#fillfgrect)
- [findParentByName](TPages.md#findparentbyname)
- [findParentByType](TPages.md#findparentbytype)
- [focusNext](TPages.md#focusnext)
- [focusPrev](TPages.md#focusprev)
- [foreach](TPages.md#foreach)
- [getAutoAdjustSize](TPages.md#getautoadjustsize)
- [getChild](TPages.md#getchild)
- [getEnable](TPages.md#getenable)
- [getFeedback](TPages.md#getfeedback)
- [getFloating](TPages.md#getfloating)
- [getFocusable](TPages.md#getfocusable)
- [getFocusedWidget](TPages.md#getfocusedwidget)
- [getNativeWindow](TPages.md#getnativewindow)
- [getPropBool](TPages.md#getpropbool)
- [getPropFloat](TPages.md#getpropfloat)
- [getPropInt](TPages.md#getpropint)
- [getPropPointer](TPages.md#getproppointer)
- [getPropStr](TPages.md#getpropstr)
- [getSensitive](TPages.md#getsensitive)
- [getStateForStyle](TPages.md#getstateforstyle)
- [getStyleType](TPages.md#getstyletype)
- [getText](TPages.md#gettext)
- [getThemeName](TPages.md#getthemename)
- [getType](TPages.md#gettype)
- [getValue](TPages.md#getvalue)
- [getValueInt](TPages.md#getvalueint)
- [getVisible](TPages.md#getvisible)
- [getWindow](TPages.md#getwindow)
- [getWindowManager](TPages.md#getwindowmanager)
- [getWithFocusState](TPages.md#getwithfocusstate)
- [indexOf](TPages.md#indexof)
- [insertChild](TPages.md#insertchild)
- [invalidateForce](TPages.md#invalidateforce)
- [isDesigningWindow](TPages.md#isdesigningwindow)
- [isDialog](TPages.md#isdialog)
- [isDirectParentOf](TPages.md#isdirectparentof)
- [isKeyboard](TPages.md#iskeyboard)
- [isNormalWindow](TPages.md#isnormalwindow)
- [isOpenedDialog](TPages.md#isopeneddialog)
- [isOpenedPopup](TPages.md#isopenedpopup)
- [isOverlay](TPages.md#isoverlay)
- [isParentOf](TPages.md#isparentof)
- [isPopup](TPages.md#ispopup)
- [isStyleExist](TPages.md#isstyleexist)
- [isSystemBar](TPages.md#issystembar)
- [isWindow](TPages.md#iswindow)
- [isWindowCreated](TPages.md#iswindowcreated)
- [isWindowManager](TPages.md#iswindowmanager)
- [isWindowOpened](TPages.md#iswindowopened)
- [layout](TPages.md#layout)
- [lookup](TPages.md#lookup)
- [lookupByType](TPages.md#lookupbytype)
- [move](TPages.md#move)
- [moveResize](TPages.md#moveresize)
- [moveResizeEx](TPages.md#moveresizeex)
- [moveToCenter](TPages.md#movetocenter)
- [off](TPages.md#off)
- [on](TPages.md#on)
- [pauseAnimator](TPages.md#pauseanimator)
- [removeChild](TPages.md#removechild)
- [resize](TPages.md#resize)
- [restack](TPages.md#restack)
- [setActive](TPages.md#setactive)
- [setActiveByName](TPages.md#setactivebyname)
- [setAnimation](TPages.md#setanimation)
- [setAnimatorTimeScale](TPages.md#setanimatortimescale)
- [setAsKeyTarget](TPages.md#setaskeytarget)
- [setAutoAdjustSize](TPages.md#setautoadjustsize)
- [setAutoFocused](TPages.md#setautofocused)
- [setChildText](TPages.md#setchildtext)
- [setChildTextWithDouble](TPages.md#setchildtextwithdouble)
- [setChildTextWithInt](TPages.md#setchildtextwithint)
- [setChildrenLayout](TPages.md#setchildrenlayout)
- [setDirtyRectTolerance](TPages.md#setdirtyrecttolerance)
- [setEnable](TPages.md#setenable)
- [setFeedback](TPages.md#setfeedback)
- [setFloating](TPages.md#setfloating)
- [setFocusable](TPages.md#setfocusable)
- [setFocused](TPages.md#setfocused)
- [setName](TPages.md#setname)
- [setOpacity](TPages.md#setopacity)
- [setPointerCursor](TPages.md#setpointercursor)
- [setPropBool](TPages.md#setpropbool)
- [setPropFloat](TPages.md#setpropfloat)
- [setPropInt](TPages.md#setpropint)
- [setPropPointer](TPages.md#setproppointer)
- [setPropStr](TPages.md#setpropstr)
- [setProps](TPages.md#setprops)
- [setSelfLayout](TPages.md#setselflayout)
- [setSelfLayoutParams](TPages.md#setselflayoutparams)
- [setSensitive](TPages.md#setsensitive)
- [setState](TPages.md#setstate)
- [setStyleColor](TPages.md#setstylecolor)
- [setStyleInt](TPages.md#setstyleint)
- [setStyleStr](TPages.md#setstylestr)
- [setText](TPages.md#settext)
- [setTextEx](TPages.md#settextex)
- [setTheme](TPages.md#settheme)
- [setTrText](TPages.md#settrtext)
- [setValue](TPages.md#setvalue)
- [setValueInt](TPages.md#setvalueint)
- [setVisible](TPages.md#setvisible)
- [setVisibleOnly](TPages.md#setvisibleonly)
- [startAnimator](TPages.md#startanimator)
- [stopAnimator](TPages.md#stopanimator)
- [strokeBorderRect](TPages.md#strokeborderrect)
- [unref](TPages.md#unref)
- [updateStyle](TPages.md#updatestyle)
- [updateStyleRecursive](TPages.md#updatestylerecursive)
- [useStyle](TPages.md#usestyle)
- [cast](TPages.md#cast)
- [create](TPages.md#create)

## Constructors

### constructor

• **new TPages**(`nativeObj`)
...
[awtk.ts:25257](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25257)
...
[awtk.ts:25256](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25256)
...
[awtk.ts:25330](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25330)
...
[awtk.ts:25334](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25334)
...
[awtk.ts:25343](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25343)

• `set` **autoFocused**(`v`): `void`
...
[awtk.ts:25347](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25347)
...
[awtk.ts:25297](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25297)

___

### setActiveByName

▸ **setActiveByName**(`name`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:25321](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25321)
...
▸ **setAutoFocused**(`auto_focused`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `auto_focused` | `boolean` | 切换界面时是否自动聚焦。 |
...
[awtk.ts:25309](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25309)
...
▸ `Static` **cast**(`widget`): [`TPages`](TPages.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | pages对象。 |
...
[awtk.ts:25285](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25285)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TPages`](TPages.md)
...
[awtk.ts:25273](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25273)
