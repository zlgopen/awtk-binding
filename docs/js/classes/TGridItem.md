[AWTK](../README.md) / [Exports](../modules.md) / TGridItem
...
- [constructor](TGridItem.md#constructor)

### Properties

- [nativeObj](TGridItem.md#nativeobj)

### Accessors

- [animation](TGridItem.md#animation)
- [autoAdjustSize](TGridItem.md#autoadjustsize)
- [dirtyRectTolerance](TGridItem.md#dirtyrecttolerance)
- [enable](TGridItem.md#enable)
- [feedback](TGridItem.md#feedback)
- [floating](TGridItem.md#floating)
- [focusable](TGridItem.md#focusable)
- [h](TGridItem.md#h)
- [name](TGridItem.md#name)
- [opacity](TGridItem.md#opacity)
- [parent](TGridItem.md#parent)
- [pointerCursor](TGridItem.md#pointercursor)
- [sensitive](TGridItem.md#sensitive)
- [style](TGridItem.md#style)
- [trText](TGridItem.md#trtext)
- [visible](TGridItem.md#visible)
- [w](TGridItem.md#w)
- [withFocusState](TGridItem.md#withfocusstate)
- [x](TGridItem.md#x)
- [y](TGridItem.md#y)

### Methods

- [addChild](TGridItem.md#addchild)
- [addChildDefault](TGridItem.md#addchilddefault)
- [addValue](TGridItem.md#addvalue)
- [addValueInt](TGridItem.md#addvalueint)
- [animateValueTo](TGridItem.md#animatevalueto)
- [back](TGridItem.md#back)
- [backToHome](TGridItem.md#backtohome)
- [child](TGridItem.md#child)
- [clone](TGridItem.md#clone)
- [closeWindow](TGridItem.md#closewindow)
- [closeWindowForce](TGridItem.md#closewindowforce)
- [countChildren](TGridItem.md#countchildren)
- [createAnimator](TGridItem.md#createanimator)
- [destroy](TGridItem.md#destroy)
- [destroyAnimator](TGridItem.md#destroyanimator)
- [destroyAsync](TGridItem.md#destroyasync)
- [destroyChildren](TGridItem.md#destroychildren)
- [dispatchToKeyTarget](TGridItem.md#dispatchtokeytarget)
- [dispatchToTarget](TGridItem.md#dispatchtotarget)
- [equal](TGridItem.md#equal)
- [fillBgRect](TGridItem.md#fillbgrect)
- [fillFgRect](TGridItem.md#fillfgrect)
- [findParentByName](TGridItem.md#findparentbyname)
- [findParentByType](TGridItem.md#findparentbytype)
- [focusNext](TGridItem.md#focusnext)
- [focusPrev](TGridItem.md#focusprev)
- [foreach](TGridItem.md#foreach)
- [getAutoAdjustSize](TGridItem.md#getautoadjustsize)
- [getChild](TGridItem.md#getchild)
- [getEnable](TGridItem.md#getenable)
- [getFeedback](TGridItem.md#getfeedback)
- [getFloating](TGridItem.md#getfloating)
- [getFocusable](TGridItem.md#getfocusable)
- [getFocusedWidget](TGridItem.md#getfocusedwidget)
- [getNativeWindow](TGridItem.md#getnativewindow)
- [getPropBool](TGridItem.md#getpropbool)
- [getPropFloat](TGridItem.md#getpropfloat)
- [getPropInt](TGridItem.md#getpropint)
- [getPropPointer](TGridItem.md#getproppointer)
- [getPropStr](TGridItem.md#getpropstr)
- [getSensitive](TGridItem.md#getsensitive)
- [getStateForStyle](TGridItem.md#getstateforstyle)
- [getStyleType](TGridItem.md#getstyletype)
- [getText](TGridItem.md#gettext)
- [getThemeName](TGridItem.md#getthemename)
- [getType](TGridItem.md#gettype)
- [getValue](TGridItem.md#getvalue)
- [getValueInt](TGridItem.md#getvalueint)
- [getVisible](TGridItem.md#getvisible)
- [getWindow](TGridItem.md#getwindow)
- [getWindowManager](TGridItem.md#getwindowmanager)
- [getWithFocusState](TGridItem.md#getwithfocusstate)
- [indexOf](TGridItem.md#indexof)
- [insertChild](TGridItem.md#insertchild)
- [invalidateForce](TGridItem.md#invalidateforce)
- [isDesigningWindow](TGridItem.md#isdesigningwindow)
- [isDialog](TGridItem.md#isdialog)
- [isDirectParentOf](TGridItem.md#isdirectparentof)
- [isKeyboard](TGridItem.md#iskeyboard)
- [isNormalWindow](TGridItem.md#isnormalwindow)
- [isOpenedDialog](TGridItem.md#isopeneddialog)
- [isOpenedPopup](TGridItem.md#isopenedpopup)
- [isOverlay](TGridItem.md#isoverlay)
- [isParentOf](TGridItem.md#isparentof)
- [isPopup](TGridItem.md#ispopup)
- [isStyleExist](TGridItem.md#isstyleexist)
- [isSystemBar](TGridItem.md#issystembar)
- [isWindow](TGridItem.md#iswindow)
- [isWindowCreated](TGridItem.md#iswindowcreated)
- [isWindowManager](TGridItem.md#iswindowmanager)
- [isWindowOpened](TGridItem.md#iswindowopened)
- [layout](TGridItem.md#layout)
- [lookup](TGridItem.md#lookup)
- [lookupByType](TGridItem.md#lookupbytype)
- [move](TGridItem.md#move)
- [moveResize](TGridItem.md#moveresize)
- [moveResizeEx](TGridItem.md#moveresizeex)
- [moveToCenter](TGridItem.md#movetocenter)
- [off](TGridItem.md#off)
- [on](TGridItem.md#on)
- [pauseAnimator](TGridItem.md#pauseanimator)
- [removeChild](TGridItem.md#removechild)
- [resize](TGridItem.md#resize)
- [restack](TGridItem.md#restack)
- [setAnimation](TGridItem.md#setanimation)
- [setAnimatorTimeScale](TGridItem.md#setanimatortimescale)
- [setAsKeyTarget](TGridItem.md#setaskeytarget)
- [setAutoAdjustSize](TGridItem.md#setautoadjustsize)
- [setChildText](TGridItem.md#setchildtext)
- [setChildTextWithDouble](TGridItem.md#setchildtextwithdouble)
- [setChildTextWithInt](TGridItem.md#setchildtextwithint)
- [setChildrenLayout](TGridItem.md#setchildrenlayout)
- [setDirtyRectTolerance](TGridItem.md#setdirtyrecttolerance)
- [setEnable](TGridItem.md#setenable)
- [setFeedback](TGridItem.md#setfeedback)
- [setFloating](TGridItem.md#setfloating)
- [setFocusable](TGridItem.md#setfocusable)
- [setFocused](TGridItem.md#setfocused)
- [setName](TGridItem.md#setname)
- [setOpacity](TGridItem.md#setopacity)
- [setPointerCursor](TGridItem.md#setpointercursor)
- [setPropBool](TGridItem.md#setpropbool)
- [setPropFloat](TGridItem.md#setpropfloat)
- [setPropInt](TGridItem.md#setpropint)
- [setPropPointer](TGridItem.md#setproppointer)
- [setPropStr](TGridItem.md#setpropstr)
- [setProps](TGridItem.md#setprops)
- [setSelfLayout](TGridItem.md#setselflayout)
- [setSelfLayoutParams](TGridItem.md#setselflayoutparams)
- [setSensitive](TGridItem.md#setsensitive)
- [setState](TGridItem.md#setstate)
- [setStyleColor](TGridItem.md#setstylecolor)
- [setStyleInt](TGridItem.md#setstyleint)
- [setStyleStr](TGridItem.md#setstylestr)
- [setText](TGridItem.md#settext)
- [setTextEx](TGridItem.md#settextex)
- [setTheme](TGridItem.md#settheme)
- [setTrText](TGridItem.md#settrtext)
- [setValue](TGridItem.md#setvalue)
- [setValueInt](TGridItem.md#setvalueint)
- [setVisible](TGridItem.md#setvisible)
- [setVisibleOnly](TGridItem.md#setvisibleonly)
- [startAnimator](TGridItem.md#startanimator)
- [stopAnimator](TGridItem.md#stopanimator)
- [strokeBorderRect](TGridItem.md#strokeborderrect)
- [unref](TGridItem.md#unref)
- [updateStyle](TGridItem.md#updatestyle)
- [updateStyleRecursive](TGridItem.md#updatestylerecursive)
- [useStyle](TGridItem.md#usestyle)
- [cast](TGridItem.md#cast)
- [create](TGridItem.md#create)

## Constructors

### constructor

• **new TGridItem**(`nativeObj`)
...
[awtk.ts:24796](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24796)
...
[awtk.ts:24795](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24795)
...
▸ `Static` **cast**(`widget`): [`TGridItem`](TGridItem.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | grid_item对象。 |
...
[awtk.ts:24824](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24824)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TGridItem`](TGridItem.md)
...
[awtk.ts:24812](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24812)
