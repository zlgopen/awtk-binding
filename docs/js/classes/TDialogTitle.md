[AWTK](../README.md) / [Exports](../modules.md) / TDialogTitle
...
- [constructor](TDialogTitle.md#constructor)

### Properties

- [nativeObj](TDialogTitle.md#nativeobj)

### Accessors

- [animation](TDialogTitle.md#animation)
- [autoAdjustSize](TDialogTitle.md#autoadjustsize)
- [dirtyRectTolerance](TDialogTitle.md#dirtyrecttolerance)
- [enable](TDialogTitle.md#enable)
- [feedback](TDialogTitle.md#feedback)
- [floating](TDialogTitle.md#floating)
- [focusable](TDialogTitle.md#focusable)
- [h](TDialogTitle.md#h)
- [name](TDialogTitle.md#name)
- [opacity](TDialogTitle.md#opacity)
- [parent](TDialogTitle.md#parent)
- [pointerCursor](TDialogTitle.md#pointercursor)
- [sensitive](TDialogTitle.md#sensitive)
- [style](TDialogTitle.md#style)
- [trText](TDialogTitle.md#trtext)
- [visible](TDialogTitle.md#visible)
- [w](TDialogTitle.md#w)
- [withFocusState](TDialogTitle.md#withfocusstate)
- [x](TDialogTitle.md#x)
- [y](TDialogTitle.md#y)

### Methods

- [addChild](TDialogTitle.md#addchild)
- [addChildDefault](TDialogTitle.md#addchilddefault)
- [addValue](TDialogTitle.md#addvalue)
- [addValueInt](TDialogTitle.md#addvalueint)
- [animateValueTo](TDialogTitle.md#animatevalueto)
- [back](TDialogTitle.md#back)
- [backToHome](TDialogTitle.md#backtohome)
- [child](TDialogTitle.md#child)
- [clone](TDialogTitle.md#clone)
- [closeWindow](TDialogTitle.md#closewindow)
- [closeWindowForce](TDialogTitle.md#closewindowforce)
- [countChildren](TDialogTitle.md#countchildren)
- [createAnimator](TDialogTitle.md#createanimator)
- [destroy](TDialogTitle.md#destroy)
- [destroyAnimator](TDialogTitle.md#destroyanimator)
- [destroyAsync](TDialogTitle.md#destroyasync)
- [destroyChildren](TDialogTitle.md#destroychildren)
- [dispatchToKeyTarget](TDialogTitle.md#dispatchtokeytarget)
- [dispatchToTarget](TDialogTitle.md#dispatchtotarget)
- [equal](TDialogTitle.md#equal)
- [fillBgRect](TDialogTitle.md#fillbgrect)
- [fillFgRect](TDialogTitle.md#fillfgrect)
- [findParentByName](TDialogTitle.md#findparentbyname)
- [findParentByType](TDialogTitle.md#findparentbytype)
- [focusNext](TDialogTitle.md#focusnext)
- [focusPrev](TDialogTitle.md#focusprev)
- [foreach](TDialogTitle.md#foreach)
- [getAutoAdjustSize](TDialogTitle.md#getautoadjustsize)
- [getChild](TDialogTitle.md#getchild)
- [getEnable](TDialogTitle.md#getenable)
- [getFeedback](TDialogTitle.md#getfeedback)
- [getFloating](TDialogTitle.md#getfloating)
- [getFocusable](TDialogTitle.md#getfocusable)
- [getFocusedWidget](TDialogTitle.md#getfocusedwidget)
- [getNativeWindow](TDialogTitle.md#getnativewindow)
- [getPropBool](TDialogTitle.md#getpropbool)
- [getPropFloat](TDialogTitle.md#getpropfloat)
- [getPropInt](TDialogTitle.md#getpropint)
- [getPropPointer](TDialogTitle.md#getproppointer)
- [getPropStr](TDialogTitle.md#getpropstr)
- [getSensitive](TDialogTitle.md#getsensitive)
- [getStateForStyle](TDialogTitle.md#getstateforstyle)
- [getStyleType](TDialogTitle.md#getstyletype)
- [getText](TDialogTitle.md#gettext)
- [getThemeName](TDialogTitle.md#getthemename)
- [getType](TDialogTitle.md#gettype)
- [getValue](TDialogTitle.md#getvalue)
- [getValueInt](TDialogTitle.md#getvalueint)
- [getVisible](TDialogTitle.md#getvisible)
- [getWindow](TDialogTitle.md#getwindow)
- [getWindowManager](TDialogTitle.md#getwindowmanager)
- [getWithFocusState](TDialogTitle.md#getwithfocusstate)
- [indexOf](TDialogTitle.md#indexof)
- [insertChild](TDialogTitle.md#insertchild)
- [invalidateForce](TDialogTitle.md#invalidateforce)
- [isDesigningWindow](TDialogTitle.md#isdesigningwindow)
- [isDialog](TDialogTitle.md#isdialog)
- [isDirectParentOf](TDialogTitle.md#isdirectparentof)
- [isKeyboard](TDialogTitle.md#iskeyboard)
- [isNormalWindow](TDialogTitle.md#isnormalwindow)
- [isOpenedDialog](TDialogTitle.md#isopeneddialog)
- [isOpenedPopup](TDialogTitle.md#isopenedpopup)
- [isOverlay](TDialogTitle.md#isoverlay)
- [isParentOf](TDialogTitle.md#isparentof)
- [isPopup](TDialogTitle.md#ispopup)
- [isStyleExist](TDialogTitle.md#isstyleexist)
- [isSystemBar](TDialogTitle.md#issystembar)
- [isWindow](TDialogTitle.md#iswindow)
- [isWindowCreated](TDialogTitle.md#iswindowcreated)
- [isWindowManager](TDialogTitle.md#iswindowmanager)
- [isWindowOpened](TDialogTitle.md#iswindowopened)
- [layout](TDialogTitle.md#layout)
- [lookup](TDialogTitle.md#lookup)
- [lookupByType](TDialogTitle.md#lookupbytype)
- [move](TDialogTitle.md#move)
- [moveResize](TDialogTitle.md#moveresize)
- [moveResizeEx](TDialogTitle.md#moveresizeex)
- [moveToCenter](TDialogTitle.md#movetocenter)
- [off](TDialogTitle.md#off)
- [on](TDialogTitle.md#on)
- [pauseAnimator](TDialogTitle.md#pauseanimator)
- [removeChild](TDialogTitle.md#removechild)
- [resize](TDialogTitle.md#resize)
- [restack](TDialogTitle.md#restack)
- [setAnimation](TDialogTitle.md#setanimation)
- [setAnimatorTimeScale](TDialogTitle.md#setanimatortimescale)
- [setAsKeyTarget](TDialogTitle.md#setaskeytarget)
- [setAutoAdjustSize](TDialogTitle.md#setautoadjustsize)
- [setChildText](TDialogTitle.md#setchildtext)
- [setChildTextWithDouble](TDialogTitle.md#setchildtextwithdouble)
- [setChildTextWithInt](TDialogTitle.md#setchildtextwithint)
- [setChildrenLayout](TDialogTitle.md#setchildrenlayout)
- [setDirtyRectTolerance](TDialogTitle.md#setdirtyrecttolerance)
- [setEnable](TDialogTitle.md#setenable)
- [setFeedback](TDialogTitle.md#setfeedback)
- [setFloating](TDialogTitle.md#setfloating)
- [setFocusable](TDialogTitle.md#setfocusable)
- [setFocused](TDialogTitle.md#setfocused)
- [setName](TDialogTitle.md#setname)
- [setOpacity](TDialogTitle.md#setopacity)
- [setPointerCursor](TDialogTitle.md#setpointercursor)
- [setPropBool](TDialogTitle.md#setpropbool)
- [setPropFloat](TDialogTitle.md#setpropfloat)
- [setPropInt](TDialogTitle.md#setpropint)
- [setPropPointer](TDialogTitle.md#setproppointer)
- [setPropStr](TDialogTitle.md#setpropstr)
- [setProps](TDialogTitle.md#setprops)
- [setSelfLayout](TDialogTitle.md#setselflayout)
- [setSelfLayoutParams](TDialogTitle.md#setselflayoutparams)
- [setSensitive](TDialogTitle.md#setsensitive)
- [setState](TDialogTitle.md#setstate)
- [setStyleColor](TDialogTitle.md#setstylecolor)
- [setStyleInt](TDialogTitle.md#setstyleint)
- [setStyleStr](TDialogTitle.md#setstylestr)
- [setText](TDialogTitle.md#settext)
- [setTextEx](TDialogTitle.md#settextex)
- [setTheme](TDialogTitle.md#settheme)
- [setTrText](TDialogTitle.md#settrtext)
- [setValue](TDialogTitle.md#setvalue)
- [setValueInt](TDialogTitle.md#setvalueint)
- [setVisible](TDialogTitle.md#setvisible)
- [setVisibleOnly](TDialogTitle.md#setvisibleonly)
- [startAnimator](TDialogTitle.md#startanimator)
- [stopAnimator](TDialogTitle.md#stopanimator)
- [strokeBorderRect](TDialogTitle.md#strokeborderrect)
- [unref](TDialogTitle.md#unref)
- [updateStyle](TDialogTitle.md#updatestyle)
- [updateStyleRecursive](TDialogTitle.md#updatestylerecursive)
- [useStyle](TDialogTitle.md#usestyle)
- [cast](TDialogTitle.md#cast)
- [create](TDialogTitle.md#create)

## Constructors

### constructor

• **new TDialogTitle**(`nativeObj`)
...
[awtk.ts:23923](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23923)
...
[awtk.ts:23922](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23922)
...
▸ `Static` **cast**(`widget`): [`TDialogTitle`](TDialogTitle.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | dialog_title对象。 |
...
[awtk.ts:23951](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23951)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TDialogTitle`](TDialogTitle.md)
...
[awtk.ts:23939](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23939)
