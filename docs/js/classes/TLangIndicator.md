[AWTK](../README.md) / [Exports](../modules.md) / TLangIndicator

# Class: TLangIndicator
...
- [constructor](TLangIndicator.md#constructor)

### Properties

- [nativeObj](TLangIndicator.md#nativeobj)

### Accessors

- [animation](TLangIndicator.md#animation)
- [autoAdjustSize](TLangIndicator.md#autoadjustsize)
- [dirtyRectTolerance](TLangIndicator.md#dirtyrecttolerance)
- [enable](TLangIndicator.md#enable)
- [feedback](TLangIndicator.md#feedback)
- [floating](TLangIndicator.md#floating)
- [focusable](TLangIndicator.md#focusable)
- [h](TLangIndicator.md#h)
- [image](TLangIndicator.md#image)
- [name](TLangIndicator.md#name)
- [opacity](TLangIndicator.md#opacity)
- [parent](TLangIndicator.md#parent)
- [pointerCursor](TLangIndicator.md#pointercursor)
- [sensitive](TLangIndicator.md#sensitive)
- [style](TLangIndicator.md#style)
- [trText](TLangIndicator.md#trtext)
- [visible](TLangIndicator.md#visible)
- [w](TLangIndicator.md#w)
- [withFocusState](TLangIndicator.md#withfocusstate)
- [x](TLangIndicator.md#x)
- [y](TLangIndicator.md#y)

### Methods

- [addChild](TLangIndicator.md#addchild)
- [addChildDefault](TLangIndicator.md#addchilddefault)
- [addValue](TLangIndicator.md#addvalue)
- [addValueInt](TLangIndicator.md#addvalueint)
- [animateValueTo](TLangIndicator.md#animatevalueto)
- [back](TLangIndicator.md#back)
- [backToHome](TLangIndicator.md#backtohome)
- [child](TLangIndicator.md#child)
- [clone](TLangIndicator.md#clone)
- [closeWindow](TLangIndicator.md#closewindow)
- [closeWindowForce](TLangIndicator.md#closewindowforce)
- [countChildren](TLangIndicator.md#countchildren)
- [createAnimator](TLangIndicator.md#createanimator)
- [destroy](TLangIndicator.md#destroy)
- [destroyAnimator](TLangIndicator.md#destroyanimator)
- [destroyAsync](TLangIndicator.md#destroyasync)
- [destroyChildren](TLangIndicator.md#destroychildren)
- [dispatchToKeyTarget](TLangIndicator.md#dispatchtokeytarget)
- [dispatchToTarget](TLangIndicator.md#dispatchtotarget)
- [equal](TLangIndicator.md#equal)
- [fillBgRect](TLangIndicator.md#fillbgrect)
- [fillFgRect](TLangIndicator.md#fillfgrect)
- [findParentByName](TLangIndicator.md#findparentbyname)
- [findParentByType](TLangIndicator.md#findparentbytype)
- [focusNext](TLangIndicator.md#focusnext)
- [focusPrev](TLangIndicator.md#focusprev)
- [foreach](TLangIndicator.md#foreach)
- [getAutoAdjustSize](TLangIndicator.md#getautoadjustsize)
- [getChild](TLangIndicator.md#getchild)
- [getEnable](TLangIndicator.md#getenable)
- [getFeedback](TLangIndicator.md#getfeedback)
- [getFloating](TLangIndicator.md#getfloating)
- [getFocusable](TLangIndicator.md#getfocusable)
- [getFocusedWidget](TLangIndicator.md#getfocusedwidget)
- [getNativeWindow](TLangIndicator.md#getnativewindow)
- [getPropBool](TLangIndicator.md#getpropbool)
- [getPropFloat](TLangIndicator.md#getpropfloat)
- [getPropInt](TLangIndicator.md#getpropint)
- [getPropPointer](TLangIndicator.md#getproppointer)
- [getPropStr](TLangIndicator.md#getpropstr)
- [getSensitive](TLangIndicator.md#getsensitive)
- [getStateForStyle](TLangIndicator.md#getstateforstyle)
- [getStyleType](TLangIndicator.md#getstyletype)
- [getText](TLangIndicator.md#gettext)
- [getThemeName](TLangIndicator.md#getthemename)
- [getType](TLangIndicator.md#gettype)
- [getValue](TLangIndicator.md#getvalue)
- [getValueInt](TLangIndicator.md#getvalueint)
- [getVisible](TLangIndicator.md#getvisible)
- [getWindow](TLangIndicator.md#getwindow)
- [getWindowManager](TLangIndicator.md#getwindowmanager)
- [getWithFocusState](TLangIndicator.md#getwithfocusstate)
- [indexOf](TLangIndicator.md#indexof)
- [insertChild](TLangIndicator.md#insertchild)
- [invalidateForce](TLangIndicator.md#invalidateforce)
- [isDesigningWindow](TLangIndicator.md#isdesigningwindow)
- [isDialog](TLangIndicator.md#isdialog)
- [isDirectParentOf](TLangIndicator.md#isdirectparentof)
- [isKeyboard](TLangIndicator.md#iskeyboard)
- [isNormalWindow](TLangIndicator.md#isnormalwindow)
- [isOpenedDialog](TLangIndicator.md#isopeneddialog)
- [isOpenedPopup](TLangIndicator.md#isopenedpopup)
- [isOverlay](TLangIndicator.md#isoverlay)
- [isParentOf](TLangIndicator.md#isparentof)
- [isPopup](TLangIndicator.md#ispopup)
- [isStyleExist](TLangIndicator.md#isstyleexist)
- [isSystemBar](TLangIndicator.md#issystembar)
- [isWindow](TLangIndicator.md#iswindow)
- [isWindowCreated](TLangIndicator.md#iswindowcreated)
- [isWindowManager](TLangIndicator.md#iswindowmanager)
- [isWindowOpened](TLangIndicator.md#iswindowopened)
- [layout](TLangIndicator.md#layout)
- [lookup](TLangIndicator.md#lookup)
- [lookupByType](TLangIndicator.md#lookupbytype)
- [move](TLangIndicator.md#move)
- [moveResize](TLangIndicator.md#moveresize)
- [moveResizeEx](TLangIndicator.md#moveresizeex)
- [moveToCenter](TLangIndicator.md#movetocenter)
- [off](TLangIndicator.md#off)
- [on](TLangIndicator.md#on)
- [pauseAnimator](TLangIndicator.md#pauseanimator)
- [removeChild](TLangIndicator.md#removechild)
- [resize](TLangIndicator.md#resize)
- [restack](TLangIndicator.md#restack)
- [setAnimation](TLangIndicator.md#setanimation)
- [setAnimatorTimeScale](TLangIndicator.md#setanimatortimescale)
- [setAsKeyTarget](TLangIndicator.md#setaskeytarget)
- [setAutoAdjustSize](TLangIndicator.md#setautoadjustsize)
- [setChildText](TLangIndicator.md#setchildtext)
- [setChildTextWithDouble](TLangIndicator.md#setchildtextwithdouble)
- [setChildTextWithInt](TLangIndicator.md#setchildtextwithint)
- [setChildrenLayout](TLangIndicator.md#setchildrenlayout)
- [setDirtyRectTolerance](TLangIndicator.md#setdirtyrecttolerance)
- [setEnable](TLangIndicator.md#setenable)
- [setFeedback](TLangIndicator.md#setfeedback)
- [setFloating](TLangIndicator.md#setfloating)
- [setFocusable](TLangIndicator.md#setfocusable)
- [setFocused](TLangIndicator.md#setfocused)
- [setImage](TLangIndicator.md#setimage)
- [setName](TLangIndicator.md#setname)
- [setOpacity](TLangIndicator.md#setopacity)
- [setPointerCursor](TLangIndicator.md#setpointercursor)
- [setPropBool](TLangIndicator.md#setpropbool)
- [setPropFloat](TLangIndicator.md#setpropfloat)
- [setPropInt](TLangIndicator.md#setpropint)
- [setPropPointer](TLangIndicator.md#setproppointer)
- [setPropStr](TLangIndicator.md#setpropstr)
- [setProps](TLangIndicator.md#setprops)
- [setSelfLayout](TLangIndicator.md#setselflayout)
- [setSelfLayoutParams](TLangIndicator.md#setselflayoutparams)
- [setSensitive](TLangIndicator.md#setsensitive)
- [setState](TLangIndicator.md#setstate)
- [setStyleColor](TLangIndicator.md#setstylecolor)
- [setStyleInt](TLangIndicator.md#setstyleint)
- [setStyleStr](TLangIndicator.md#setstylestr)
- [setText](TLangIndicator.md#settext)
- [setTextEx](TLangIndicator.md#settextex)
- [setTheme](TLangIndicator.md#settheme)
- [setTrText](TLangIndicator.md#settrtext)
- [setValue](TLangIndicator.md#setvalue)
- [setValueInt](TLangIndicator.md#setvalueint)
- [setVisible](TLangIndicator.md#setvisible)
- [setVisibleOnly](TLangIndicator.md#setvisibleonly)
- [startAnimator](TLangIndicator.md#startanimator)
- [stopAnimator](TLangIndicator.md#stopanimator)
- [strokeBorderRect](TLangIndicator.md#strokeborderrect)
- [unref](TLangIndicator.md#unref)
- [updateStyle](TLangIndicator.md#updatestyle)
- [updateStyleRecursive](TLangIndicator.md#updatestylerecursive)
- [useStyle](TLangIndicator.md#usestyle)
- [cast](TLangIndicator.md#cast)
- [create](TLangIndicator.md#create)

## Constructors

### constructor

• **new TLangIndicator**(`nativeObj`)
...
[awtk.ts:18103](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18103)
...
[awtk.ts:18102](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18102)
...
[awtk.ts:18152](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18152)
...
[awtk.ts:18156](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18156)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `image` | `string` | 缺省获得焦点的子控件(可用控件名或类型)。 |
...
[awtk.ts:18131](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18131)
...
▸ `Static` **cast**(`widget`): [`TLangIndicator`](TLangIndicator.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | lang_indicator对象。 |
...
[awtk.ts:18143](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18143)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TLangIndicator`](TLangIndicator.md)
...
[awtk.ts:18119](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18119)
