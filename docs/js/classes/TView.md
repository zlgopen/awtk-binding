[AWTK](../README.md) / [Exports](../modules.md) / TView
...
- [constructor](TView.md#constructor)

### Properties

- [nativeObj](TView.md#nativeobj)

### Accessors

- [animation](TView.md#animation)
- [autoAdjustSize](TView.md#autoadjustsize)
- [defaultFocusedChild](TView.md#defaultfocusedchild)
- [dirtyRectTolerance](TView.md#dirtyrecttolerance)
- [enable](TView.md#enable)
- [feedback](TView.md#feedback)
- [floating](TView.md#floating)
- [focusable](TView.md#focusable)
- [h](TView.md#h)
- [name](TView.md#name)
- [opacity](TView.md#opacity)
- [parent](TView.md#parent)
- [pointerCursor](TView.md#pointercursor)
- [sensitive](TView.md#sensitive)
- [style](TView.md#style)
- [trText](TView.md#trtext)
- [visible](TView.md#visible)
- [w](TView.md#w)
- [withFocusState](TView.md#withfocusstate)
- [x](TView.md#x)
- [y](TView.md#y)

### Methods

- [addChild](TView.md#addchild)
- [addChildDefault](TView.md#addchilddefault)
- [addValue](TView.md#addvalue)
- [addValueInt](TView.md#addvalueint)
- [animateValueTo](TView.md#animatevalueto)
- [back](TView.md#back)
- [backToHome](TView.md#backtohome)
- [child](TView.md#child)
- [clone](TView.md#clone)
- [closeWindow](TView.md#closewindow)
- [closeWindowForce](TView.md#closewindowforce)
- [countChildren](TView.md#countchildren)
- [createAnimator](TView.md#createanimator)
- [destroy](TView.md#destroy)
- [destroyAnimator](TView.md#destroyanimator)
- [destroyAsync](TView.md#destroyasync)
- [destroyChildren](TView.md#destroychildren)
- [dispatchToKeyTarget](TView.md#dispatchtokeytarget)
- [dispatchToTarget](TView.md#dispatchtotarget)
- [equal](TView.md#equal)
- [fillBgRect](TView.md#fillbgrect)
- [fillFgRect](TView.md#fillfgrect)
- [findParentByName](TView.md#findparentbyname)
- [findParentByType](TView.md#findparentbytype)
- [focusNext](TView.md#focusnext)
- [focusPrev](TView.md#focusprev)
- [foreach](TView.md#foreach)
- [getAutoAdjustSize](TView.md#getautoadjustsize)
- [getChild](TView.md#getchild)
- [getEnable](TView.md#getenable)
- [getFeedback](TView.md#getfeedback)
- [getFloating](TView.md#getfloating)
- [getFocusable](TView.md#getfocusable)
- [getFocusedWidget](TView.md#getfocusedwidget)
- [getNativeWindow](TView.md#getnativewindow)
- [getPropBool](TView.md#getpropbool)
- [getPropFloat](TView.md#getpropfloat)
- [getPropInt](TView.md#getpropint)
- [getPropPointer](TView.md#getproppointer)
- [getPropStr](TView.md#getpropstr)
- [getSensitive](TView.md#getsensitive)
- [getStateForStyle](TView.md#getstateforstyle)
- [getStyleType](TView.md#getstyletype)
- [getText](TView.md#gettext)
- [getThemeName](TView.md#getthemename)
- [getType](TView.md#gettype)
- [getValue](TView.md#getvalue)
- [getValueInt](TView.md#getvalueint)
- [getVisible](TView.md#getvisible)
- [getWindow](TView.md#getwindow)
- [getWindowManager](TView.md#getwindowmanager)
- [getWithFocusState](TView.md#getwithfocusstate)
- [indexOf](TView.md#indexof)
- [insertChild](TView.md#insertchild)
- [invalidateForce](TView.md#invalidateforce)
- [isDesigningWindow](TView.md#isdesigningwindow)
- [isDialog](TView.md#isdialog)
- [isDirectParentOf](TView.md#isdirectparentof)
- [isKeyboard](TView.md#iskeyboard)
- [isNormalWindow](TView.md#isnormalwindow)
- [isOpenedDialog](TView.md#isopeneddialog)
- [isOpenedPopup](TView.md#isopenedpopup)
- [isOverlay](TView.md#isoverlay)
- [isParentOf](TView.md#isparentof)
- [isPopup](TView.md#ispopup)
- [isStyleExist](TView.md#isstyleexist)
- [isSystemBar](TView.md#issystembar)
- [isWindow](TView.md#iswindow)
- [isWindowCreated](TView.md#iswindowcreated)
- [isWindowManager](TView.md#iswindowmanager)
- [isWindowOpened](TView.md#iswindowopened)
- [layout](TView.md#layout)
- [lookup](TView.md#lookup)
- [lookupByType](TView.md#lookupbytype)
- [move](TView.md#move)
- [moveResize](TView.md#moveresize)
- [moveResizeEx](TView.md#moveresizeex)
- [moveToCenter](TView.md#movetocenter)
- [off](TView.md#off)
- [on](TView.md#on)
- [pauseAnimator](TView.md#pauseanimator)
- [removeChild](TView.md#removechild)
- [resize](TView.md#resize)
- [restack](TView.md#restack)
- [setAnimation](TView.md#setanimation)
- [setAnimatorTimeScale](TView.md#setanimatortimescale)
- [setAsKeyTarget](TView.md#setaskeytarget)
- [setAutoAdjustSize](TView.md#setautoadjustsize)
- [setChildText](TView.md#setchildtext)
- [setChildTextWithDouble](TView.md#setchildtextwithdouble)
- [setChildTextWithInt](TView.md#setchildtextwithint)
- [setChildrenLayout](TView.md#setchildrenlayout)
- [setDefaultFocusedChild](TView.md#setdefaultfocusedchild)
- [setDirtyRectTolerance](TView.md#setdirtyrecttolerance)
- [setEnable](TView.md#setenable)
- [setFeedback](TView.md#setfeedback)
- [setFloating](TView.md#setfloating)
- [setFocusable](TView.md#setfocusable)
- [setFocused](TView.md#setfocused)
- [setName](TView.md#setname)
- [setOpacity](TView.md#setopacity)
- [setPointerCursor](TView.md#setpointercursor)
- [setPropBool](TView.md#setpropbool)
- [setPropFloat](TView.md#setpropfloat)
- [setPropInt](TView.md#setpropint)
- [setPropPointer](TView.md#setproppointer)
- [setPropStr](TView.md#setpropstr)
- [setProps](TView.md#setprops)
- [setSelfLayout](TView.md#setselflayout)
- [setSelfLayoutParams](TView.md#setselflayoutparams)
- [setSensitive](TView.md#setsensitive)
- [setState](TView.md#setstate)
- [setStyleColor](TView.md#setstylecolor)
- [setStyleInt](TView.md#setstyleint)
- [setStyleStr](TView.md#setstylestr)
- [setText](TView.md#settext)
- [setTextEx](TView.md#settextex)
- [setTheme](TView.md#settheme)
- [setTrText](TView.md#settrtext)
- [setValue](TView.md#setvalue)
- [setValueInt](TView.md#setvalueint)
- [setVisible](TView.md#setvisible)
- [setVisibleOnly](TView.md#setvisibleonly)
- [startAnimator](TView.md#startanimator)
- [stopAnimator](TView.md#stopanimator)
- [strokeBorderRect](TView.md#strokeborderrect)
- [unref](TView.md#unref)
- [updateStyle](TView.md#updatestyle)
- [updateStyleRecursive](TView.md#updatestylerecursive)
- [useStyle](TView.md#usestyle)
- [cast](TView.md#cast)
- [create](TView.md#create)
...
[awtk.ts:26330](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26330)
...
[awtk.ts:26329](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26329)
...
[awtk.ts:26383](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26383)

• `set` **defaultFocusedChild**(`v`): `void`
...
[awtk.ts:26387](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26387)
...
▸ **setDefaultFocusedChild**(`default_focused_child`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `default_focused_child` | `string` | 缺省获得焦点的子控件(可用控件名或类型)。 |
...
[awtk.ts:26358](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26358)
...
▸ `Static` **cast**(`widget`): [`TView`](TView.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | view对象。 |
...
[awtk.ts:26370](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26370)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TView`](TView.md)
...
[awtk.ts:26346](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26346)
