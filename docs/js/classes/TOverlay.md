[AWTK](../README.md) / [Exports](../modules.md) / TOverlay
...
- [constructor](TOverlay.md#constructor)

### Properties

- [nativeObj](TOverlay.md#nativeobj)

### Accessors

- [alwaysOnTop](TOverlay.md#alwaysontop)
- [animation](TOverlay.md#animation)
- [appletName](TOverlay.md#appletname)
- [autoAdjustSize](TOverlay.md#autoadjustsize)
- [autoScaleChildrenH](TOverlay.md#autoscalechildrenh)
- [autoScaleChildrenW](TOverlay.md#autoscalechildrenw)
- [autoScaleChildrenX](TOverlay.md#autoscalechildrenx)
- [autoScaleChildrenY](TOverlay.md#autoscalechildreny)
- [clickThrough](TOverlay.md#clickthrough)
- [closable](TOverlay.md#closable)
- [closeAnimHint](TOverlay.md#closeanimhint)
- [designH](TOverlay.md#designh)
- [designW](TOverlay.md#designw)
- [dirtyRectTolerance](TOverlay.md#dirtyrecttolerance)
- [disableAnim](TOverlay.md#disableanim)
- [enable](TOverlay.md#enable)
- [feedback](TOverlay.md#feedback)
- [floating](TOverlay.md#floating)
- [focusable](TOverlay.md#focusable)
- [h](TOverlay.md#h)
- [moveFocusDownKey](TOverlay.md#movefocusdownkey)
- [moveFocusLeftKey](TOverlay.md#movefocusleftkey)
- [moveFocusNextKey](TOverlay.md#movefocusnextkey)
- [moveFocusPrevKey](TOverlay.md#movefocusprevkey)
- [moveFocusRightKey](TOverlay.md#movefocusrightkey)
- [moveFocusUpKey](TOverlay.md#movefocusupkey)
- [name](TOverlay.md#name)
- [opacity](TOverlay.md#opacity)
- [openAnimHint](TOverlay.md#openanimhint)
- [parent](TOverlay.md#parent)
- [pointerCursor](TOverlay.md#pointercursor)
- [sensitive](TOverlay.md#sensitive)
- [singleInstance](TOverlay.md#singleinstance)
- [stronglyFocus](TOverlay.md#stronglyfocus)
- [style](TOverlay.md#style)
- [theme](TOverlay.md#theme)
- [trText](TOverlay.md#trtext)
- [visible](TOverlay.md#visible)
- [w](TOverlay.md#w)
- [withFocusState](TOverlay.md#withfocusstate)
- [x](TOverlay.md#x)
- [y](TOverlay.md#y)

### Methods

- [addChild](TOverlay.md#addchild)
- [addChildDefault](TOverlay.md#addchilddefault)
- [addValue](TOverlay.md#addvalue)
- [addValueInt](TOverlay.md#addvalueint)
- [animateValueTo](TOverlay.md#animatevalueto)
- [back](TOverlay.md#back)
- [backToHome](TOverlay.md#backtohome)
- [child](TOverlay.md#child)
- [clone](TOverlay.md#clone)
- [closeWindow](TOverlay.md#closewindow)
- [closeWindowForce](TOverlay.md#closewindowforce)
- [countChildren](TOverlay.md#countchildren)
- [createAnimator](TOverlay.md#createanimator)
- [destroy](TOverlay.md#destroy)
- [destroyAnimator](TOverlay.md#destroyanimator)
- [destroyAsync](TOverlay.md#destroyasync)
- [destroyChildren](TOverlay.md#destroychildren)
- [dispatchToKeyTarget](TOverlay.md#dispatchtokeytarget)
- [dispatchToTarget](TOverlay.md#dispatchtotarget)
- [equal](TOverlay.md#equal)
- [fillBgRect](TOverlay.md#fillbgrect)
- [fillFgRect](TOverlay.md#fillfgrect)
- [findParentByName](TOverlay.md#findparentbyname)
- [findParentByType](TOverlay.md#findparentbytype)
- [focusNext](TOverlay.md#focusnext)
- [focusPrev](TOverlay.md#focusprev)
- [foreach](TOverlay.md#foreach)
- [getAutoAdjustSize](TOverlay.md#getautoadjustsize)
- [getChild](TOverlay.md#getchild)
- [getEnable](TOverlay.md#getenable)
- [getFeedback](TOverlay.md#getfeedback)
- [getFloating](TOverlay.md#getfloating)
- [getFocusable](TOverlay.md#getfocusable)
- [getFocusedWidget](TOverlay.md#getfocusedwidget)
- [getNativeWindow](TOverlay.md#getnativewindow)
- [getPropBool](TOverlay.md#getpropbool)
- [getPropFloat](TOverlay.md#getpropfloat)
- [getPropInt](TOverlay.md#getpropint)
- [getPropPointer](TOverlay.md#getproppointer)
- [getPropStr](TOverlay.md#getpropstr)
- [getSensitive](TOverlay.md#getsensitive)
- [getStateForStyle](TOverlay.md#getstateforstyle)
- [getStyleType](TOverlay.md#getstyletype)
- [getText](TOverlay.md#gettext)
- [getThemeName](TOverlay.md#getthemename)
- [getType](TOverlay.md#gettype)
- [getValue](TOverlay.md#getvalue)
- [getValueInt](TOverlay.md#getvalueint)
- [getVisible](TOverlay.md#getvisible)
- [getWindow](TOverlay.md#getwindow)
- [getWindowManager](TOverlay.md#getwindowmanager)
- [getWithFocusState](TOverlay.md#getwithfocusstate)
- [indexOf](TOverlay.md#indexof)
- [insertChild](TOverlay.md#insertchild)
- [invalidateForce](TOverlay.md#invalidateforce)
- [isDesigningWindow](TOverlay.md#isdesigningwindow)
- [isDialog](TOverlay.md#isdialog)
- [isDirectParentOf](TOverlay.md#isdirectparentof)
- [isKeyboard](TOverlay.md#iskeyboard)
- [isNormalWindow](TOverlay.md#isnormalwindow)
- [isOpenedDialog](TOverlay.md#isopeneddialog)
- [isOpenedPopup](TOverlay.md#isopenedpopup)
- [isOverlay](TOverlay.md#isoverlay)
- [isParentOf](TOverlay.md#isparentof)
- [isPopup](TOverlay.md#ispopup)
- [isStyleExist](TOverlay.md#isstyleexist)
- [isSystemBar](TOverlay.md#issystembar)
- [isWindow](TOverlay.md#iswindow)
- [isWindowCreated](TOverlay.md#iswindowcreated)
- [isWindowManager](TOverlay.md#iswindowmanager)
- [isWindowOpened](TOverlay.md#iswindowopened)
- [layout](TOverlay.md#layout)
- [lookup](TOverlay.md#lookup)
- [lookupByType](TOverlay.md#lookupbytype)
- [move](TOverlay.md#move)
- [moveResize](TOverlay.md#moveresize)
- [moveResizeEx](TOverlay.md#moveresizeex)
- [moveToCenter](TOverlay.md#movetocenter)
- [off](TOverlay.md#off)
- [on](TOverlay.md#on)
- [pauseAnimator](TOverlay.md#pauseanimator)
- [removeChild](TOverlay.md#removechild)
- [resize](TOverlay.md#resize)
- [restack](TOverlay.md#restack)
- [setAlwaysOnTop](TOverlay.md#setalwaysontop)
- [setAnimation](TOverlay.md#setanimation)
- [setAnimatorTimeScale](TOverlay.md#setanimatortimescale)
- [setAsKeyTarget](TOverlay.md#setaskeytarget)
- [setAutoAdjustSize](TOverlay.md#setautoadjustsize)
- [setChildText](TOverlay.md#setchildtext)
- [setChildTextWithDouble](TOverlay.md#setchildtextwithdouble)
- [setChildTextWithInt](TOverlay.md#setchildtextwithint)
- [setChildrenLayout](TOverlay.md#setchildrenlayout)
- [setClickThrough](TOverlay.md#setclickthrough)
- [setDirtyRectTolerance](TOverlay.md#setdirtyrecttolerance)
- [setEnable](TOverlay.md#setenable)
- [setFeedback](TOverlay.md#setfeedback)
- [setFloating](TOverlay.md#setfloating)
- [setFocusable](TOverlay.md#setfocusable)
- [setFocused](TOverlay.md#setfocused)
- [setName](TOverlay.md#setname)
- [setOpacity](TOverlay.md#setopacity)
- [setPointerCursor](TOverlay.md#setpointercursor)
- [setPropBool](TOverlay.md#setpropbool)
- [setPropFloat](TOverlay.md#setpropfloat)
- [setPropInt](TOverlay.md#setpropint)
- [setPropPointer](TOverlay.md#setproppointer)
- [setPropStr](TOverlay.md#setpropstr)
- [setProps](TOverlay.md#setprops)
- [setSelfLayout](TOverlay.md#setselflayout)
- [setSelfLayoutParams](TOverlay.md#setselflayoutparams)
- [setSensitive](TOverlay.md#setsensitive)
- [setState](TOverlay.md#setstate)
- [setStyleColor](TOverlay.md#setstylecolor)
- [setStyleInt](TOverlay.md#setstyleint)
- [setStyleStr](TOverlay.md#setstylestr)
- [setText](TOverlay.md#settext)
- [setTextEx](TOverlay.md#settextex)
- [setTheme](TOverlay.md#settheme)
- [setTrText](TOverlay.md#settrtext)
- [setValue](TOverlay.md#setvalue)
- [setValueInt](TOverlay.md#setvalueint)
- [setVisible](TOverlay.md#setvisible)
- [setVisibleOnly](TOverlay.md#setvisibleonly)
- [startAnimator](TOverlay.md#startanimator)
- [stopAnimator](TOverlay.md#stopanimator)
- [strokeBorderRect](TOverlay.md#strokeborderrect)
- [unref](TOverlay.md#unref)
- [updateStyle](TOverlay.md#updatestyle)
- [updateStyleRecursive](TOverlay.md#updatestylerecursive)
- [useStyle](TOverlay.md#usestyle)
- [cast](TOverlay.md#cast)
- [create](TOverlay.md#create)

## Constructors

### constructor

• **new TOverlay**(`nativeObj`)
...
[awtk.ts:28482](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L28482)
...
[awtk.ts:28481](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L28481)
...
[awtk.ts:28560](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L28560)

• `set` **alwaysOnTop**(`v`): `void`
...
[awtk.ts:28564](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L28564)
...
[awtk.ts:28545](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L28545)

• `set` **clickThrough**(`v`): `void`
...
[awtk.ts:28549](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L28549)
...
▸ **setAlwaysOnTop**(`always_on_top`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `always_on_top` | `boolean` | 是否总是在最上面。 |
...
[awtk.ts:28522](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L28522)
...
▸ **setClickThrough**(`click_through`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `click_through` | `boolean` | 是否启用点击穿透。 |
...
[awtk.ts:28510](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L28510)
...
▸ `Static` **cast**(`widget`): [`TOverlay`](TOverlay.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | overlay对象。 |
...
[awtk.ts:28534](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L28534)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TOverlay`](TOverlay.md)
...
[awtk.ts:28498](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L28498)
