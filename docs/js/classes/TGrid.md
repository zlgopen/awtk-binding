[AWTK](../README.md) / [Exports](../modules.md) / TGrid
...
- [constructor](TGrid.md#constructor)

### Properties

- [nativeObj](TGrid.md#nativeobj)

### Accessors

- [animation](TGrid.md#animation)
- [autoAdjustSize](TGrid.md#autoadjustsize)
- [columnsDefinition](TGrid.md#columnsdefinition)
- [dirtyRectTolerance](TGrid.md#dirtyrecttolerance)
- [enable](TGrid.md#enable)
- [feedback](TGrid.md#feedback)
- [floating](TGrid.md#floating)
- [focusable](TGrid.md#focusable)
- [h](TGrid.md#h)
- [name](TGrid.md#name)
- [opacity](TGrid.md#opacity)
- [parent](TGrid.md#parent)
- [pointerCursor](TGrid.md#pointercursor)
- [rows](TGrid.md#rows)
- [sensitive](TGrid.md#sensitive)
- [showGrid](TGrid.md#showgrid)
- [style](TGrid.md#style)
- [trText](TGrid.md#trtext)
- [visible](TGrid.md#visible)
- [w](TGrid.md#w)
- [withFocusState](TGrid.md#withfocusstate)
- [x](TGrid.md#x)
- [y](TGrid.md#y)

### Methods

- [addChild](TGrid.md#addchild)
- [addChildDefault](TGrid.md#addchilddefault)
- [addValue](TGrid.md#addvalue)
- [addValueInt](TGrid.md#addvalueint)
- [animateValueTo](TGrid.md#animatevalueto)
- [back](TGrid.md#back)
- [backToHome](TGrid.md#backtohome)
- [child](TGrid.md#child)
- [clone](TGrid.md#clone)
- [closeWindow](TGrid.md#closewindow)
- [closeWindowForce](TGrid.md#closewindowforce)
- [countChildren](TGrid.md#countchildren)
- [createAnimator](TGrid.md#createanimator)
- [destroy](TGrid.md#destroy)
- [destroyAnimator](TGrid.md#destroyanimator)
- [destroyAsync](TGrid.md#destroyasync)
- [destroyChildren](TGrid.md#destroychildren)
- [dispatchToKeyTarget](TGrid.md#dispatchtokeytarget)
- [dispatchToTarget](TGrid.md#dispatchtotarget)
- [equal](TGrid.md#equal)
- [fillBgRect](TGrid.md#fillbgrect)
- [fillFgRect](TGrid.md#fillfgrect)
- [findParentByName](TGrid.md#findparentbyname)
- [findParentByType](TGrid.md#findparentbytype)
- [focusNext](TGrid.md#focusnext)
- [focusPrev](TGrid.md#focusprev)
- [foreach](TGrid.md#foreach)
- [getAutoAdjustSize](TGrid.md#getautoadjustsize)
- [getChild](TGrid.md#getchild)
- [getEnable](TGrid.md#getenable)
- [getFeedback](TGrid.md#getfeedback)
- [getFloating](TGrid.md#getfloating)
- [getFocusable](TGrid.md#getfocusable)
- [getFocusedWidget](TGrid.md#getfocusedwidget)
- [getNativeWindow](TGrid.md#getnativewindow)
- [getPropBool](TGrid.md#getpropbool)
- [getPropFloat](TGrid.md#getpropfloat)
- [getPropInt](TGrid.md#getpropint)
- [getPropPointer](TGrid.md#getproppointer)
- [getPropStr](TGrid.md#getpropstr)
- [getSensitive](TGrid.md#getsensitive)
- [getStateForStyle](TGrid.md#getstateforstyle)
- [getStyleType](TGrid.md#getstyletype)
- [getText](TGrid.md#gettext)
- [getThemeName](TGrid.md#getthemename)
- [getType](TGrid.md#gettype)
- [getValue](TGrid.md#getvalue)
- [getValueInt](TGrid.md#getvalueint)
- [getVisible](TGrid.md#getvisible)
- [getWindow](TGrid.md#getwindow)
- [getWindowManager](TGrid.md#getwindowmanager)
- [getWithFocusState](TGrid.md#getwithfocusstate)
- [indexOf](TGrid.md#indexof)
- [insertChild](TGrid.md#insertchild)
- [invalidateForce](TGrid.md#invalidateforce)
- [isDesigningWindow](TGrid.md#isdesigningwindow)
- [isDialog](TGrid.md#isdialog)
- [isDirectParentOf](TGrid.md#isdirectparentof)
- [isKeyboard](TGrid.md#iskeyboard)
- [isNormalWindow](TGrid.md#isnormalwindow)
- [isOpenedDialog](TGrid.md#isopeneddialog)
- [isOpenedPopup](TGrid.md#isopenedpopup)
- [isOverlay](TGrid.md#isoverlay)
- [isParentOf](TGrid.md#isparentof)
- [isPopup](TGrid.md#ispopup)
- [isStyleExist](TGrid.md#isstyleexist)
- [isSystemBar](TGrid.md#issystembar)
- [isWindow](TGrid.md#iswindow)
- [isWindowCreated](TGrid.md#iswindowcreated)
- [isWindowManager](TGrid.md#iswindowmanager)
- [isWindowOpened](TGrid.md#iswindowopened)
- [layout](TGrid.md#layout)
- [lookup](TGrid.md#lookup)
- [lookupByType](TGrid.md#lookupbytype)
- [move](TGrid.md#move)
- [moveResize](TGrid.md#moveresize)
- [moveResizeEx](TGrid.md#moveresizeex)
- [moveToCenter](TGrid.md#movetocenter)
- [off](TGrid.md#off)
- [on](TGrid.md#on)
- [pauseAnimator](TGrid.md#pauseanimator)
- [removeChild](TGrid.md#removechild)
- [resize](TGrid.md#resize)
- [restack](TGrid.md#restack)
- [setAnimation](TGrid.md#setanimation)
- [setAnimatorTimeScale](TGrid.md#setanimatortimescale)
- [setAsKeyTarget](TGrid.md#setaskeytarget)
- [setAutoAdjustSize](TGrid.md#setautoadjustsize)
- [setChildText](TGrid.md#setchildtext)
- [setChildTextWithDouble](TGrid.md#setchildtextwithdouble)
- [setChildTextWithInt](TGrid.md#setchildtextwithint)
- [setChildrenLayout](TGrid.md#setchildrenlayout)
- [setColumnsDefinition](TGrid.md#setcolumnsdefinition)
- [setDirtyRectTolerance](TGrid.md#setdirtyrecttolerance)
- [setEnable](TGrid.md#setenable)
- [setFeedback](TGrid.md#setfeedback)
- [setFloating](TGrid.md#setfloating)
- [setFocusable](TGrid.md#setfocusable)
- [setFocused](TGrid.md#setfocused)
- [setName](TGrid.md#setname)
- [setOpacity](TGrid.md#setopacity)
- [setPointerCursor](TGrid.md#setpointercursor)
- [setPropBool](TGrid.md#setpropbool)
- [setPropFloat](TGrid.md#setpropfloat)
- [setPropInt](TGrid.md#setpropint)
- [setPropPointer](TGrid.md#setproppointer)
- [setPropStr](TGrid.md#setpropstr)
- [setProps](TGrid.md#setprops)
- [setRows](TGrid.md#setrows)
- [setSelfLayout](TGrid.md#setselflayout)
- [setSelfLayoutParams](TGrid.md#setselflayoutparams)
- [setSensitive](TGrid.md#setsensitive)
- [setShowGrid](TGrid.md#setshowgrid)
- [setState](TGrid.md#setstate)
- [setStyleColor](TGrid.md#setstylecolor)
- [setStyleInt](TGrid.md#setstyleint)
- [setStyleStr](TGrid.md#setstylestr)
- [setText](TGrid.md#settext)
- [setTextEx](TGrid.md#settextex)
- [setTheme](TGrid.md#settheme)
- [setTrText](TGrid.md#settrtext)
- [setValue](TGrid.md#setvalue)
- [setValueInt](TGrid.md#setvalueint)
- [setVisible](TGrid.md#setvisible)
- [setVisibleOnly](TGrid.md#setvisibleonly)
- [startAnimator](TGrid.md#startanimator)
- [stopAnimator](TGrid.md#stopanimator)
- [strokeBorderRect](TGrid.md#strokeborderrect)
- [unref](TGrid.md#unref)
- [updateStyle](TGrid.md#updatestyle)
- [updateStyleRecursive](TGrid.md#updatestylerecursive)
- [useStyle](TGrid.md#usestyle)
- [cast](TGrid.md#cast)
- [create](TGrid.md#create)
...
[awtk.ts:24852](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24852)
...
[awtk.ts:24851](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24851)
...
[awtk.ts:24950](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24950)

• `set` **columnsDefinition**(`v`): `void`
...
[awtk.ts:24954](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24954)
...
[awtk.ts:24925](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24925)
...
[awtk.ts:24929](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24929)
...
[awtk.ts:24963](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24963)
...
[awtk.ts:24967](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24967)
...
▸ **setColumnsDefinition**(`columns_definition`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `columns_definition` | `string` | 各列的参数。 |
...
[awtk.ts:24904](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24904)
...
▸ **setRows**(`rows`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:24892](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24892)
...
▸ **setShowGrid**(`show_grid`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:24916](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24916)
...
▸ `Static` **cast**(`widget`): [`TGrid`](TGrid.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | grid对象。 |
...
[awtk.ts:24880](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24880)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TGrid`](TGrid.md)
...
[awtk.ts:24868](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L24868)
