[AWTK](../README.md) / [Exports](../modules.md) / TWindowManager
...
- [constructor](TWindowManager.md#constructor)

### Properties

- [nativeObj](TWindowManager.md#nativeobj)

### Accessors

- [animation](TWindowManager.md#animation)
- [autoAdjustSize](TWindowManager.md#autoadjustsize)
- [dirtyRectTolerance](TWindowManager.md#dirtyrecttolerance)
- [enable](TWindowManager.md#enable)
- [feedback](TWindowManager.md#feedback)
- [floating](TWindowManager.md#floating)
- [focusable](TWindowManager.md#focusable)
- [h](TWindowManager.md#h)
- [name](TWindowManager.md#name)
- [opacity](TWindowManager.md#opacity)
- [parent](TWindowManager.md#parent)
- [pointerCursor](TWindowManager.md#pointercursor)
- [sensitive](TWindowManager.md#sensitive)
- [style](TWindowManager.md#style)
- [trText](TWindowManager.md#trtext)
- [visible](TWindowManager.md#visible)
- [w](TWindowManager.md#w)
- [withFocusState](TWindowManager.md#withfocusstate)
- [x](TWindowManager.md#x)
- [y](TWindowManager.md#y)

### Methods

- [addChild](TWindowManager.md#addchild)
- [addChildDefault](TWindowManager.md#addchilddefault)
- [addValue](TWindowManager.md#addvalue)
- [addValueInt](TWindowManager.md#addvalueint)
- [animateValueTo](TWindowManager.md#animatevalueto)
- [back](TWindowManager.md#back)
- [backTo](TWindowManager.md#backto)
- [backToHome](TWindowManager.md#backtohome)
- [child](TWindowManager.md#child)
- [clone](TWindowManager.md#clone)
- [closeAll](TWindowManager.md#closeall)
- [closeWindow](TWindowManager.md#closewindow)
- [closeWindowForce](TWindowManager.md#closewindowforce)
- [countChildren](TWindowManager.md#countchildren)
- [createAnimator](TWindowManager.md#createanimator)
- [destroy](TWindowManager.md#destroy)
- [destroyAnimator](TWindowManager.md#destroyanimator)
- [destroyAsync](TWindowManager.md#destroyasync)
- [destroyChildren](TWindowManager.md#destroychildren)
- [dispatchToKeyTarget](TWindowManager.md#dispatchtokeytarget)
- [dispatchToTarget](TWindowManager.md#dispatchtotarget)
- [equal](TWindowManager.md#equal)
- [fillBgRect](TWindowManager.md#fillbgrect)
- [fillFgRect](TWindowManager.md#fillfgrect)
- [findParentByName](TWindowManager.md#findparentbyname)
- [findParentByType](TWindowManager.md#findparentbytype)
- [focusNext](TWindowManager.md#focusnext)
- [focusPrev](TWindowManager.md#focusprev)
- [foreach](TWindowManager.md#foreach)
- [getAutoAdjustSize](TWindowManager.md#getautoadjustsize)
- [getChild](TWindowManager.md#getchild)
- [getEnable](TWindowManager.md#getenable)
- [getFeedback](TWindowManager.md#getfeedback)
- [getFloating](TWindowManager.md#getfloating)
- [getFocusable](TWindowManager.md#getfocusable)
- [getFocusedWidget](TWindowManager.md#getfocusedwidget)
- [getNativeWindow](TWindowManager.md#getnativewindow)
- [getPointerPressed](TWindowManager.md#getpointerpressed)
- [getPointerX](TWindowManager.md#getpointerx)
- [getPointerY](TWindowManager.md#getpointery)
- [getPrevWindow](TWindowManager.md#getprevwindow)
- [getPropBool](TWindowManager.md#getpropbool)
- [getPropFloat](TWindowManager.md#getpropfloat)
- [getPropInt](TWindowManager.md#getpropint)
- [getPropPointer](TWindowManager.md#getproppointer)
- [getPropStr](TWindowManager.md#getpropstr)
- [getSensitive](TWindowManager.md#getsensitive)
- [getStateForStyle](TWindowManager.md#getstateforstyle)
- [getStyleType](TWindowManager.md#getstyletype)
- [getText](TWindowManager.md#gettext)
- [getThemeName](TWindowManager.md#getthemename)
- [getTopMainWindow](TWindowManager.md#gettopmainwindow)
- [getTopWindow](TWindowManager.md#gettopwindow)
- [getType](TWindowManager.md#gettype)
- [getValue](TWindowManager.md#getvalue)
- [getValueInt](TWindowManager.md#getvalueint)
- [getVisible](TWindowManager.md#getvisible)
- [getWindow](TWindowManager.md#getwindow)
- [getWindowManager](TWindowManager.md#getwindowmanager)
- [getWithFocusState](TWindowManager.md#getwithfocusstate)
- [indexOf](TWindowManager.md#indexof)
- [insertChild](TWindowManager.md#insertchild)
- [invalidateForce](TWindowManager.md#invalidateforce)
- [isAnimating](TWindowManager.md#isanimating)
- [isDesigningWindow](TWindowManager.md#isdesigningwindow)
- [isDialog](TWindowManager.md#isdialog)
- [isDirectParentOf](TWindowManager.md#isdirectparentof)
- [isKeyboard](TWindowManager.md#iskeyboard)
- [isNormalWindow](TWindowManager.md#isnormalwindow)
- [isOpenedDialog](TWindowManager.md#isopeneddialog)
- [isOpenedPopup](TWindowManager.md#isopenedpopup)
- [isOverlay](TWindowManager.md#isoverlay)
- [isParentOf](TWindowManager.md#isparentof)
- [isPopup](TWindowManager.md#ispopup)
- [isStyleExist](TWindowManager.md#isstyleexist)
- [isSystemBar](TWindowManager.md#issystembar)
- [isWindow](TWindowManager.md#iswindow)
- [isWindowCreated](TWindowManager.md#iswindowcreated)
- [isWindowManager](TWindowManager.md#iswindowmanager)
- [isWindowOpened](TWindowManager.md#iswindowopened)
- [layout](TWindowManager.md#layout)
- [lookup](TWindowManager.md#lookup)
- [lookupByType](TWindowManager.md#lookupbytype)
- [move](TWindowManager.md#move)
- [moveResize](TWindowManager.md#moveresize)
- [moveResizeEx](TWindowManager.md#moveresizeex)
- [moveToCenter](TWindowManager.md#movetocenter)
- [off](TWindowManager.md#off)
- [on](TWindowManager.md#on)
- [pauseAnimator](TWindowManager.md#pauseanimator)
- [removeChild](TWindowManager.md#removechild)
- [resize](TWindowManager.md#resize)
- [restack](TWindowManager.md#restack)
- [setAnimation](TWindowManager.md#setanimation)
- [setAnimatorTimeScale](TWindowManager.md#setanimatortimescale)
- [setAsKeyTarget](TWindowManager.md#setaskeytarget)
- [setAutoAdjustSize](TWindowManager.md#setautoadjustsize)
- [setChildText](TWindowManager.md#setchildtext)
- [setChildTextWithDouble](TWindowManager.md#setchildtextwithdouble)
- [setChildTextWithInt](TWindowManager.md#setchildtextwithint)
- [setChildrenLayout](TWindowManager.md#setchildrenlayout)
- [setCursor](TWindowManager.md#setcursor)
- [setDirtyRectTolerance](TWindowManager.md#setdirtyrecttolerance)
- [setEnable](TWindowManager.md#setenable)
- [setFeedback](TWindowManager.md#setfeedback)
- [setFloating](TWindowManager.md#setfloating)
- [setFocusable](TWindowManager.md#setfocusable)
- [setFocused](TWindowManager.md#setfocused)
- [setIgnoreInputEvents](TWindowManager.md#setignoreinputevents)
- [setMaxFps](TWindowManager.md#setmaxfps)
- [setName](TWindowManager.md#setname)
- [setOpacity](TWindowManager.md#setopacity)
- [setPointerCursor](TWindowManager.md#setpointercursor)
- [setPropBool](TWindowManager.md#setpropbool)
- [setPropFloat](TWindowManager.md#setpropfloat)
- [setPropInt](TWindowManager.md#setpropint)
- [setPropPointer](TWindowManager.md#setproppointer)
- [setPropStr](TWindowManager.md#setpropstr)
- [setProps](TWindowManager.md#setprops)
- [setScreenSaverTime](TWindowManager.md#setscreensavertime)
- [setSelfLayout](TWindowManager.md#setselflayout)
- [setSelfLayoutParams](TWindowManager.md#setselflayoutparams)
- [setSensitive](TWindowManager.md#setsensitive)
- [setShowFps](TWindowManager.md#setshowfps)
- [setState](TWindowManager.md#setstate)
- [setStyleColor](TWindowManager.md#setstylecolor)
- [setStyleInt](TWindowManager.md#setstyleint)
- [setStyleStr](TWindowManager.md#setstylestr)
- [setText](TWindowManager.md#settext)
- [setTextEx](TWindowManager.md#settextex)
- [setTheme](TWindowManager.md#settheme)
- [setTrText](TWindowManager.md#settrtext)
- [setValue](TWindowManager.md#setvalue)
- [setValueInt](TWindowManager.md#setvalueint)
- [setVisible](TWindowManager.md#setvisible)
- [setVisibleOnly](TWindowManager.md#setvisibleonly)
- [startAnimator](TWindowManager.md#startanimator)
- [stopAnimator](TWindowManager.md#stopanimator)
- [strokeBorderRect](TWindowManager.md#strokeborderrect)
- [unref](TWindowManager.md#unref)
- [updateStyle](TWindowManager.md#updatestyle)
- [updateStyleRecursive](TWindowManager.md#updatestylerecursive)
- [useStyle](TWindowManager.md#usestyle)
- [cast](TWindowManager.md#cast)
- [instance](TWindowManager.md#instance)

## Constructors

### constructor

• **new TWindowManager**(`nativeObj`)
...
[awtk.ts:15805](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15805)
...
[awtk.ts:15804](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15804)
...
[awtk.ts:15980](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15980)

___

### backTo

▸ **backTo**(`target`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:16007](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L16007)
...
[awtk.ts:15993](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15993)
...
[awtk.ts:16031](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L16031)
...
[awtk.ts:15894](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15894)
...
[awtk.ts:15872](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15872)
...
[awtk.ts:15883](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15883)

___

### getPrevWindow

▸ **getPrevWindow**(): [`TWidget`](TWidget.md)
...
[awtk.ts:15861](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15861)
...
▸ **getTopMainWindow**(): [`TWidget`](TWidget.md)
...
[awtk.ts:15839](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15839)

___

### getTopWindow

▸ **getTopWindow**(): [`TWidget`](TWidget.md)
...
[awtk.ts:15850](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15850)
...
返回TRUE表示正在播放，FALSE表示没有播放。

#### Defined in

[awtk.ts:15905](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15905)
...
[awtk.ts:16020](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L16020)
...
[awtk.ts:15967](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15967)
...
▸ **setIgnoreInputEvents**(`ignore_input_events`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `ignore_input_events` | `boolean` | 是否忽略用户输入事件。 |
...
[awtk.ts:15943](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15943)

___

### setMaxFps

▸ **setMaxFps**(`max_fps`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:15931](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15931)
...
▸ **setScreenSaverTime**(`screen_saver_time`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `screen_saver_time` | `number` | 屏保时间(单位毫秒), 为0关闭屏保。 |
...
[awtk.ts:15955](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15955)
...
▸ **setShowFps**(`show_fps`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:15917](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15917)
...
▸ `Static` **cast**(`widget`): [`TWindowManager`](TWindowManager.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | window_manager对象。 |
...
[awtk.ts:15828](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15828)

___

### instance

▸ `Static` **instance**(): [`TWindowManager`](TWindowManager.md)
...
[awtk.ts:15816](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15816)
