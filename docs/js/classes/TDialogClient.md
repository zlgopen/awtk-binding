[AWTK](../README.md) / [Exports](../modules.md) / TDialogClient
...
- [constructor](TDialogClient.md#constructor)

### Properties

- [nativeObj](TDialogClient.md#nativeobj)

### Accessors

- [animation](TDialogClient.md#animation)
- [autoAdjustSize](TDialogClient.md#autoadjustsize)
- [dirtyRectTolerance](TDialogClient.md#dirtyrecttolerance)
- [enable](TDialogClient.md#enable)
- [feedback](TDialogClient.md#feedback)
- [floating](TDialogClient.md#floating)
- [focusable](TDialogClient.md#focusable)
- [h](TDialogClient.md#h)
- [name](TDialogClient.md#name)
- [opacity](TDialogClient.md#opacity)
- [parent](TDialogClient.md#parent)
- [pointerCursor](TDialogClient.md#pointercursor)
- [sensitive](TDialogClient.md#sensitive)
- [style](TDialogClient.md#style)
- [trText](TDialogClient.md#trtext)
- [visible](TDialogClient.md#visible)
- [w](TDialogClient.md#w)
- [withFocusState](TDialogClient.md#withfocusstate)
- [x](TDialogClient.md#x)
- [y](TDialogClient.md#y)

### Methods

- [addChild](TDialogClient.md#addchild)
- [addChildDefault](TDialogClient.md#addchilddefault)
- [addValue](TDialogClient.md#addvalue)
- [addValueInt](TDialogClient.md#addvalueint)
- [animateValueTo](TDialogClient.md#animatevalueto)
- [back](TDialogClient.md#back)
- [backToHome](TDialogClient.md#backtohome)
- [child](TDialogClient.md#child)
- [clone](TDialogClient.md#clone)
- [closeWindow](TDialogClient.md#closewindow)
- [closeWindowForce](TDialogClient.md#closewindowforce)
- [countChildren](TDialogClient.md#countchildren)
- [createAnimator](TDialogClient.md#createanimator)
- [destroy](TDialogClient.md#destroy)
- [destroyAnimator](TDialogClient.md#destroyanimator)
- [destroyAsync](TDialogClient.md#destroyasync)
- [destroyChildren](TDialogClient.md#destroychildren)
- [dispatchToKeyTarget](TDialogClient.md#dispatchtokeytarget)
- [dispatchToTarget](TDialogClient.md#dispatchtotarget)
- [equal](TDialogClient.md#equal)
- [fillBgRect](TDialogClient.md#fillbgrect)
- [fillFgRect](TDialogClient.md#fillfgrect)
- [findParentByName](TDialogClient.md#findparentbyname)
- [findParentByType](TDialogClient.md#findparentbytype)
- [focusNext](TDialogClient.md#focusnext)
- [focusPrev](TDialogClient.md#focusprev)
- [foreach](TDialogClient.md#foreach)
- [getAutoAdjustSize](TDialogClient.md#getautoadjustsize)
- [getChild](TDialogClient.md#getchild)
- [getEnable](TDialogClient.md#getenable)
- [getFeedback](TDialogClient.md#getfeedback)
- [getFloating](TDialogClient.md#getfloating)
- [getFocusable](TDialogClient.md#getfocusable)
- [getFocusedWidget](TDialogClient.md#getfocusedwidget)
- [getNativeWindow](TDialogClient.md#getnativewindow)
- [getPropBool](TDialogClient.md#getpropbool)
- [getPropFloat](TDialogClient.md#getpropfloat)
- [getPropInt](TDialogClient.md#getpropint)
- [getPropPointer](TDialogClient.md#getproppointer)
- [getPropStr](TDialogClient.md#getpropstr)
- [getSensitive](TDialogClient.md#getsensitive)
- [getStateForStyle](TDialogClient.md#getstateforstyle)
- [getStyleType](TDialogClient.md#getstyletype)
- [getText](TDialogClient.md#gettext)
- [getThemeName](TDialogClient.md#getthemename)
- [getType](TDialogClient.md#gettype)
- [getValue](TDialogClient.md#getvalue)
- [getValueInt](TDialogClient.md#getvalueint)
- [getVisible](TDialogClient.md#getvisible)
- [getWindow](TDialogClient.md#getwindow)
- [getWindowManager](TDialogClient.md#getwindowmanager)
- [getWithFocusState](TDialogClient.md#getwithfocusstate)
- [indexOf](TDialogClient.md#indexof)
- [insertChild](TDialogClient.md#insertchild)
- [invalidateForce](TDialogClient.md#invalidateforce)
- [isDesigningWindow](TDialogClient.md#isdesigningwindow)
- [isDialog](TDialogClient.md#isdialog)
- [isDirectParentOf](TDialogClient.md#isdirectparentof)
- [isKeyboard](TDialogClient.md#iskeyboard)
- [isNormalWindow](TDialogClient.md#isnormalwindow)
- [isOpenedDialog](TDialogClient.md#isopeneddialog)
- [isOpenedPopup](TDialogClient.md#isopenedpopup)
- [isOverlay](TDialogClient.md#isoverlay)
- [isParentOf](TDialogClient.md#isparentof)
- [isPopup](TDialogClient.md#ispopup)
- [isStyleExist](TDialogClient.md#isstyleexist)
- [isSystemBar](TDialogClient.md#issystembar)
- [isWindow](TDialogClient.md#iswindow)
- [isWindowCreated](TDialogClient.md#iswindowcreated)
- [isWindowManager](TDialogClient.md#iswindowmanager)
- [isWindowOpened](TDialogClient.md#iswindowopened)
- [layout](TDialogClient.md#layout)
- [lookup](TDialogClient.md#lookup)
- [lookupByType](TDialogClient.md#lookupbytype)
- [move](TDialogClient.md#move)
- [moveResize](TDialogClient.md#moveresize)
- [moveResizeEx](TDialogClient.md#moveresizeex)
- [moveToCenter](TDialogClient.md#movetocenter)
- [off](TDialogClient.md#off)
- [on](TDialogClient.md#on)
- [pauseAnimator](TDialogClient.md#pauseanimator)
- [removeChild](TDialogClient.md#removechild)
- [resize](TDialogClient.md#resize)
- [restack](TDialogClient.md#restack)
- [setAnimation](TDialogClient.md#setanimation)
- [setAnimatorTimeScale](TDialogClient.md#setanimatortimescale)
- [setAsKeyTarget](TDialogClient.md#setaskeytarget)
- [setAutoAdjustSize](TDialogClient.md#setautoadjustsize)
- [setChildText](TDialogClient.md#setchildtext)
- [setChildTextWithDouble](TDialogClient.md#setchildtextwithdouble)
- [setChildTextWithInt](TDialogClient.md#setchildtextwithint)
- [setChildrenLayout](TDialogClient.md#setchildrenlayout)
- [setDirtyRectTolerance](TDialogClient.md#setdirtyrecttolerance)
- [setEnable](TDialogClient.md#setenable)
- [setFeedback](TDialogClient.md#setfeedback)
- [setFloating](TDialogClient.md#setfloating)
- [setFocusable](TDialogClient.md#setfocusable)
- [setFocused](TDialogClient.md#setfocused)
- [setName](TDialogClient.md#setname)
- [setOpacity](TDialogClient.md#setopacity)
- [setPointerCursor](TDialogClient.md#setpointercursor)
- [setPropBool](TDialogClient.md#setpropbool)
- [setPropFloat](TDialogClient.md#setpropfloat)
- [setPropInt](TDialogClient.md#setpropint)
- [setPropPointer](TDialogClient.md#setproppointer)
- [setPropStr](TDialogClient.md#setpropstr)
- [setProps](TDialogClient.md#setprops)
- [setSelfLayout](TDialogClient.md#setselflayout)
- [setSelfLayoutParams](TDialogClient.md#setselflayoutparams)
- [setSensitive](TDialogClient.md#setsensitive)
- [setState](TDialogClient.md#setstate)
- [setStyleColor](TDialogClient.md#setstylecolor)
- [setStyleInt](TDialogClient.md#setstyleint)
- [setStyleStr](TDialogClient.md#setstylestr)
- [setText](TDialogClient.md#settext)
- [setTextEx](TDialogClient.md#settextex)
- [setTheme](TDialogClient.md#settheme)
- [setTrText](TDialogClient.md#settrtext)
- [setValue](TDialogClient.md#setvalue)
- [setValueInt](TDialogClient.md#setvalueint)
- [setVisible](TDialogClient.md#setvisible)
- [setVisibleOnly](TDialogClient.md#setvisibleonly)
- [startAnimator](TDialogClient.md#startanimator)
- [stopAnimator](TDialogClient.md#stopanimator)
- [strokeBorderRect](TDialogClient.md#strokeborderrect)
- [unref](TDialogClient.md#unref)
- [updateStyle](TDialogClient.md#updatestyle)
- [updateStyleRecursive](TDialogClient.md#updatestylerecursive)
- [useStyle](TDialogClient.md#usestyle)
- [cast](TDialogClient.md#cast)
- [create](TDialogClient.md#create)

## Constructors

### constructor

• **new TDialogClient**(`nativeObj`)
...
[awtk.ts:23863](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23863)
...
[awtk.ts:23862](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23862)
...
▸ `Static` **cast**(`widget`): [`TDialogClient`](TDialogClient.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | dialog_client对象。 |
...
[awtk.ts:23891](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23891)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TDialogClient`](TDialogClient.md)
...
[awtk.ts:23879](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23879)
