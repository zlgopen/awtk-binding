[AWTK](../README.md) / [Exports](../modules.md) / TButtonGroup
...
- [constructor](TButtonGroup.md#constructor)

### Properties

- [nativeObj](TButtonGroup.md#nativeobj)

### Accessors

- [animation](TButtonGroup.md#animation)
- [autoAdjustSize](TButtonGroup.md#autoadjustsize)
- [dirtyRectTolerance](TButtonGroup.md#dirtyrecttolerance)
- [enable](TButtonGroup.md#enable)
- [feedback](TButtonGroup.md#feedback)
- [floating](TButtonGroup.md#floating)
- [focusable](TButtonGroup.md#focusable)
- [h](TButtonGroup.md#h)
- [name](TButtonGroup.md#name)
- [opacity](TButtonGroup.md#opacity)
- [parent](TButtonGroup.md#parent)
- [pointerCursor](TButtonGroup.md#pointercursor)
- [sensitive](TButtonGroup.md#sensitive)
- [style](TButtonGroup.md#style)
- [trText](TButtonGroup.md#trtext)
- [visible](TButtonGroup.md#visible)
- [w](TButtonGroup.md#w)
- [withFocusState](TButtonGroup.md#withfocusstate)
- [x](TButtonGroup.md#x)
- [y](TButtonGroup.md#y)

### Methods

- [addChild](TButtonGroup.md#addchild)
- [addChildDefault](TButtonGroup.md#addchilddefault)
- [addValue](TButtonGroup.md#addvalue)
- [addValueInt](TButtonGroup.md#addvalueint)
- [animateValueTo](TButtonGroup.md#animatevalueto)
- [back](TButtonGroup.md#back)
- [backToHome](TButtonGroup.md#backtohome)
- [child](TButtonGroup.md#child)
- [clone](TButtonGroup.md#clone)
- [closeWindow](TButtonGroup.md#closewindow)
- [closeWindowForce](TButtonGroup.md#closewindowforce)
- [countChildren](TButtonGroup.md#countchildren)
- [createAnimator](TButtonGroup.md#createanimator)
- [destroy](TButtonGroup.md#destroy)
- [destroyAnimator](TButtonGroup.md#destroyanimator)
- [destroyAsync](TButtonGroup.md#destroyasync)
- [destroyChildren](TButtonGroup.md#destroychildren)
- [dispatchToKeyTarget](TButtonGroup.md#dispatchtokeytarget)
- [dispatchToTarget](TButtonGroup.md#dispatchtotarget)
- [equal](TButtonGroup.md#equal)
- [fillBgRect](TButtonGroup.md#fillbgrect)
- [fillFgRect](TButtonGroup.md#fillfgrect)
- [findParentByName](TButtonGroup.md#findparentbyname)
- [findParentByType](TButtonGroup.md#findparentbytype)
- [focusNext](TButtonGroup.md#focusnext)
- [focusPrev](TButtonGroup.md#focusprev)
- [foreach](TButtonGroup.md#foreach)
- [getAutoAdjustSize](TButtonGroup.md#getautoadjustsize)
- [getChild](TButtonGroup.md#getchild)
- [getEnable](TButtonGroup.md#getenable)
- [getFeedback](TButtonGroup.md#getfeedback)
- [getFloating](TButtonGroup.md#getfloating)
- [getFocusable](TButtonGroup.md#getfocusable)
- [getFocusedWidget](TButtonGroup.md#getfocusedwidget)
- [getNativeWindow](TButtonGroup.md#getnativewindow)
- [getPropBool](TButtonGroup.md#getpropbool)
- [getPropFloat](TButtonGroup.md#getpropfloat)
- [getPropInt](TButtonGroup.md#getpropint)
- [getPropPointer](TButtonGroup.md#getproppointer)
- [getPropStr](TButtonGroup.md#getpropstr)
- [getSensitive](TButtonGroup.md#getsensitive)
- [getStateForStyle](TButtonGroup.md#getstateforstyle)
- [getStyleType](TButtonGroup.md#getstyletype)
- [getText](TButtonGroup.md#gettext)
- [getThemeName](TButtonGroup.md#getthemename)
- [getType](TButtonGroup.md#gettype)
- [getValue](TButtonGroup.md#getvalue)
- [getValueInt](TButtonGroup.md#getvalueint)
- [getVisible](TButtonGroup.md#getvisible)
- [getWindow](TButtonGroup.md#getwindow)
- [getWindowManager](TButtonGroup.md#getwindowmanager)
- [getWithFocusState](TButtonGroup.md#getwithfocusstate)
- [indexOf](TButtonGroup.md#indexof)
- [insertChild](TButtonGroup.md#insertchild)
- [invalidateForce](TButtonGroup.md#invalidateforce)
- [isDesigningWindow](TButtonGroup.md#isdesigningwindow)
- [isDialog](TButtonGroup.md#isdialog)
- [isDirectParentOf](TButtonGroup.md#isdirectparentof)
- [isKeyboard](TButtonGroup.md#iskeyboard)
- [isNormalWindow](TButtonGroup.md#isnormalwindow)
- [isOpenedDialog](TButtonGroup.md#isopeneddialog)
- [isOpenedPopup](TButtonGroup.md#isopenedpopup)
- [isOverlay](TButtonGroup.md#isoverlay)
- [isParentOf](TButtonGroup.md#isparentof)
- [isPopup](TButtonGroup.md#ispopup)
- [isStyleExist](TButtonGroup.md#isstyleexist)
- [isSystemBar](TButtonGroup.md#issystembar)
- [isWindow](TButtonGroup.md#iswindow)
- [isWindowCreated](TButtonGroup.md#iswindowcreated)
- [isWindowManager](TButtonGroup.md#iswindowmanager)
- [isWindowOpened](TButtonGroup.md#iswindowopened)
- [layout](TButtonGroup.md#layout)
- [lookup](TButtonGroup.md#lookup)
- [lookupByType](TButtonGroup.md#lookupbytype)
- [move](TButtonGroup.md#move)
- [moveResize](TButtonGroup.md#moveresize)
- [moveResizeEx](TButtonGroup.md#moveresizeex)
- [moveToCenter](TButtonGroup.md#movetocenter)
- [off](TButtonGroup.md#off)
- [on](TButtonGroup.md#on)
- [pauseAnimator](TButtonGroup.md#pauseanimator)
- [removeChild](TButtonGroup.md#removechild)
- [resize](TButtonGroup.md#resize)
- [restack](TButtonGroup.md#restack)
- [setAnimation](TButtonGroup.md#setanimation)
- [setAnimatorTimeScale](TButtonGroup.md#setanimatortimescale)
- [setAsKeyTarget](TButtonGroup.md#setaskeytarget)
- [setAutoAdjustSize](TButtonGroup.md#setautoadjustsize)
- [setChildText](TButtonGroup.md#setchildtext)
- [setChildTextWithDouble](TButtonGroup.md#setchildtextwithdouble)
- [setChildTextWithInt](TButtonGroup.md#setchildtextwithint)
- [setChildrenLayout](TButtonGroup.md#setchildrenlayout)
- [setDirtyRectTolerance](TButtonGroup.md#setdirtyrecttolerance)
- [setEnable](TButtonGroup.md#setenable)
- [setFeedback](TButtonGroup.md#setfeedback)
- [setFloating](TButtonGroup.md#setfloating)
- [setFocusable](TButtonGroup.md#setfocusable)
- [setFocused](TButtonGroup.md#setfocused)
- [setName](TButtonGroup.md#setname)
- [setOpacity](TButtonGroup.md#setopacity)
- [setPointerCursor](TButtonGroup.md#setpointercursor)
- [setPropBool](TButtonGroup.md#setpropbool)
- [setPropFloat](TButtonGroup.md#setpropfloat)
- [setPropInt](TButtonGroup.md#setpropint)
- [setPropPointer](TButtonGroup.md#setproppointer)
- [setPropStr](TButtonGroup.md#setpropstr)
- [setProps](TButtonGroup.md#setprops)
- [setSelfLayout](TButtonGroup.md#setselflayout)
- [setSelfLayoutParams](TButtonGroup.md#setselflayoutparams)
- [setSensitive](TButtonGroup.md#setsensitive)
- [setState](TButtonGroup.md#setstate)
- [setStyleColor](TButtonGroup.md#setstylecolor)
- [setStyleInt](TButtonGroup.md#setstyleint)
- [setStyleStr](TButtonGroup.md#setstylestr)
- [setText](TButtonGroup.md#settext)
- [setTextEx](TButtonGroup.md#settextex)
- [setTheme](TButtonGroup.md#settheme)
- [setTrText](TButtonGroup.md#settrtext)
- [setValue](TButtonGroup.md#setvalue)
- [setValueInt](TButtonGroup.md#setvalueint)
- [setVisible](TButtonGroup.md#setvisible)
- [setVisibleOnly](TButtonGroup.md#setvisibleonly)
- [startAnimator](TButtonGroup.md#startanimator)
- [stopAnimator](TButtonGroup.md#stopanimator)
- [strokeBorderRect](TButtonGroup.md#strokeborderrect)
- [unref](TButtonGroup.md#unref)
- [updateStyle](TButtonGroup.md#updatestyle)
- [updateStyleRecursive](TButtonGroup.md#updatestylerecursive)
- [useStyle](TButtonGroup.md#usestyle)
- [cast](TButtonGroup.md#cast)
- [create](TButtonGroup.md#create)

## Constructors

### constructor

• **new TButtonGroup**(`nativeObj`)
...
[awtk.ts:23139](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23139)
...
[awtk.ts:23138](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23138)
...
▸ `Static` **cast**(`widget`): [`TButtonGroup`](TButtonGroup.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | button_group对象。 |
...
[awtk.ts:23167](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23167)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TButtonGroup`](TButtonGroup.md)
...
[awtk.ts:23155](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23155)
