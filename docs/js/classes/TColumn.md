[AWTK](../README.md) / [Exports](../modules.md) / TColumn
...
- [constructor](TColumn.md#constructor)

### Properties

- [nativeObj](TColumn.md#nativeobj)

### Accessors

- [animation](TColumn.md#animation)
- [autoAdjustSize](TColumn.md#autoadjustsize)
- [dirtyRectTolerance](TColumn.md#dirtyrecttolerance)
- [enable](TColumn.md#enable)
- [feedback](TColumn.md#feedback)
- [floating](TColumn.md#floating)
- [focusable](TColumn.md#focusable)
- [h](TColumn.md#h)
- [name](TColumn.md#name)
- [opacity](TColumn.md#opacity)
- [parent](TColumn.md#parent)
- [pointerCursor](TColumn.md#pointercursor)
- [sensitive](TColumn.md#sensitive)
- [style](TColumn.md#style)
- [trText](TColumn.md#trtext)
- [visible](TColumn.md#visible)
- [w](TColumn.md#w)
- [withFocusState](TColumn.md#withfocusstate)
- [x](TColumn.md#x)
- [y](TColumn.md#y)

### Methods

- [addChild](TColumn.md#addchild)
- [addChildDefault](TColumn.md#addchilddefault)
- [addValue](TColumn.md#addvalue)
- [addValueInt](TColumn.md#addvalueint)
- [animateValueTo](TColumn.md#animatevalueto)
- [back](TColumn.md#back)
- [backToHome](TColumn.md#backtohome)
- [child](TColumn.md#child)
- [clone](TColumn.md#clone)
- [closeWindow](TColumn.md#closewindow)
- [closeWindowForce](TColumn.md#closewindowforce)
- [countChildren](TColumn.md#countchildren)
- [createAnimator](TColumn.md#createanimator)
- [destroy](TColumn.md#destroy)
- [destroyAnimator](TColumn.md#destroyanimator)
- [destroyAsync](TColumn.md#destroyasync)
- [destroyChildren](TColumn.md#destroychildren)
- [dispatchToKeyTarget](TColumn.md#dispatchtokeytarget)
- [dispatchToTarget](TColumn.md#dispatchtotarget)
- [equal](TColumn.md#equal)
- [fillBgRect](TColumn.md#fillbgrect)
- [fillFgRect](TColumn.md#fillfgrect)
- [findParentByName](TColumn.md#findparentbyname)
- [findParentByType](TColumn.md#findparentbytype)
- [focusNext](TColumn.md#focusnext)
- [focusPrev](TColumn.md#focusprev)
- [foreach](TColumn.md#foreach)
- [getAutoAdjustSize](TColumn.md#getautoadjustsize)
- [getChild](TColumn.md#getchild)
- [getEnable](TColumn.md#getenable)
- [getFeedback](TColumn.md#getfeedback)
- [getFloating](TColumn.md#getfloating)
- [getFocusable](TColumn.md#getfocusable)
- [getFocusedWidget](TColumn.md#getfocusedwidget)
- [getNativeWindow](TColumn.md#getnativewindow)
- [getPropBool](TColumn.md#getpropbool)
- [getPropFloat](TColumn.md#getpropfloat)
- [getPropInt](TColumn.md#getpropint)
- [getPropPointer](TColumn.md#getproppointer)
- [getPropStr](TColumn.md#getpropstr)
- [getSensitive](TColumn.md#getsensitive)
- [getStateForStyle](TColumn.md#getstateforstyle)
- [getStyleType](TColumn.md#getstyletype)
- [getText](TColumn.md#gettext)
- [getThemeName](TColumn.md#getthemename)
- [getType](TColumn.md#gettype)
- [getValue](TColumn.md#getvalue)
- [getValueInt](TColumn.md#getvalueint)
- [getVisible](TColumn.md#getvisible)
- [getWindow](TColumn.md#getwindow)
- [getWindowManager](TColumn.md#getwindowmanager)
- [getWithFocusState](TColumn.md#getwithfocusstate)
- [indexOf](TColumn.md#indexof)
- [insertChild](TColumn.md#insertchild)
- [invalidateForce](TColumn.md#invalidateforce)
- [isDesigningWindow](TColumn.md#isdesigningwindow)
- [isDialog](TColumn.md#isdialog)
- [isDirectParentOf](TColumn.md#isdirectparentof)
- [isKeyboard](TColumn.md#iskeyboard)
- [isNormalWindow](TColumn.md#isnormalwindow)
- [isOpenedDialog](TColumn.md#isopeneddialog)
- [isOpenedPopup](TColumn.md#isopenedpopup)
- [isOverlay](TColumn.md#isoverlay)
- [isParentOf](TColumn.md#isparentof)
- [isPopup](TColumn.md#ispopup)
- [isStyleExist](TColumn.md#isstyleexist)
- [isSystemBar](TColumn.md#issystembar)
- [isWindow](TColumn.md#iswindow)
- [isWindowCreated](TColumn.md#iswindowcreated)
- [isWindowManager](TColumn.md#iswindowmanager)
- [isWindowOpened](TColumn.md#iswindowopened)
- [layout](TColumn.md#layout)
- [lookup](TColumn.md#lookup)
- [lookupByType](TColumn.md#lookupbytype)
- [move](TColumn.md#move)
- [moveResize](TColumn.md#moveresize)
- [moveResizeEx](TColumn.md#moveresizeex)
- [moveToCenter](TColumn.md#movetocenter)
- [off](TColumn.md#off)
- [on](TColumn.md#on)
- [pauseAnimator](TColumn.md#pauseanimator)
- [removeChild](TColumn.md#removechild)
- [resize](TColumn.md#resize)
- [restack](TColumn.md#restack)
- [setAnimation](TColumn.md#setanimation)
- [setAnimatorTimeScale](TColumn.md#setanimatortimescale)
- [setAsKeyTarget](TColumn.md#setaskeytarget)
- [setAutoAdjustSize](TColumn.md#setautoadjustsize)
- [setChildText](TColumn.md#setchildtext)
- [setChildTextWithDouble](TColumn.md#setchildtextwithdouble)
- [setChildTextWithInt](TColumn.md#setchildtextwithint)
- [setChildrenLayout](TColumn.md#setchildrenlayout)
- [setDirtyRectTolerance](TColumn.md#setdirtyrecttolerance)
- [setEnable](TColumn.md#setenable)
- [setFeedback](TColumn.md#setfeedback)
- [setFloating](TColumn.md#setfloating)
- [setFocusable](TColumn.md#setfocusable)
- [setFocused](TColumn.md#setfocused)
- [setName](TColumn.md#setname)
- [setOpacity](TColumn.md#setopacity)
- [setPointerCursor](TColumn.md#setpointercursor)
- [setPropBool](TColumn.md#setpropbool)
- [setPropFloat](TColumn.md#setpropfloat)
- [setPropInt](TColumn.md#setpropint)
- [setPropPointer](TColumn.md#setproppointer)
- [setPropStr](TColumn.md#setpropstr)
- [setProps](TColumn.md#setprops)
- [setSelfLayout](TColumn.md#setselflayout)
- [setSelfLayoutParams](TColumn.md#setselflayoutparams)
- [setSensitive](TColumn.md#setsensitive)
- [setState](TColumn.md#setstate)
- [setStyleColor](TColumn.md#setstylecolor)
- [setStyleInt](TColumn.md#setstyleint)
- [setStyleStr](TColumn.md#setstylestr)
- [setText](TColumn.md#settext)
- [setTextEx](TColumn.md#settextex)
- [setTheme](TColumn.md#settheme)
- [setTrText](TColumn.md#settrtext)
- [setValue](TColumn.md#setvalue)
- [setValueInt](TColumn.md#setvalueint)
- [setVisible](TColumn.md#setvisible)
- [setVisibleOnly](TColumn.md#setvisibleonly)
- [startAnimator](TColumn.md#startanimator)
- [stopAnimator](TColumn.md#stopanimator)
- [strokeBorderRect](TColumn.md#strokeborderrect)
- [unref](TColumn.md#unref)
- [updateStyle](TColumn.md#updatestyle)
- [updateStyleRecursive](TColumn.md#updatestylerecursive)
- [useStyle](TColumn.md#usestyle)
- [cast](TColumn.md#cast)
- [create](TColumn.md#create)

## Constructors

### constructor

• **new TColumn**(`nativeObj`)
...
[awtk.ts:23712](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23712)
...
[awtk.ts:23711](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23711)
...
▸ `Static` **cast**(`widget`): [`TColumn`](TColumn.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | column对象。 |
...
[awtk.ts:23740](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23740)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TColumn`](TColumn.md)
...
[awtk.ts:23728](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23728)
