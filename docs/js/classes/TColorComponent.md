[AWTK](../README.md) / [Exports](../modules.md) / TColorComponent
...
- [constructor](TColorComponent.md#constructor)

### Properties

- [nativeObj](TColorComponent.md#nativeobj)

### Accessors

- [animation](TColorComponent.md#animation)
- [autoAdjustSize](TColorComponent.md#autoadjustsize)
- [dirtyRectTolerance](TColorComponent.md#dirtyrecttolerance)
- [enable](TColorComponent.md#enable)
- [feedback](TColorComponent.md#feedback)
- [floating](TColorComponent.md#floating)
- [focusable](TColorComponent.md#focusable)
- [h](TColorComponent.md#h)
- [name](TColorComponent.md#name)
- [opacity](TColorComponent.md#opacity)
- [parent](TColorComponent.md#parent)
- [pointerCursor](TColorComponent.md#pointercursor)
- [sensitive](TColorComponent.md#sensitive)
- [style](TColorComponent.md#style)
- [trText](TColorComponent.md#trtext)
- [visible](TColorComponent.md#visible)
- [w](TColorComponent.md#w)
- [withFocusState](TColorComponent.md#withfocusstate)
- [x](TColorComponent.md#x)
- [y](TColorComponent.md#y)

### Methods

- [addChild](TColorComponent.md#addchild)
- [addChildDefault](TColorComponent.md#addchilddefault)
- [addValue](TColorComponent.md#addvalue)
- [addValueInt](TColorComponent.md#addvalueint)
- [animateValueTo](TColorComponent.md#animatevalueto)
- [back](TColorComponent.md#back)
- [backToHome](TColorComponent.md#backtohome)
- [child](TColorComponent.md#child)
- [clone](TColorComponent.md#clone)
- [closeWindow](TColorComponent.md#closewindow)
- [closeWindowForce](TColorComponent.md#closewindowforce)
- [countChildren](TColorComponent.md#countchildren)
- [createAnimator](TColorComponent.md#createanimator)
- [destroy](TColorComponent.md#destroy)
- [destroyAnimator](TColorComponent.md#destroyanimator)
- [destroyAsync](TColorComponent.md#destroyasync)
- [destroyChildren](TColorComponent.md#destroychildren)
- [dispatchToKeyTarget](TColorComponent.md#dispatchtokeytarget)
- [dispatchToTarget](TColorComponent.md#dispatchtotarget)
- [equal](TColorComponent.md#equal)
- [fillBgRect](TColorComponent.md#fillbgrect)
- [fillFgRect](TColorComponent.md#fillfgrect)
- [findParentByName](TColorComponent.md#findparentbyname)
- [findParentByType](TColorComponent.md#findparentbytype)
- [focusNext](TColorComponent.md#focusnext)
- [focusPrev](TColorComponent.md#focusprev)
- [foreach](TColorComponent.md#foreach)
- [getAutoAdjustSize](TColorComponent.md#getautoadjustsize)
- [getChild](TColorComponent.md#getchild)
- [getEnable](TColorComponent.md#getenable)
- [getFeedback](TColorComponent.md#getfeedback)
- [getFloating](TColorComponent.md#getfloating)
- [getFocusable](TColorComponent.md#getfocusable)
- [getFocusedWidget](TColorComponent.md#getfocusedwidget)
- [getNativeWindow](TColorComponent.md#getnativewindow)
- [getPropBool](TColorComponent.md#getpropbool)
- [getPropFloat](TColorComponent.md#getpropfloat)
- [getPropInt](TColorComponent.md#getpropint)
- [getPropPointer](TColorComponent.md#getproppointer)
- [getPropStr](TColorComponent.md#getpropstr)
- [getSensitive](TColorComponent.md#getsensitive)
- [getStateForStyle](TColorComponent.md#getstateforstyle)
- [getStyleType](TColorComponent.md#getstyletype)
- [getText](TColorComponent.md#gettext)
- [getThemeName](TColorComponent.md#getthemename)
- [getType](TColorComponent.md#gettype)
- [getValue](TColorComponent.md#getvalue)
- [getValueInt](TColorComponent.md#getvalueint)
- [getVisible](TColorComponent.md#getvisible)
- [getWindow](TColorComponent.md#getwindow)
- [getWindowManager](TColorComponent.md#getwindowmanager)
- [getWithFocusState](TColorComponent.md#getwithfocusstate)
- [indexOf](TColorComponent.md#indexof)
- [insertChild](TColorComponent.md#insertchild)
- [invalidateForce](TColorComponent.md#invalidateforce)
- [isDesigningWindow](TColorComponent.md#isdesigningwindow)
- [isDialog](TColorComponent.md#isdialog)
- [isDirectParentOf](TColorComponent.md#isdirectparentof)
- [isKeyboard](TColorComponent.md#iskeyboard)
- [isNormalWindow](TColorComponent.md#isnormalwindow)
- [isOpenedDialog](TColorComponent.md#isopeneddialog)
- [isOpenedPopup](TColorComponent.md#isopenedpopup)
- [isOverlay](TColorComponent.md#isoverlay)
- [isParentOf](TColorComponent.md#isparentof)
- [isPopup](TColorComponent.md#ispopup)
- [isStyleExist](TColorComponent.md#isstyleexist)
- [isSystemBar](TColorComponent.md#issystembar)
- [isWindow](TColorComponent.md#iswindow)
- [isWindowCreated](TColorComponent.md#iswindowcreated)
- [isWindowManager](TColorComponent.md#iswindowmanager)
- [isWindowOpened](TColorComponent.md#iswindowopened)
- [layout](TColorComponent.md#layout)
- [lookup](TColorComponent.md#lookup)
- [lookupByType](TColorComponent.md#lookupbytype)
- [move](TColorComponent.md#move)
- [moveResize](TColorComponent.md#moveresize)
- [moveResizeEx](TColorComponent.md#moveresizeex)
- [moveToCenter](TColorComponent.md#movetocenter)
- [off](TColorComponent.md#off)
- [on](TColorComponent.md#on)
- [pauseAnimator](TColorComponent.md#pauseanimator)
- [removeChild](TColorComponent.md#removechild)
- [resize](TColorComponent.md#resize)
- [restack](TColorComponent.md#restack)
- [setAnimation](TColorComponent.md#setanimation)
- [setAnimatorTimeScale](TColorComponent.md#setanimatortimescale)
- [setAsKeyTarget](TColorComponent.md#setaskeytarget)
- [setAutoAdjustSize](TColorComponent.md#setautoadjustsize)
- [setChildText](TColorComponent.md#setchildtext)
- [setChildTextWithDouble](TColorComponent.md#setchildtextwithdouble)
- [setChildTextWithInt](TColorComponent.md#setchildtextwithint)
- [setChildrenLayout](TColorComponent.md#setchildrenlayout)
- [setDirtyRectTolerance](TColorComponent.md#setdirtyrecttolerance)
- [setEnable](TColorComponent.md#setenable)
- [setFeedback](TColorComponent.md#setfeedback)
- [setFloating](TColorComponent.md#setfloating)
- [setFocusable](TColorComponent.md#setfocusable)
- [setFocused](TColorComponent.md#setfocused)
- [setName](TColorComponent.md#setname)
- [setOpacity](TColorComponent.md#setopacity)
- [setPointerCursor](TColorComponent.md#setpointercursor)
- [setPropBool](TColorComponent.md#setpropbool)
- [setPropFloat](TColorComponent.md#setpropfloat)
- [setPropInt](TColorComponent.md#setpropint)
- [setPropPointer](TColorComponent.md#setproppointer)
- [setPropStr](TColorComponent.md#setpropstr)
- [setProps](TColorComponent.md#setprops)
- [setSelfLayout](TColorComponent.md#setselflayout)
- [setSelfLayoutParams](TColorComponent.md#setselflayoutparams)
- [setSensitive](TColorComponent.md#setsensitive)
- [setState](TColorComponent.md#setstate)
- [setStyleColor](TColorComponent.md#setstylecolor)
- [setStyleInt](TColorComponent.md#setstyleint)
- [setStyleStr](TColorComponent.md#setstylestr)
- [setText](TColorComponent.md#settext)
- [setTextEx](TColorComponent.md#settextex)
- [setTheme](TColorComponent.md#settheme)
- [setTrText](TColorComponent.md#settrtext)
- [setValue](TColorComponent.md#setvalue)
- [setValueInt](TColorComponent.md#setvalueint)
- [setVisible](TColorComponent.md#setvisible)
- [setVisibleOnly](TColorComponent.md#setvisibleonly)
- [startAnimator](TColorComponent.md#startanimator)
- [stopAnimator](TColorComponent.md#stopanimator)
- [strokeBorderRect](TColorComponent.md#strokeborderrect)
- [unref](TColorComponent.md#unref)
- [updateStyle](TColorComponent.md#updatestyle)
- [updateStyleRecursive](TColorComponent.md#updatestylerecursive)
- [useStyle](TColorComponent.md#usestyle)
- [cast](TColorComponent.md#cast)
- [create](TColorComponent.md#create)

## Constructors

### constructor

• **new TColorComponent**(`nativeObj`)
...
[awtk.ts:16115](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L16115)
...
[awtk.ts:16114](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L16114)
...
▸ `Static` **cast**(`widget`): [`TColorComponent`](TColorComponent.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | color_component对象。 |
...
[awtk.ts:16143](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L16143)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TColorComponent`](TColorComponent.md)
...
[awtk.ts:16131](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L16131)
