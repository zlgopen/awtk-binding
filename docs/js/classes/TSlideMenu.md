[AWTK](../README.md) / [Exports](../modules.md) / TSlideMenu
...
- [constructor](TSlideMenu.md#constructor)

### Properties

- [nativeObj](TSlideMenu.md#nativeobj)

### Accessors

- [alignV](TSlideMenu.md#alignv)
- [animation](TSlideMenu.md#animation)
- [autoAdjustSize](TSlideMenu.md#autoadjustsize)
- [clip](TSlideMenu.md#clip)
- [dirtyRectTolerance](TSlideMenu.md#dirtyrecttolerance)
- [enable](TSlideMenu.md#enable)
- [feedback](TSlideMenu.md#feedback)
- [floating](TSlideMenu.md#floating)
- [focusable](TSlideMenu.md#focusable)
- [h](TSlideMenu.md#h)
- [menuW](TSlideMenu.md#menuw)
- [minScale](TSlideMenu.md#minscale)
- [name](TSlideMenu.md#name)
- [opacity](TSlideMenu.md#opacity)
- [parent](TSlideMenu.md#parent)
- [pointerCursor](TSlideMenu.md#pointercursor)
- [sensitive](TSlideMenu.md#sensitive)
- [spacer](TSlideMenu.md#spacer)
- [style](TSlideMenu.md#style)
- [trText](TSlideMenu.md#trtext)
- [value](TSlideMenu.md#value)
- [visible](TSlideMenu.md#visible)
- [w](TSlideMenu.md#w)
- [withFocusState](TSlideMenu.md#withfocusstate)
- [x](TSlideMenu.md#x)
- [y](TSlideMenu.md#y)

### Methods

- [addChild](TSlideMenu.md#addchild)
- [addChildDefault](TSlideMenu.md#addchilddefault)
- [addValue](TSlideMenu.md#addvalue)
- [addValueInt](TSlideMenu.md#addvalueint)
- [animateValueTo](TSlideMenu.md#animatevalueto)
- [back](TSlideMenu.md#back)
- [backToHome](TSlideMenu.md#backtohome)
- [child](TSlideMenu.md#child)
- [clone](TSlideMenu.md#clone)
- [closeWindow](TSlideMenu.md#closewindow)
- [closeWindowForce](TSlideMenu.md#closewindowforce)
- [countChildren](TSlideMenu.md#countchildren)
- [createAnimator](TSlideMenu.md#createanimator)
- [destroy](TSlideMenu.md#destroy)
- [destroyAnimator](TSlideMenu.md#destroyanimator)
- [destroyAsync](TSlideMenu.md#destroyasync)
- [destroyChildren](TSlideMenu.md#destroychildren)
- [dispatchToKeyTarget](TSlideMenu.md#dispatchtokeytarget)
- [dispatchToTarget](TSlideMenu.md#dispatchtotarget)
- [equal](TSlideMenu.md#equal)
- [fillBgRect](TSlideMenu.md#fillbgrect)
- [fillFgRect](TSlideMenu.md#fillfgrect)
- [findParentByName](TSlideMenu.md#findparentbyname)
- [findParentByType](TSlideMenu.md#findparentbytype)
- [focusNext](TSlideMenu.md#focusnext)
- [focusPrev](TSlideMenu.md#focusprev)
- [foreach](TSlideMenu.md#foreach)
- [getAutoAdjustSize](TSlideMenu.md#getautoadjustsize)
- [getChild](TSlideMenu.md#getchild)
- [getEnable](TSlideMenu.md#getenable)
- [getFeedback](TSlideMenu.md#getfeedback)
- [getFloating](TSlideMenu.md#getfloating)
- [getFocusable](TSlideMenu.md#getfocusable)
- [getFocusedWidget](TSlideMenu.md#getfocusedwidget)
- [getNativeWindow](TSlideMenu.md#getnativewindow)
- [getPropBool](TSlideMenu.md#getpropbool)
- [getPropFloat](TSlideMenu.md#getpropfloat)
- [getPropInt](TSlideMenu.md#getpropint)
- [getPropPointer](TSlideMenu.md#getproppointer)
- [getPropStr](TSlideMenu.md#getpropstr)
- [getSensitive](TSlideMenu.md#getsensitive)
- [getStateForStyle](TSlideMenu.md#getstateforstyle)
- [getStyleType](TSlideMenu.md#getstyletype)
- [getText](TSlideMenu.md#gettext)
- [getThemeName](TSlideMenu.md#getthemename)
- [getType](TSlideMenu.md#gettype)
- [getValue](TSlideMenu.md#getvalue)
- [getValueInt](TSlideMenu.md#getvalueint)
- [getVisible](TSlideMenu.md#getvisible)
- [getWindow](TSlideMenu.md#getwindow)
- [getWindowManager](TSlideMenu.md#getwindowmanager)
- [getWithFocusState](TSlideMenu.md#getwithfocusstate)
- [indexOf](TSlideMenu.md#indexof)
- [insertChild](TSlideMenu.md#insertchild)
- [invalidateForce](TSlideMenu.md#invalidateforce)
- [isDesigningWindow](TSlideMenu.md#isdesigningwindow)
- [isDialog](TSlideMenu.md#isdialog)
- [isDirectParentOf](TSlideMenu.md#isdirectparentof)
- [isKeyboard](TSlideMenu.md#iskeyboard)
- [isNormalWindow](TSlideMenu.md#isnormalwindow)
- [isOpenedDialog](TSlideMenu.md#isopeneddialog)
- [isOpenedPopup](TSlideMenu.md#isopenedpopup)
- [isOverlay](TSlideMenu.md#isoverlay)
- [isParentOf](TSlideMenu.md#isparentof)
- [isPopup](TSlideMenu.md#ispopup)
- [isStyleExist](TSlideMenu.md#isstyleexist)
- [isSystemBar](TSlideMenu.md#issystembar)
- [isWindow](TSlideMenu.md#iswindow)
- [isWindowCreated](TSlideMenu.md#iswindowcreated)
- [isWindowManager](TSlideMenu.md#iswindowmanager)
- [isWindowOpened](TSlideMenu.md#iswindowopened)
- [layout](TSlideMenu.md#layout)
- [lookup](TSlideMenu.md#lookup)
- [lookupByType](TSlideMenu.md#lookupbytype)
- [move](TSlideMenu.md#move)
- [moveResize](TSlideMenu.md#moveresize)
- [moveResizeEx](TSlideMenu.md#moveresizeex)
- [moveToCenter](TSlideMenu.md#movetocenter)
- [off](TSlideMenu.md#off)
- [on](TSlideMenu.md#on)
- [pauseAnimator](TSlideMenu.md#pauseanimator)
- [removeChild](TSlideMenu.md#removechild)
- [resize](TSlideMenu.md#resize)
- [restack](TSlideMenu.md#restack)
- [scrollToNext](TSlideMenu.md#scrolltonext)
- [scrollToPrev](TSlideMenu.md#scrolltoprev)
- [setAlignV](TSlideMenu.md#setalignv)
- [setAnimation](TSlideMenu.md#setanimation)
- [setAnimatorTimeScale](TSlideMenu.md#setanimatortimescale)
- [setAsKeyTarget](TSlideMenu.md#setaskeytarget)
- [setAutoAdjustSize](TSlideMenu.md#setautoadjustsize)
- [setChildText](TSlideMenu.md#setchildtext)
- [setChildTextWithDouble](TSlideMenu.md#setchildtextwithdouble)
- [setChildTextWithInt](TSlideMenu.md#setchildtextwithint)
- [setChildrenLayout](TSlideMenu.md#setchildrenlayout)
- [setClip](TSlideMenu.md#setclip)
- [setDirtyRectTolerance](TSlideMenu.md#setdirtyrecttolerance)
- [setEnable](TSlideMenu.md#setenable)
- [setFeedback](TSlideMenu.md#setfeedback)
- [setFloating](TSlideMenu.md#setfloating)
- [setFocusable](TSlideMenu.md#setfocusable)
- [setFocused](TSlideMenu.md#setfocused)
- [setMenuW](TSlideMenu.md#setmenuw)
- [setMinScale](TSlideMenu.md#setminscale)
- [setName](TSlideMenu.md#setname)
- [setOpacity](TSlideMenu.md#setopacity)
- [setPointerCursor](TSlideMenu.md#setpointercursor)
- [setPropBool](TSlideMenu.md#setpropbool)
- [setPropFloat](TSlideMenu.md#setpropfloat)
- [setPropInt](TSlideMenu.md#setpropint)
- [setPropPointer](TSlideMenu.md#setproppointer)
- [setPropStr](TSlideMenu.md#setpropstr)
- [setProps](TSlideMenu.md#setprops)
- [setSelfLayout](TSlideMenu.md#setselflayout)
- [setSelfLayoutParams](TSlideMenu.md#setselflayoutparams)
- [setSensitive](TSlideMenu.md#setsensitive)
- [setSpacer](TSlideMenu.md#setspacer)
- [setState](TSlideMenu.md#setstate)
- [setStyleColor](TSlideMenu.md#setstylecolor)
- [setStyleInt](TSlideMenu.md#setstyleint)
- [setStyleStr](TSlideMenu.md#setstylestr)
- [setText](TSlideMenu.md#settext)
- [setTextEx](TSlideMenu.md#settextex)
- [setTheme](TSlideMenu.md#settheme)
- [setTrText](TSlideMenu.md#settrtext)
- [setValue](TSlideMenu.md#setvalue)
- [setValueInt](TSlideMenu.md#setvalueint)
- [setVisible](TSlideMenu.md#setvisible)
- [setVisibleOnly](TSlideMenu.md#setvisibleonly)
- [startAnimator](TSlideMenu.md#startanimator)
- [stopAnimator](TSlideMenu.md#stopanimator)
- [strokeBorderRect](TSlideMenu.md#strokeborderrect)
- [unref](TSlideMenu.md#unref)
- [updateStyle](TSlideMenu.md#updatestyle)
- [updateStyleRecursive](TSlideMenu.md#updatestylerecursive)
- [useStyle](TSlideMenu.md#usestyle)
- [cast](TSlideMenu.md#cast)
- [create](TSlideMenu.md#create)

## Constructors

### constructor

• **new TSlideMenu**(`nativeObj`)
...
[awtk.ts:20933](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L20933)
...
[awtk.ts:20932](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L20932)

## Accessors

### alignV

• `get` **alignV**(): [`TAlignV`](../enums/TAlignV.md)

垂直对齐方式。

#### Returns

[`TAlignV`](../enums/TAlignV.md)

#### Defined in

[awtk.ts:21077](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21077)
...
[awtk.ts:21081](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21081)
...
[awtk.ts:21129](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21129)
...
[awtk.ts:21133](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21133)
...
[awtk.ts:21116](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21116)
...
[awtk.ts:21120](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21120)
...
[awtk.ts:21090](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21090)
...
[awtk.ts:21094](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21094)
...
[awtk.ts:21103](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21103)
...
[awtk.ts:21107](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21107)
...
[awtk.ts:21064](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21064)
...
[awtk.ts:21068](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21068)
...
▸ **scrollToNext**(): [`TRet`](../enums/TRet.md)
...
[awtk.ts:21055](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21055)

___

### scrollToPrev

▸ **scrollToPrev**(): [`TRet`](../enums/TRet.md)
...
[awtk.ts:21044](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21044)

___

### setAlignV

▸ **setAlignV**(`align_v`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `align_v` | [`TAlignV`](../enums/TAlignV.md) | 对齐方式。 |
...
[awtk.ts:20985](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L20985)
...
▸ **setClip**(`clip`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `clip` | `boolean` | 是否动态裁剪菜单项。(关闭后，如果显示偶数项，左边会多一项) |
...
[awtk.ts:21033](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21033)
...
▸ **setMenuW**(`menu_w`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `menu_w` | `string` | 菜单项的宽度。(后面加上px为像素点，不加px为相对百分比坐标0.0f到1.0f)(空字符串则使用控件高度) |
...
[awtk.ts:21021](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21021)

___

### setMinScale

▸ **setMinScale**(`min_scale`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:20997](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L20997)
...
▸ **setSpacer**(`spacer`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:21009](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21009)
...
[awtk.ts:20973](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L20973)
...
▸ `Static` **cast**(`widget`): [`TSlideMenu`](TSlideMenu.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | slide_menu对象。 |
...
[awtk.ts:20961](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L20961)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TSlideMenu`](TSlideMenu.md)
...
[awtk.ts:20949](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L20949)
