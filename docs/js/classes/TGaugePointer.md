[AWTK](../README.md) / [Exports](../modules.md) / TGaugePointer
...
- [constructor](TGaugePointer.md#constructor)

### Properties

- [nativeObj](TGaugePointer.md#nativeobj)

### Accessors

- [anchorX](TGaugePointer.md#anchorx)
- [anchorY](TGaugePointer.md#anchory)
- [angle](TGaugePointer.md#angle)
- [animation](TGaugePointer.md#animation)
- [autoAdjustSize](TGaugePointer.md#autoadjustsize)
- [dirtyRectTolerance](TGaugePointer.md#dirtyrecttolerance)
- [enable](TGaugePointer.md#enable)
- [feedback](TGaugePointer.md#feedback)
- [floating](TGaugePointer.md#floating)
- [focusable](TGaugePointer.md#focusable)
- [h](TGaugePointer.md#h)
- [image](TGaugePointer.md#image)
- [name](TGaugePointer.md#name)
- [opacity](TGaugePointer.md#opacity)
- [parent](TGaugePointer.md#parent)
- [pointerCursor](TGaugePointer.md#pointercursor)
- [sensitive](TGaugePointer.md#sensitive)
- [style](TGaugePointer.md#style)
- [trText](TGaugePointer.md#trtext)
- [visible](TGaugePointer.md#visible)
- [w](TGaugePointer.md#w)
- [withFocusState](TGaugePointer.md#withfocusstate)
- [x](TGaugePointer.md#x)
- [y](TGaugePointer.md#y)

### Methods

- [addChild](TGaugePointer.md#addchild)
- [addChildDefault](TGaugePointer.md#addchilddefault)
- [addValue](TGaugePointer.md#addvalue)
- [addValueInt](TGaugePointer.md#addvalueint)
- [animateValueTo](TGaugePointer.md#animatevalueto)
- [back](TGaugePointer.md#back)
- [backToHome](TGaugePointer.md#backtohome)
- [child](TGaugePointer.md#child)
- [clone](TGaugePointer.md#clone)
- [closeWindow](TGaugePointer.md#closewindow)
- [closeWindowForce](TGaugePointer.md#closewindowforce)
- [countChildren](TGaugePointer.md#countchildren)
- [createAnimator](TGaugePointer.md#createanimator)
- [destroy](TGaugePointer.md#destroy)
- [destroyAnimator](TGaugePointer.md#destroyanimator)
- [destroyAsync](TGaugePointer.md#destroyasync)
- [destroyChildren](TGaugePointer.md#destroychildren)
- [dispatchToKeyTarget](TGaugePointer.md#dispatchtokeytarget)
- [dispatchToTarget](TGaugePointer.md#dispatchtotarget)
- [equal](TGaugePointer.md#equal)
- [fillBgRect](TGaugePointer.md#fillbgrect)
- [fillFgRect](TGaugePointer.md#fillfgrect)
- [findParentByName](TGaugePointer.md#findparentbyname)
- [findParentByType](TGaugePointer.md#findparentbytype)
- [focusNext](TGaugePointer.md#focusnext)
- [focusPrev](TGaugePointer.md#focusprev)
- [foreach](TGaugePointer.md#foreach)
- [getAutoAdjustSize](TGaugePointer.md#getautoadjustsize)
- [getChild](TGaugePointer.md#getchild)
- [getEnable](TGaugePointer.md#getenable)
- [getFeedback](TGaugePointer.md#getfeedback)
- [getFloating](TGaugePointer.md#getfloating)
- [getFocusable](TGaugePointer.md#getfocusable)
- [getFocusedWidget](TGaugePointer.md#getfocusedwidget)
- [getNativeWindow](TGaugePointer.md#getnativewindow)
- [getPropBool](TGaugePointer.md#getpropbool)
- [getPropFloat](TGaugePointer.md#getpropfloat)
- [getPropInt](TGaugePointer.md#getpropint)
- [getPropPointer](TGaugePointer.md#getproppointer)
- [getPropStr](TGaugePointer.md#getpropstr)
- [getSensitive](TGaugePointer.md#getsensitive)
- [getStateForStyle](TGaugePointer.md#getstateforstyle)
- [getStyleType](TGaugePointer.md#getstyletype)
- [getText](TGaugePointer.md#gettext)
- [getThemeName](TGaugePointer.md#getthemename)
- [getType](TGaugePointer.md#gettype)
- [getValue](TGaugePointer.md#getvalue)
- [getValueInt](TGaugePointer.md#getvalueint)
- [getVisible](TGaugePointer.md#getvisible)
- [getWindow](TGaugePointer.md#getwindow)
- [getWindowManager](TGaugePointer.md#getwindowmanager)
- [getWithFocusState](TGaugePointer.md#getwithfocusstate)
- [indexOf](TGaugePointer.md#indexof)
- [insertChild](TGaugePointer.md#insertchild)
- [invalidateForce](TGaugePointer.md#invalidateforce)
- [isDesigningWindow](TGaugePointer.md#isdesigningwindow)
- [isDialog](TGaugePointer.md#isdialog)
- [isDirectParentOf](TGaugePointer.md#isdirectparentof)
- [isKeyboard](TGaugePointer.md#iskeyboard)
- [isNormalWindow](TGaugePointer.md#isnormalwindow)
- [isOpenedDialog](TGaugePointer.md#isopeneddialog)
- [isOpenedPopup](TGaugePointer.md#isopenedpopup)
- [isOverlay](TGaugePointer.md#isoverlay)
- [isParentOf](TGaugePointer.md#isparentof)
- [isPopup](TGaugePointer.md#ispopup)
- [isStyleExist](TGaugePointer.md#isstyleexist)
- [isSystemBar](TGaugePointer.md#issystembar)
- [isWindow](TGaugePointer.md#iswindow)
- [isWindowCreated](TGaugePointer.md#iswindowcreated)
- [isWindowManager](TGaugePointer.md#iswindowmanager)
- [isWindowOpened](TGaugePointer.md#iswindowopened)
- [layout](TGaugePointer.md#layout)
- [lookup](TGaugePointer.md#lookup)
- [lookupByType](TGaugePointer.md#lookupbytype)
- [move](TGaugePointer.md#move)
- [moveResize](TGaugePointer.md#moveresize)
- [moveResizeEx](TGaugePointer.md#moveresizeex)
- [moveToCenter](TGaugePointer.md#movetocenter)
- [off](TGaugePointer.md#off)
- [on](TGaugePointer.md#on)
- [pauseAnimator](TGaugePointer.md#pauseanimator)
- [removeChild](TGaugePointer.md#removechild)
- [resize](TGaugePointer.md#resize)
- [restack](TGaugePointer.md#restack)
- [setAnchor](TGaugePointer.md#setanchor)
- [setAngle](TGaugePointer.md#setangle)
- [setAnimation](TGaugePointer.md#setanimation)
- [setAnimatorTimeScale](TGaugePointer.md#setanimatortimescale)
- [setAsKeyTarget](TGaugePointer.md#setaskeytarget)
- [setAutoAdjustSize](TGaugePointer.md#setautoadjustsize)
- [setChildText](TGaugePointer.md#setchildtext)
- [setChildTextWithDouble](TGaugePointer.md#setchildtextwithdouble)
- [setChildTextWithInt](TGaugePointer.md#setchildtextwithint)
- [setChildrenLayout](TGaugePointer.md#setchildrenlayout)
- [setDirtyRectTolerance](TGaugePointer.md#setdirtyrecttolerance)
- [setEnable](TGaugePointer.md#setenable)
- [setFeedback](TGaugePointer.md#setfeedback)
- [setFloating](TGaugePointer.md#setfloating)
- [setFocusable](TGaugePointer.md#setfocusable)
- [setFocused](TGaugePointer.md#setfocused)
- [setImage](TGaugePointer.md#setimage)
- [setName](TGaugePointer.md#setname)
- [setOpacity](TGaugePointer.md#setopacity)
- [setPointerCursor](TGaugePointer.md#setpointercursor)
- [setPropBool](TGaugePointer.md#setpropbool)
- [setPropFloat](TGaugePointer.md#setpropfloat)
- [setPropInt](TGaugePointer.md#setpropint)
- [setPropPointer](TGaugePointer.md#setproppointer)
- [setPropStr](TGaugePointer.md#setpropstr)
- [setProps](TGaugePointer.md#setprops)
- [setSelfLayout](TGaugePointer.md#setselflayout)
- [setSelfLayoutParams](TGaugePointer.md#setselflayoutparams)
- [setSensitive](TGaugePointer.md#setsensitive)
- [setState](TGaugePointer.md#setstate)
- [setStyleColor](TGaugePointer.md#setstylecolor)
- [setStyleInt](TGaugePointer.md#setstyleint)
- [setStyleStr](TGaugePointer.md#setstylestr)
- [setText](TGaugePointer.md#settext)
- [setTextEx](TGaugePointer.md#settextex)
- [setTheme](TGaugePointer.md#settheme)
- [setTrText](TGaugePointer.md#settrtext)
- [setValue](TGaugePointer.md#setvalue)
- [setValueInt](TGaugePointer.md#setvalueint)
- [setVisible](TGaugePointer.md#setvisible)
- [setVisibleOnly](TGaugePointer.md#setvisibleonly)
- [startAnimator](TGaugePointer.md#startanimator)
- [stopAnimator](TGaugePointer.md#stopanimator)
- [strokeBorderRect](TGaugePointer.md#strokeborderrect)
- [unref](TGaugePointer.md#unref)
- [updateStyle](TGaugePointer.md#updatestyle)
- [updateStyleRecursive](TGaugePointer.md#updatestylerecursive)
- [useStyle](TGaugePointer.md#usestyle)
- [cast](TGaugePointer.md#cast)
- [create](TGaugePointer.md#create)

## Constructors

### constructor

• **new TGaugePointer**(`nativeObj`)
...
[awtk.ts:17038](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17038)
...
[awtk.ts:17037](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17037)
...
[awtk.ts:17140](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17140)
...
[awtk.ts:17149](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17149)
...
[awtk.ts:17112](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17112)
...
[awtk.ts:17116](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17116)
...
[awtk.ts:17127](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17127)
...
[awtk.ts:17131](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17131)
...
[awtk.ts:17103](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17103)

___

### setAngle

▸ **setAngle**(`angle`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:17078](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17078)
...
[awtk.ts:17090](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17090)
...
▸ `Static` **cast**(`widget`): [`TGaugePointer`](TGaugePointer.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | gauge_pointer对象。 |
...
[awtk.ts:17066](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17066)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TGaugePointer`](TGaugePointer.md)
...
[awtk.ts:17054](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17054)
