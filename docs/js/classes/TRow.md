[AWTK](../README.md) / [Exports](../modules.md) / TRow
...
- [constructor](TRow.md#constructor)

### Properties

- [nativeObj](TRow.md#nativeobj)

### Accessors

- [animation](TRow.md#animation)
- [autoAdjustSize](TRow.md#autoadjustsize)
- [dirtyRectTolerance](TRow.md#dirtyrecttolerance)
- [enable](TRow.md#enable)
- [feedback](TRow.md#feedback)
- [floating](TRow.md#floating)
- [focusable](TRow.md#focusable)
- [h](TRow.md#h)
- [name](TRow.md#name)
- [opacity](TRow.md#opacity)
- [parent](TRow.md#parent)
- [pointerCursor](TRow.md#pointercursor)
- [sensitive](TRow.md#sensitive)
- [style](TRow.md#style)
- [trText](TRow.md#trtext)
- [visible](TRow.md#visible)
- [w](TRow.md#w)
- [withFocusState](TRow.md#withfocusstate)
- [x](TRow.md#x)
- [y](TRow.md#y)

### Methods

- [addChild](TRow.md#addchild)
- [addChildDefault](TRow.md#addchilddefault)
- [addValue](TRow.md#addvalue)
- [addValueInt](TRow.md#addvalueint)
- [animateValueTo](TRow.md#animatevalueto)
- [back](TRow.md#back)
- [backToHome](TRow.md#backtohome)
- [child](TRow.md#child)
- [clone](TRow.md#clone)
- [closeWindow](TRow.md#closewindow)
- [closeWindowForce](TRow.md#closewindowforce)
- [countChildren](TRow.md#countchildren)
- [createAnimator](TRow.md#createanimator)
- [destroy](TRow.md#destroy)
- [destroyAnimator](TRow.md#destroyanimator)
- [destroyAsync](TRow.md#destroyasync)
- [destroyChildren](TRow.md#destroychildren)
- [dispatchToKeyTarget](TRow.md#dispatchtokeytarget)
- [dispatchToTarget](TRow.md#dispatchtotarget)
- [equal](TRow.md#equal)
- [fillBgRect](TRow.md#fillbgrect)
- [fillFgRect](TRow.md#fillfgrect)
- [findParentByName](TRow.md#findparentbyname)
- [findParentByType](TRow.md#findparentbytype)
- [focusNext](TRow.md#focusnext)
- [focusPrev](TRow.md#focusprev)
- [foreach](TRow.md#foreach)
- [getAutoAdjustSize](TRow.md#getautoadjustsize)
- [getChild](TRow.md#getchild)
- [getEnable](TRow.md#getenable)
- [getFeedback](TRow.md#getfeedback)
- [getFloating](TRow.md#getfloating)
- [getFocusable](TRow.md#getfocusable)
- [getFocusedWidget](TRow.md#getfocusedwidget)
- [getNativeWindow](TRow.md#getnativewindow)
- [getPropBool](TRow.md#getpropbool)
- [getPropFloat](TRow.md#getpropfloat)
- [getPropInt](TRow.md#getpropint)
- [getPropPointer](TRow.md#getproppointer)
- [getPropStr](TRow.md#getpropstr)
- [getSensitive](TRow.md#getsensitive)
- [getStateForStyle](TRow.md#getstateforstyle)
- [getStyleType](TRow.md#getstyletype)
- [getText](TRow.md#gettext)
- [getThemeName](TRow.md#getthemename)
- [getType](TRow.md#gettype)
- [getValue](TRow.md#getvalue)
- [getValueInt](TRow.md#getvalueint)
- [getVisible](TRow.md#getvisible)
- [getWindow](TRow.md#getwindow)
- [getWindowManager](TRow.md#getwindowmanager)
- [getWithFocusState](TRow.md#getwithfocusstate)
- [indexOf](TRow.md#indexof)
- [insertChild](TRow.md#insertchild)
- [invalidateForce](TRow.md#invalidateforce)
- [isDesigningWindow](TRow.md#isdesigningwindow)
- [isDialog](TRow.md#isdialog)
- [isDirectParentOf](TRow.md#isdirectparentof)
- [isKeyboard](TRow.md#iskeyboard)
- [isNormalWindow](TRow.md#isnormalwindow)
- [isOpenedDialog](TRow.md#isopeneddialog)
- [isOpenedPopup](TRow.md#isopenedpopup)
- [isOverlay](TRow.md#isoverlay)
- [isParentOf](TRow.md#isparentof)
- [isPopup](TRow.md#ispopup)
- [isStyleExist](TRow.md#isstyleexist)
- [isSystemBar](TRow.md#issystembar)
- [isWindow](TRow.md#iswindow)
- [isWindowCreated](TRow.md#iswindowcreated)
- [isWindowManager](TRow.md#iswindowmanager)
- [isWindowOpened](TRow.md#iswindowopened)
- [layout](TRow.md#layout)
- [lookup](TRow.md#lookup)
- [lookupByType](TRow.md#lookupbytype)
- [move](TRow.md#move)
- [moveResize](TRow.md#moveresize)
- [moveResizeEx](TRow.md#moveresizeex)
- [moveToCenter](TRow.md#movetocenter)
- [off](TRow.md#off)
- [on](TRow.md#on)
- [pauseAnimator](TRow.md#pauseanimator)
- [removeChild](TRow.md#removechild)
- [resize](TRow.md#resize)
- [restack](TRow.md#restack)
- [setAnimation](TRow.md#setanimation)
- [setAnimatorTimeScale](TRow.md#setanimatortimescale)
- [setAsKeyTarget](TRow.md#setaskeytarget)
- [setAutoAdjustSize](TRow.md#setautoadjustsize)
- [setChildText](TRow.md#setchildtext)
- [setChildTextWithDouble](TRow.md#setchildtextwithdouble)
- [setChildTextWithInt](TRow.md#setchildtextwithint)
- [setChildrenLayout](TRow.md#setchildrenlayout)
- [setDirtyRectTolerance](TRow.md#setdirtyrecttolerance)
- [setEnable](TRow.md#setenable)
- [setFeedback](TRow.md#setfeedback)
- [setFloating](TRow.md#setfloating)
- [setFocusable](TRow.md#setfocusable)
- [setFocused](TRow.md#setfocused)
- [setName](TRow.md#setname)
- [setOpacity](TRow.md#setopacity)
- [setPointerCursor](TRow.md#setpointercursor)
- [setPropBool](TRow.md#setpropbool)
- [setPropFloat](TRow.md#setpropfloat)
- [setPropInt](TRow.md#setpropint)
- [setPropPointer](TRow.md#setproppointer)
- [setPropStr](TRow.md#setpropstr)
- [setProps](TRow.md#setprops)
- [setSelfLayout](TRow.md#setselflayout)
- [setSelfLayoutParams](TRow.md#setselflayoutparams)
- [setSensitive](TRow.md#setsensitive)
- [setState](TRow.md#setstate)
- [setStyleColor](TRow.md#setstylecolor)
- [setStyleInt](TRow.md#setstyleint)
- [setStyleStr](TRow.md#setstylestr)
- [setText](TRow.md#settext)
- [setTextEx](TRow.md#settextex)
- [setTheme](TRow.md#settheme)
- [setTrText](TRow.md#settrtext)
- [setValue](TRow.md#setvalue)
- [setValueInt](TRow.md#setvalueint)
- [setVisible](TRow.md#setvisible)
- [setVisibleOnly](TRow.md#setvisibleonly)
- [startAnimator](TRow.md#startanimator)
- [stopAnimator](TRow.md#stopanimator)
- [strokeBorderRect](TRow.md#strokeborderrect)
- [unref](TRow.md#unref)
- [updateStyle](TRow.md#updatestyle)
- [updateStyleRecursive](TRow.md#updatestylerecursive)
- [useStyle](TRow.md#usestyle)
- [cast](TRow.md#cast)
- [create](TRow.md#create)
...
[awtk.ts:25617](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25617)
...
[awtk.ts:25616](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25616)
...
▸ `Static` **cast**(`widget`): [`TRow`](TRow.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | row对象。 |
...
[awtk.ts:25645](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25645)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TRow`](TRow.md)
...
[awtk.ts:25633](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25633)
