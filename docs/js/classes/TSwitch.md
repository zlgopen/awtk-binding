[AWTK](../README.md) / [Exports](../modules.md) / TSwitch
...
- [constructor](TSwitch.md#constructor)

### Properties

- [nativeObj](TSwitch.md#nativeobj)

### Accessors

- [animation](TSwitch.md#animation)
- [autoAdjustSize](TSwitch.md#autoadjustsize)
- [dirtyRectTolerance](TSwitch.md#dirtyrecttolerance)
- [enable](TSwitch.md#enable)
- [feedback](TSwitch.md#feedback)
- [floating](TSwitch.md#floating)
- [focusable](TSwitch.md#focusable)
- [h](TSwitch.md#h)
- [maxXoffsetRatio](TSwitch.md#maxxoffsetratio)
- [name](TSwitch.md#name)
- [opacity](TSwitch.md#opacity)
- [parent](TSwitch.md#parent)
- [pointerCursor](TSwitch.md#pointercursor)
- [sensitive](TSwitch.md#sensitive)
- [style](TSwitch.md#style)
- [trText](TSwitch.md#trtext)
- [value](TSwitch.md#value)
- [visible](TSwitch.md#visible)
- [w](TSwitch.md#w)
- [withFocusState](TSwitch.md#withfocusstate)
- [x](TSwitch.md#x)
- [y](TSwitch.md#y)

### Methods

- [addChild](TSwitch.md#addchild)
- [addChildDefault](TSwitch.md#addchilddefault)
- [addValue](TSwitch.md#addvalue)
- [addValueInt](TSwitch.md#addvalueint)
- [animateValueTo](TSwitch.md#animatevalueto)
- [back](TSwitch.md#back)
- [backToHome](TSwitch.md#backtohome)
- [child](TSwitch.md#child)
- [clone](TSwitch.md#clone)
- [closeWindow](TSwitch.md#closewindow)
- [closeWindowForce](TSwitch.md#closewindowforce)
- [countChildren](TSwitch.md#countchildren)
- [createAnimator](TSwitch.md#createanimator)
- [destroy](TSwitch.md#destroy)
- [destroyAnimator](TSwitch.md#destroyanimator)
- [destroyAsync](TSwitch.md#destroyasync)
- [destroyChildren](TSwitch.md#destroychildren)
- [dispatchToKeyTarget](TSwitch.md#dispatchtokeytarget)
- [dispatchToTarget](TSwitch.md#dispatchtotarget)
- [equal](TSwitch.md#equal)
- [fillBgRect](TSwitch.md#fillbgrect)
- [fillFgRect](TSwitch.md#fillfgrect)
- [findParentByName](TSwitch.md#findparentbyname)
- [findParentByType](TSwitch.md#findparentbytype)
- [focusNext](TSwitch.md#focusnext)
- [focusPrev](TSwitch.md#focusprev)
- [foreach](TSwitch.md#foreach)
- [getAutoAdjustSize](TSwitch.md#getautoadjustsize)
- [getChild](TSwitch.md#getchild)
- [getEnable](TSwitch.md#getenable)
- [getFeedback](TSwitch.md#getfeedback)
- [getFloating](TSwitch.md#getfloating)
- [getFocusable](TSwitch.md#getfocusable)
- [getFocusedWidget](TSwitch.md#getfocusedwidget)
- [getNativeWindow](TSwitch.md#getnativewindow)
- [getPropBool](TSwitch.md#getpropbool)
- [getPropFloat](TSwitch.md#getpropfloat)
- [getPropInt](TSwitch.md#getpropint)
- [getPropPointer](TSwitch.md#getproppointer)
- [getPropStr](TSwitch.md#getpropstr)
- [getSensitive](TSwitch.md#getsensitive)
- [getStateForStyle](TSwitch.md#getstateforstyle)
- [getStyleType](TSwitch.md#getstyletype)
- [getText](TSwitch.md#gettext)
- [getThemeName](TSwitch.md#getthemename)
- [getType](TSwitch.md#gettype)
- [getValue](TSwitch.md#getvalue)
- [getValueInt](TSwitch.md#getvalueint)
- [getVisible](TSwitch.md#getvisible)
- [getWindow](TSwitch.md#getwindow)
- [getWindowManager](TSwitch.md#getwindowmanager)
- [getWithFocusState](TSwitch.md#getwithfocusstate)
- [indexOf](TSwitch.md#indexof)
- [insertChild](TSwitch.md#insertchild)
- [invalidateForce](TSwitch.md#invalidateforce)
- [isDesigningWindow](TSwitch.md#isdesigningwindow)
- [isDialog](TSwitch.md#isdialog)
- [isDirectParentOf](TSwitch.md#isdirectparentof)
- [isKeyboard](TSwitch.md#iskeyboard)
- [isNormalWindow](TSwitch.md#isnormalwindow)
- [isOpenedDialog](TSwitch.md#isopeneddialog)
- [isOpenedPopup](TSwitch.md#isopenedpopup)
- [isOverlay](TSwitch.md#isoverlay)
- [isParentOf](TSwitch.md#isparentof)
- [isPopup](TSwitch.md#ispopup)
- [isStyleExist](TSwitch.md#isstyleexist)
- [isSystemBar](TSwitch.md#issystembar)
- [isWindow](TSwitch.md#iswindow)
- [isWindowCreated](TSwitch.md#iswindowcreated)
- [isWindowManager](TSwitch.md#iswindowmanager)
- [isWindowOpened](TSwitch.md#iswindowopened)
- [layout](TSwitch.md#layout)
- [lookup](TSwitch.md#lookup)
- [lookupByType](TSwitch.md#lookupbytype)
- [move](TSwitch.md#move)
- [moveResize](TSwitch.md#moveresize)
- [moveResizeEx](TSwitch.md#moveresizeex)
- [moveToCenter](TSwitch.md#movetocenter)
- [off](TSwitch.md#off)
- [on](TSwitch.md#on)
- [pauseAnimator](TSwitch.md#pauseanimator)
- [removeChild](TSwitch.md#removechild)
- [resize](TSwitch.md#resize)
- [restack](TSwitch.md#restack)
- [setAnimation](TSwitch.md#setanimation)
- [setAnimatorTimeScale](TSwitch.md#setanimatortimescale)
- [setAsKeyTarget](TSwitch.md#setaskeytarget)
- [setAutoAdjustSize](TSwitch.md#setautoadjustsize)
- [setChildText](TSwitch.md#setchildtext)
- [setChildTextWithDouble](TSwitch.md#setchildtextwithdouble)
- [setChildTextWithInt](TSwitch.md#setchildtextwithint)
- [setChildrenLayout](TSwitch.md#setchildrenlayout)
- [setDirtyRectTolerance](TSwitch.md#setdirtyrecttolerance)
- [setEnable](TSwitch.md#setenable)
- [setFeedback](TSwitch.md#setfeedback)
- [setFloating](TSwitch.md#setfloating)
- [setFocusable](TSwitch.md#setfocusable)
- [setFocused](TSwitch.md#setfocused)
- [setName](TSwitch.md#setname)
- [setOpacity](TSwitch.md#setopacity)
- [setPointerCursor](TSwitch.md#setpointercursor)
- [setPropBool](TSwitch.md#setpropbool)
- [setPropFloat](TSwitch.md#setpropfloat)
- [setPropInt](TSwitch.md#setpropint)
- [setPropPointer](TSwitch.md#setproppointer)
- [setPropStr](TSwitch.md#setpropstr)
- [setProps](TSwitch.md#setprops)
- [setSelfLayout](TSwitch.md#setselflayout)
- [setSelfLayoutParams](TSwitch.md#setselflayoutparams)
- [setSensitive](TSwitch.md#setsensitive)
- [setState](TSwitch.md#setstate)
- [setStyleColor](TSwitch.md#setstylecolor)
- [setStyleInt](TSwitch.md#setstyleint)
- [setStyleStr](TSwitch.md#setstylestr)
- [setText](TSwitch.md#settext)
- [setTextEx](TSwitch.md#settextex)
- [setTheme](TSwitch.md#settheme)
- [setTrText](TSwitch.md#settrtext)
- [setValue](TSwitch.md#setvalue)
- [setValueInt](TSwitch.md#setvalueint)
- [setVisible](TSwitch.md#setvisible)
- [setVisibleOnly](TSwitch.md#setvisibleonly)
- [startAnimator](TSwitch.md#startanimator)
- [stopAnimator](TSwitch.md#stopanimator)
- [strokeBorderRect](TSwitch.md#strokeborderrect)
- [unref](TSwitch.md#unref)
- [updateStyle](TSwitch.md#updatestyle)
- [updateStyleRecursive](TSwitch.md#updatestylerecursive)
- [useStyle](TSwitch.md#usestyle)
- [cast](TSwitch.md#cast)
- [create](TSwitch.md#create)

## Constructors

### constructor

• **new TSwitch**(`nativeObj`)
...
[awtk.ts:21807](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21807)
...
[awtk.ts:21806](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21806)
...
[awtk.ts:21869](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21869)
...
[awtk.ts:21856](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21856)
...
[awtk.ts:21860](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21860)
...
[awtk.ts:21835](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21835)
...
▸ `Static` **cast**(`widget`): [`TSwitch`](TSwitch.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | switch对象。 |
...
[awtk.ts:21847](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21847)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TSwitch`](TSwitch.md)
...
[awtk.ts:21823](https://github.com/zlgopen/awtk-binding/blob/5d7e9b70/tools/code_gen/js/output/awtk.ts#L21823)
