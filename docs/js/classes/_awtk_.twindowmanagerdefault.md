[AWTK](../README.md) › [Globals](../globals.md) › ["awtk"](../modules/_awtk_.md) › [TWindowManagerDefault](_awtk_.twindowmanagerdefault.md)

# Class: TWindowManagerDefault
...
## Hierarchy
  ...
  ↳ **TWindowManagerDefault**

## Index

### Constructors

* [constructor](_awtk_.twindowmanagerdefault.md#constructor)

### Properties

* [nativeObj](_awtk_.twindowmanagerdefault.md#nativeobj)

### Accessors

* [animation](_awtk_.twindowmanagerdefault.md#animation)
* [enable](_awtk_.twindowmanagerdefault.md#enable)
* [feedback](_awtk_.twindowmanagerdefault.md#feedback)
* [floating](_awtk_.twindowmanagerdefault.md#floating)
* [focusable](_awtk_.twindowmanagerdefault.md#focusable)
* [h](_awtk_.twindowmanagerdefault.md#h)
* [name](_awtk_.twindowmanagerdefault.md#name)
* [parent](_awtk_.twindowmanagerdefault.md#parent)
* [sensitive](_awtk_.twindowmanagerdefault.md#sensitive)
* [style](_awtk_.twindowmanagerdefault.md#style)
* [trText](_awtk_.twindowmanagerdefault.md#trtext)
* [visible](_awtk_.twindowmanagerdefault.md#visible)
* [w](_awtk_.twindowmanagerdefault.md#w)
* [withFocusState](_awtk_.twindowmanagerdefault.md#withfocusstate)
* [x](_awtk_.twindowmanagerdefault.md#x)
* [y](_awtk_.twindowmanagerdefault.md#y)

### Methods

* [addChild](_awtk_.twindowmanagerdefault.md#addchild)
* [addValue](_awtk_.twindowmanagerdefault.md#addvalue)
* [animateValueTo](_awtk_.twindowmanagerdefault.md#animatevalueto)
* [back](_awtk_.twindowmanagerdefault.md#back)
* [backTo](_awtk_.twindowmanagerdefault.md#backto)
* [backToHome](_awtk_.twindowmanagerdefault.md#backtohome)
* [child](_awtk_.twindowmanagerdefault.md#child)
* [clone](_awtk_.twindowmanagerdefault.md#clone)
* [countChildren](_awtk_.twindowmanagerdefault.md#countchildren)
* [createAnimator](_awtk_.twindowmanagerdefault.md#createanimator)
* [destroy](_awtk_.twindowmanagerdefault.md#destroy)
* [destroyAnimator](_awtk_.twindowmanagerdefault.md#destroyanimator)
* [destroyChildren](_awtk_.twindowmanagerdefault.md#destroychildren)
* [equal](_awtk_.twindowmanagerdefault.md#equal)
* [foreach](_awtk_.twindowmanagerdefault.md#foreach)
* [getChild](_awtk_.twindowmanagerdefault.md#getchild)
* [getPointerPressed](_awtk_.twindowmanagerdefault.md#getpointerpressed)
* [getPointerX](_awtk_.twindowmanagerdefault.md#getpointerx)
* [getPointerY](_awtk_.twindowmanagerdefault.md#getpointery)
* [getPrevWindow](_awtk_.twindowmanagerdefault.md#getprevwindow)
* [getPropBool](_awtk_.twindowmanagerdefault.md#getpropbool)
* [getPropInt](_awtk_.twindowmanagerdefault.md#getpropint)
* [getPropStr](_awtk_.twindowmanagerdefault.md#getpropstr)
* [getText](_awtk_.twindowmanagerdefault.md#gettext)
* [getTopMainWindow](_awtk_.twindowmanagerdefault.md#gettopmainwindow)
* [getTopWindow](_awtk_.twindowmanagerdefault.md#gettopwindow)
* [getType](_awtk_.twindowmanagerdefault.md#gettype)
* [getValue](_awtk_.twindowmanagerdefault.md#getvalue)
* [getWindow](_awtk_.twindowmanagerdefault.md#getwindow)
* [getWindowManager](_awtk_.twindowmanagerdefault.md#getwindowmanager)
* [indexOf](_awtk_.twindowmanagerdefault.md#indexof)
* [insertChild](_awtk_.twindowmanagerdefault.md#insertchild)
* [invalidateForce](_awtk_.twindowmanagerdefault.md#invalidateforce)
* [isDesigningWindow](_awtk_.twindowmanagerdefault.md#isdesigningwindow)
* [isWindow](_awtk_.twindowmanagerdefault.md#iswindow)
* [isWindowManager](_awtk_.twindowmanagerdefault.md#iswindowmanager)
* [isWindowOpened](_awtk_.twindowmanagerdefault.md#iswindowopened)
* [layout](_awtk_.twindowmanagerdefault.md#layout)
* [lookup](_awtk_.twindowmanagerdefault.md#lookup)
* [lookupByType](_awtk_.twindowmanagerdefault.md#lookupbytype)
* [move](_awtk_.twindowmanagerdefault.md#move)
* [moveResize](_awtk_.twindowmanagerdefault.md#moveresize)
* [off](_awtk_.twindowmanagerdefault.md#off)
* [on](_awtk_.twindowmanagerdefault.md#on)
* [pauseAnimator](_awtk_.twindowmanagerdefault.md#pauseanimator)
* [removeChild](_awtk_.twindowmanagerdefault.md#removechild)
* [resize](_awtk_.twindowmanagerdefault.md#resize)
* [restack](_awtk_.twindowmanagerdefault.md#restack)
* [setAnimation](_awtk_.twindowmanagerdefault.md#setanimation)
* [setAnimatorTimeScale](_awtk_.twindowmanagerdefault.md#setanimatortimescale)
* [setChildrenLayout](_awtk_.twindowmanagerdefault.md#setchildrenlayout)
* [setCursor](_awtk_.twindowmanagerdefault.md#setcursor)
* [setEnable](_awtk_.twindowmanagerdefault.md#setenable)
* [setFeedback](_awtk_.twindowmanagerdefault.md#setfeedback)
* [setFloating](_awtk_.twindowmanagerdefault.md#setfloating)
* [setFocused](_awtk_.twindowmanagerdefault.md#setfocused)
* [setName](_awtk_.twindowmanagerdefault.md#setname)
* [setOpacity](_awtk_.twindowmanagerdefault.md#setopacity)
* [setPointerCursor](_awtk_.twindowmanagerdefault.md#setpointercursor)
* [setPropBool](_awtk_.twindowmanagerdefault.md#setpropbool)
* [setPropInt](_awtk_.twindowmanagerdefault.md#setpropint)
* [setPropStr](_awtk_.twindowmanagerdefault.md#setpropstr)
* [setScreenSaverTime](_awtk_.twindowmanagerdefault.md#setscreensavertime)
* [setSelfLayout](_awtk_.twindowmanagerdefault.md#setselflayout)
* [setSelfLayoutParams](_awtk_.twindowmanagerdefault.md#setselflayoutparams)
* [setSensitive](_awtk_.twindowmanagerdefault.md#setsensitive)
* [setShowFps](_awtk_.twindowmanagerdefault.md#setshowfps)
* [setState](_awtk_.twindowmanagerdefault.md#setstate)
* [setStyleColor](_awtk_.twindowmanagerdefault.md#setstylecolor)
* [setStyleInt](_awtk_.twindowmanagerdefault.md#setstyleint)
* [setStyleStr](_awtk_.twindowmanagerdefault.md#setstylestr)
* [setText](_awtk_.twindowmanagerdefault.md#settext)
* [setTheme](_awtk_.twindowmanagerdefault.md#settheme)
* [setTrText](_awtk_.twindowmanagerdefault.md#settrtext)
* [setValue](_awtk_.twindowmanagerdefault.md#setvalue)
* [setVisible](_awtk_.twindowmanagerdefault.md#setvisible)
* [setVisibleOnly](_awtk_.twindowmanagerdefault.md#setvisibleonly)
* [startAnimator](_awtk_.twindowmanagerdefault.md#startanimator)
* [stopAnimator](_awtk_.twindowmanagerdefault.md#stopanimator)
* [unref](_awtk_.twindowmanagerdefault.md#unref)
* [useStyle](_awtk_.twindowmanagerdefault.md#usestyle)
* [cast](_awtk_.twindowmanagerdefault.md#static-cast)
* [instance](_awtk_.twindowmanagerdefault.md#static-instance)

## Constructors

###  constructor

\+ **new TWindowManagerDefault**(`nativeObj`: any): *[TWindowManagerDefault](_awtk_.twindowmanagerdefault.md)*

*Overrides [TWindowManager](_awtk_.twindowmanager.md).[constructor](_awtk_.twindowmanager.md#constructor)*

*Defined in [awtk.ts:22044](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L22044)*
...
**Returns:** *[TWindowManagerDefault](_awtk_.twindowmanagerdefault.md)*
...
*Overrides [TWindowManager](_awtk_.twindowmanager.md).[nativeObj](_awtk_.twindowmanager.md#nativeobj)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[back](_awtk_.twindowmanager.md#back)*

*Defined in [awtk.ts:18101](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L18101)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[backTo](_awtk_.twindowmanager.md#backto)*

*Defined in [awtk.ts:18130](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L18130)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[backToHome](_awtk_.twindowmanager.md#backtohome)*

*Defined in [awtk.ts:18115](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L18115)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[getPointerPressed](_awtk_.twindowmanager.md#getpointerpressed)*

*Defined in [awtk.ts:18045](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L18045)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[getPointerX](_awtk_.twindowmanager.md#getpointerx)*

*Defined in [awtk.ts:18019](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L18019)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[getPointerY](_awtk_.twindowmanager.md#getpointery)*

*Defined in [awtk.ts:18032](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L18032)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[getPrevWindow](_awtk_.twindowmanager.md#getprevwindow)*

*Defined in [awtk.ts:18006](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L18006)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[getTopMainWindow](_awtk_.twindowmanager.md#gettopmainwindow)*

*Defined in [awtk.ts:17980](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L17980)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[getTopWindow](_awtk_.twindowmanager.md#gettopwindow)*

*Defined in [awtk.ts:17993](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L17993)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[setCursor](_awtk_.twindowmanager.md#setcursor)*

*Defined in [awtk.ts:18087](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L18087)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[setScreenSaverTime](_awtk_.twindowmanager.md#setscreensavertime)*

*Defined in [awtk.ts:18073](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L18073)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[setShowFps](_awtk_.twindowmanager.md#setshowfps)*

*Defined in [awtk.ts:18059](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L18059)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[cast](_awtk_.twindowmanager.md#static-cast)*

*Overrides [TWidget](_awtk_.twidget.md).[cast](_awtk_.twidget.md#static-cast)*

*Defined in [awtk.ts:17967](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L17967)*
...
*Inherited from [TWindowManager](_awtk_.twindowmanager.md).[instance](_awtk_.twindowmanager.md#static-instance)*

*Defined in [awtk.ts:17954](https://github.com/zlgopen/awtk-binding/blob/540939e/tools/code_gen/js/output/awtk.ts#L17954)*
