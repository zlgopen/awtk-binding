[AWTK](../README.md) / [Exports](../modules.md) / TLabel
...
- [constructor](TLabel.md#constructor)

### Properties

- [nativeObj](TLabel.md#nativeobj)

### Accessors

- [animation](TLabel.md#animation)
- [autoAdjustSize](TLabel.md#autoadjustsize)
- [dirtyRectTolerance](TLabel.md#dirtyrecttolerance)
- [enable](TLabel.md#enable)
- [feedback](TLabel.md#feedback)
- [floating](TLabel.md#floating)
- [focusable](TLabel.md#focusable)
- [h](TLabel.md#h)
- [length](TLabel.md#length)
- [lineWrap](TLabel.md#linewrap)
- [maxW](TLabel.md#maxw)
- [name](TLabel.md#name)
- [opacity](TLabel.md#opacity)
- [parent](TLabel.md#parent)
- [pointerCursor](TLabel.md#pointercursor)
- [sensitive](TLabel.md#sensitive)
- [style](TLabel.md#style)
- [trText](TLabel.md#trtext)
- [visible](TLabel.md#visible)
- [w](TLabel.md#w)
- [withFocusState](TLabel.md#withfocusstate)
- [wordWrap](TLabel.md#wordwrap)
- [x](TLabel.md#x)
- [y](TLabel.md#y)

### Methods

- [addChild](TLabel.md#addchild)
- [addChildDefault](TLabel.md#addchilddefault)
- [addValue](TLabel.md#addvalue)
- [addValueInt](TLabel.md#addvalueint)
- [animateValueTo](TLabel.md#animatevalueto)
- [back](TLabel.md#back)
- [backToHome](TLabel.md#backtohome)
- [child](TLabel.md#child)
- [clone](TLabel.md#clone)
- [closeWindow](TLabel.md#closewindow)
- [closeWindowForce](TLabel.md#closewindowforce)
- [countChildren](TLabel.md#countchildren)
- [createAnimator](TLabel.md#createanimator)
- [destroy](TLabel.md#destroy)
- [destroyAnimator](TLabel.md#destroyanimator)
- [destroyAsync](TLabel.md#destroyasync)
- [destroyChildren](TLabel.md#destroychildren)
- [dispatchToKeyTarget](TLabel.md#dispatchtokeytarget)
- [dispatchToTarget](TLabel.md#dispatchtotarget)
- [equal](TLabel.md#equal)
- [fillBgRect](TLabel.md#fillbgrect)
- [fillFgRect](TLabel.md#fillfgrect)
- [findParentByName](TLabel.md#findparentbyname)
- [findParentByType](TLabel.md#findparentbytype)
- [focusNext](TLabel.md#focusnext)
- [focusPrev](TLabel.md#focusprev)
- [foreach](TLabel.md#foreach)
- [getAutoAdjustSize](TLabel.md#getautoadjustsize)
- [getChild](TLabel.md#getchild)
- [getEnable](TLabel.md#getenable)
- [getFeedback](TLabel.md#getfeedback)
- [getFloating](TLabel.md#getfloating)
- [getFocusable](TLabel.md#getfocusable)
- [getFocusedWidget](TLabel.md#getfocusedwidget)
- [getNativeWindow](TLabel.md#getnativewindow)
- [getPropBool](TLabel.md#getpropbool)
- [getPropFloat](TLabel.md#getpropfloat)
- [getPropInt](TLabel.md#getpropint)
- [getPropPointer](TLabel.md#getproppointer)
- [getPropStr](TLabel.md#getpropstr)
- [getSensitive](TLabel.md#getsensitive)
- [getStateForStyle](TLabel.md#getstateforstyle)
- [getStyleType](TLabel.md#getstyletype)
- [getText](TLabel.md#gettext)
- [getThemeName](TLabel.md#getthemename)
- [getType](TLabel.md#gettype)
- [getValue](TLabel.md#getvalue)
- [getValueInt](TLabel.md#getvalueint)
- [getVisible](TLabel.md#getvisible)
- [getWindow](TLabel.md#getwindow)
- [getWindowManager](TLabel.md#getwindowmanager)
- [getWithFocusState](TLabel.md#getwithfocusstate)
- [indexOf](TLabel.md#indexof)
- [insertChild](TLabel.md#insertchild)
- [invalidateForce](TLabel.md#invalidateforce)
- [isDesigningWindow](TLabel.md#isdesigningwindow)
- [isDialog](TLabel.md#isdialog)
- [isDirectParentOf](TLabel.md#isdirectparentof)
- [isKeyboard](TLabel.md#iskeyboard)
- [isNormalWindow](TLabel.md#isnormalwindow)
- [isOpenedDialog](TLabel.md#isopeneddialog)
- [isOpenedPopup](TLabel.md#isopenedpopup)
- [isOverlay](TLabel.md#isoverlay)
- [isParentOf](TLabel.md#isparentof)
- [isPopup](TLabel.md#ispopup)
- [isStyleExist](TLabel.md#isstyleexist)
- [isSystemBar](TLabel.md#issystembar)
- [isWindow](TLabel.md#iswindow)
- [isWindowCreated](TLabel.md#iswindowcreated)
- [isWindowManager](TLabel.md#iswindowmanager)
- [isWindowOpened](TLabel.md#iswindowopened)
- [layout](TLabel.md#layout)
- [lookup](TLabel.md#lookup)
- [lookupByType](TLabel.md#lookupbytype)
- [move](TLabel.md#move)
- [moveResize](TLabel.md#moveresize)
- [moveResizeEx](TLabel.md#moveresizeex)
- [moveToCenter](TLabel.md#movetocenter)
- [off](TLabel.md#off)
- [on](TLabel.md#on)
- [pauseAnimator](TLabel.md#pauseanimator)
- [removeChild](TLabel.md#removechild)
- [resize](TLabel.md#resize)
- [resizeToContent](TLabel.md#resizetocontent)
- [restack](TLabel.md#restack)
- [setAnimation](TLabel.md#setanimation)
- [setAnimatorTimeScale](TLabel.md#setanimatortimescale)
- [setAsKeyTarget](TLabel.md#setaskeytarget)
- [setAutoAdjustSize](TLabel.md#setautoadjustsize)
- [setChildText](TLabel.md#setchildtext)
- [setChildTextWithDouble](TLabel.md#setchildtextwithdouble)
- [setChildTextWithInt](TLabel.md#setchildtextwithint)
- [setChildrenLayout](TLabel.md#setchildrenlayout)
- [setDirtyRectTolerance](TLabel.md#setdirtyrecttolerance)
- [setEnable](TLabel.md#setenable)
- [setFeedback](TLabel.md#setfeedback)
- [setFloating](TLabel.md#setfloating)
- [setFocusable](TLabel.md#setfocusable)
- [setFocused](TLabel.md#setfocused)
- [setLength](TLabel.md#setlength)
- [setLineWrap](TLabel.md#setlinewrap)
- [setMaxW](TLabel.md#setmaxw)
- [setName](TLabel.md#setname)
- [setOpacity](TLabel.md#setopacity)
- [setPointerCursor](TLabel.md#setpointercursor)
- [setPropBool](TLabel.md#setpropbool)
- [setPropFloat](TLabel.md#setpropfloat)
- [setPropInt](TLabel.md#setpropint)
- [setPropPointer](TLabel.md#setproppointer)
- [setPropStr](TLabel.md#setpropstr)
- [setProps](TLabel.md#setprops)
- [setSelfLayout](TLabel.md#setselflayout)
- [setSelfLayoutParams](TLabel.md#setselflayoutparams)
- [setSensitive](TLabel.md#setsensitive)
- [setState](TLabel.md#setstate)
- [setStyleColor](TLabel.md#setstylecolor)
- [setStyleInt](TLabel.md#setstyleint)
- [setStyleStr](TLabel.md#setstylestr)
- [setText](TLabel.md#settext)
- [setTextEx](TLabel.md#settextex)
- [setTheme](TLabel.md#settheme)
- [setTrText](TLabel.md#settrtext)
- [setValue](TLabel.md#setvalue)
- [setValueInt](TLabel.md#setvalueint)
- [setVisible](TLabel.md#setvisible)
- [setVisibleOnly](TLabel.md#setvisibleonly)
- [setWordWrap](TLabel.md#setwordwrap)
- [startAnimator](TLabel.md#startanimator)
- [stopAnimator](TLabel.md#stopanimator)
- [strokeBorderRect](TLabel.md#strokeborderrect)
- [unref](TLabel.md#unref)
- [updateStyle](TLabel.md#updatestyle)
- [updateStyleRecursive](TLabel.md#updatestylerecursive)
- [useStyle](TLabel.md#usestyle)
- [cast](TLabel.md#cast)
- [create](TLabel.md#create)

## Constructors

### constructor

• **new TLabel**(`nativeObj`)
...
[awtk.ts:25078](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25078)
...
[awtk.ts:25077](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25077)
...
[awtk.ts:25179](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25179)
...
[awtk.ts:25183](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25183)
...
[awtk.ts:25192](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25192)
...
[awtk.ts:25196](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25196)
...
[awtk.ts:25220](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25220)
...
[awtk.ts:25224](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25224)
...
[awtk.ts:25206](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25206)
...
[awtk.ts:25210](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25210)
...
▸ **resizeToContent**(`min_w`, `max_w`, `min_h`, `max_h`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:25157](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25157)
...
▸ **setLength**(`length`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:25106](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25106)

___

### setLineWrap

▸ **setLineWrap**(`line_wrap`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:25130](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25130)

___

### setMaxW

▸ **setMaxW**(`max_w`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:25118](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25118)
...
▸ **setWordWrap**(`word_wrap`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:25142](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25142)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | label对象。 |
...
[awtk.ts:25169](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25169)
...
[awtk.ts:25094](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L25094)
