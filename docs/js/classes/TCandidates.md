[AWTK](../README.md) / [Exports](../modules.md) / TCandidates
...
- [constructor](TCandidates.md#constructor)

### Properties

- [nativeObj](TCandidates.md#nativeobj)

### Accessors

- [animation](TCandidates.md#animation)
- [autoAdjustSize](TCandidates.md#autoadjustsize)
- [autoHide](TCandidates.md#autohide)
- [buttonStyle](TCandidates.md#buttonstyle)
- [dirtyRectTolerance](TCandidates.md#dirtyrecttolerance)
- [enable](TCandidates.md#enable)
- [enablePreview](TCandidates.md#enablepreview)
- [feedback](TCandidates.md#feedback)
- [floating](TCandidates.md#floating)
- [focusable](TCandidates.md#focusable)
- [h](TCandidates.md#h)
- [name](TCandidates.md#name)
- [opacity](TCandidates.md#opacity)
- [parent](TCandidates.md#parent)
- [pointerCursor](TCandidates.md#pointercursor)
- [pre](TCandidates.md#pre)
- [selectByNum](TCandidates.md#selectbynum)
- [sensitive](TCandidates.md#sensitive)
- [style](TCandidates.md#style)
- [trText](TCandidates.md#trtext)
- [visible](TCandidates.md#visible)
- [w](TCandidates.md#w)
- [withFocusState](TCandidates.md#withfocusstate)
- [x](TCandidates.md#x)
- [y](TCandidates.md#y)

### Methods

- [addChild](TCandidates.md#addchild)
- [addChildDefault](TCandidates.md#addchilddefault)
- [addValue](TCandidates.md#addvalue)
- [addValueInt](TCandidates.md#addvalueint)
- [animateValueTo](TCandidates.md#animatevalueto)
- [back](TCandidates.md#back)
- [backToHome](TCandidates.md#backtohome)
- [child](TCandidates.md#child)
- [clone](TCandidates.md#clone)
- [closeWindow](TCandidates.md#closewindow)
- [closeWindowForce](TCandidates.md#closewindowforce)
- [countChildren](TCandidates.md#countchildren)
- [createAnimator](TCandidates.md#createanimator)
- [destroy](TCandidates.md#destroy)
- [destroyAnimator](TCandidates.md#destroyanimator)
- [destroyAsync](TCandidates.md#destroyasync)
- [destroyChildren](TCandidates.md#destroychildren)
- [dispatchToKeyTarget](TCandidates.md#dispatchtokeytarget)
- [dispatchToTarget](TCandidates.md#dispatchtotarget)
- [equal](TCandidates.md#equal)
- [fillBgRect](TCandidates.md#fillbgrect)
- [fillFgRect](TCandidates.md#fillfgrect)
- [findParentByName](TCandidates.md#findparentbyname)
- [findParentByType](TCandidates.md#findparentbytype)
- [focusNext](TCandidates.md#focusnext)
- [focusPrev](TCandidates.md#focusprev)
- [foreach](TCandidates.md#foreach)
- [getAutoAdjustSize](TCandidates.md#getautoadjustsize)
- [getChild](TCandidates.md#getchild)
- [getEnable](TCandidates.md#getenable)
- [getFeedback](TCandidates.md#getfeedback)
- [getFloating](TCandidates.md#getfloating)
- [getFocusable](TCandidates.md#getfocusable)
- [getFocusedWidget](TCandidates.md#getfocusedwidget)
- [getNativeWindow](TCandidates.md#getnativewindow)
- [getPropBool](TCandidates.md#getpropbool)
- [getPropFloat](TCandidates.md#getpropfloat)
- [getPropInt](TCandidates.md#getpropint)
- [getPropPointer](TCandidates.md#getproppointer)
- [getPropStr](TCandidates.md#getpropstr)
- [getSensitive](TCandidates.md#getsensitive)
- [getStateForStyle](TCandidates.md#getstateforstyle)
- [getStyleType](TCandidates.md#getstyletype)
- [getText](TCandidates.md#gettext)
- [getThemeName](TCandidates.md#getthemename)
- [getType](TCandidates.md#gettype)
- [getValue](TCandidates.md#getvalue)
- [getValueInt](TCandidates.md#getvalueint)
- [getVisible](TCandidates.md#getvisible)
- [getWindow](TCandidates.md#getwindow)
- [getWindowManager](TCandidates.md#getwindowmanager)
- [getWithFocusState](TCandidates.md#getwithfocusstate)
- [indexOf](TCandidates.md#indexof)
- [insertChild](TCandidates.md#insertchild)
- [invalidateForce](TCandidates.md#invalidateforce)
- [isDesigningWindow](TCandidates.md#isdesigningwindow)
- [isDialog](TCandidates.md#isdialog)
- [isDirectParentOf](TCandidates.md#isdirectparentof)
- [isKeyboard](TCandidates.md#iskeyboard)
- [isNormalWindow](TCandidates.md#isnormalwindow)
- [isOpenedDialog](TCandidates.md#isopeneddialog)
- [isOpenedPopup](TCandidates.md#isopenedpopup)
- [isOverlay](TCandidates.md#isoverlay)
- [isParentOf](TCandidates.md#isparentof)
- [isPopup](TCandidates.md#ispopup)
- [isStyleExist](TCandidates.md#isstyleexist)
- [isSystemBar](TCandidates.md#issystembar)
- [isWindow](TCandidates.md#iswindow)
- [isWindowCreated](TCandidates.md#iswindowcreated)
- [isWindowManager](TCandidates.md#iswindowmanager)
- [isWindowOpened](TCandidates.md#iswindowopened)
- [layout](TCandidates.md#layout)
- [lookup](TCandidates.md#lookup)
- [lookupByType](TCandidates.md#lookupbytype)
- [move](TCandidates.md#move)
- [moveResize](TCandidates.md#moveresize)
- [moveResizeEx](TCandidates.md#moveresizeex)
- [moveToCenter](TCandidates.md#movetocenter)
- [off](TCandidates.md#off)
- [on](TCandidates.md#on)
- [pauseAnimator](TCandidates.md#pauseanimator)
- [removeChild](TCandidates.md#removechild)
- [resize](TCandidates.md#resize)
- [restack](TCandidates.md#restack)
- [setAnimation](TCandidates.md#setanimation)
- [setAnimatorTimeScale](TCandidates.md#setanimatortimescale)
- [setAsKeyTarget](TCandidates.md#setaskeytarget)
- [setAutoAdjustSize](TCandidates.md#setautoadjustsize)
- [setAutoHide](TCandidates.md#setautohide)
- [setButtonStyle](TCandidates.md#setbuttonstyle)
- [setChildText](TCandidates.md#setchildtext)
- [setChildTextWithDouble](TCandidates.md#setchildtextwithdouble)
- [setChildTextWithInt](TCandidates.md#setchildtextwithint)
- [setChildrenLayout](TCandidates.md#setchildrenlayout)
- [setDirtyRectTolerance](TCandidates.md#setdirtyrecttolerance)
- [setEnable](TCandidates.md#setenable)
- [setFeedback](TCandidates.md#setfeedback)
- [setFloating](TCandidates.md#setfloating)
- [setFocusable](TCandidates.md#setfocusable)
- [setFocused](TCandidates.md#setfocused)
- [setName](TCandidates.md#setname)
- [setOpacity](TCandidates.md#setopacity)
- [setPointerCursor](TCandidates.md#setpointercursor)
- [setPre](TCandidates.md#setpre)
- [setPropBool](TCandidates.md#setpropbool)
- [setPropFloat](TCandidates.md#setpropfloat)
- [setPropInt](TCandidates.md#setpropint)
- [setPropPointer](TCandidates.md#setproppointer)
- [setPropStr](TCandidates.md#setpropstr)
- [setProps](TCandidates.md#setprops)
- [setSelectByNum](TCandidates.md#setselectbynum)
- [setSelfLayout](TCandidates.md#setselflayout)
- [setSelfLayoutParams](TCandidates.md#setselflayoutparams)
- [setSensitive](TCandidates.md#setsensitive)
- [setState](TCandidates.md#setstate)
- [setStyleColor](TCandidates.md#setstylecolor)
- [setStyleInt](TCandidates.md#setstyleint)
- [setStyleStr](TCandidates.md#setstylestr)
- [setText](TCandidates.md#settext)
- [setTextEx](TCandidates.md#settextex)
- [setTheme](TCandidates.md#settheme)
- [setTrText](TCandidates.md#settrtext)
- [setValue](TCandidates.md#setvalue)
- [setValueInt](TCandidates.md#setvalueint)
- [setVisible](TCandidates.md#setvisible)
- [setVisibleOnly](TCandidates.md#setvisibleonly)
- [startAnimator](TCandidates.md#startanimator)
- [stopAnimator](TCandidates.md#stopanimator)
- [strokeBorderRect](TCandidates.md#strokeborderrect)
- [unref](TCandidates.md#unref)
- [updateStyle](TCandidates.md#updatestyle)
- [updateStyleRecursive](TCandidates.md#updatestylerecursive)
- [useStyle](TCandidates.md#usestyle)
- [cast](TCandidates.md#cast)
- [create](TCandidates.md#create)

## Constructors

### constructor

• **new TCandidates**(`nativeObj`)
...
[awtk.ts:17931](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17931)
...
[awtk.ts:17930](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17930)
...
[awtk.ts:18047](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18047)
...
[awtk.ts:18051](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18051)
...
[awtk.ts:18060](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18060)

• `set` **buttonStyle**(`v`): `void`
...
[awtk.ts:18064](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18064)
...
[awtk.ts:18073](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18073)
...
[awtk.ts:18021](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18021)
...
[awtk.ts:18025](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18025)
...
[awtk.ts:18034](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18034)

• `set` **selectByNum**(`v`): `void`
...
[awtk.ts:18038](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18038)
...
[awtk.ts:17997](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17997)

___

### setButtonStyle

▸ **setButtonStyle**(`button_style`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `button_style` | `string` | 按钮的style名称。 |
...
[awtk.ts:18009](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L18009)
...
[awtk.ts:17973](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17973)
...
▸ **setSelectByNum**(`select_by_num`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `select_by_num` | `boolean` | 是否启用用数字选择候选字。 |
...
[awtk.ts:17985](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17985)
...
▸ `Static` **cast**(`widget`): [`TCandidates`](TCandidates.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | candidates对象。 |
...
[awtk.ts:17959](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17959)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TCandidates`](TCandidates.md)
...
[awtk.ts:17947](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L17947)
