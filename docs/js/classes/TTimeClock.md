[AWTK](../README.md) / [Exports](../modules.md) / TTimeClock
...
- [constructor](TTimeClock.md#constructor)

### Properties

- [nativeObj](TTimeClock.md#nativeobj)

### Accessors

- [animation](TTimeClock.md#animation)
- [autoAdjustSize](TTimeClock.md#autoadjustsize)
- [bgImage](TTimeClock.md#bgimage)
- [dirtyRectTolerance](TTimeClock.md#dirtyrecttolerance)
- [enable](TTimeClock.md#enable)
- [feedback](TTimeClock.md#feedback)
- [floating](TTimeClock.md#floating)
- [focusable](TTimeClock.md#focusable)
- [h](TTimeClock.md#h)
- [hour](TTimeClock.md#hour)
- [hourAnchorX](TTimeClock.md#houranchorx)
- [hourAnchorY](TTimeClock.md#houranchory)
- [hourImage](TTimeClock.md#hourimage)
- [image](TTimeClock.md#image)
- [minute](TTimeClock.md#minute)
- [minuteAnchorX](TTimeClock.md#minuteanchorx)
- [minuteAnchorY](TTimeClock.md#minuteanchory)
- [minuteImage](TTimeClock.md#minuteimage)
- [name](TTimeClock.md#name)
- [opacity](TTimeClock.md#opacity)
- [parent](TTimeClock.md#parent)
- [pointerCursor](TTimeClock.md#pointercursor)
- [second](TTimeClock.md#second)
- [secondAnchorX](TTimeClock.md#secondanchorx)
- [secondAnchorY](TTimeClock.md#secondanchory)
- [secondImage](TTimeClock.md#secondimage)
- [sensitive](TTimeClock.md#sensitive)
- [style](TTimeClock.md#style)
- [trText](TTimeClock.md#trtext)
- [visible](TTimeClock.md#visible)
- [w](TTimeClock.md#w)
- [withFocusState](TTimeClock.md#withfocusstate)
- [x](TTimeClock.md#x)
- [y](TTimeClock.md#y)

### Methods

- [addChild](TTimeClock.md#addchild)
- [addChildDefault](TTimeClock.md#addchilddefault)
- [addValue](TTimeClock.md#addvalue)
- [addValueInt](TTimeClock.md#addvalueint)
- [animateValueTo](TTimeClock.md#animatevalueto)
- [back](TTimeClock.md#back)
- [backToHome](TTimeClock.md#backtohome)
- [child](TTimeClock.md#child)
- [clone](TTimeClock.md#clone)
- [closeWindow](TTimeClock.md#closewindow)
- [closeWindowForce](TTimeClock.md#closewindowforce)
- [countChildren](TTimeClock.md#countchildren)
- [createAnimator](TTimeClock.md#createanimator)
- [destroy](TTimeClock.md#destroy)
- [destroyAnimator](TTimeClock.md#destroyanimator)
- [destroyAsync](TTimeClock.md#destroyasync)
- [destroyChildren](TTimeClock.md#destroychildren)
- [dispatchToKeyTarget](TTimeClock.md#dispatchtokeytarget)
- [dispatchToTarget](TTimeClock.md#dispatchtotarget)
- [equal](TTimeClock.md#equal)
- [fillBgRect](TTimeClock.md#fillbgrect)
- [fillFgRect](TTimeClock.md#fillfgrect)
- [findParentByName](TTimeClock.md#findparentbyname)
- [findParentByType](TTimeClock.md#findparentbytype)
- [focusNext](TTimeClock.md#focusnext)
- [focusPrev](TTimeClock.md#focusprev)
- [foreach](TTimeClock.md#foreach)
- [getAutoAdjustSize](TTimeClock.md#getautoadjustsize)
- [getChild](TTimeClock.md#getchild)
- [getEnable](TTimeClock.md#getenable)
- [getFeedback](TTimeClock.md#getfeedback)
- [getFloating](TTimeClock.md#getfloating)
- [getFocusable](TTimeClock.md#getfocusable)
- [getFocusedWidget](TTimeClock.md#getfocusedwidget)
- [getNativeWindow](TTimeClock.md#getnativewindow)
- [getPropBool](TTimeClock.md#getpropbool)
- [getPropFloat](TTimeClock.md#getpropfloat)
- [getPropInt](TTimeClock.md#getpropint)
- [getPropPointer](TTimeClock.md#getproppointer)
- [getPropStr](TTimeClock.md#getpropstr)
- [getSensitive](TTimeClock.md#getsensitive)
- [getStateForStyle](TTimeClock.md#getstateforstyle)
- [getStyleType](TTimeClock.md#getstyletype)
- [getText](TTimeClock.md#gettext)
- [getThemeName](TTimeClock.md#getthemename)
- [getType](TTimeClock.md#gettype)
- [getValue](TTimeClock.md#getvalue)
- [getValueInt](TTimeClock.md#getvalueint)
- [getVisible](TTimeClock.md#getvisible)
- [getWindow](TTimeClock.md#getwindow)
- [getWindowManager](TTimeClock.md#getwindowmanager)
- [getWithFocusState](TTimeClock.md#getwithfocusstate)
- [indexOf](TTimeClock.md#indexof)
- [insertChild](TTimeClock.md#insertchild)
- [invalidateForce](TTimeClock.md#invalidateforce)
- [isDesigningWindow](TTimeClock.md#isdesigningwindow)
- [isDialog](TTimeClock.md#isdialog)
- [isDirectParentOf](TTimeClock.md#isdirectparentof)
- [isKeyboard](TTimeClock.md#iskeyboard)
- [isNormalWindow](TTimeClock.md#isnormalwindow)
- [isOpenedDialog](TTimeClock.md#isopeneddialog)
- [isOpenedPopup](TTimeClock.md#isopenedpopup)
- [isOverlay](TTimeClock.md#isoverlay)
- [isParentOf](TTimeClock.md#isparentof)
- [isPopup](TTimeClock.md#ispopup)
- [isStyleExist](TTimeClock.md#isstyleexist)
- [isSystemBar](TTimeClock.md#issystembar)
- [isWindow](TTimeClock.md#iswindow)
- [isWindowCreated](TTimeClock.md#iswindowcreated)
- [isWindowManager](TTimeClock.md#iswindowmanager)
- [isWindowOpened](TTimeClock.md#iswindowopened)
- [layout](TTimeClock.md#layout)
- [lookup](TTimeClock.md#lookup)
- [lookupByType](TTimeClock.md#lookupbytype)
- [move](TTimeClock.md#move)
- [moveResize](TTimeClock.md#moveresize)
- [moveResizeEx](TTimeClock.md#moveresizeex)
- [moveToCenter](TTimeClock.md#movetocenter)
- [off](TTimeClock.md#off)
- [on](TTimeClock.md#on)
- [pauseAnimator](TTimeClock.md#pauseanimator)
- [removeChild](TTimeClock.md#removechild)
- [resize](TTimeClock.md#resize)
- [restack](TTimeClock.md#restack)
- [setAnimation](TTimeClock.md#setanimation)
- [setAnimatorTimeScale](TTimeClock.md#setanimatortimescale)
- [setAsKeyTarget](TTimeClock.md#setaskeytarget)
- [setAutoAdjustSize](TTimeClock.md#setautoadjustsize)
- [setBgImage](TTimeClock.md#setbgimage)
- [setChildText](TTimeClock.md#setchildtext)
- [setChildTextWithDouble](TTimeClock.md#setchildtextwithdouble)
- [setChildTextWithInt](TTimeClock.md#setchildtextwithint)
- [setChildrenLayout](TTimeClock.md#setchildrenlayout)
- [setDirtyRectTolerance](TTimeClock.md#setdirtyrecttolerance)
- [setEnable](TTimeClock.md#setenable)
- [setFeedback](TTimeClock.md#setfeedback)
- [setFloating](TTimeClock.md#setfloating)
- [setFocusable](TTimeClock.md#setfocusable)
- [setFocused](TTimeClock.md#setfocused)
- [setHour](TTimeClock.md#sethour)
- [setHourAnchor](TTimeClock.md#sethouranchor)
- [setHourImage](TTimeClock.md#sethourimage)
- [setImage](TTimeClock.md#setimage)
- [setMinute](TTimeClock.md#setminute)
- [setMinuteAnchor](TTimeClock.md#setminuteanchor)
- [setMinuteImage](TTimeClock.md#setminuteimage)
- [setName](TTimeClock.md#setname)
- [setOpacity](TTimeClock.md#setopacity)
- [setPointerCursor](TTimeClock.md#setpointercursor)
- [setPropBool](TTimeClock.md#setpropbool)
- [setPropFloat](TTimeClock.md#setpropfloat)
- [setPropInt](TTimeClock.md#setpropint)
- [setPropPointer](TTimeClock.md#setproppointer)
- [setPropStr](TTimeClock.md#setpropstr)
- [setProps](TTimeClock.md#setprops)
- [setSecond](TTimeClock.md#setsecond)
- [setSecondAnchor](TTimeClock.md#setsecondanchor)
- [setSecondImage](TTimeClock.md#setsecondimage)
- [setSelfLayout](TTimeClock.md#setselflayout)
- [setSelfLayoutParams](TTimeClock.md#setselflayoutparams)
- [setSensitive](TTimeClock.md#setsensitive)
- [setState](TTimeClock.md#setstate)
- [setStyleColor](TTimeClock.md#setstylecolor)
- [setStyleInt](TTimeClock.md#setstyleint)
- [setStyleStr](TTimeClock.md#setstylestr)
- [setText](TTimeClock.md#settext)
- [setTextEx](TTimeClock.md#settextex)
- [setTheme](TTimeClock.md#settheme)
- [setTrText](TTimeClock.md#settrtext)
- [setValue](TTimeClock.md#setvalue)
- [setValueInt](TTimeClock.md#setvalueint)
- [setVisible](TTimeClock.md#setvisible)
- [setVisibleOnly](TTimeClock.md#setvisibleonly)
- [startAnimator](TTimeClock.md#startanimator)
- [stopAnimator](TTimeClock.md#stopanimator)
- [strokeBorderRect](TTimeClock.md#strokeborderrect)
- [unref](TTimeClock.md#unref)
- [updateStyle](TTimeClock.md#updatestyle)
- [updateStyleRecursive](TTimeClock.md#updatestylerecursive)
- [useStyle](TTimeClock.md#usestyle)
- [cast](TTimeClock.md#cast)
- [create](TTimeClock.md#create)

## Constructors

### constructor

• **new TTimeClock**(`nativeObj`)
...
[awtk.ts:22309](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22309)
...
[awtk.ts:22308](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22308)
...
[awtk.ts:22536](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22536)
...
[awtk.ts:22540](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22540)
...
[awtk.ts:22484](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22484)
...
[awtk.ts:22488](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22488)
...
[awtk.ts:22588](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22588)
...
[awtk.ts:22597](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22597)
...
[awtk.ts:22549](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22549)

• `set` **hourImage**(`v`): `void`
...
[awtk.ts:22553](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22553)
...
[awtk.ts:22523](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22523)
...
[awtk.ts:22527](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22527)
...
[awtk.ts:22497](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22497)
...
[awtk.ts:22501](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22501)
...
[awtk.ts:22606](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22606)
...
[awtk.ts:22615](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22615)
...
[awtk.ts:22562](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22562)

• `set` **minuteImage**(`v`): `void`
...
[awtk.ts:22566](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22566)
...
[awtk.ts:22510](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22510)
...
[awtk.ts:22514](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22514)
...
[awtk.ts:22624](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22624)
...
[awtk.ts:22633](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22633)
...
[awtk.ts:22575](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22575)

• `set` **secondImage**(`v`): `void`
...
[awtk.ts:22579](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22579)
...
▸ **setBgImage**(`bg_image`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:22421](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22421)
...
[awtk.ts:22349](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22349)

___

### setHourAnchor

▸ **setHourAnchor**(`anchor_x`, `anchor_y`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:22447](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22447)

___

### setHourImage

▸ **setHourImage**(`hour`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:22385](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22385)
...
[awtk.ts:22433](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22433)
...
[awtk.ts:22361](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22361)

___

### setMinuteAnchor

▸ **setMinuteAnchor**(`anchor_x`, `anchor_y`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:22461](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22461)

___

### setMinuteImage

▸ **setMinuteImage**(`minute_image`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:22397](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22397)
...
[awtk.ts:22373](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22373)

___

### setSecondAnchor

▸ **setSecondAnchor**(`anchor_x`, `anchor_y`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:22475](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22475)

___

### setSecondImage

▸ **setSecondImage**(`second_image`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:22409](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22409)
...
▸ `Static` **cast**(`widget`): [`TTimeClock`](TTimeClock.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | time_clock对象。 |
...
[awtk.ts:22337](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22337)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TTimeClock`](TTimeClock.md)
...
[awtk.ts:22325](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L22325)
