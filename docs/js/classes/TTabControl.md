[AWTK](../README.md) / [Exports](../modules.md) / TTabControl
...
- [constructor](TTabControl.md#constructor)

### Properties

- [nativeObj](TTabControl.md#nativeobj)

### Accessors

- [animation](TTabControl.md#animation)
- [autoAdjustSize](TTabControl.md#autoadjustsize)
- [dirtyRectTolerance](TTabControl.md#dirtyrecttolerance)
- [enable](TTabControl.md#enable)
- [feedback](TTabControl.md#feedback)
- [floating](TTabControl.md#floating)
- [focusable](TTabControl.md#focusable)
- [h](TTabControl.md#h)
- [name](TTabControl.md#name)
- [opacity](TTabControl.md#opacity)
- [parent](TTabControl.md#parent)
- [pointerCursor](TTabControl.md#pointercursor)
- [sensitive](TTabControl.md#sensitive)
- [style](TTabControl.md#style)
- [trText](TTabControl.md#trtext)
- [visible](TTabControl.md#visible)
- [w](TTabControl.md#w)
- [withFocusState](TTabControl.md#withfocusstate)
- [x](TTabControl.md#x)
- [y](TTabControl.md#y)

### Methods

- [addChild](TTabControl.md#addchild)
- [addChildDefault](TTabControl.md#addchilddefault)
- [addValue](TTabControl.md#addvalue)
- [addValueInt](TTabControl.md#addvalueint)
- [animateValueTo](TTabControl.md#animatevalueto)
- [back](TTabControl.md#back)
- [backToHome](TTabControl.md#backtohome)
- [child](TTabControl.md#child)
- [clone](TTabControl.md#clone)
- [closeWindow](TTabControl.md#closewindow)
- [closeWindowForce](TTabControl.md#closewindowforce)
- [countChildren](TTabControl.md#countchildren)
- [createAnimator](TTabControl.md#createanimator)
- [destroy](TTabControl.md#destroy)
- [destroyAnimator](TTabControl.md#destroyanimator)
- [destroyAsync](TTabControl.md#destroyasync)
- [destroyChildren](TTabControl.md#destroychildren)
- [dispatchToKeyTarget](TTabControl.md#dispatchtokeytarget)
- [dispatchToTarget](TTabControl.md#dispatchtotarget)
- [equal](TTabControl.md#equal)
- [fillBgRect](TTabControl.md#fillbgrect)
- [fillFgRect](TTabControl.md#fillfgrect)
- [findParentByName](TTabControl.md#findparentbyname)
- [findParentByType](TTabControl.md#findparentbytype)
- [focusNext](TTabControl.md#focusnext)
- [focusPrev](TTabControl.md#focusprev)
- [foreach](TTabControl.md#foreach)
- [getAutoAdjustSize](TTabControl.md#getautoadjustsize)
- [getChild](TTabControl.md#getchild)
- [getEnable](TTabControl.md#getenable)
- [getFeedback](TTabControl.md#getfeedback)
- [getFloating](TTabControl.md#getfloating)
- [getFocusable](TTabControl.md#getfocusable)
- [getFocusedWidget](TTabControl.md#getfocusedwidget)
- [getNativeWindow](TTabControl.md#getnativewindow)
- [getPropBool](TTabControl.md#getpropbool)
- [getPropFloat](TTabControl.md#getpropfloat)
- [getPropInt](TTabControl.md#getpropint)
- [getPropPointer](TTabControl.md#getproppointer)
- [getPropStr](TTabControl.md#getpropstr)
- [getSensitive](TTabControl.md#getsensitive)
- [getStateForStyle](TTabControl.md#getstateforstyle)
- [getStyleType](TTabControl.md#getstyletype)
- [getText](TTabControl.md#gettext)
- [getThemeName](TTabControl.md#getthemename)
- [getType](TTabControl.md#gettype)
- [getValue](TTabControl.md#getvalue)
- [getValueInt](TTabControl.md#getvalueint)
- [getVisible](TTabControl.md#getvisible)
- [getWindow](TTabControl.md#getwindow)
- [getWindowManager](TTabControl.md#getwindowmanager)
- [getWithFocusState](TTabControl.md#getwithfocusstate)
- [indexOf](TTabControl.md#indexof)
- [insertChild](TTabControl.md#insertchild)
- [invalidateForce](TTabControl.md#invalidateforce)
- [isDesigningWindow](TTabControl.md#isdesigningwindow)
- [isDialog](TTabControl.md#isdialog)
- [isDirectParentOf](TTabControl.md#isdirectparentof)
- [isKeyboard](TTabControl.md#iskeyboard)
- [isNormalWindow](TTabControl.md#isnormalwindow)
- [isOpenedDialog](TTabControl.md#isopeneddialog)
- [isOpenedPopup](TTabControl.md#isopenedpopup)
- [isOverlay](TTabControl.md#isoverlay)
- [isParentOf](TTabControl.md#isparentof)
- [isPopup](TTabControl.md#ispopup)
- [isStyleExist](TTabControl.md#isstyleexist)
- [isSystemBar](TTabControl.md#issystembar)
- [isWindow](TTabControl.md#iswindow)
- [isWindowCreated](TTabControl.md#iswindowcreated)
- [isWindowManager](TTabControl.md#iswindowmanager)
- [isWindowOpened](TTabControl.md#iswindowopened)
- [layout](TTabControl.md#layout)
- [lookup](TTabControl.md#lookup)
- [lookupByType](TTabControl.md#lookupbytype)
- [move](TTabControl.md#move)
- [moveResize](TTabControl.md#moveresize)
- [moveResizeEx](TTabControl.md#moveresizeex)
- [moveToCenter](TTabControl.md#movetocenter)
- [off](TTabControl.md#off)
- [on](TTabControl.md#on)
- [pauseAnimator](TTabControl.md#pauseanimator)
- [removeChild](TTabControl.md#removechild)
- [resize](TTabControl.md#resize)
- [restack](TTabControl.md#restack)
- [setAnimation](TTabControl.md#setanimation)
- [setAnimatorTimeScale](TTabControl.md#setanimatortimescale)
- [setAsKeyTarget](TTabControl.md#setaskeytarget)
- [setAutoAdjustSize](TTabControl.md#setautoadjustsize)
- [setChildText](TTabControl.md#setchildtext)
- [setChildTextWithDouble](TTabControl.md#setchildtextwithdouble)
- [setChildTextWithInt](TTabControl.md#setchildtextwithint)
- [setChildrenLayout](TTabControl.md#setchildrenlayout)
- [setDirtyRectTolerance](TTabControl.md#setdirtyrecttolerance)
- [setEnable](TTabControl.md#setenable)
- [setFeedback](TTabControl.md#setfeedback)
- [setFloating](TTabControl.md#setfloating)
- [setFocusable](TTabControl.md#setfocusable)
- [setFocused](TTabControl.md#setfocused)
- [setName](TTabControl.md#setname)
- [setOpacity](TTabControl.md#setopacity)
- [setPointerCursor](TTabControl.md#setpointercursor)
- [setPropBool](TTabControl.md#setpropbool)
- [setPropFloat](TTabControl.md#setpropfloat)
- [setPropInt](TTabControl.md#setpropint)
- [setPropPointer](TTabControl.md#setproppointer)
- [setPropStr](TTabControl.md#setpropstr)
- [setProps](TTabControl.md#setprops)
- [setSelfLayout](TTabControl.md#setselflayout)
- [setSelfLayoutParams](TTabControl.md#setselflayoutparams)
- [setSensitive](TTabControl.md#setsensitive)
- [setState](TTabControl.md#setstate)
- [setStyleColor](TTabControl.md#setstylecolor)
- [setStyleInt](TTabControl.md#setstyleint)
- [setStyleStr](TTabControl.md#setstylestr)
- [setText](TTabControl.md#settext)
- [setTextEx](TTabControl.md#settextex)
- [setTheme](TTabControl.md#settheme)
- [setTrText](TTabControl.md#settrtext)
- [setValue](TTabControl.md#setvalue)
- [setValueInt](TTabControl.md#setvalueint)
- [setVisible](TTabControl.md#setvisible)
- [setVisibleOnly](TTabControl.md#setvisibleonly)
- [startAnimator](TTabControl.md#startanimator)
- [stopAnimator](TTabControl.md#stopanimator)
- [strokeBorderRect](TTabControl.md#strokeborderrect)
- [unref](TTabControl.md#unref)
- [updateStyle](TTabControl.md#updatestyle)
- [updateStyleRecursive](TTabControl.md#updatestylerecursive)
- [useStyle](TTabControl.md#usestyle)
- [cast](TTabControl.md#cast)
- [create](TTabControl.md#create)

## Constructors

### constructor

• **new TTabControl**(`nativeObj`)
...
[awtk.ts:26270](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26270)
...
[awtk.ts:26269](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26269)
...
▸ `Static` **cast**(`widget`): [`TTabControl`](TTabControl.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | tab_control对象。 |
...
[awtk.ts:26298](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26298)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TTabControl`](TTabControl.md)
...
[awtk.ts:26286](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L26286)
