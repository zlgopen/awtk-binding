[AWTK](../README.md) / [Exports](../modules.md) / TClipView
...
- [constructor](TClipView.md#constructor)

### Properties

- [nativeObj](TClipView.md#nativeobj)

### Accessors

- [animation](TClipView.md#animation)
- [autoAdjustSize](TClipView.md#autoadjustsize)
- [dirtyRectTolerance](TClipView.md#dirtyrecttolerance)
- [enable](TClipView.md#enable)
- [feedback](TClipView.md#feedback)
- [floating](TClipView.md#floating)
- [focusable](TClipView.md#focusable)
- [h](TClipView.md#h)
- [name](TClipView.md#name)
- [opacity](TClipView.md#opacity)
- [parent](TClipView.md#parent)
- [pointerCursor](TClipView.md#pointercursor)
- [sensitive](TClipView.md#sensitive)
- [style](TClipView.md#style)
- [trText](TClipView.md#trtext)
- [visible](TClipView.md#visible)
- [w](TClipView.md#w)
- [withFocusState](TClipView.md#withfocusstate)
- [x](TClipView.md#x)
- [y](TClipView.md#y)

### Methods

- [addChild](TClipView.md#addchild)
- [addChildDefault](TClipView.md#addchilddefault)
- [addValue](TClipView.md#addvalue)
- [addValueInt](TClipView.md#addvalueint)
- [animateValueTo](TClipView.md#animatevalueto)
- [back](TClipView.md#back)
- [backToHome](TClipView.md#backtohome)
- [child](TClipView.md#child)
- [clone](TClipView.md#clone)
- [closeWindow](TClipView.md#closewindow)
- [closeWindowForce](TClipView.md#closewindowforce)
- [countChildren](TClipView.md#countchildren)
- [createAnimator](TClipView.md#createanimator)
- [destroy](TClipView.md#destroy)
- [destroyAnimator](TClipView.md#destroyanimator)
- [destroyAsync](TClipView.md#destroyasync)
- [destroyChildren](TClipView.md#destroychildren)
- [dispatchToKeyTarget](TClipView.md#dispatchtokeytarget)
- [dispatchToTarget](TClipView.md#dispatchtotarget)
- [equal](TClipView.md#equal)
- [fillBgRect](TClipView.md#fillbgrect)
- [fillFgRect](TClipView.md#fillfgrect)
- [findParentByName](TClipView.md#findparentbyname)
- [findParentByType](TClipView.md#findparentbytype)
- [focusNext](TClipView.md#focusnext)
- [focusPrev](TClipView.md#focusprev)
- [foreach](TClipView.md#foreach)
- [getAutoAdjustSize](TClipView.md#getautoadjustsize)
- [getChild](TClipView.md#getchild)
- [getEnable](TClipView.md#getenable)
- [getFeedback](TClipView.md#getfeedback)
- [getFloating](TClipView.md#getfloating)
- [getFocusable](TClipView.md#getfocusable)
- [getFocusedWidget](TClipView.md#getfocusedwidget)
- [getNativeWindow](TClipView.md#getnativewindow)
- [getPropBool](TClipView.md#getpropbool)
- [getPropFloat](TClipView.md#getpropfloat)
- [getPropInt](TClipView.md#getpropint)
- [getPropPointer](TClipView.md#getproppointer)
- [getPropStr](TClipView.md#getpropstr)
- [getSensitive](TClipView.md#getsensitive)
- [getStateForStyle](TClipView.md#getstateforstyle)
- [getStyleType](TClipView.md#getstyletype)
- [getText](TClipView.md#gettext)
- [getThemeName](TClipView.md#getthemename)
- [getType](TClipView.md#gettype)
- [getValue](TClipView.md#getvalue)
- [getValueInt](TClipView.md#getvalueint)
- [getVisible](TClipView.md#getvisible)
- [getWindow](TClipView.md#getwindow)
- [getWindowManager](TClipView.md#getwindowmanager)
- [getWithFocusState](TClipView.md#getwithfocusstate)
- [indexOf](TClipView.md#indexof)
- [insertChild](TClipView.md#insertchild)
- [invalidateForce](TClipView.md#invalidateforce)
- [isDesigningWindow](TClipView.md#isdesigningwindow)
- [isDialog](TClipView.md#isdialog)
- [isDirectParentOf](TClipView.md#isdirectparentof)
- [isKeyboard](TClipView.md#iskeyboard)
- [isNormalWindow](TClipView.md#isnormalwindow)
- [isOpenedDialog](TClipView.md#isopeneddialog)
- [isOpenedPopup](TClipView.md#isopenedpopup)
- [isOverlay](TClipView.md#isoverlay)
- [isParentOf](TClipView.md#isparentof)
- [isPopup](TClipView.md#ispopup)
- [isStyleExist](TClipView.md#isstyleexist)
- [isSystemBar](TClipView.md#issystembar)
- [isWindow](TClipView.md#iswindow)
- [isWindowCreated](TClipView.md#iswindowcreated)
- [isWindowManager](TClipView.md#iswindowmanager)
- [isWindowOpened](TClipView.md#iswindowopened)
- [layout](TClipView.md#layout)
- [lookup](TClipView.md#lookup)
- [lookupByType](TClipView.md#lookupbytype)
- [move](TClipView.md#move)
- [moveResize](TClipView.md#moveresize)
- [moveResizeEx](TClipView.md#moveresizeex)
- [moveToCenter](TClipView.md#movetocenter)
- [off](TClipView.md#off)
- [on](TClipView.md#on)
- [pauseAnimator](TClipView.md#pauseanimator)
- [removeChild](TClipView.md#removechild)
- [resize](TClipView.md#resize)
- [restack](TClipView.md#restack)
- [setAnimation](TClipView.md#setanimation)
- [setAnimatorTimeScale](TClipView.md#setanimatortimescale)
- [setAsKeyTarget](TClipView.md#setaskeytarget)
- [setAutoAdjustSize](TClipView.md#setautoadjustsize)
- [setChildText](TClipView.md#setchildtext)
- [setChildTextWithDouble](TClipView.md#setchildtextwithdouble)
- [setChildTextWithInt](TClipView.md#setchildtextwithint)
- [setChildrenLayout](TClipView.md#setchildrenlayout)
- [setDirtyRectTolerance](TClipView.md#setdirtyrecttolerance)
- [setEnable](TClipView.md#setenable)
- [setFeedback](TClipView.md#setfeedback)
- [setFloating](TClipView.md#setfloating)
- [setFocusable](TClipView.md#setfocusable)
- [setFocused](TClipView.md#setfocused)
- [setName](TClipView.md#setname)
- [setOpacity](TClipView.md#setopacity)
- [setPointerCursor](TClipView.md#setpointercursor)
- [setPropBool](TClipView.md#setpropbool)
- [setPropFloat](TClipView.md#setpropfloat)
- [setPropInt](TClipView.md#setpropint)
- [setPropPointer](TClipView.md#setproppointer)
- [setPropStr](TClipView.md#setpropstr)
- [setProps](TClipView.md#setprops)
- [setSelfLayout](TClipView.md#setselflayout)
- [setSelfLayoutParams](TClipView.md#setselflayoutparams)
- [setSensitive](TClipView.md#setsensitive)
- [setState](TClipView.md#setstate)
- [setStyleColor](TClipView.md#setstylecolor)
- [setStyleInt](TClipView.md#setstyleint)
- [setStyleStr](TClipView.md#setstylestr)
- [setText](TClipView.md#settext)
- [setTextEx](TClipView.md#settextex)
- [setTheme](TClipView.md#settheme)
- [setTrText](TClipView.md#settrtext)
- [setValue](TClipView.md#setvalue)
- [setValueInt](TClipView.md#setvalueint)
- [setVisible](TClipView.md#setvisible)
- [setVisibleOnly](TClipView.md#setvisibleonly)
- [startAnimator](TClipView.md#startanimator)
- [stopAnimator](TClipView.md#stopanimator)
- [strokeBorderRect](TClipView.md#strokeborderrect)
- [unref](TClipView.md#unref)
- [updateStyle](TClipView.md#updatestyle)
- [updateStyleRecursive](TClipView.md#updatestylerecursive)
- [useStyle](TClipView.md#usestyle)
- [cast](TClipView.md#cast)
- [create](TClipView.md#create)

## Constructors

### constructor

• **new TClipView**(`nativeObj`)
...
[awtk.ts:23534](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23534)
...
[awtk.ts:23533](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23533)
...
▸ `Static` **cast**(`widget`): [`TClipView`](TClipView.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | clip_view对象。 |
...
[awtk.ts:23562](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23562)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TClipView`](TClipView.md)
...
[awtk.ts:23550](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L23550)
