[AWTK](../README.md) / [Exports](../modules.md) / TImageBase
...
- [constructor](TImageBase.md#constructor)

### Properties

- [nativeObj](TImageBase.md#nativeobj)

### Accessors

- [anchorX](TImageBase.md#anchorx)
- [anchorY](TImageBase.md#anchory)
- [animation](TImageBase.md#animation)
- [autoAdjustSize](TImageBase.md#autoadjustsize)
- [clickable](TImageBase.md#clickable)
- [dirtyRectTolerance](TImageBase.md#dirtyrecttolerance)
- [enable](TImageBase.md#enable)
- [feedback](TImageBase.md#feedback)
- [floating](TImageBase.md#floating)
- [focusable](TImageBase.md#focusable)
- [h](TImageBase.md#h)
- [image](TImageBase.md#image)
- [name](TImageBase.md#name)
- [opacity](TImageBase.md#opacity)
- [parent](TImageBase.md#parent)
- [pointerCursor](TImageBase.md#pointercursor)
- [rotation](TImageBase.md#rotation)
- [scaleX](TImageBase.md#scalex)
- [scaleY](TImageBase.md#scaley)
- [selectable](TImageBase.md#selectable)
- [selected](TImageBase.md#selected)
- [sensitive](TImageBase.md#sensitive)
- [style](TImageBase.md#style)
- [trText](TImageBase.md#trtext)
- [visible](TImageBase.md#visible)
- [w](TImageBase.md#w)
- [withFocusState](TImageBase.md#withfocusstate)
- [x](TImageBase.md#x)
- [y](TImageBase.md#y)

### Methods

- [addChild](TImageBase.md#addchild)
- [addChildDefault](TImageBase.md#addchilddefault)
- [addValue](TImageBase.md#addvalue)
- [addValueInt](TImageBase.md#addvalueint)
- [animateValueTo](TImageBase.md#animatevalueto)
- [back](TImageBase.md#back)
- [backToHome](TImageBase.md#backtohome)
- [child](TImageBase.md#child)
- [clone](TImageBase.md#clone)
- [closeWindow](TImageBase.md#closewindow)
- [closeWindowForce](TImageBase.md#closewindowforce)
- [countChildren](TImageBase.md#countchildren)
- [createAnimator](TImageBase.md#createanimator)
- [destroy](TImageBase.md#destroy)
- [destroyAnimator](TImageBase.md#destroyanimator)
- [destroyAsync](TImageBase.md#destroyasync)
- [destroyChildren](TImageBase.md#destroychildren)
- [dispatchToKeyTarget](TImageBase.md#dispatchtokeytarget)
- [dispatchToTarget](TImageBase.md#dispatchtotarget)
- [equal](TImageBase.md#equal)
- [fillBgRect](TImageBase.md#fillbgrect)
- [fillFgRect](TImageBase.md#fillfgrect)
- [findParentByName](TImageBase.md#findparentbyname)
- [findParentByType](TImageBase.md#findparentbytype)
- [focusNext](TImageBase.md#focusnext)
- [focusPrev](TImageBase.md#focusprev)
- [foreach](TImageBase.md#foreach)
- [getAutoAdjustSize](TImageBase.md#getautoadjustsize)
- [getChild](TImageBase.md#getchild)
- [getEnable](TImageBase.md#getenable)
- [getFeedback](TImageBase.md#getfeedback)
- [getFloating](TImageBase.md#getfloating)
- [getFocusable](TImageBase.md#getfocusable)
- [getFocusedWidget](TImageBase.md#getfocusedwidget)
- [getNativeWindow](TImageBase.md#getnativewindow)
- [getPropBool](TImageBase.md#getpropbool)
- [getPropFloat](TImageBase.md#getpropfloat)
- [getPropInt](TImageBase.md#getpropint)
- [getPropPointer](TImageBase.md#getproppointer)
- [getPropStr](TImageBase.md#getpropstr)
- [getSensitive](TImageBase.md#getsensitive)
- [getStateForStyle](TImageBase.md#getstateforstyle)
- [getStyleType](TImageBase.md#getstyletype)
- [getText](TImageBase.md#gettext)
- [getThemeName](TImageBase.md#getthemename)
- [getType](TImageBase.md#gettype)
- [getValue](TImageBase.md#getvalue)
- [getValueInt](TImageBase.md#getvalueint)
- [getVisible](TImageBase.md#getvisible)
- [getWindow](TImageBase.md#getwindow)
- [getWindowManager](TImageBase.md#getwindowmanager)
- [getWithFocusState](TImageBase.md#getwithfocusstate)
- [indexOf](TImageBase.md#indexof)
- [insertChild](TImageBase.md#insertchild)
- [invalidateForce](TImageBase.md#invalidateforce)
- [isDesigningWindow](TImageBase.md#isdesigningwindow)
- [isDialog](TImageBase.md#isdialog)
- [isDirectParentOf](TImageBase.md#isdirectparentof)
- [isKeyboard](TImageBase.md#iskeyboard)
- [isNormalWindow](TImageBase.md#isnormalwindow)
- [isOpenedDialog](TImageBase.md#isopeneddialog)
- [isOpenedPopup](TImageBase.md#isopenedpopup)
- [isOverlay](TImageBase.md#isoverlay)
- [isParentOf](TImageBase.md#isparentof)
- [isPopup](TImageBase.md#ispopup)
- [isStyleExist](TImageBase.md#isstyleexist)
- [isSystemBar](TImageBase.md#issystembar)
- [isWindow](TImageBase.md#iswindow)
- [isWindowCreated](TImageBase.md#iswindowcreated)
- [isWindowManager](TImageBase.md#iswindowmanager)
- [isWindowOpened](TImageBase.md#iswindowopened)
- [layout](TImageBase.md#layout)
- [lookup](TImageBase.md#lookup)
- [lookupByType](TImageBase.md#lookupbytype)
- [move](TImageBase.md#move)
- [moveResize](TImageBase.md#moveresize)
- [moveResizeEx](TImageBase.md#moveresizeex)
- [moveToCenter](TImageBase.md#movetocenter)
- [off](TImageBase.md#off)
- [on](TImageBase.md#on)
- [pauseAnimator](TImageBase.md#pauseanimator)
- [removeChild](TImageBase.md#removechild)
- [resize](TImageBase.md#resize)
- [restack](TImageBase.md#restack)
- [setAnchor](TImageBase.md#setanchor)
- [setAnimation](TImageBase.md#setanimation)
- [setAnimatorTimeScale](TImageBase.md#setanimatortimescale)
- [setAsKeyTarget](TImageBase.md#setaskeytarget)
- [setAutoAdjustSize](TImageBase.md#setautoadjustsize)
- [setChildText](TImageBase.md#setchildtext)
- [setChildTextWithDouble](TImageBase.md#setchildtextwithdouble)
- [setChildTextWithInt](TImageBase.md#setchildtextwithint)
- [setChildrenLayout](TImageBase.md#setchildrenlayout)
- [setClickable](TImageBase.md#setclickable)
- [setDirtyRectTolerance](TImageBase.md#setdirtyrecttolerance)
- [setEnable](TImageBase.md#setenable)
- [setFeedback](TImageBase.md#setfeedback)
- [setFloating](TImageBase.md#setfloating)
- [setFocusable](TImageBase.md#setfocusable)
- [setFocused](TImageBase.md#setfocused)
- [setImage](TImageBase.md#setimage)
- [setName](TImageBase.md#setname)
- [setOpacity](TImageBase.md#setopacity)
- [setPointerCursor](TImageBase.md#setpointercursor)
- [setPropBool](TImageBase.md#setpropbool)
- [setPropFloat](TImageBase.md#setpropfloat)
- [setPropInt](TImageBase.md#setpropint)
- [setPropPointer](TImageBase.md#setproppointer)
- [setPropStr](TImageBase.md#setpropstr)
- [setProps](TImageBase.md#setprops)
- [setRotation](TImageBase.md#setrotation)
- [setScale](TImageBase.md#setscale)
- [setSelectable](TImageBase.md#setselectable)
- [setSelected](TImageBase.md#setselected)
- [setSelfLayout](TImageBase.md#setselflayout)
- [setSelfLayoutParams](TImageBase.md#setselflayoutparams)
- [setSensitive](TImageBase.md#setsensitive)
- [setState](TImageBase.md#setstate)
- [setStyleColor](TImageBase.md#setstylecolor)
- [setStyleInt](TImageBase.md#setstyleint)
- [setStyleStr](TImageBase.md#setstylestr)
- [setText](TImageBase.md#settext)
- [setTextEx](TImageBase.md#settextex)
- [setTheme](TImageBase.md#settheme)
- [setTrText](TImageBase.md#settrtext)
- [setValue](TImageBase.md#setvalue)
- [setValueInt](TImageBase.md#setvalueint)
- [setVisible](TImageBase.md#setvisible)
- [setVisibleOnly](TImageBase.md#setvisibleonly)
- [startAnimator](TImageBase.md#startanimator)
- [stopAnimator](TImageBase.md#stopanimator)
- [strokeBorderRect](TImageBase.md#strokeborderrect)
- [unref](TImageBase.md#unref)
- [updateStyle](TImageBase.md#updatestyle)
- [updateStyleRecursive](TImageBase.md#updatestylerecursive)
- [useStyle](TImageBase.md#usestyle)
- [cast](TImageBase.md#cast)

## Constructors

### constructor

• **new TImageBase**(`nativeObj`)
...
[awtk.ts:15279](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15279)
...
[awtk.ts:15278](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15278)
...
[awtk.ts:15379](https://github.com/zlgopen/awtk-binding/blob/145cdd58/tools/code_gen/js/output/awtk.ts#L15379)
