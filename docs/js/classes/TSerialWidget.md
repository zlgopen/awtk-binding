[AWTK](../README.md) / [Exports](../modules.md) / TSerialWidget
...
- [constructor](TSerialWidget.md#constructor)

### Properties

- [nativeObj](TSerialWidget.md#nativeobj)

### Accessors

- [animation](TSerialWidget.md#animation)
- [autoAdjustSize](TSerialWidget.md#autoadjustsize)
- [baudrate](TSerialWidget.md#baudrate)
- [bytesize](TSerialWidget.md#bytesize)
- [checkInterval](TSerialWidget.md#checkinterval)
- [device](TSerialWidget.md#device)
- [dirtyRectTolerance](TSerialWidget.md#dirtyrecttolerance)
- [enable](TSerialWidget.md#enable)
- [feedback](TSerialWidget.md#feedback)
- [floating](TSerialWidget.md#floating)
- [flowcontrol](TSerialWidget.md#flowcontrol)
- [focusable](TSerialWidget.md#focusable)
- [h](TSerialWidget.md#h)
- [iostream](TSerialWidget.md#iostream)
- [istream](TSerialWidget.md#istream)
- [name](TSerialWidget.md#name)
- [opacity](TSerialWidget.md#opacity)
- [ostream](TSerialWidget.md#ostream)
- [parent](TSerialWidget.md#parent)
- [parity](TSerialWidget.md#parity)
- [pointerCursor](TSerialWidget.md#pointercursor)
- [sensitive](TSerialWidget.md#sensitive)
- [stopbits](TSerialWidget.md#stopbits)
- [style](TSerialWidget.md#style)
- [trText](TSerialWidget.md#trtext)
- [visible](TSerialWidget.md#visible)
- [w](TSerialWidget.md#w)
- [withFocusState](TSerialWidget.md#withfocusstate)
- [x](TSerialWidget.md#x)
- [y](TSerialWidget.md#y)

### Methods

- [addChild](TSerialWidget.md#addchild)
- [addChildDefault](TSerialWidget.md#addchilddefault)
- [addValue](TSerialWidget.md#addvalue)
- [addValueInt](TSerialWidget.md#addvalueint)
- [animateValueTo](TSerialWidget.md#animatevalueto)
- [back](TSerialWidget.md#back)
- [backToHome](TSerialWidget.md#backtohome)
- [child](TSerialWidget.md#child)
- [clone](TSerialWidget.md#clone)
- [closeWindow](TSerialWidget.md#closewindow)
- [closeWindowForce](TSerialWidget.md#closewindowforce)
- [countChildren](TSerialWidget.md#countchildren)
- [createAnimator](TSerialWidget.md#createanimator)
- [destroy](TSerialWidget.md#destroy)
- [destroyAnimator](TSerialWidget.md#destroyanimator)
- [destroyAsync](TSerialWidget.md#destroyasync)
- [destroyChildren](TSerialWidget.md#destroychildren)
- [dispatchToKeyTarget](TSerialWidget.md#dispatchtokeytarget)
- [dispatchToTarget](TSerialWidget.md#dispatchtotarget)
- [equal](TSerialWidget.md#equal)
- [fillBgRect](TSerialWidget.md#fillbgrect)
- [fillFgRect](TSerialWidget.md#fillfgrect)
- [findParentByName](TSerialWidget.md#findparentbyname)
- [findParentByType](TSerialWidget.md#findparentbytype)
- [focusNext](TSerialWidget.md#focusnext)
- [focusPrev](TSerialWidget.md#focusprev)
- [foreach](TSerialWidget.md#foreach)
- [getAutoAdjustSize](TSerialWidget.md#getautoadjustsize)
- [getChild](TSerialWidget.md#getchild)
- [getEnable](TSerialWidget.md#getenable)
- [getFeedback](TSerialWidget.md#getfeedback)
- [getFloating](TSerialWidget.md#getfloating)
- [getFocusable](TSerialWidget.md#getfocusable)
- [getFocusedWidget](TSerialWidget.md#getfocusedwidget)
- [getNativeWindow](TSerialWidget.md#getnativewindow)
- [getPropBool](TSerialWidget.md#getpropbool)
- [getPropFloat](TSerialWidget.md#getpropfloat)
- [getPropInt](TSerialWidget.md#getpropint)
- [getPropPointer](TSerialWidget.md#getproppointer)
- [getPropStr](TSerialWidget.md#getpropstr)
- [getSensitive](TSerialWidget.md#getsensitive)
- [getStateForStyle](TSerialWidget.md#getstateforstyle)
- [getStyleType](TSerialWidget.md#getstyletype)
- [getText](TSerialWidget.md#gettext)
- [getThemeName](TSerialWidget.md#getthemename)
- [getType](TSerialWidget.md#gettype)
- [getValue](TSerialWidget.md#getvalue)
- [getValueInt](TSerialWidget.md#getvalueint)
- [getVisible](TSerialWidget.md#getvisible)
- [getWindow](TSerialWidget.md#getwindow)
- [getWindowManager](TSerialWidget.md#getwindowmanager)
- [getWithFocusState](TSerialWidget.md#getwithfocusstate)
- [indexOf](TSerialWidget.md#indexof)
- [insertChild](TSerialWidget.md#insertchild)
- [invalidateForce](TSerialWidget.md#invalidateforce)
- [isDesigningWindow](TSerialWidget.md#isdesigningwindow)
- [isDialog](TSerialWidget.md#isdialog)
- [isDirectParentOf](TSerialWidget.md#isdirectparentof)
- [isKeyboard](TSerialWidget.md#iskeyboard)
- [isNormalWindow](TSerialWidget.md#isnormalwindow)
- [isOpenedDialog](TSerialWidget.md#isopeneddialog)
- [isOpenedPopup](TSerialWidget.md#isopenedpopup)
- [isOverlay](TSerialWidget.md#isoverlay)
- [isParentOf](TSerialWidget.md#isparentof)
- [isPopup](TSerialWidget.md#ispopup)
- [isStyleExist](TSerialWidget.md#isstyleexist)
- [isSystemBar](TSerialWidget.md#issystembar)
- [isWindow](TSerialWidget.md#iswindow)
- [isWindowCreated](TSerialWidget.md#iswindowcreated)
- [isWindowManager](TSerialWidget.md#iswindowmanager)
- [isWindowOpened](TSerialWidget.md#iswindowopened)
- [layout](TSerialWidget.md#layout)
- [lookup](TSerialWidget.md#lookup)
- [lookupByType](TSerialWidget.md#lookupbytype)
- [move](TSerialWidget.md#move)
- [moveResize](TSerialWidget.md#moveresize)
- [moveToCenter](TSerialWidget.md#movetocenter)
- [off](TSerialWidget.md#off)
- [on](TSerialWidget.md#on)
- [pauseAnimator](TSerialWidget.md#pauseanimator)
- [removeChild](TSerialWidget.md#removechild)
- [resize](TSerialWidget.md#resize)
- [restack](TSerialWidget.md#restack)
- [setAnimation](TSerialWidget.md#setanimation)
- [setAnimatorTimeScale](TSerialWidget.md#setanimatortimescale)
- [setAsKeyTarget](TSerialWidget.md#setaskeytarget)
- [setAutoAdjustSize](TSerialWidget.md#setautoadjustsize)
- [setBaudrate](TSerialWidget.md#setbaudrate)
- [setBytesize](TSerialWidget.md#setbytesize)
- [setCheckInterval](TSerialWidget.md#setcheckinterval)
- [setChildText](TSerialWidget.md#setchildtext)
- [setChildTextWithDouble](TSerialWidget.md#setchildtextwithdouble)
- [setChildTextWithInt](TSerialWidget.md#setchildtextwithint)
- [setChildrenLayout](TSerialWidget.md#setchildrenlayout)
- [setDevice](TSerialWidget.md#setdevice)
- [setDirtyRectTolerance](TSerialWidget.md#setdirtyrecttolerance)
- [setEnable](TSerialWidget.md#setenable)
- [setFeedback](TSerialWidget.md#setfeedback)
- [setFloating](TSerialWidget.md#setfloating)
- [setFlowcontrol](TSerialWidget.md#setflowcontrol)
- [setFocusable](TSerialWidget.md#setfocusable)
- [setFocused](TSerialWidget.md#setfocused)
- [setName](TSerialWidget.md#setname)
- [setOpacity](TSerialWidget.md#setopacity)
- [setParity](TSerialWidget.md#setparity)
- [setPointerCursor](TSerialWidget.md#setpointercursor)
- [setPropBool](TSerialWidget.md#setpropbool)
- [setPropFloat](TSerialWidget.md#setpropfloat)
- [setPropInt](TSerialWidget.md#setpropint)
- [setPropPointer](TSerialWidget.md#setproppointer)
- [setPropStr](TSerialWidget.md#setpropstr)
- [setProps](TSerialWidget.md#setprops)
- [setSelfLayout](TSerialWidget.md#setselflayout)
- [setSelfLayoutParams](TSerialWidget.md#setselflayoutparams)
- [setSensitive](TSerialWidget.md#setsensitive)
- [setState](TSerialWidget.md#setstate)
- [setStopbits](TSerialWidget.md#setstopbits)
- [setStyleColor](TSerialWidget.md#setstylecolor)
- [setStyleInt](TSerialWidget.md#setstyleint)
- [setStyleStr](TSerialWidget.md#setstylestr)
- [setText](TSerialWidget.md#settext)
- [setTextEx](TSerialWidget.md#settextex)
- [setTheme](TSerialWidget.md#settheme)
- [setTrText](TSerialWidget.md#settrtext)
- [setValue](TSerialWidget.md#setvalue)
- [setValueInt](TSerialWidget.md#setvalueint)
- [setVisible](TSerialWidget.md#setvisible)
- [setVisibleOnly](TSerialWidget.md#setvisibleonly)
- [startAnimator](TSerialWidget.md#startanimator)
- [stopAnimator](TSerialWidget.md#stopanimator)
- [strokeBorderRect](TSerialWidget.md#strokeborderrect)
- [unref](TSerialWidget.md#unref)
- [updateStyle](TSerialWidget.md#updatestyle)
- [updateStyleRecursive](TSerialWidget.md#updatestylerecursive)
- [useStyle](TSerialWidget.md#usestyle)
- [cast](TSerialWidget.md#cast)
- [create](TSerialWidget.md#create)

## Constructors

### constructor

• **new TSerialWidget**(`nativeObj`)
...
[awtk.ts:20284](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20284)
...
[awtk.ts:20283](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20283)
...
[awtk.ts:20418](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20418)
...
[awtk.ts:20422](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20422)
...
[awtk.ts:20431](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20431)
...
[awtk.ts:20435](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20435)
...
[awtk.ts:20511](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20511)

• `set` **checkInterval**(`v`): `void`
...
[awtk.ts:20515](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20515)
...
[awtk.ts:20405](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20405)
...
[awtk.ts:20409](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20409)
...
[awtk.ts:20470](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20470)

• `set` **flowcontrol**(`v`): `void`
...
[awtk.ts:20474](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20474)
...
[awtk.ts:20501](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20501)
...
[awtk.ts:20483](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20483)
...
[awtk.ts:20492](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20492)
...
[awtk.ts:20444](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20444)
...
[awtk.ts:20448](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20448)
...
[awtk.ts:20457](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20457)
...
[awtk.ts:20461](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20461)
...
▸ **setBaudrate**(`baudrate`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:20324](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20324)

___

### setBytesize

▸ **setBytesize**(`bytesize`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:20348](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20348)

___

### setCheckInterval

▸ **setCheckInterval**(`check_interval`): [`TRet`](../enums/TRet.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `check_interval` | `number` | 轮询时间（单位：ms）。 |
...
[awtk.ts:20396](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20396)
...
▸ **setDevice**(`device`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:20336](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20336)
...
▸ **setFlowcontrol**(`flowcontrol`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:20384](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20384)
...
▸ **setParity**(`parity`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:20360](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20360)
...
▸ **setStopbits**(`stopbits`): [`TRet`](../enums/TRet.md)
...
[awtk.ts:20372](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20372)
...
▸ `Static` **cast**(`widget`): [`TSerialWidget`](TSerialWidget.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `widget` | [`TWidget`](TWidget.md) | serial_widget对象。 |
...
[awtk.ts:20312](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20312)

___

### create

▸ `Static` **create**(`parent`, `x`, `y`, `w`, `h`): [`TSerialWidget`](TSerialWidget.md)
...
[awtk.ts:20300](https://github.com/zlgopen/awtk-binding/blob/25012c6/tools/code_gen/js/output/awtk.ts#L20300)
