#include "awtk_cpp.hpp"
 ...
 int32_t TObject::Compare(TObject& other)  {
 ...
 ret_t TObject::SetPropObjectByPath(const char* path, TObject& value)  {
   return object_set_prop_object_by_path(((object_t*)(this->nativeObj)), path, ((object_t*)(value.nativeObj)));
 }
 ...
 TRect TValue::Rect()  {
   return TRect((rect_t*)(value_rect(((const value_t*)(this->nativeObj)))));
 }
 ...
 ret_t TCanvas::ResetCache()  {
   return canvas_reset_cache(((canvas_t*)(this->nativeObj)));
 }
 ...
 font_size_t TCanvas::GetFontSize() const {
 ...
 uint32_t TEvent::GetType() const {
   return ((event_t*)(this->nativeObj))->type;
 }

 uint32_t TEvent::GetSize() const {
 ...
 ret_t TInputMethod::DispatchKeys(const char* keys)  {
   return input_method_dispatch_keys(((input_method_t*)(this->nativeObj)), keys);
 }
 ...
 ret_t TLocaleInfos::Unref(TLocaleInfo& locale_info)  {
   return locale_infos_unref(((locale_info_t*)(locale_info.nativeObj)));
 }

 ret_t TLocaleInfos::Change(const char* language, const char* country)  {
   return locale_infos_change(language, country);
 }

 uint32_t TLocaleInfos::On(event_type_t type, event_func_t on_event, void* ctx)  {
    return locale_infos_on(type, on_event, ctx);
 }

 ret_t TLocaleInfos::Off(uint32_t id)  {
   return locale_infos_off(id);
 }

 ret_t TLocaleInfos::ReloadAll()  {
 ...
 ret_t TStyle::Get(const char* state, const char* name, TValue& value)  {
   return style_get(((style_t*)(this->nativeObj)), state, name, ((value_t*)(value.nativeObj)));
 }
 ...
 ret_t TStyle::UpdateState(TTheme& theme, const char* widget_type, const char* style_name, const char* widget_state)  {
   return style_update_state(((style_t*)(this->nativeObj)), ((theme_t*)(theme.nativeObj)), widget_type, style_name, widget_state);
 }
 ...
 ret_t TVgcanvas::SetFontSize(float_t size)  {
   return vgcanvas_set_font_size(((vgcanvas_t*)(this->nativeObj)), size);
 }
 ...
 ret_t TVgcanvas::FillTextByGlyphs(glyphs_t* glyphs, uint32_t start, uint32_t len, xy_t x, xy_t y, float_t max_width)  {
   return vgcanvas_fill_text_by_glyphs(((vgcanvas_t*)(this->nativeObj)), glyphs, start, len, x, y, max_width);
 }
 ...
 ret_t TVgcanvas::DrawImageRepeat(TBitmap& img, float_t sx, float_t sy, float_t sw, float_t sh, float_t dx, float_t dy, float_t dw, float_t dh, float_t dst_w, float_t dst_h)  {
   return vgcanvas_draw_image_repeat(((vgcanvas_t*)(this->nativeObj)), ((bitmap_t*)(img.nativeObj)), sx, sy, sw, sh, dx, dy, dw, dh, dst_w, dst_h);
 }
 ...
 ret_t TVgcanvas::SetStrokeColor(const char* str)  {
   return vgcanvas_set_stroke_color_str(((vgcanvas_t*)(this->nativeObj)), str);
 }
 ...
 uint32_t TVgcanvas::GetW() const {
   return ((vgcanvas_t*)(this->nativeObj))->w;
 }

 uint32_t TVgcanvas::GetH() const {
 ...
 char* TVgcanvas::GetTextAlign() const {
   return ((vgcanvas_t*)(this->nativeObj))->text_align;
 }

 char* TVgcanvas::GetTextBaseline() const {
 ...
 bool TWidget::IsSupportHighlighter()  {
 ...
 ret_t TWidget::SetTextEx(const char* text, bool check_diff)  {
   return widget_set_text_utf8_ex(((widget_t*)(this->nativeObj)), text, check_diff);
 }
 ...
 const char* TWidget::GetThemeName()  {
    return widget_get_theme_name(((widget_t*)(this->nativeObj)));
 }
 ...
 ret_t TWidget::SetSyncStateToChildren(bool sync_state_to_children)  {
   return widget_set_sync_state_to_children(((widget_t*)(this->nativeObj)), sync_state_to_children);
 }

 ret_t TWidget::SetStateFromParentSync(bool state_from_parent_sync)  {
   return widget_set_state_from_parent_sync(((widget_t*)(this->nativeObj)), state_from_parent_sync);
 }
 ...
 ret_t TWidget::SetProps(const char* params)  {
   return widget_set_props(((widget_t*)(this->nativeObj)), params);
 }
 ...
 bool TWidget::IsFullscreenWindow()  {
    return widget_is_fullscreen_window(((widget_t*)(this->nativeObj)));
 }
 ...
 ret_t TWidget::AddChildDefault(TWidget& child)  {
   return widget_add_child_default(((widget_t*)(this->nativeObj)), ((widget_t*)(child.nativeObj)));
 }
 ...
 bool TWidget::GetSyncStateToChildren() const {
   return ((widget_t*)(this->nativeObj))->sync_state_to_children;
 }

 bool TWidget::GetStateFromParentSync() const {
   return ((widget_t*)(this->nativeObj))->state_from_parent_sync;
 }

 uint8_t TWidget::GetOpacity() const {
   return ((widget_t*)(this->nativeObj))->opacity;
 }
 ...
 TColor TColor::Create(uint8_t r, uint8_t g, uint8_t b, uint8_t a)  {
   return TColor((color_t*)(color_create(r, g, b, a)));
 }
 ...
 ret_t TDateTime::FromTime(int64_t time)  {
   return date_time_from_time(((date_time_t*)(this->nativeObj)), time);
 }

 int64_t TDateTime::ToTime()  {
 ...
 int32_t TDateTime::GetDays(uint32_t year, uint32_t month)  {
    return date_time_get_days(year, month);
 }

 int32_t TDateTime::GetWday(uint32_t year, uint32_t month, uint32_t day)  {
    return date_time_get_wday(year, month, day);
 }

 const char* TDateTime::GetMonthName(uint32_t month)  {
 ...
 const char* TModelEvent::GetChangeType() const {
   return ((model_event_t*)(this->nativeObj))->change_type;
 }
 ...
 lcd_orientation_t TOrientationEvent::GetOrientation() const {
   return ((orientation_event_t*)(this->nativeObj))->orientation;
 }

 lcd_orientation_t TOrientationEvent::GetOldOrientation() const {
 ...
 int32_t TPointerEvent::GetFingerId() const {
   return ((pointer_event_t*)(this->nativeObj))->finger_id;
 }
 ...
 float_t TMultiGestureEvent::GetRotation() const {
   return ((multi_gesture_event_t*)(this->nativeObj))->rotation;
 }

 float_t TMultiGestureEvent::GetDistance() const {
 ...
 const char* TDropFileEvent::GetFilename() const {
   return ((drop_file_event_t*)(this->nativeObj))->filename;
 }
 ...
 int64_t TTouchEvent::GetTouchId() const {
   return ((touch_event_t*)(this->nativeObj))->touch_id;
 }

 int64_t TTouchEvent::GetFingerId() const {
   return ((touch_event_t*)(this->nativeObj))->finger_id;
 }

 float TTouchEvent::GetX() const {
   return ((touch_event_t*)(this->nativeObj))->x;
 }

 float TTouchEvent::GetY() const {
   return ((touch_event_t*)(this->nativeObj))->y;
 }

 float TTouchEvent::GetPressure() const {
   return ((touch_event_t*)(this->nativeObj))->pressure;
 }
 ...
 char* TWindowBase::GetAcceptButton() const {
   return ((window_base_t*)(this->nativeObj))->accept_button;
 }

 char* TWindowBase::GetCancelButton() const {
   return ((window_base_t*)(this->nativeObj))->cancel_button;
 }

 char* TWindowBase::GetAppletName() const {
   return ((window_base_t*)(this->nativeObj))->applet_name;
 }
 ...
 TWidget TColorComponent::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h)  {
   return TColorComponent((widget_t*)(color_component_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
 }
 ...
 char* TColorPicker::GetValue() const {
 ...
 ret_t TDraggable::SetAllowOutOfScreen(bool allow_out_of_screen)  {
   return draggable_set_allow_out_of_screen(((widget_t*)(this->nativeObj)), allow_out_of_screen);
 }
 ...
 bool TDraggable::GetAllowOutOfScreen() const {
   return ((draggable_t*)(this->nativeObj))->allow_out_of_screen;
 }
 ...
 ret_t TImageValue::SetClickAddDelta(double click_add_delta)  {
   return image_value_set_click_add_delta(((widget_t*)(this->nativeObj)), click_add_delta);
 }
 ...
 ret_t TCandidates::SetVisibleNum(uint32_t visible_num)  {
   return candidates_set_visible_num(((widget_t*)(this->nativeObj)), visible_num);
 }
 ...
 uint32_t TCandidates::GetVisibleNum() const {
   return ((candidates_t*)(this->nativeObj))->visible_num;
 }

 TWidget TLangIndicator::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h)  {
   return TLangIndicator((widget_t*)(lang_indicator_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
 }
 ...
 bool TMledit::GetAcceptReturn() const {
   return ((mledit_t*)(this->nativeObj))->accept_return;
 }
 ...
 int32_t TListView::GetItemWidth() const {
   return ((list_view_t*)(this->nativeObj))->item_width;
 }
 ...
 ret_t TScrollBar::ShowByOpacityAnimation(int32_t duration, int32_t delay)  {
 ...
 TWidget TSerialWidget::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h)  {
   return TSerialWidget((widget_t*)(serial_widget_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
 }

 ret_t TSerialWidget::SetBaudrate(uint32_t baudrate)  {
   return serial_widget_set_baudrate(((widget_t*)(this->nativeObj)), baudrate);
 }

 ret_t TSerialWidget::SetDevice(const char* device)  {
   return serial_widget_set_device(((widget_t*)(this->nativeObj)), device);
 }

 ret_t TSerialWidget::SetBytesize(uint32_t bytesize)  {
   return serial_widget_set_bytesize(((widget_t*)(this->nativeObj)), bytesize);
 }

 ret_t TSerialWidget::SetParity(uint32_t parity)  {
   return serial_widget_set_parity(((widget_t*)(this->nativeObj)), parity);
 }

 ret_t TSerialWidget::SetStopbits(uint32_t stopbits)  {
   return serial_widget_set_stopbits(((widget_t*)(this->nativeObj)), stopbits);
 }

 ret_t TSerialWidget::SetFlowcontrol(uint32_t flowcontrol)  {
   return serial_widget_set_flowcontrol(((widget_t*)(this->nativeObj)), flowcontrol);
 }

 ret_t TSerialWidget::SetCheckInterval(uint32_t check_interval)  {
   return serial_widget_set_check_interval(((widget_t*)(this->nativeObj)), check_interval);
 }

 char* TSerialWidget::GetDevice() const {
   return ((serial_widget_t*)(this->nativeObj))->device;
 }

 uint32_t TSerialWidget::GetBaudrate() const {
   return ((serial_widget_t*)(this->nativeObj))->baudrate;
 }

 uint32_t TSerialWidget::GetBytesize() const {
   return ((serial_widget_t*)(this->nativeObj))->bytesize;
 }

 uint32_t TSerialWidget::GetParity() const {
   return ((serial_widget_t*)(this->nativeObj))->parity;
 }

 uint32_t TSerialWidget::GetStopbits() const {
   return ((serial_widget_t*)(this->nativeObj))->stopbits;
 }

 uint32_t TSerialWidget::GetFlowcontrol() const {
 ...
 ret_t TSlideView::SetDragThreshold(uint32_t drag_threshold)  {
   return slide_view_set_drag_threshold(((widget_t*)(this->nativeObj)), drag_threshold);
 }

 ret_t TSlideView::SetAnimatingTime(uint32_t animating_time)  {
   return slide_view_set_animating_time(((widget_t*)(this->nativeObj)), animating_time);
 }
 ...
 uint32_t TSlideView::GetDragThreshold() const {
   return ((slide_view_t*)(this->nativeObj))->drag_threshold;
 }

 uint32_t TSlideView::GetAnimatingTime() const {
 ...
 ret_t TTextSelector::SetRangeOptionsEx(int32_t start, uint32_t nr, int32_t step, const char* format)  {
   return text_selector_set_range_options_ex(((widget_t*)(this->nativeObj)), start, nr, step, format);
 }
 ...
 TWidget TTimerWidget::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h)  {
   return TTimerWidget((widget_t*)(timer_widget_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
 }

 ret_t TTimerWidget::SetDuration(uint32_t duration)  {
   return timer_widget_set_duration(((widget_t*)(this->nativeObj)), duration);
 }

 uint32_t TTimerWidget::GetDuration() const {
   return ((timer_widget_t*)(this->nativeObj))->duration;
 }
 ...
 TNamedValue TNamedValue::Create()  {
   return TNamedValue((value_t*)(named_value_create()));
 }
 ...
 bool TButton::GetIsAcceptStatus() const {
   return ((button_t*)(this->nativeObj))->is_accept_status;
 }

 bool TButton::GetPressed() const {
   return ((button_t*)(this->nativeObj))->pressed;
 }
 ...
 char* TColorTile::GetBgColor() const {
   return ((color_tile_t*)(this->nativeObj))->bg_color;
 }

 char* TColorTile::GetBorderColor() const {
 ...
 ret_t TGrid::SetRows(uint32_t rows)  {
   return grid_set_rows(((widget_t*)(this->nativeObj)), rows);
 }

 ret_t TGrid::SetColumnsDefinition(const char* columns_definition)  {
   return grid_set_columns_definition(((widget_t*)(this->nativeObj)), columns_definition);
 }

 ret_t TGrid::SetShowGrid(bool show_grid)  {
   return grid_set_show_grid(((widget_t*)(this->nativeObj)), show_grid);
 }

 uint32_t TGrid::GetRows() const {
   return ((grid_t*)(this->nativeObj))->rows;
 }

 char* TGrid::GetColumnsDefinition() const {
   return ((grid_t*)(this->nativeObj))->columns_definition;
 }

 bool TGrid::GetShowGrid() const {
   return ((grid_t*)(this->nativeObj))->show_grid;
 }
 ...
 ret_t TTabButtonGroup::RemoveIndex(uint32_t index)  {
   return tab_button_group_remove_index(((widget_t*)(this->nativeObj)), index);
 }
 ...
 char* TDialog::GetHighlight() const {
 ...
 ret_t TNativeWindow::SetWindowHitTest(xy_t x, xy_t y, wh_t w, wh_t h)  {
   return native_window_set_window_hit_test(((native_window_t*)(this->nativeObj)), x, y, w, h);
 }
 ...
 TWidget TEditEx::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h)  {
 ...
 ret_t TEditEx::SetSuggestWordsItemFormats(const char* formats)  {
   return edit_ex_set_suggest_words_item_formats(((widget_t*)(this->nativeObj)), formats);
 }

 ret_t TEditEx::SetSuggestWordsInputName(const char* name)  {
 ...
 char* TEditEx::GetSuggestWordsItemFormats() const {
   return ((edit_ex_t*)(this->nativeObj))->suggest_words_item_formats;
 }
 ...
 TWidget TMutableImage::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h)  {
   return TMutableImage((widget_t*)(mutable_image_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
 }

 TWidget TListItemSeperator::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h)  {
   return TListItemSeperator((widget_t*)(list_item_seperator_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
 }
 ...
 ret_t TSvgImage::SetCacheMode(bool is_cache_mode)  {
   return svg_image_set_cache_mode(((widget_t*)(this->nativeObj)), is_cache_mode);
 }

 ret_t TSvgImage::SetDrawType(image_draw_type_t draw_type)  {
   return svg_image_set_draw_type(((widget_t*)(this->nativeObj)), draw_type);
 }

 bool TSvgImage::GetIsCacheMode() const {
   return ((svg_image_t*)(this->nativeObj))->is_cache_mode;
 }

 image_draw_type_t TSvgImage::GetDrawType() const {
   return ((svg_image_t*)(this->nativeObj))->draw_type;
 }
 ...
 TNamedValueHash TNamedValueHash::Create()  {
   return TNamedValueHash((value_t*)(named_value_hash_create()));
 }
 ...
 TNamedValueHash TNamedValueHash::Clone()  {
   return TNamedValueHash((value_t*)(named_value_hash_clone(((named_value_hash_t*)(this->nativeObj)))));
 }
 ...
 int32_t TObjectArray::LastIndexOf(TValue& v)  {
    return object_array_last_index_of(((object_t*)(this->nativeObj)), ((const value_t*)(v.nativeObj)));
 }
 ...
 ret_t TObjectArray::RemoveValue(TValue& v)  {
   return object_array_remove_value(((object_t*)(this->nativeObj)), ((value_t*)(v.nativeObj)));
 }

 ret_t TObjectArray::GetAndRemove(uint32_t index, TValue& v)  {
   return object_array_get_and_remove(((object_t*)(this->nativeObj)), index, ((value_t*)(v.nativeObj)));
 }
 ...
 ret_t TObjectHash::SetKeepPropsOrder(bool keep_props_order)  {
   return object_hash_set_keep_props_order(((object_t*)(this->nativeObj)), keep_props_order);
 }
 ...
 TWidget TCalibrationWin::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h)  {
   return TCalibrationWin((widget_t*)(calibration_win_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
 }
 ...
 ret_t TComboBox::SetThemeOfPopup(const char* theme_of_popup)  {
   return combo_box_set_theme_of_popup(((widget_t*)(this->nativeObj)), theme_of_popup);
 }
 ...
 ret_t TComboBox::RemoveOptionByIndex(uint32_t index)  {
   return combo_box_remove_option_by_index(((widget_t*)(this->nativeObj)), index);
 }
 ...
 char* TComboBox::GetThemeOfPopup() const {
   return ((combo_box_t*)(this->nativeObj))->theme_of_popup;
 }
 ...
 TWidget TImage::IconCreate(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h)  {
   return TImage((widget_t*)(icon_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
 }
 ...
 ret_t TOverlay::SetModeless(bool modeless)  {
   return overlay_set_modeless(((widget_t*)(this->nativeObj)), modeless);
 }
 ...
 bool TOverlay::GetModeless() const {
   return ((overlay_t*)(this->nativeObj))->modeless;
 }
 ...
 ret_t TSpinBox::SetEasyTouchMode(bool easy_touch_mode)  {
