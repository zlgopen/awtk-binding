...
pyobject_t wrap_value_equal(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  const value_t* value = NULL;
  const value_t* other = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&O&" , &__parse_voidp, &value, &__parse_voidp, &other)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_value_id(pyobject_t self, pyobject_t pyargs) {
  const char* ret = NULL;
  const value_t* v = NULL;
...
pyobject_t wrap_value_func(pyobject_t self, pyobject_t pyargs) {
  void* ret = NULL;
  const value_t* v = NULL;
...
pyobject_t wrap_value_func_def(pyobject_t self, pyobject_t pyargs) {
  void* ret = NULL;
  const value_t* v = NULL;
...
pyobject_t wrap_value_rect(pyobject_t self, pyobject_t pyargs) {
  rect_t* ret = NULL;
  const value_t* v = NULL;
...
pyobject_t wrap_tk_pre_init(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
...
pyobject_t wrap_tk_quit_ex(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  uint32_t delay = 0;

  if (!PyArg_ParseTuple(pyargs, "i" , &delay)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t get_IMAGE_DRAW_FILL(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", IMAGE_DRAW_FILL);
}
...
pyobject_t wrap_canvas_reset_font(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  canvas_t* c = NULL;
...
pyobject_t wrap_canvas_reset_cache(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  canvas_t* c = NULL;
...
pyobject_t get_EVT_MOUSE_EXTRA_BUTTON_DOWN(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_MOUSE_EXTRA_BUTTON_DOWN);
}

pyobject_t get_EVT_MOUSE_EXTRA_BUTTON_UP(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_MOUSE_EXTRA_BUTTON_UP);
}
...
pyobject_t get_EVT_DOUBLE_CLICK(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_DOUBLE_CLICK);
}
...
pyobject_t get_EVT_THEME_WILL_CHANGE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_THEME_WILL_CHANGE);
}
...
pyobject_t get_EVT_WIDGET_WILL_UPDATE_STYLE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_WIDGET_WILL_UPDATE_STYLE);
}

pyobject_t get_EVT_WIDGET_UPDATE_STYLE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_WIDGET_UPDATE_STYLE);
}
...
pyobject_t get_EVT_PAGE_CHANGING(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_PAGE_CHANGING);
}
...
pyobject_t get_EVT_DATA(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_DATA);
}

pyobject_t get_EVT_CONNECT(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_CONNECT);
}

pyobject_t get_EVT_MODEL_CHANGE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_MODEL_CHANGE);
}

pyobject_t get_EVT_SYSTEM(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_SYSTEM);
}

pyobject_t get_EVT_DROP_FILE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_DROP_FILE);
}

pyobject_t get_EVT_LOCALE_INFOS_LOAD_INFO(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_LOCALE_INFOS_LOAD_INFO);
}

pyobject_t get_EVT_LOCALE_INFOS_UNLOAD_INFO(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_LOCALE_INFOS_UNLOAD_INFO);
}

pyobject_t get_EVT_ACTIVATED(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_ACTIVATED);
}

pyobject_t get_EVT_UNACTIVATED(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_UNACTIVATED);
}

pyobject_t get_EVT_UI_LOAD(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t get_EVT_LOG_MESSAGE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_LOG_MESSAGE);
}
...
pyobject_t get_GLYPH_FMT_ALPHA2(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", GLYPH_FMT_ALPHA2);
}

pyobject_t get_GLYPH_FMT_ALPHA4(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", GLYPH_FMT_ALPHA4);
}
...
pyobject_t wrap_input_method_dispatch_keys(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &im, &keys)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t get_TK_KEY_KP_DIVIDE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_DIVIDE);
}

pyobject_t get_TK_KEY_KP_MULTIPLY(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_MULTIPLY);
}

pyobject_t get_TK_KEY_KP_MINUS(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_MINUS);
}

pyobject_t get_TK_KEY_KP_PLUS(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_PLUS);
}

pyobject_t get_TK_KEY_KP_ENTER(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_ENTER);
}

pyobject_t get_TK_KEY_KP_1(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_1);
}

pyobject_t get_TK_KEY_KP_2(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_2);
}

pyobject_t get_TK_KEY_KP_3(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_3);
}

pyobject_t get_TK_KEY_KP_4(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_4);
}

pyobject_t get_TK_KEY_KP_5(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_5);
}

pyobject_t get_TK_KEY_KP_6(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_6);
}

pyobject_t get_TK_KEY_KP_7(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_7);
}

pyobject_t get_TK_KEY_KP_8(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_8);
}

pyobject_t get_TK_KEY_KP_9(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_9);
}

pyobject_t get_TK_KEY_KP_0(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_0);
}

pyobject_t get_TK_KEY_KP_PERIOD(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_KP_PERIOD);
}

pyobject_t get_TK_KEY_NUMLOCKCLEAR(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", TK_KEY_NUMLOCKCLEAR);
}
...
pyobject_t wrap_locale_infos_ref(pyobject_t self, pyobject_t pyargs) {
  locale_info_t* ret = NULL;
  const char* name = NULL;
...
pyobject_t wrap_locale_infos_unref(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  locale_info_t* locale_info = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&" , &__parse_voidp, &locale_info)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_locale_infos_change(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  const char* language = NULL;
  const char* country = NULL;

  if (!PyArg_ParseTuple(pyargs, "ss" , &language, &country)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_locale_infos_off(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  uint32_t id = 0;
...
pyobject_t wrap_locale_infos_reload_all(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
...
pyobject_t get_STYLE_ID_DRAGGER_COLOR(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", STYLE_ID_DRAGGER_COLOR);
}
...
pyobject_t get_STYLE_ID_FOCUSABLE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", STYLE_ID_FOCUSABLE);
}

pyobject_t get_STYLE_ID_FEEDBACK(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", STYLE_ID_FEEDBACK);
}

pyobject_t get_STYLE_ID_CLEAR_BG(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", STYLE_ID_CLEAR_BG);
}

pyobject_t get_STYLE_ID_GRID_COLOR(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", STYLE_ID_GRID_COLOR);
}

pyobject_t get_STYLE_ID_EVEN_BG_COLOR(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", STYLE_ID_EVEN_BG_COLOR);
}

pyobject_t get_STYLE_ID_ODD_BG_COLOR(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", STYLE_ID_ODD_BG_COLOR);
}
...
pyobject_t wrap_style_get(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  style_t* s = NULL;
...
pyobject_t get_SYSTEM_INFO_FLAG_NONE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", SYSTEM_INFO_FLAG_NONE);
}

pyobject_t get_SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT);
}
...
pyobject_t wrap_timer_modify_ex(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  uint32_t timer_id = 0;
  uint32_t duration = 0;
  bool_t reset_timer = 0;

  if (!PyArg_ParseTuple(pyargs, "iib" , &timer_id, &duration, &reset_timer)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t get_APP_CONSOLE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", APP_CONSOLE);
}
...
pyobject_t get_BITMAP_FLAG_LCD_ORIENTATION(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", BITMAP_FLAG_LCD_ORIENTATION);
}

pyobject_t get_BITMAP_FLAG_GPU_FBO_TEXTURE(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_vgcanvas_is_rectf_in_clip_rect(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "O&ffff" , &__parse_voidp, &vg, &left, &top, &right, &bottom)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_vgcanvas_set_font_size(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "O&f" , &__parse_voidp, &vg, &size)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_vgcanvas_draw_image_repeat(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  vgcanvas_t* vg = NULL;
  bitmap_t* img = NULL;
  float_t sx = 0;
  ...
  if (!PyArg_ParseTuple(pyargs, "O&O&ffffffffff" , &__parse_voidp, &vg, &__parse_voidp, &img, &sx, &sy, &sw, &sh, &dx, &dy, &dw, &dh, &dst_w, &dst_h)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_vgcanvas_set_stroke_color_str(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &vg, &str)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t get_WIDGET_PROP_MAX_H(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_MAX_H);
}
...
pyobject_t get_WIDGET_PROP_LINE_HEIGHT(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_LINE_HEIGHT);
}
...
pyobject_t get_WIDGET_PROP_STRONGLY_FOCUS(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_STRONGLY_FOCUS);
}
...
pyobject_t get_WIDGET_PROP_LOADING(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_LOADING);
}
...
pyobject_t get_WIDGET_PROP_EASY_TOUCH_MODE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_EASY_TOUCH_MODE);
}

pyobject_t get_WIDGET_PROP_RADIO(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_RADIO);
}
...
pyobject_t get_WIDGET_PROP_ELLIPSES(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_ELLIPSES);
}

pyobject_t get_WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL);
}
...
pyobject_t get_WIDGET_PROP_STATE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_STATE);
}
...
pyobject_t get_WIDGET_PROP_APPLET_NAME(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_APPLET_NAME);
}
...
pyobject_t get_WIDGET_PROP_RUNNING(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_RUNNING);
}
...
pyobject_t get_WIDGET_PROP_ENABLE_PREVIEW(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t get_WIDGET_PROP_AUTO_HIDE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_AUTO_HIDE);
}
...
pyobject_t get_WIDGET_PROP_THEME_OF_POPUP(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_THEME_OF_POPUP);
}
...
pyobject_t get_WIDGET_PROP_SHOW_GRID(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_SHOW_GRID);
}

pyobject_t get_WIDGET_PROP_COLUMNS_DEFINITION(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_COLUMNS_DEFINITION);
}

pyobject_t get_WIDGET_PROP_DRAG_THRESHOLD(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_DRAG_THRESHOLD);
}

pyobject_t get_WIDGET_PROP_ANIMATING_TIME(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_ANIMATING_TIME);
}

pyobject_t get_WIDGET_PROP_ANIMATE_PREFIX(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_ANIMATE_PREFIX);
}

pyobject_t get_WIDGET_PROP_ANIMATE_ANIMATING_TIME(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_ANIMATE_ANIMATING_TIME);
}

pyobject_t get_WIDGET_PROP_DIRTY_RECT(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_DIRTY_RECT);
}

pyobject_t get_WIDGET_PROP_SCREEN_SAVER_TIME(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_SCREEN_SAVER_TIME);
}

pyobject_t get_WIDGET_PROP_SHOW_FPS(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_SHOW_FPS);
}

pyobject_t get_WIDGET_PROP_MAX_FPS(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_PROP_MAX_FPS);
}
...
pyobject_t get_WIDGET_TYPE_ICON(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_TYPE_ICON);
}
...
pyobject_t get_WIDGET_TYPE_PAGE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_TYPE_PAGE);
}
...
pyobject_t get_WINDOW_STAGE_LOADED(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", WINDOW_STAGE_LOADED);
}
...
pyobject_t get_WIDGET_STATE_ACTIVATED(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_STATE_ACTIVATED);
}
...
pyobject_t get_WIDGET_STATE_EMPTY_OVER(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_STATE_EMPTY_OVER);
}
...
pyobject_t get_WIDGET_STATE_NORMAL_OF_INDETERMINATE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_STATE_NORMAL_OF_INDETERMINATE);
}

pyobject_t get_WIDGET_STATE_PRESSED_OF_INDETERMINATE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_STATE_PRESSED_OF_INDETERMINATE);
}

pyobject_t get_WIDGET_STATE_OVER_OF_INDETERMINATE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_STATE_OVER_OF_INDETERMINATE);
}

pyobject_t get_WIDGET_STATE_DISABLE_OF_INDETERMINATE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_STATE_DISABLE_OF_INDETERMINATE);
}

pyobject_t get_WIDGET_STATE_FOCUSED_OF_INDETERMINATE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", WIDGET_STATE_FOCUSED_OF_INDETERMINATE);
}
...
pyobject_t wrap_widget_find_parent_by_name(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* widget = NULL;
  const char* name = NULL;
...
pyobject_t wrap_widget_find_parent_by_type(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* widget = NULL;
  const char* type = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &widget, &type)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_widget_get_focused_widget(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_move_to_center(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_move_resize_ex(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  xy_t x = 0;
  xy_t y = 0;
  wh_t w = 0;
  wh_t h = 0;
  bool_t update_layout = 0;

  if (!PyArg_ParseTuple(pyargs, "O&iiiib" , &__parse_voidp, &widget, &x, &y, &w, &h, &update_layout)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_widget_add_value(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "O&f" , &__parse_voidp, &widget, &delta)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_widget_get_value_int(pyobject_t self, pyobject_t pyargs) {
  int32_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_set_value_int(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t value = 0;
...
pyobject_t wrap_widget_add_value_int(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t delta = 0;
...
pyobject_t wrap_widget_animate_value_to(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "O&fi" , &__parse_voidp, &widget, &value, &duration)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_widget_is_support_highlighter(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_has_highlighter(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_set_text_utf8_ex(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* text = NULL;
  bool_t check_diff = 0;

  if (!PyArg_ParseTuple(pyargs, "O&sb" , &__parse_voidp, &widget, &text, &check_diff)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_widget_get_enable(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_get_floating(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_get_auto_adjust_size(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_get_with_focus_state(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_get_focusable(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_get_sensitive(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_get_visible(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_get_feedback(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_get_theme_name(pyobject_t self, pyobject_t pyargs) {
  const char* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_get_prop(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* name = NULL;
  value_t* v = NULL;
...
pyobject_t wrap_widget_set_prop(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* name = NULL;
  const value_t* v = NULL;
...
pyobject_t wrap_widget_set_props(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_set_prop_float(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* name = NULL;
  float_t v = 0;

  if (!PyArg_ParseTuple(pyargs, "O&sf" , &__parse_voidp, &widget, &name, &v)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_widget_get_prop_float(pyobject_t self, pyobject_t pyargs) {
  float_t ret = 0;
  widget_t* widget = NULL;
  const char* name = NULL;
  float_t defval = 0;

  if (!PyArg_ParseTuple(pyargs, "O&sf" , &__parse_voidp, &widget, &name, &defval)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_widget_is_window_created(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_is_fullscreen_window(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_is_always_on_top(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_is_suspend_dialog(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_is_suspend_popup(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_ref(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_widget_add_child_default(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  widget_t* child = NULL;
...
pyobject_t wrap_widget_t_get_prop_opacity(pyobject_t self, pyobject_t pyargs) {
  ...
  return Py_BuildValue("i", obj->opacity);
}
...
pyobject_t wrap_object_load_conf(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  object_t* obj = NULL;
  const char* url = NULL;
  const char* type = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&ss" , &__parse_voidp, &obj, &url, &type)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t get_EDIT_EX_PROP_MULTILINE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", EDIT_EX_PROP_MULTILINE);
}

pyobject_t get_EDIT_EX_PROP_SUGGEST_WORDS(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", EDIT_EX_PROP_SUGGEST_WORDS);
}

pyobject_t get_EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS);
}

pyobject_t get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE);
}

pyobject_t get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE);
}

pyobject_t get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE);
}

pyobject_t get_EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME);
}

pyobject_t get_EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD);
}

pyobject_t get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS);
}

pyobject_t get_EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME);
}
...
pyobject_t get_EVT_VPAGE_WILL_OPEN(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_VPAGE_WILL_OPEN);
}

pyobject_t get_EVT_VPAGE_OPEN(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_VPAGE_OPEN);
}

pyobject_t get_EVT_VPAGE_CLOSE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", EVT_VPAGE_CLOSE);
}
...
pyobject_t wrap_asset_info_get_type(pyobject_t self, pyobject_t pyargs) {
  uint16_t ret = 0;
...
pyobject_t wrap_asset_info_get_name(pyobject_t self, pyobject_t pyargs) {
  const char* ret = NULL;
...
pyobject_t wrap_asset_info_is_in_rom(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  const asset_info_t* info = NULL;
...
pyobject_t wrap_asset_info_set_is_in_rom(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &info, &is_in_rom)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_asset_info_t_get_prop_flags(pyobject_t self, pyobject_t pyargs) {
  asset_info_t* obj = NULL;
...
pyobject_t wrap_color_create(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "iiii" , &r, &g, &b, &a)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_color_get_color(pyobject_t self, pyobject_t pyargs) {
  uint32_t ret = 0;
  color_t* c = NULL;
...
pyobject_t wrap_date_time_get_days(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "ii" , &year, &month)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_date_time_get_wday(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "iii" , &year, &month, &day)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_date_time_get_month_name(pyobject_t self, pyobject_t pyargs) {
  ...
  if (!PyArg_ParseTuple(pyargs, "i" , &month)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t get_OBJECT_CMD_EXEC(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", OBJECT_CMD_EXEC);
}

pyobject_t get_OBJECT_CMD_UNDO(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", OBJECT_CMD_UNDO);
}
...
pyobject_t get_OBJECT_PROP_DISABLE_PATH(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", OBJECT_PROP_DISABLE_PATH);
}

pyobject_t get_OBJECT_PROP_KEEP_PROPS_ORDER(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("s", OBJECT_PROP_KEEP_PROPS_ORDER);
}
...
pyobject_t get_RET_NO_PERMISSION(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", RET_NO_PERMISSION);
}

pyobject_t get_RET_INVALID_ADDR(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", RET_INVALID_ADDR);
}

pyobject_t get_RET_EXCEED_RANGE(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", RET_EXCEED_RANGE);
}

pyobject_t get_RET_MAX_NR(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", RET_MAX_NR);
}
...
pyobject_t get_VALUE_TYPE_ID(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", VALUE_TYPE_ID);
}

pyobject_t get_VALUE_TYPE_FUNC(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", VALUE_TYPE_FUNC);
}

pyobject_t get_VALUE_TYPE_FUNC_DEF(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", VALUE_TYPE_FUNC_DEF);
}

pyobject_t get_VALUE_TYPE_POINTER_REF(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", VALUE_TYPE_POINTER_REF);
}

pyobject_t get_VALUE_TYPE_BITMAP(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", VALUE_TYPE_BITMAP);
}

pyobject_t get_VALUE_TYPE_RECT(pyobject_t self, pyobject_t pyargs) {
  return Py_BuildValue("i", VALUE_TYPE_RECT);
}
...
pyobject_t wrap_widget_animator_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_widget_animator_event_t_get_prop_widget(pyobject_t self, pyobject_t pyargs) {
  widget_animator_event_t* obj = NULL;
  ...
  return PyLong_FromVoidPtr((void*)obj->widget);
}

pyobject_t wrap_widget_animator_event_t_get_prop_animator(pyobject_t self, pyobject_t pyargs) {
  widget_animator_event_t* obj = NULL;
  ...
  return PyLong_FromVoidPtr((void*)obj->animator);
}

pyobject_t wrap_model_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_model_event_t_get_prop_name(pyobject_t self, pyobject_t pyargs) {
  model_event_t* obj = NULL;
...
pyobject_t wrap_model_event_t_get_prop_change_type(pyobject_t self, pyobject_t pyargs) {
  model_event_t* obj = NULL;
  ...
  return Py_BuildValue("s", obj->change_type);
}

pyobject_t wrap_model_event_t_get_prop_model(pyobject_t self, pyobject_t pyargs) {
  model_event_t* obj = NULL;
  ...
  return PyLong_FromVoidPtr((void*)obj->model);
}
...
pyobject_t wrap_wheel_event_t_get_prop_x(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_wheel_event_t_get_prop_y(pyobject_t self, pyobject_t pyargs) {
  wheel_event_t* obj = NULL;
...
pyobject_t wrap_offset_change_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_key_event_t_get_prop_numlock(pyobject_t self, pyobject_t pyargs) {
  key_event_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->numlock);
}
...
pyobject_t wrap_theme_change_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_theme_change_event_t_get_prop_name(pyobject_t self, pyobject_t pyargs) {
  theme_change_event_t* obj = NULL;
...
pyobject_t wrap_drop_file_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_drop_file_event_t_get_prop_filename(pyobject_t self, pyobject_t pyargs) {
  drop_file_event_t* obj = NULL;
  ...
  return Py_BuildValue("s", obj->filename);
}

pyobject_t wrap_system_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_system_event_t_get_prop_sdl_event(pyobject_t self, pyobject_t pyargs) {
  system_event_t* obj = NULL;
...
pyobject_t wrap_ui_load_event_t_get_prop_root(pyobject_t self, pyobject_t pyargs) {
  ui_load_event_t* obj = NULL;
  ...
  return PyLong_FromVoidPtr((void*)obj->root);
}

pyobject_t wrap_ui_load_event_t_get_prop_name(pyobject_t self, pyobject_t pyargs) {
  ui_load_event_t* obj = NULL;
...
pyobject_t wrap_window_base_t_get_prop_applet_name(pyobject_t self, pyobject_t pyargs) {
  ...
  return Py_BuildValue("s", obj->applet_name);
}
...
pyobject_t wrap_window_base_t_get_prop_strongly_focus(pyobject_t self, pyobject_t pyargs) {
  ...
  return Py_BuildValue("b", obj->strongly_focus);
}
...
pyobject_t wrap_window_manager_get_foreground_window(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_window_manager_set_show_fps_position(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  xy_t x = 0;
  xy_t y = 0;
...
pyobject_t wrap_window_manager_set_ignore_input_events(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_window_manager_set_fullscreen(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t fullscreen = 0;
...
pyobject_t wrap_color_component_create(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* parent = NULL;
  xy_t x = 0;
  xy_t y = 0;
...
pyobject_t wrap_draggable_set_allow_out_of_screen(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t allow_out_of_screen = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &allow_out_of_screen)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_draggable_set_drag_native_window(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t drag_native_window = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &drag_native_window)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_draggable_set_drag_parent(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t drag_parent = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &drag_parent)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_draggable_t_get_prop_allow_out_of_screen(pyobject_t self, pyobject_t pyargs) {
  draggable_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->allow_out_of_screen);
}
...
pyobject_t wrap_draggable_t_get_prop_drag_native_window(pyobject_t self, pyobject_t pyargs) {
  draggable_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->drag_native_window);
}

pyobject_t wrap_draggable_t_get_prop_drag_parent(pyobject_t self, pyobject_t pyargs) {
  draggable_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->drag_parent);
}
...
pyobject_t wrap_file_browser_view_set_top_dir(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_file_browser_view_set_odd_item_style(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* odd_item_style = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &widget, &odd_item_style)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_file_browser_view_set_even_item_style(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* even_item_style = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &widget, &even_item_style)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_file_browser_view_t_get_prop_top_dir(pyobject_t self, pyobject_t pyargs) {
  ...
  return Py_BuildValue("s", obj->top_dir);
}
...
pyobject_t wrap_file_browser_view_t_get_prop_odd_item_style(pyobject_t self, pyobject_t pyargs) {
  file_browser_view_t* obj = NULL;
  ...
  return Py_BuildValue("s", obj->odd_item_style);
}

pyobject_t wrap_file_browser_view_t_get_prop_even_item_style(pyobject_t self, pyobject_t pyargs) {
  file_browser_view_t* obj = NULL;
  ...
  return Py_BuildValue("s", obj->even_item_style);
}
...
pyobject_t wrap_file_chooser_set_top_dir(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  file_chooser_t* chooser = NULL;
  const char* top_dir = NULL;
...
pyobject_t wrap_gauge_pointer_t_get_prop_angle(pyobject_t self, pyobject_t pyargs) {
  ...
  return Py_BuildValue("f", obj->angle);
}
...
pyobject_t wrap_image_value_set_click_add_delta(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  double click_add_delta = 0;

  if (!PyArg_ParseTuple(pyargs, "O&d" , &__parse_voidp, &widget, &click_add_delta)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_candidates_create(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* parent = NULL;
  xy_t x = 0;
  xy_t y = 0;
...
pyobject_t wrap_candidates_t_get_prop_enable_preview(pyobject_t self, pyobject_t pyargs) {
  candidates_t* obj = NULL;
...
pyobject_t wrap_line_number_add_highlight_line(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t line = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &line)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_line_number_set_active_line(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t line = 0;
...
pyobject_t wrap_line_number_clear_highlight(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_line_number_is_highlight_line(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
  int32_t line = 0;
...
pyobject_t wrap_mledit_get_cursor(pyobject_t self, pyobject_t pyargs) {
  uint32_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_mledit_set_select(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t start = 0;
  uint32_t end = 0;
...
pyobject_t wrap_mledit_get_selected_text(pyobject_t self, pyobject_t pyargs) {
  char* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_mledit_get_current_line_index(pyobject_t self, pyobject_t pyargs) {
  uint32_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_mledit_get_current_row_index(pyobject_t self, pyobject_t pyargs) {
  uint32_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_mledit_get_start_line_index(pyobject_t self, pyobject_t pyargs) {
  int32_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_mledit_get_start_row_index(pyobject_t self, pyobject_t pyargs) {
  int32_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_mledit_get_line_at(pyobject_t self, pyobject_t pyargs) {
  int32_t ret = 0;
  widget_t* widget = NULL;
  uint32_t offset = 0;
...
pyobject_t wrap_mledit_get_row_at(pyobject_t self, pyobject_t pyargs) {
  int32_t ret = 0;
  widget_t* widget = NULL;
  uint32_t offset = 0;
...
pyobject_t wrap_mledit_get_row_of_line(pyobject_t self, pyobject_t pyargs) {
  int32_t ret = 0;
  widget_t* widget = NULL;
  uint32_t line = 0;
...
pyobject_t wrap_mledit_t_get_prop_auto_adjust_height(pyobject_t self, pyobject_t pyargs) {
  mledit_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->auto_adjust_height);
}
...
pyobject_t wrap_rich_text_set_word_wrap(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t word_wrap = 0;
...
pyobject_t wrap_rich_text_t_get_prop_word_wrap(pyobject_t self, pyobject_t pyargs) {
  rich_text_t* obj = NULL;
...
pyobject_t wrap_hscroll_label_set_speed(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  float_t speed = 0;

  if (!PyArg_ParseTuple(pyargs, "O&f" , &__parse_voidp, &widget, &speed)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_hscroll_label_set_stop_at_begin(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t stop_at_begin = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &stop_at_begin)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_hscroll_label_set_delay(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t delay = 0;
...
pyobject_t wrap_hscroll_label_set_loop_interval_distance(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t loop_interval_distance = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &loop_interval_distance)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_hscroll_label_t_get_prop_delay(pyobject_t self, pyobject_t pyargs) {
  hscroll_label_t* obj = NULL;
...
pyobject_t wrap_hscroll_label_t_get_prop_speed(pyobject_t self, pyobject_t pyargs) {
  hscroll_label_t* obj = NULL;
  ...
  return Py_BuildValue("f", obj->speed);
}
...
pyobject_t wrap_hscroll_label_t_get_prop_stop_at_begin(pyobject_t self, pyobject_t pyargs) {
  hscroll_label_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->stop_at_begin);
}

pyobject_t wrap_hscroll_label_t_get_prop_loop_interval_distance(pyobject_t self, pyobject_t pyargs) {
  hscroll_label_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->loop_interval_distance);
}
...
pyobject_t wrap_scroll_bar_set_auto_hide(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t auto_hide = 0;
...
pyobject_t wrap_scroll_bar_set_animator_time(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t animator_time = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &animator_time)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_scroll_bar_hide_by_opacity_animation(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t duration = 0;
  int32_t delay = 0;

  if (!PyArg_ParseTuple(pyargs, "O&ii" , &__parse_voidp, &widget, &duration, &delay)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_scroll_bar_show_by_opacity_animation(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t duration = 0;
  int32_t delay = 0;
...
pyobject_t wrap_scroll_bar_set_wheel_scroll(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t scroll = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &scroll)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_scroll_bar_set_scroll_delta(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t scroll_delta = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &scroll_delta)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_scroll_bar_set_scroll_rows(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint8_t scroll_rows = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &scroll_rows)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_scroll_bar_t_get_prop_animator_time(pyobject_t self, pyobject_t pyargs) {
  scroll_bar_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->animator_time);
}

pyobject_t wrap_scroll_bar_t_get_prop_scroll_delta(pyobject_t self, pyobject_t pyargs) {
  scroll_bar_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->scroll_delta);
}

pyobject_t wrap_scroll_bar_t_get_prop_scroll_rows(pyobject_t self, pyobject_t pyargs) {
  scroll_bar_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->scroll_rows);
}
...
pyobject_t wrap_scroll_bar_t_get_prop_wheel_scroll(pyobject_t self, pyobject_t pyargs) {
  scroll_bar_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->wheel_scroll);
}

pyobject_t wrap_scroll_bar_t_get_prop_wheel_modifier_key(pyobject_t self, pyobject_t pyargs) {
  scroll_bar_t* obj = NULL;
  ...
  return Py_BuildValue("s", obj->wheel_modifier_key);
}
...
pyobject_t wrap_scroll_view_set_slide_limit_ratio(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  float_t slide_limit_ratio = 0;

  if (!PyArg_ParseTuple(pyargs, "O&f" , &__parse_voidp, &widget, &slide_limit_ratio)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_scroll_view_t_get_prop_use_virtual_w(pyobject_t self, pyobject_t pyargs) {
  ...
  return Py_BuildValue("b", obj->use_virtual_w);
}

pyobject_t wrap_scroll_view_t_get_prop_use_widget_w(pyobject_t self, pyobject_t pyargs) {
  scroll_view_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->use_widget_w);
}

pyobject_t wrap_scroll_view_t_get_prop_use_virtual_h(pyobject_t self, pyobject_t pyargs) {
  scroll_view_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->use_virtual_h);
}

pyobject_t wrap_scroll_view_t_get_prop_use_widget_h(pyobject_t self, pyobject_t pyargs) {
  scroll_view_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->use_widget_h);
}
...
pyobject_t wrap_scroll_view_t_get_prop_slide_limit_ratio(pyobject_t self, pyobject_t pyargs) {
  scroll_view_t* obj = NULL;
  ...
  return Py_BuildValue("f", obj->slide_limit_ratio);
}

pyobject_t wrap_serial_widget_create(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* parent = NULL;
  xy_t x = 0;
  xy_t y = 0;
...
pyobject_t wrap_serial_widget_cast(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_serial_widget_set_baudrate(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t baudrate = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &baudrate)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_serial_widget_set_device(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* device = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &widget, &device)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_serial_widget_set_bytesize(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t bytesize = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &bytesize)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_serial_widget_set_parity(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t parity = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &parity)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_serial_widget_set_stopbits(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t stopbits = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &stopbits)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_serial_widget_set_flowcontrol(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t flowcontrol = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &flowcontrol)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_serial_widget_set_check_interval(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t check_interval = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &check_interval)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_serial_widget_t_get_prop_device(pyobject_t self, pyobject_t pyargs) {
  ...
  return Py_BuildValue("s", obj->device);
}

pyobject_t wrap_serial_widget_t_get_prop_baudrate(pyobject_t self, pyobject_t pyargs) {
  serial_widget_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->baudrate);
}

pyobject_t wrap_serial_widget_t_get_prop_bytesize(pyobject_t self, pyobject_t pyargs) {
  serial_widget_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->bytesize);
}

pyobject_t wrap_serial_widget_t_get_prop_parity(pyobject_t self, pyobject_t pyargs) {
  serial_widget_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->parity);
}

pyobject_t wrap_serial_widget_t_get_prop_stopbits(pyobject_t self, pyobject_t pyargs) {
  serial_widget_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->stopbits);
}

pyobject_t wrap_serial_widget_t_get_prop_flowcontrol(pyobject_t self, pyobject_t pyargs) {
  serial_widget_t* obj = NULL;
...
pyobject_t wrap_serial_widget_t_get_prop_check_interval(pyobject_t self, pyobject_t pyargs) {
  ...
  return Py_BuildValue("i", obj->check_interval);
}
...
pyobject_t wrap_slide_menu_set_spacer(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t spacer = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &spacer)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_slide_menu_set_menu_w(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* menu_w = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &widget, &menu_w)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_slide_menu_set_clip(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t clip = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &clip)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_slide_menu_scroll_to_prev(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_slide_menu_scroll_to_next(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_slide_menu_t_get_prop_spacer(pyobject_t self, pyobject_t pyargs) {
  slide_menu_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->spacer);
}

pyobject_t wrap_slide_menu_t_get_prop_menu_w(pyobject_t self, pyobject_t pyargs) {
  slide_menu_t* obj = NULL;
  ...
  return Py_BuildValue("s", obj->menu_w);
}

pyobject_t wrap_slide_menu_t_get_prop_clip(pyobject_t self, pyobject_t pyargs) {
  slide_menu_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->clip);
}
...
pyobject_t wrap_slide_indicator_set_transition(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t transition = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &transition)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_slide_indicator_t_get_prop_transition(pyobject_t self, pyobject_t pyargs) {
  slide_indicator_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->transition);
}
...
pyobject_t wrap_slide_view_set_drag_threshold(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t drag_threshold = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &drag_threshold)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_slide_view_set_animating_time(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_slide_view_t_get_prop_drag_threshold(pyobject_t self, pyobject_t pyargs) {
  slide_view_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->drag_threshold);
}

pyobject_t wrap_slide_view_t_get_prop_animating_time(pyobject_t self, pyobject_t pyargs) {
  slide_view_t* obj = NULL;
...
pyobject_t wrap_text_selector_set_enable_value_animator(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t enable_value_animator = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &enable_value_animator)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_text_selector_set_mask_easing(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  easing_type_t mask_easing = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &mask_easing)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_text_selector_set_mask_area_scale(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  float_t mask_area_scale = 0;

  if (!PyArg_ParseTuple(pyargs, "O&f" , &__parse_voidp, &widget, &mask_area_scale)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_text_selector_set_ellipses(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t ellipses = 0;
...
pyobject_t wrap_text_selector_t_get_prop_enable_value_animator(pyobject_t self, pyobject_t pyargs) {
  text_selector_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->enable_value_animator);
}

pyobject_t wrap_text_selector_t_get_prop_ellipses(pyobject_t self, pyobject_t pyargs) {
  text_selector_t* obj = NULL;
...
pyobject_t wrap_text_selector_t_get_prop_mask_easing(pyobject_t self, pyobject_t pyargs) {
  text_selector_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->mask_easing);
}

pyobject_t wrap_text_selector_t_get_prop_mask_area_scale(pyobject_t self, pyobject_t pyargs) {
  text_selector_t* obj = NULL;
  ...
  return Py_BuildValue("f", obj->mask_area_scale);
}
...
pyobject_t wrap_timer_widget_create(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* parent = NULL;
  xy_t x = 0;
  xy_t y = 0;
...
pyobject_t wrap_timer_widget_cast(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_timer_widget_set_duration(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t duration = 0;
...
pyobject_t wrap_timer_widget_t_get_prop_duration(pyobject_t self, pyobject_t pyargs) {
  timer_widget_t* obj = NULL;
...
pyobject_t wrap_vpage_create(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* parent = NULL;
  xy_t x = 0;
  xy_t y = 0;
...
pyobject_t wrap_vpage_cast(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_vpage_set_ui_asset(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_vpage_set_anim_hint(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* anim_hint = NULL;
...
pyobject_t wrap_vpage_t_get_prop_ui_asset(pyobject_t self, pyobject_t pyargs) {
  ...
  return Py_BuildValue("s", obj->ui_asset);
}
...
pyobject_t wrap_log_message_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_object_fifo_set_event_t_get_prop_index(pyobject_t self, pyobject_t pyargs) {
  object_fifo_set_event_t* obj = NULL;
...
pyobject_t wrap_object_fifo_set_event_t_get_prop_nr(pyobject_t self, pyobject_t pyargs) {
  object_fifo_set_event_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->nr);
}

pyobject_t wrap_object_fifo_set_event_t_get_prop_data(pyobject_t self, pyobject_t pyargs) {
  object_fifo_set_event_t* obj = NULL;
  ...
  return PyLong_FromVoidPtr((void*)obj->data);
}

pyobject_t wrap_object_fifo_push_event_t_get_prop_nr(pyobject_t self, pyobject_t pyargs) {
  object_fifo_push_event_t* obj = NULL;
...
pyobject_t wrap_object_fifo_push_event_t_get_prop_data(pyobject_t self, pyobject_t pyargs) {
  object_fifo_push_event_t* obj = NULL;
...
pyobject_t wrap_object_fifo_push_head_event_t_get_prop_nr(pyobject_t self, pyobject_t pyargs) {
  object_fifo_push_head_event_t* obj = NULL;
...
pyobject_t wrap_object_fifo_push_head_event_t_get_prop_data(pyobject_t self, pyobject_t pyargs) {
  object_fifo_push_head_event_t* obj = NULL;
...
pyobject_t wrap_object_fifo_pop_event_t_get_prop_nr(pyobject_t self, pyobject_t pyargs) {
  object_fifo_pop_event_t* obj = NULL;
...
pyobject_t wrap_object_fifo_pop_tail_event_t_get_prop_nr(pyobject_t self, pyobject_t pyargs) {
  object_fifo_pop_tail_event_t* obj = NULL;
...
pyobject_t wrap_object_fifo_set_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_object_fifo_push_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_object_fifo_push_head_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_object_fifo_pop_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_object_fifo_pop_tail_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_object_fifo_value_change_event_cast(pyobject_t self, pyobject_t pyargs) {
...
pyobject_t wrap_object_fifo_value_change_event_t_get_prop_type(pyobject_t self, pyobject_t pyargs) {
  object_fifo_value_change_event_t* obj = NULL;
...
pyobject_t wrap_button_set_enable_preview(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t enable_preview = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &enable_preview)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_button_t_get_prop_enable_preview(pyobject_t self, pyobject_t pyargs) {
  button_t* obj = NULL;
...
pyobject_t wrap_check_button_set_indeterminate(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t indeterminate = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &indeterminate)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_check_button_get_indeterminate(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_check_button_create_ex(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* parent = NULL;
  xy_t x = 0;
  xy_t y = 0;
  ...
  if (!PyArg_ParseTuple(pyargs, "O&iiiisb" , &__parse_voidp, &parent, &x, &y, &w, &h, &type, &radio)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_color_tile_get_bg_color(pyobject_t self, pyobject_t pyargs) {
  const char* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_color_tile_get_border_color(pyobject_t self, pyobject_t pyargs) {
  const char* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_edit_get_int64(pyobject_t self, pyobject_t pyargs) {
  int64_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_edit_set_double_ex(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* format = NULL;
  double value = 0;

  if (!PyArg_ParseTuple(pyargs, "O&sd" , &__parse_voidp, &widget, &format, &value)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_edit_set_select(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t start = 0;
  uint32_t end = 0;
...
pyobject_t wrap_edit_get_selected_text(pyobject_t self, pyobject_t pyargs) {
  char* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_edit_set_focus_next_when_enter(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t focus_next_when_enter = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &focus_next_when_enter)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_edit_t_get_prop_validator(pyobject_t self, pyobject_t pyargs) {
  edit_t* obj = NULL;
  ...
  return Py_BuildValue("s", obj->validator);
}
...
pyobject_t wrap_edit_t_get_prop_focus_next_when_enter(pyobject_t self, pyobject_t pyargs) {
  edit_t* obj = NULL;
...
pyobject_t wrap_grid_set_rows(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t rows = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &rows)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_grid_set_columns_definition(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* columns_definition = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &widget, &columns_definition)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_grid_set_show_grid(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t show_grid = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &show_grid)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_grid_t_get_prop_rows(pyobject_t self, pyobject_t pyargs) {
  grid_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->rows);
}

pyobject_t wrap_grid_t_get_prop_columns_definition(pyobject_t self, pyobject_t pyargs) {
  grid_t* obj = NULL;
  ...
  return Py_BuildValue("s", obj->columns_definition);
}

pyobject_t wrap_grid_t_get_prop_show_grid(pyobject_t self, pyobject_t pyargs) {
  grid_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->show_grid);
}
...
pyobject_t wrap_group_box_set_value(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t value = 0;
...
pyobject_t wrap_group_box_t_get_prop_value(pyobject_t self, pyobject_t pyargs) {
  group_box_t* obj = NULL;
...
pyobject_t wrap_label_set_max_w(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t max_w = 0;
...
pyobject_t wrap_label_set_ellipses(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t ellipses = 0;
...
pyobject_t wrap_label_t_get_prop_ellipses(pyobject_t self, pyobject_t pyargs) {
  label_t* obj = NULL;
...
pyobject_t wrap_label_t_get_prop_max_w(pyobject_t self, pyobject_t pyargs) {
  ...
  return Py_BuildValue("i", obj->max_w);
}
...
pyobject_t wrap_pages_set_auto_focused(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t auto_focused = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &auto_focused)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_pages_t_get_prop_auto_focused(pyobject_t self, pyobject_t pyargs) {
  pages_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->auto_focused);
}
...
pyobject_t wrap_slider_set_line_cap(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* line_cap = NULL;
...
pyobject_t wrap_slider_set_drag_threshold(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t drag_threshold = 0;
...
pyobject_t wrap_slider_t_get_prop_drag_threshold(pyobject_t self, pyobject_t pyargs) {
  slider_t* obj = NULL;
...
pyobject_t wrap_tab_button_group_set_drag_child(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t drag_child = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &drag_child)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_tab_button_group_t_get_prop_drag_child(pyobject_t self, pyobject_t pyargs) {
  tab_button_group_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->drag_child);
}
...
pyobject_t wrap_tab_button_set_max_w(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t max_w = 0;
...
pyobject_t wrap_tab_button_restack(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t index = 0;
...
pyobject_t wrap_tab_button_t_get_prop_max_w(pyobject_t self, pyobject_t pyargs) {
  tab_button_t* obj = NULL;
...
pyobject_t wrap_native_window_set_title(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  native_window_t* win = NULL;
  const char* app_name = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &win, &app_name)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_edit_ex_set_multiline(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t multiline = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &multiline)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_edit_ex_update_suggest_words_popup(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_edit_ex_t_get_prop_is_select_suggest_word(pyobject_t self, pyobject_t pyargs) {
  edit_ex_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->is_select_suggest_word);
}

pyobject_t wrap_edit_ex_t_get_prop_multiline(pyobject_t self, pyobject_t pyargs) {
  edit_ex_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->multiline);
}
...
pyobject_t wrap_gif_image_play(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_gif_image_stop(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_gif_image_pause(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
...
pyobject_t wrap_gif_image_set_loop(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t loop = 0;

  if (!PyArg_ParseTuple(pyargs, "O&i" , &__parse_voidp, &widget, &loop)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_gif_image_set_part_buffer_load_mode(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t part_buffer_load_mode = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &part_buffer_load_mode)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_gif_image_t_get_prop_loop(pyobject_t self, pyobject_t pyargs) {
  gif_image_t* obj = NULL;
  ...
  return Py_BuildValue("i", obj->loop);
}

pyobject_t wrap_gif_image_t_get_prop_part_buffer_load_mode(pyobject_t self, pyobject_t pyargs) {
  gif_image_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->part_buffer_load_mode);
}
...
pyobject_t wrap_mutable_image_create(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* parent = NULL;
  xy_t x = 0;
  xy_t y = 0;
...
pyobject_t wrap_list_item_seperator_create(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* parent = NULL;
  xy_t x = 0;
  xy_t y = 0;
...
pyobject_t wrap_list_item_seperator_cast(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_svg_image_set_cache_mode(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t is_cache_mode = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &is_cache_mode)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_svg_image_set_draw_type(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  image_draw_type_t draw_type = 0;
...
pyobject_t wrap_svg_image_t_get_prop_is_cache_mode(pyobject_t self, pyobject_t pyargs) {
  svg_image_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->is_cache_mode);
}

pyobject_t wrap_svg_image_t_get_prop_draw_type(pyobject_t self, pyobject_t pyargs) {
  svg_image_t* obj = NULL;
...
pyobject_t wrap_idle_info_t_get_prop_extra_ctx(pyobject_t self, pyobject_t pyargs) {
  ...
  return PyLong_FromVoidPtr((void*)obj->extra_ctx);
}
...
pyobject_t wrap_object_array_remove_value(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  object_t* obj = NULL;
  value_t* v = NULL;
...
pyobject_t wrap_object_default_set_keep_prop_type(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  object_t* obj = NULL;
...
pyobject_t wrap_object_default_set_name_case_insensitive(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  object_t* obj = NULL;
  bool_t name_case_insensitive = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &obj, &name_case_insensitive)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_object_hash_set_name_case_insensitive(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  object_t* obj = NULL;
  bool_t name_case_insensitive = 0;
...
pyobject_t wrap_calibration_win_create(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* parent = NULL;
  xy_t x = 0;
  xy_t y = 0;
...
pyobject_t wrap_combo_box_set_theme_of_popup(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* theme_of_popup = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &widget, &theme_of_popup)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_combo_box_set_selected_index_by_text(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* text = NULL;
...
pyobject_t wrap_combo_box_remove_option_by_index(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  uint32_t index = 0;
...
pyobject_t wrap_combo_box_has_option_text(pyobject_t self, pyobject_t pyargs) {
  bool_t ret = 0;
  widget_t* widget = NULL;
  const char* text = NULL;
...
pyobject_t wrap_combo_box_get_text_of_selected(pyobject_t self, pyobject_t pyargs) {
  const char* ret = NULL;
  widget_t* widget = NULL;
...
pyobject_t wrap_combo_box_t_get_prop_theme_of_popup(pyobject_t self, pyobject_t pyargs) {
  combo_box_t* obj = NULL;
  ...
  return Py_BuildValue("s", obj->theme_of_popup);
}
...
pyobject_t wrap_icon_create(pyobject_t self, pyobject_t pyargs) {
  widget_t* ret = NULL;
  widget_t* parent = NULL;
  xy_t x = 0;
  xy_t y = 0;
...
pyobject_t wrap_overlay_set_modeless(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t modeless = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &modeless)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_overlay_t_get_prop_modeless(pyobject_t self, pyobject_t pyargs) {
  overlay_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->modeless);
}
...
pyobject_t wrap_spin_box_set_easy_touch_mode(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  bool_t easy_touch_mode = 0;

  if (!PyArg_ParseTuple(pyargs, "O&b" , &__parse_voidp, &widget, &easy_touch_mode)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_spin_box_set_button_position(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  const char* button_position = NULL;

  if (!PyArg_ParseTuple(pyargs, "O&s" , &__parse_voidp, &widget, &button_position)) {
    PyErr_SetString(PyExc_TypeError, "invalid arguments");
    return NULL;
  }
...
pyobject_t wrap_spin_set_repeat(pyobject_t self, pyobject_t pyargs) {
  ret_t ret = 0;
  widget_t* widget = NULL;
  int32_t repeat = 0;
...
pyobject_t wrap_spin_box_t_get_prop_easy_touch_mode(pyobject_t self, pyobject_t pyargs) {
  spin_box_t* obj = NULL;
  ...
  return Py_BuildValue("b", obj->easy_touch_mode);
}

pyobject_t wrap_spin_box_t_get_prop_button_position(pyobject_t self, pyobject_t pyargs) {
  spin_box_t* obj = NULL;
  ...
  return Py_BuildValue("s", obj->button_position);
}
...
{"value_id", wrap_value_id, METH_VARARGS, "value_id"},
{"value_func", wrap_value_func, METH_VARARGS, "value_func"},
{"value_func_def", wrap_value_func_def, METH_VARARGS, "value_func_def"},
{"value_bitmap", wrap_value_bitmap, METH_VARARGS, "value_bitmap"},
{"value_rect", wrap_value_rect, METH_VARARGS, "value_rect"},
{"tk_pre_init", wrap_tk_pre_init, METH_VARARGS, "tk_pre_init"},
{"tk_init", wrap_tk_init, METH_VARARGS, "tk_init"},
{"tk_run", wrap_tk_run, METH_VARARGS, "tk_run"},
{"tk_quit", wrap_tk_quit, METH_VARARGS, "tk_quit"},
{"tk_quit_ex", wrap_tk_quit_ex, METH_VARARGS, "tk_quit_ex"},
...
{"IMAGE_DRAW_FILL", get_IMAGE_DRAW_FILL, METH_VARARGS, "IMAGE_DRAW_FILL"},
...
{"canvas_reset_font", wrap_canvas_reset_font, METH_VARARGS, "canvas_reset_font"},
...
{"canvas_reset_cache", wrap_canvas_reset_cache, METH_VARARGS, "canvas_reset_cache"},
...
{"EVT_MOUSE_EXTRA_BUTTON_DOWN", get_EVT_MOUSE_EXTRA_BUTTON_DOWN, METH_VARARGS, "EVT_MOUSE_EXTRA_BUTTON_DOWN"},
{"EVT_MOUSE_EXTRA_BUTTON_UP", get_EVT_MOUSE_EXTRA_BUTTON_UP, METH_VARARGS, "EVT_MOUSE_EXTRA_BUTTON_UP"},
...
{"EVT_DOUBLE_CLICK", get_EVT_DOUBLE_CLICK, METH_VARARGS, "EVT_DOUBLE_CLICK"},
...
{"EVT_THEME_WILL_CHANGE", get_EVT_THEME_WILL_CHANGE, METH_VARARGS, "EVT_THEME_WILL_CHANGE"},
{"EVT_THEME_CHANGED", get_EVT_THEME_CHANGED, METH_VARARGS, "EVT_THEME_CHANGED"},
{"EVT_WIDGET_WILL_UPDATE_STYLE", get_EVT_WIDGET_WILL_UPDATE_STYLE, METH_VARARGS, "EVT_WIDGET_WILL_UPDATE_STYLE"},
{"EVT_WIDGET_UPDATE_STYLE", get_EVT_WIDGET_UPDATE_STYLE, METH_VARARGS, "EVT_WIDGET_UPDATE_STYLE"},
...
{"EVT_PAGE_CHANGING", get_EVT_PAGE_CHANGING, METH_VARARGS, "EVT_PAGE_CHANGING"},
...
{"EVT_DATA", get_EVT_DATA, METH_VARARGS, "EVT_DATA"},
{"EVT_CONNECT", get_EVT_CONNECT, METH_VARARGS, "EVT_CONNECT"},
{"EVT_MODEL_CHANGE", get_EVT_MODEL_CHANGE, METH_VARARGS, "EVT_MODEL_CHANGE"},
{"EVT_SYSTEM", get_EVT_SYSTEM, METH_VARARGS, "EVT_SYSTEM"},
{"EVT_DROP_FILE", get_EVT_DROP_FILE, METH_VARARGS, "EVT_DROP_FILE"},
{"EVT_LOCALE_INFOS_LOAD_INFO", get_EVT_LOCALE_INFOS_LOAD_INFO, METH_VARARGS, "EVT_LOCALE_INFOS_LOAD_INFO"},
{"EVT_LOCALE_INFOS_UNLOAD_INFO", get_EVT_LOCALE_INFOS_UNLOAD_INFO, METH_VARARGS, "EVT_LOCALE_INFOS_UNLOAD_INFO"},
...
{"GLYPH_FMT_ALPHA2", get_GLYPH_FMT_ALPHA2, METH_VARARGS, "GLYPH_FMT_ALPHA2"},
...
{"TK_KEY_KP_DIVIDE", get_TK_KEY_KP_DIVIDE, METH_VARARGS, "TK_KEY_KP_DIVIDE"},
{"TK_KEY_KP_MULTIPLY", get_TK_KEY_KP_MULTIPLY, METH_VARARGS, "TK_KEY_KP_MULTIPLY"},
{"TK_KEY_KP_MINUS", get_TK_KEY_KP_MINUS, METH_VARARGS, "TK_KEY_KP_MINUS"},
{"TK_KEY_KP_PLUS", get_TK_KEY_KP_PLUS, METH_VARARGS, "TK_KEY_KP_PLUS"},
{"TK_KEY_KP_ENTER", get_TK_KEY_KP_ENTER, METH_VARARGS, "TK_KEY_KP_ENTER"},
{"TK_KEY_KP_1", get_TK_KEY_KP_1, METH_VARARGS, "TK_KEY_KP_1"},
{"TK_KEY_KP_2", get_TK_KEY_KP_2, METH_VARARGS, "TK_KEY_KP_2"},
{"TK_KEY_KP_3", get_TK_KEY_KP_3, METH_VARARGS, "TK_KEY_KP_3"},
{"TK_KEY_KP_4", get_TK_KEY_KP_4, METH_VARARGS, "TK_KEY_KP_4"},
{"TK_KEY_KP_5", get_TK_KEY_KP_5, METH_VARARGS, "TK_KEY_KP_5"},
{"TK_KEY_KP_6", get_TK_KEY_KP_6, METH_VARARGS, "TK_KEY_KP_6"},
{"TK_KEY_KP_7", get_TK_KEY_KP_7, METH_VARARGS, "TK_KEY_KP_7"},
{"TK_KEY_KP_8", get_TK_KEY_KP_8, METH_VARARGS, "TK_KEY_KP_8"},
{"TK_KEY_KP_9", get_TK_KEY_KP_9, METH_VARARGS, "TK_KEY_KP_9"},
{"TK_KEY_KP_0", get_TK_KEY_KP_0, METH_VARARGS, "TK_KEY_KP_0"},
{"TK_KEY_KP_PERIOD", get_TK_KEY_KP_PERIOD, METH_VARARGS, "TK_KEY_KP_PERIOD"},
{"TK_KEY_NUMLOCKCLEAR", get_TK_KEY_NUMLOCKCLEAR, METH_VARARGS, "TK_KEY_NUMLOCKCLEAR"},
...
{"locale_infos_ref", wrap_locale_infos_ref, METH_VARARGS, "locale_infos_ref"},
{"locale_infos_unref", wrap_locale_infos_unref, METH_VARARGS, "locale_infos_unref"},
{"locale_infos_change", wrap_locale_infos_change, METH_VARARGS, "locale_infos_change"},
...
{"STYLE_ID_DRAGGER_COLOR", get_STYLE_ID_DRAGGER_COLOR, METH_VARARGS, "STYLE_ID_DRAGGER_COLOR"},
...
{"STYLE_ID_FOCUSABLE", get_STYLE_ID_FOCUSABLE, METH_VARARGS, "STYLE_ID_FOCUSABLE"},
{"STYLE_ID_FEEDBACK", get_STYLE_ID_FEEDBACK, METH_VARARGS, "STYLE_ID_FEEDBACK"},
{"STYLE_ID_CLEAR_BG", get_STYLE_ID_CLEAR_BG, METH_VARARGS, "STYLE_ID_CLEAR_BG"},
{"STYLE_ID_GRID_COLOR", get_STYLE_ID_GRID_COLOR, METH_VARARGS, "STYLE_ID_GRID_COLOR"},
{"STYLE_ID_EVEN_BG_COLOR", get_STYLE_ID_EVEN_BG_COLOR, METH_VARARGS, "STYLE_ID_EVEN_BG_COLOR"},
{"STYLE_ID_ODD_BG_COLOR", get_STYLE_ID_ODD_BG_COLOR, METH_VARARGS, "STYLE_ID_ODD_BG_COLOR"},
...
{"style_get", wrap_style_get, METH_VARARGS, "style_get"},
...
{"SYSTEM_INFO_FLAG_NONE", get_SYSTEM_INFO_FLAG_NONE, METH_VARARGS, "SYSTEM_INFO_FLAG_NONE"},
{"SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT", get_SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT, METH_VARARGS, "SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT"},
...
{"timer_modify_ex", wrap_timer_modify_ex, METH_VARARGS, "timer_modify_ex"},
...
{"APP_CONSOLE", get_APP_CONSOLE, METH_VARARGS, "APP_CONSOLE"},
...
{"WIDGET_PROP_MAX_H", get_WIDGET_PROP_MAX_H, METH_VARARGS, "WIDGET_PROP_MAX_H"},
...
{"WIDGET_PROP_STRONGLY_FOCUS", get_WIDGET_PROP_STRONGLY_FOCUS, METH_VARARGS, "WIDGET_PROP_STRONGLY_FOCUS"},
...
{"WIDGET_PROP_LOADING", get_WIDGET_PROP_LOADING, METH_VARARGS, "WIDGET_PROP_LOADING"},
...
{"WIDGET_PROP_EASY_TOUCH_MODE", get_WIDGET_PROP_EASY_TOUCH_MODE, METH_VARARGS, "WIDGET_PROP_EASY_TOUCH_MODE"},
{"WIDGET_PROP_RADIO", get_WIDGET_PROP_RADIO, METH_VARARGS, "WIDGET_PROP_RADIO"},
...
{"WIDGET_PROP_ELLIPSES", get_WIDGET_PROP_ELLIPSES, METH_VARARGS, "WIDGET_PROP_ELLIPSES"},
{"WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL", get_WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL, METH_VARARGS, "WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL"},
...
{"WIDGET_PROP_STATE", get_WIDGET_PROP_STATE, METH_VARARGS, "WIDGET_PROP_STATE"},
...
{"WIDGET_PROP_APPLET_NAME", get_WIDGET_PROP_APPLET_NAME, METH_VARARGS, "WIDGET_PROP_APPLET_NAME"},
...
{"WIDGET_PROP_RUNNING", get_WIDGET_PROP_RUNNING, METH_VARARGS, "WIDGET_PROP_RUNNING"},
...
{"WIDGET_PROP_THEME_OF_POPUP", get_WIDGET_PROP_THEME_OF_POPUP, METH_VARARGS, "WIDGET_PROP_THEME_OF_POPUP"},
...
{"WIDGET_PROP_DRAG_THRESHOLD", get_WIDGET_PROP_DRAG_THRESHOLD, METH_VARARGS, "WIDGET_PROP_DRAG_THRESHOLD"},
{"WIDGET_PROP_ANIMATING_TIME", get_WIDGET_PROP_ANIMATING_TIME, METH_VARARGS, "WIDGET_PROP_ANIMATING_TIME"},
{"WIDGET_PROP_ANIMATE_PREFIX", get_WIDGET_PROP_ANIMATE_PREFIX, METH_VARARGS, "WIDGET_PROP_ANIMATE_PREFIX"},
{"WIDGET_PROP_ANIMATE_ANIMATING_TIME", get_WIDGET_PROP_ANIMATE_ANIMATING_TIME, METH_VARARGS, "WIDGET_PROP_ANIMATE_ANIMATING_TIME"},
{"WIDGET_PROP_DIRTY_RECT", get_WIDGET_PROP_DIRTY_RECT, METH_VARARGS, "WIDGET_PROP_DIRTY_RECT"},
{"WIDGET_PROP_SCREEN_SAVER_TIME", get_WIDGET_PROP_SCREEN_SAVER_TIME, METH_VARARGS, "WIDGET_PROP_SCREEN_SAVER_TIME"},
...
{"WIDGET_TYPE_ICON", get_WIDGET_TYPE_ICON, METH_VARARGS, "WIDGET_TYPE_ICON"},
...
{"WIDGET_TYPE_PAGE", get_WIDGET_TYPE_PAGE, METH_VARARGS, "WIDGET_TYPE_PAGE"},
...
{"WINDOW_STAGE_LOADED", get_WINDOW_STAGE_LOADED, METH_VARARGS, "WINDOW_STAGE_LOADED"},
...
{"WIDGET_STATE_ACTIVATED", get_WIDGET_STATE_ACTIVATED, METH_VARARGS, "WIDGET_STATE_ACTIVATED"},
...
{"WIDGET_STATE_EMPTY_OVER", get_WIDGET_STATE_EMPTY_OVER, METH_VARARGS, "WIDGET_STATE_EMPTY_OVER"},
...
{"WIDGET_STATE_NORMAL_OF_INDETERMINATE", get_WIDGET_STATE_NORMAL_OF_INDETERMINATE, METH_VARARGS, "WIDGET_STATE_NORMAL_OF_INDETERMINATE"},
{"WIDGET_STATE_PRESSED_OF_INDETERMINATE", get_WIDGET_STATE_PRESSED_OF_INDETERMINATE, METH_VARARGS, "WIDGET_STATE_PRESSED_OF_INDETERMINATE"},
{"WIDGET_STATE_OVER_OF_INDETERMINATE", get_WIDGET_STATE_OVER_OF_INDETERMINATE, METH_VARARGS, "WIDGET_STATE_OVER_OF_INDETERMINATE"},
{"WIDGET_STATE_DISABLE_OF_INDETERMINATE", get_WIDGET_STATE_DISABLE_OF_INDETERMINATE, METH_VARARGS, "WIDGET_STATE_DISABLE_OF_INDETERMINATE"},
{"WIDGET_STATE_FOCUSED_OF_INDETERMINATE", get_WIDGET_STATE_FOCUSED_OF_INDETERMINATE, METH_VARARGS, "WIDGET_STATE_FOCUSED_OF_INDETERMINATE"},
...
{"widget_find_parent_by_name", wrap_widget_find_parent_by_name, METH_VARARGS, "widget_find_parent_by_name"},
{"widget_find_parent_by_type", wrap_widget_find_parent_by_type, METH_VARARGS, "widget_find_parent_by_type"},
{"widget_get_focused_widget", wrap_widget_get_focused_widget, METH_VARARGS, "widget_get_focused_widget"},
...
{"widget_move_to_center", wrap_widget_move_to_center, METH_VARARGS, "widget_move_to_center"},
...
{"widget_move_resize_ex", wrap_widget_move_resize_ex, METH_VARARGS, "widget_move_resize_ex"},
...
{"widget_get_value_int", wrap_widget_get_value_int, METH_VARARGS, "widget_get_value_int"},
...
{"widget_set_text_utf8_ex", wrap_widget_set_text_utf8_ex, METH_VARARGS, "widget_set_text_utf8_ex"},
...
{"widget_get_enable", wrap_widget_get_enable, METH_VARARGS, "widget_get_enable"},
{"widget_get_floating", wrap_widget_get_floating, METH_VARARGS, "widget_get_floating"},
{"widget_get_auto_adjust_size", wrap_widget_get_auto_adjust_size, METH_VARARGS, "widget_get_auto_adjust_size"},
{"widget_get_with_focus_state", wrap_widget_get_with_focus_state, METH_VARARGS, "widget_get_with_focus_state"},
{"widget_get_focusable", wrap_widget_get_focusable, METH_VARARGS, "widget_get_focusable"},
{"widget_get_sensitive", wrap_widget_get_sensitive, METH_VARARGS, "widget_get_sensitive"},
{"widget_get_visible", wrap_widget_get_visible, METH_VARARGS, "widget_get_visible"},
{"widget_get_feedback", wrap_widget_get_feedback, METH_VARARGS, "widget_get_feedback"},
...
{"widget_get_theme_name", wrap_widget_get_theme_name, METH_VARARGS, "widget_get_theme_name"},
...
{"widget_get_prop", wrap_widget_get_prop, METH_VARARGS, "widget_get_prop"},
{"widget_set_prop", wrap_widget_set_prop, METH_VARARGS, "widget_set_prop"},
...
{"widget_is_window_created", wrap_widget_is_window_created, METH_VARARGS, "widget_is_window_created"},
...
{"widget_is_fullscreen_window", wrap_widget_is_fullscreen_window, METH_VARARGS, "widget_is_fullscreen_window"},
...
{"widget_is_always_on_top", wrap_widget_is_always_on_top, METH_VARARGS, "widget_is_always_on_top"},
{"widget_is_suspend_dialog", wrap_widget_is_suspend_dialog, METH_VARARGS, "widget_is_suspend_dialog"},
{"widget_is_suspend_popup", wrap_widget_is_suspend_popup, METH_VARARGS, "widget_is_suspend_popup"},
...
{"widget_ref", wrap_widget_ref, METH_VARARGS, "widget_ref"},
...
{"widget_add_child_default", wrap_widget_add_child_default, METH_VARARGS, "widget_add_child_default"},
...
{"object_load_conf", wrap_object_load_conf, METH_VARARGS, "object_load_conf"},
{"EDIT_EX_PROP_MULTILINE", get_EDIT_EX_PROP_MULTILINE, METH_VARARGS, "EDIT_EX_PROP_MULTILINE"},
{"EDIT_EX_PROP_SUGGEST_WORDS", get_EDIT_EX_PROP_SUGGEST_WORDS, METH_VARARGS, "EDIT_EX_PROP_SUGGEST_WORDS"},
{"EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS", get_EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS, METH_VARARGS, "EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS"},
{"EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE", get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE, METH_VARARGS, "EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE"},
{"EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE", get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE, METH_VARARGS, "EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE"},
{"EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE", get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE, METH_VARARGS, "EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE"},
{"EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME", get_EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME, METH_VARARGS, "EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME"},
{"EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD", get_EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD, METH_VARARGS, "EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD"},
{"EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS", get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS, METH_VARARGS, "EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS"},
{"EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME", get_EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME, METH_VARARGS, "EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME"},
...
{"EVT_VPAGE_WILL_OPEN", get_EVT_VPAGE_WILL_OPEN, METH_VARARGS, "EVT_VPAGE_WILL_OPEN"},
{"EVT_VPAGE_OPEN", get_EVT_VPAGE_OPEN, METH_VARARGS, "EVT_VPAGE_OPEN"},
{"EVT_VPAGE_CLOSE", get_EVT_VPAGE_CLOSE, METH_VARARGS, "EVT_VPAGE_CLOSE"},
...
{"asset_info_get_type", wrap_asset_info_get_type, METH_VARARGS, "asset_info_get_type"},
{"asset_info_get_name", wrap_asset_info_get_name, METH_VARARGS, "asset_info_get_name"},
{"asset_info_is_in_rom", wrap_asset_info_is_in_rom, METH_VARARGS, "asset_info_is_in_rom"},
{"asset_info_set_is_in_rom", wrap_asset_info_set_is_in_rom, METH_VARARGS, "asset_info_set_is_in_rom"},
...
{"asset_info_t_get_prop_flags", wrap_asset_info_t_get_prop_flags, METH_VARARGS, "asset_info_t_get_prop_flags"},
...
{"color_get_color", wrap_color_get_color, METH_VARARGS, "color_get_color"},
...
{"OBJECT_CMD_EXEC", get_OBJECT_CMD_EXEC, METH_VARARGS, "OBJECT_CMD_EXEC"},
{"OBJECT_CMD_UNDO", get_OBJECT_CMD_UNDO, METH_VARARGS, "OBJECT_CMD_UNDO"},
{"OBJECT_PROP_SIZE", get_OBJECT_PROP_SIZE, METH_VARARGS, "OBJECT_PROP_SIZE"},
{"OBJECT_PROP_DISABLE_PATH", get_OBJECT_PROP_DISABLE_PATH, METH_VARARGS, "OBJECT_PROP_DISABLE_PATH"},
{"OBJECT_PROP_KEEP_PROPS_ORDER", get_OBJECT_PROP_KEEP_PROPS_ORDER, METH_VARARGS, "OBJECT_PROP_KEEP_PROPS_ORDER"},
...
{"RET_NO_PERMISSION", get_RET_NO_PERMISSION, METH_VARARGS, "RET_NO_PERMISSION"},
{"RET_INVALID_ADDR", get_RET_INVALID_ADDR, METH_VARARGS, "RET_INVALID_ADDR"},
{"RET_EXCEED_RANGE", get_RET_EXCEED_RANGE, METH_VARARGS, "RET_EXCEED_RANGE"},
{"RET_MAX_NR", get_RET_MAX_NR, METH_VARARGS, "RET_MAX_NR"},
...
{"VALUE_TYPE_ID", get_VALUE_TYPE_ID, METH_VARARGS, "VALUE_TYPE_ID"},
{"VALUE_TYPE_FUNC", get_VALUE_TYPE_FUNC, METH_VARARGS, "VALUE_TYPE_FUNC"},
{"VALUE_TYPE_FUNC_DEF", get_VALUE_TYPE_FUNC_DEF, METH_VARARGS, "VALUE_TYPE_FUNC_DEF"},
{"VALUE_TYPE_POINTER_REF", get_VALUE_TYPE_POINTER_REF, METH_VARARGS, "VALUE_TYPE_POINTER_REF"},
{"VALUE_TYPE_BITMAP", get_VALUE_TYPE_BITMAP, METH_VARARGS, "VALUE_TYPE_BITMAP"},
{"VALUE_TYPE_RECT", get_VALUE_TYPE_RECT, METH_VARARGS, "VALUE_TYPE_RECT"},
...
{"widget_animator_event_cast", wrap_widget_animator_event_cast, METH_VARARGS, "widget_animator_event_cast"},
{"widget_animator_event_t_get_prop_widget", wrap_widget_animator_event_t_get_prop_widget, METH_VARARGS, "widget_animator_event_t_get_prop_widget"},
{"widget_animator_event_t_get_prop_animator", wrap_widget_animator_event_t_get_prop_animator, METH_VARARGS, "widget_animator_event_t_get_prop_animator"},
{"model_event_cast", wrap_model_event_cast, METH_VARARGS, "model_event_cast"},
{"model_event_t_get_prop_name", wrap_model_event_t_get_prop_name, METH_VARARGS, "model_event_t_get_prop_name"},
{"model_event_t_get_prop_change_type", wrap_model_event_t_get_prop_change_type, METH_VARARGS, "model_event_t_get_prop_change_type"},
{"model_event_t_get_prop_model", wrap_model_event_t_get_prop_model, METH_VARARGS, "model_event_t_get_prop_model"},
{"wheel_event_cast", wrap_wheel_event_cast, METH_VARARGS, "wheel_event_cast"},
{"wheel_event_t_get_prop_x", wrap_wheel_event_t_get_prop_x, METH_VARARGS, "wheel_event_t_get_prop_x"},
{"wheel_event_t_get_prop_y", wrap_wheel_event_t_get_prop_y, METH_VARARGS, "wheel_event_t_get_prop_y"},
...
{"offset_change_event_cast", wrap_offset_change_event_cast, METH_VARARGS, "offset_change_event_cast"},
...
{"key_event_t_get_prop_numlock", wrap_key_event_t_get_prop_numlock, METH_VARARGS, "key_event_t_get_prop_numlock"},
...
{"theme_change_event_cast", wrap_theme_change_event_cast, METH_VARARGS, "theme_change_event_cast"},
{"theme_change_event_t_get_prop_name", wrap_theme_change_event_t_get_prop_name, METH_VARARGS, "theme_change_event_t_get_prop_name"},
{"drop_file_event_cast", wrap_drop_file_event_cast, METH_VARARGS, "drop_file_event_cast"},
...
{"window_manager_get_foreground_window", wrap_window_manager_get_foreground_window, METH_VARARGS, "window_manager_get_foreground_window"},
...
{"window_manager_set_show_fps_position", wrap_window_manager_set_show_fps_position, METH_VARARGS, "window_manager_set_show_fps_position"},
...
{"window_manager_set_fullscreen", wrap_window_manager_set_fullscreen, METH_VARARGS, "window_manager_set_fullscreen"},
...
{"color_component_create", wrap_color_component_create, METH_VARARGS, "color_component_create"},
...
{"draggable_set_allow_out_of_screen", wrap_draggable_set_allow_out_of_screen, METH_VARARGS, "draggable_set_allow_out_of_screen"},
{"draggable_set_drag_window", wrap_draggable_set_drag_window, METH_VARARGS, "draggable_set_drag_window"},
{"draggable_set_drag_native_window", wrap_draggable_set_drag_native_window, METH_VARARGS, "draggable_set_drag_native_window"},
{"draggable_set_drag_parent", wrap_draggable_set_drag_parent, METH_VARARGS, "draggable_set_drag_parent"},
...
{"draggable_t_get_prop_allow_out_of_screen", wrap_draggable_t_get_prop_allow_out_of_screen, METH_VARARGS, "draggable_t_get_prop_allow_out_of_screen"},
...
{"draggable_t_get_prop_drag_native_window", wrap_draggable_t_get_prop_drag_native_window, METH_VARARGS, "draggable_t_get_prop_drag_native_window"},
{"draggable_t_get_prop_drag_parent", wrap_draggable_t_get_prop_drag_parent, METH_VARARGS, "draggable_t_get_prop_drag_parent"},
...
{"file_browser_view_set_top_dir", wrap_file_browser_view_set_top_dir, METH_VARARGS, "file_browser_view_set_top_dir"},
...
{"file_browser_view_set_odd_item_style", wrap_file_browser_view_set_odd_item_style, METH_VARARGS, "file_browser_view_set_odd_item_style"},
{"file_browser_view_set_even_item_style", wrap_file_browser_view_set_even_item_style, METH_VARARGS, "file_browser_view_set_even_item_style"},
...
{"file_browser_view_t_get_prop_top_dir", wrap_file_browser_view_t_get_prop_top_dir, METH_VARARGS, "file_browser_view_t_get_prop_top_dir"},
...
{"file_browser_view_t_get_prop_odd_item_style", wrap_file_browser_view_t_get_prop_odd_item_style, METH_VARARGS, "file_browser_view_t_get_prop_odd_item_style"},
{"file_browser_view_t_get_prop_even_item_style", wrap_file_browser_view_t_get_prop_even_item_style, METH_VARARGS, "file_browser_view_t_get_prop_even_item_style"},
...
{"file_chooser_set_top_dir", wrap_file_chooser_set_top_dir, METH_VARARGS, "file_chooser_set_top_dir"},
...
{"candidates_create", wrap_candidates_create, METH_VARARGS, "candidates_create"},
...
{"line_number_add_highlight_line", wrap_line_number_add_highlight_line, METH_VARARGS, "line_number_add_highlight_line"},
{"line_number_set_active_line", wrap_line_number_set_active_line, METH_VARARGS, "line_number_set_active_line"},
{"line_number_clear_highlight", wrap_line_number_clear_highlight, METH_VARARGS, "line_number_clear_highlight"},
{"line_number_is_highlight_line", wrap_line_number_is_highlight_line, METH_VARARGS, "line_number_is_highlight_line"},
...
{"mledit_get_current_line_index", wrap_mledit_get_current_line_index, METH_VARARGS, "mledit_get_current_line_index"},
{"mledit_get_current_row_index", wrap_mledit_get_current_row_index, METH_VARARGS, "mledit_get_current_row_index"},
{"mledit_get_start_line_index", wrap_mledit_get_start_line_index, METH_VARARGS, "mledit_get_start_line_index"},
{"mledit_get_start_row_index", wrap_mledit_get_start_row_index, METH_VARARGS, "mledit_get_start_row_index"},
{"mledit_get_line_at", wrap_mledit_get_line_at, METH_VARARGS, "mledit_get_line_at"},
{"mledit_get_row_at", wrap_mledit_get_row_at, METH_VARARGS, "mledit_get_row_at"},
{"mledit_get_row_of_line", wrap_mledit_get_row_of_line, METH_VARARGS, "mledit_get_row_of_line"},
...
{"mledit_t_get_prop_auto_adjust_height", wrap_mledit_t_get_prop_auto_adjust_height, METH_VARARGS, "mledit_t_get_prop_auto_adjust_height"},
...
{"rich_text_set_word_wrap", wrap_rich_text_set_word_wrap, METH_VARARGS, "rich_text_set_word_wrap"},
...
{"rich_text_t_get_prop_word_wrap", wrap_rich_text_t_get_prop_word_wrap, METH_VARARGS, "rich_text_t_get_prop_word_wrap"},
...
{"hscroll_label_set_speed", wrap_hscroll_label_set_speed, METH_VARARGS, "hscroll_label_set_speed"},
...
{"hscroll_label_set_stop_at_begin", wrap_hscroll_label_set_stop_at_begin, METH_VARARGS, "hscroll_label_set_stop_at_begin"},
{"hscroll_label_set_delay", wrap_hscroll_label_set_delay, METH_VARARGS, "hscroll_label_set_delay"},
{"hscroll_label_set_loop_interval_distance", wrap_hscroll_label_set_loop_interval_distance, METH_VARARGS, "hscroll_label_set_loop_interval_distance"},
...
{"hscroll_label_t_get_prop_delay", wrap_hscroll_label_t_get_prop_delay, METH_VARARGS, "hscroll_label_t_get_prop_delay"},
{"hscroll_label_t_get_prop_speed", wrap_hscroll_label_t_get_prop_speed, METH_VARARGS, "hscroll_label_t_get_prop_speed"},
...
{"hscroll_label_t_get_prop_stop_at_begin", wrap_hscroll_label_t_get_prop_stop_at_begin, METH_VARARGS, "hscroll_label_t_get_prop_stop_at_begin"},
{"hscroll_label_t_get_prop_loop_interval_distance", wrap_hscroll_label_t_get_prop_loop_interval_distance, METH_VARARGS, "hscroll_label_t_get_prop_loop_interval_distance"},
...
{"scroll_bar_set_auto_hide", wrap_scroll_bar_set_auto_hide, METH_VARARGS, "scroll_bar_set_auto_hide"},
{"scroll_bar_is_mobile", wrap_scroll_bar_is_mobile, METH_VARARGS, "scroll_bar_is_mobile"},
{"scroll_bar_set_animator_time", wrap_scroll_bar_set_animator_time, METH_VARARGS, "scroll_bar_set_animator_time"},
{"scroll_bar_hide_by_opacity_animation", wrap_scroll_bar_hide_by_opacity_animation, METH_VARARGS, "scroll_bar_hide_by_opacity_animation"},
{"scroll_bar_show_by_opacity_animation", wrap_scroll_bar_show_by_opacity_animation, METH_VARARGS, "scroll_bar_show_by_opacity_animation"},
{"scroll_bar_set_wheel_scroll", wrap_scroll_bar_set_wheel_scroll, METH_VARARGS, "scroll_bar_set_wheel_scroll"},
{"scroll_bar_set_scroll_delta", wrap_scroll_bar_set_scroll_delta, METH_VARARGS, "scroll_bar_set_scroll_delta"},
{"scroll_bar_set_scroll_rows", wrap_scroll_bar_set_scroll_rows, METH_VARARGS, "scroll_bar_set_scroll_rows"},
...
{"scroll_bar_t_get_prop_animator_time", wrap_scroll_bar_t_get_prop_animator_time, METH_VARARGS, "scroll_bar_t_get_prop_animator_time"},
{"scroll_bar_t_get_prop_scroll_delta", wrap_scroll_bar_t_get_prop_scroll_delta, METH_VARARGS, "scroll_bar_t_get_prop_scroll_delta"},
{"scroll_bar_t_get_prop_scroll_rows", wrap_scroll_bar_t_get_prop_scroll_rows, METH_VARARGS, "scroll_bar_t_get_prop_scroll_rows"},
{"scroll_bar_t_get_prop_animatable", wrap_scroll_bar_t_get_prop_animatable, METH_VARARGS, "scroll_bar_t_get_prop_animatable"},
{"scroll_bar_t_get_prop_auto_hide", wrap_scroll_bar_t_get_prop_auto_hide, METH_VARARGS, "scroll_bar_t_get_prop_auto_hide"},
{"scroll_bar_t_get_prop_wheel_scroll", wrap_scroll_bar_t_get_prop_wheel_scroll, METH_VARARGS, "scroll_bar_t_get_prop_wheel_scroll"},
{"scroll_bar_t_get_prop_wheel_modifier_key", wrap_scroll_bar_t_get_prop_wheel_modifier_key, METH_VARARGS, "scroll_bar_t_get_prop_wheel_modifier_key"},
...
{"scroll_view_set_slide_limit_ratio", wrap_scroll_view_set_slide_limit_ratio, METH_VARARGS, "scroll_view_set_slide_limit_ratio"},
...
{"scroll_view_t_get_prop_use_virtual_w", wrap_scroll_view_t_get_prop_use_virtual_w, METH_VARARGS, "scroll_view_t_get_prop_use_virtual_w"},
{"scroll_view_t_get_prop_use_widget_w", wrap_scroll_view_t_get_prop_use_widget_w, METH_VARARGS, "scroll_view_t_get_prop_use_widget_w"},
{"scroll_view_t_get_prop_use_virtual_h", wrap_scroll_view_t_get_prop_use_virtual_h, METH_VARARGS, "scroll_view_t_get_prop_use_virtual_h"},
{"scroll_view_t_get_prop_use_widget_h", wrap_scroll_view_t_get_prop_use_widget_h, METH_VARARGS, "scroll_view_t_get_prop_use_widget_h"},
...
{"scroll_view_t_get_prop_slide_limit_ratio", wrap_scroll_view_t_get_prop_slide_limit_ratio, METH_VARARGS, "scroll_view_t_get_prop_slide_limit_ratio"},
{"serial_widget_create", wrap_serial_widget_create, METH_VARARGS, "serial_widget_create"},
{"serial_widget_cast", wrap_serial_widget_cast, METH_VARARGS, "serial_widget_cast"},
{"serial_widget_set_baudrate", wrap_serial_widget_set_baudrate, METH_VARARGS, "serial_widget_set_baudrate"},
{"serial_widget_set_device", wrap_serial_widget_set_device, METH_VARARGS, "serial_widget_set_device"},
{"serial_widget_set_bytesize", wrap_serial_widget_set_bytesize, METH_VARARGS, "serial_widget_set_bytesize"},
{"serial_widget_set_parity", wrap_serial_widget_set_parity, METH_VARARGS, "serial_widget_set_parity"},
{"serial_widget_set_stopbits", wrap_serial_widget_set_stopbits, METH_VARARGS, "serial_widget_set_stopbits"},
{"serial_widget_set_flowcontrol", wrap_serial_widget_set_flowcontrol, METH_VARARGS, "serial_widget_set_flowcontrol"},
{"serial_widget_set_check_interval", wrap_serial_widget_set_check_interval, METH_VARARGS, "serial_widget_set_check_interval"},
{"serial_widget_t_get_prop_device", wrap_serial_widget_t_get_prop_device, METH_VARARGS, "serial_widget_t_get_prop_device"},
{"serial_widget_t_get_prop_baudrate", wrap_serial_widget_t_get_prop_baudrate, METH_VARARGS, "serial_widget_t_get_prop_baudrate"},
{"serial_widget_t_get_prop_bytesize", wrap_serial_widget_t_get_prop_bytesize, METH_VARARGS, "serial_widget_t_get_prop_bytesize"},
...
{"slide_menu_set_spacer", wrap_slide_menu_set_spacer, METH_VARARGS, "slide_menu_set_spacer"},
{"slide_menu_set_menu_w", wrap_slide_menu_set_menu_w, METH_VARARGS, "slide_menu_set_menu_w"},
{"slide_menu_set_clip", wrap_slide_menu_set_clip, METH_VARARGS, "slide_menu_set_clip"},
{"slide_menu_scroll_to_prev", wrap_slide_menu_scroll_to_prev, METH_VARARGS, "slide_menu_scroll_to_prev"},
{"slide_menu_scroll_to_next", wrap_slide_menu_scroll_to_next, METH_VARARGS, "slide_menu_scroll_to_next"},
...
{"slide_menu_t_get_prop_spacer", wrap_slide_menu_t_get_prop_spacer, METH_VARARGS, "slide_menu_t_get_prop_spacer"},
{"slide_menu_t_get_prop_menu_w", wrap_slide_menu_t_get_prop_menu_w, METH_VARARGS, "slide_menu_t_get_prop_menu_w"},
{"slide_menu_t_get_prop_clip", wrap_slide_menu_t_get_prop_clip, METH_VARARGS, "slide_menu_t_get_prop_clip"},
...
{"slide_indicator_set_transition", wrap_slide_indicator_set_transition, METH_VARARGS, "slide_indicator_set_transition"},
...
{"slide_indicator_t_get_prop_transition", wrap_slide_indicator_t_get_prop_transition, METH_VARARGS, "slide_indicator_t_get_prop_transition"},
...
{"slide_view_set_drag_threshold", wrap_slide_view_set_drag_threshold, METH_VARARGS, "slide_view_set_drag_threshold"},
{"slide_view_set_animating_time", wrap_slide_view_set_animating_time, METH_VARARGS, "slide_view_set_animating_time"},
...
{"text_selector_set_enable_value_animator", wrap_text_selector_set_enable_value_animator, METH_VARARGS, "text_selector_set_enable_value_animator"},
{"text_selector_set_mask_easing", wrap_text_selector_set_mask_easing, METH_VARARGS, "text_selector_set_mask_easing"},
{"text_selector_set_mask_area_scale", wrap_text_selector_set_mask_area_scale, METH_VARARGS, "text_selector_set_mask_area_scale"},
{"text_selector_set_ellipses", wrap_text_selector_set_ellipses, METH_VARARGS, "text_selector_set_ellipses"},
...
{"text_selector_t_get_prop_enable_value_animator", wrap_text_selector_t_get_prop_enable_value_animator, METH_VARARGS, "text_selector_t_get_prop_enable_value_animator"},
{"text_selector_t_get_prop_ellipses", wrap_text_selector_t_get_prop_ellipses, METH_VARARGS, "text_selector_t_get_prop_ellipses"},
{"text_selector_t_get_prop_mask_easing", wrap_text_selector_t_get_prop_mask_easing, METH_VARARGS, "text_selector_t_get_prop_mask_easing"},
{"text_selector_t_get_prop_mask_area_scale", wrap_text_selector_t_get_prop_mask_area_scale, METH_VARARGS, "text_selector_t_get_prop_mask_area_scale"},
...
{"timer_widget_create", wrap_timer_widget_create, METH_VARARGS, "timer_widget_create"},
{"timer_widget_cast", wrap_timer_widget_cast, METH_VARARGS, "timer_widget_cast"},
{"timer_widget_set_duration", wrap_timer_widget_set_duration, METH_VARARGS, "timer_widget_set_duration"},
{"timer_widget_t_get_prop_duration", wrap_timer_widget_t_get_prop_duration, METH_VARARGS, "timer_widget_t_get_prop_duration"},
{"vpage_create", wrap_vpage_create, METH_VARARGS, "vpage_create"},
{"vpage_cast", wrap_vpage_cast, METH_VARARGS, "vpage_cast"},
{"vpage_set_ui_asset", wrap_vpage_set_ui_asset, METH_VARARGS, "vpage_set_ui_asset"},
{"vpage_set_anim_hint", wrap_vpage_set_anim_hint, METH_VARARGS, "vpage_set_anim_hint"},
{"vpage_t_get_prop_ui_asset", wrap_vpage_t_get_prop_ui_asset, METH_VARARGS, "vpage_t_get_prop_ui_asset"},
{"vpage_t_get_prop_anim_hint", wrap_vpage_t_get_prop_anim_hint, METH_VARARGS, "vpage_t_get_prop_anim_hint"},
...
{"object_fifo_set_event_t_get_prop_index", wrap_object_fifo_set_event_t_get_prop_index, METH_VARARGS, "object_fifo_set_event_t_get_prop_index"},
{"object_fifo_set_event_t_get_prop_nr", wrap_object_fifo_set_event_t_get_prop_nr, METH_VARARGS, "object_fifo_set_event_t_get_prop_nr"},
{"object_fifo_set_event_t_get_prop_data", wrap_object_fifo_set_event_t_get_prop_data, METH_VARARGS, "object_fifo_set_event_t_get_prop_data"},
{"object_fifo_push_event_t_get_prop_nr", wrap_object_fifo_push_event_t_get_prop_nr, METH_VARARGS, "object_fifo_push_event_t_get_prop_nr"},
{"object_fifo_push_event_t_get_prop_data", wrap_object_fifo_push_event_t_get_prop_data, METH_VARARGS, "object_fifo_push_event_t_get_prop_data"},
{"object_fifo_push_head_event_t_get_prop_nr", wrap_object_fifo_push_head_event_t_get_prop_nr, METH_VARARGS, "object_fifo_push_head_event_t_get_prop_nr"},
{"object_fifo_push_head_event_t_get_prop_data", wrap_object_fifo_push_head_event_t_get_prop_data, METH_VARARGS, "object_fifo_push_head_event_t_get_prop_data"},
{"object_fifo_pop_event_t_get_prop_nr", wrap_object_fifo_pop_event_t_get_prop_nr, METH_VARARGS, "object_fifo_pop_event_t_get_prop_nr"},
{"object_fifo_pop_tail_event_t_get_prop_nr", wrap_object_fifo_pop_tail_event_t_get_prop_nr, METH_VARARGS, "object_fifo_pop_tail_event_t_get_prop_nr"},
{"object_fifo_set_event_cast", wrap_object_fifo_set_event_cast, METH_VARARGS, "object_fifo_set_event_cast"},
{"object_fifo_push_event_cast", wrap_object_fifo_push_event_cast, METH_VARARGS, "object_fifo_push_event_cast"},
{"object_fifo_push_head_event_cast", wrap_object_fifo_push_head_event_cast, METH_VARARGS, "object_fifo_push_head_event_cast"},
{"object_fifo_pop_event_cast", wrap_object_fifo_pop_event_cast, METH_VARARGS, "object_fifo_pop_event_cast"},
{"object_fifo_pop_tail_event_cast", wrap_object_fifo_pop_tail_event_cast, METH_VARARGS, "object_fifo_pop_tail_event_cast"},
{"object_fifo_value_change_event_cast", wrap_object_fifo_value_change_event_cast, METH_VARARGS, "object_fifo_value_change_event_cast"},
{"object_fifo_value_change_event_t_get_prop_type", wrap_object_fifo_value_change_event_t_get_prop_type, METH_VARARGS, "object_fifo_value_change_event_t_get_prop_type"},
...
{"button_set_enable_preview", wrap_button_set_enable_preview, METH_VARARGS, "button_set_enable_preview"},
...
{"check_button_set_indeterminate", wrap_check_button_set_indeterminate, METH_VARARGS, "check_button_set_indeterminate"},
{"check_button_get_indeterminate", wrap_check_button_get_indeterminate, METH_VARARGS, "check_button_get_indeterminate"},
{"check_button_cast", wrap_check_button_cast, METH_VARARGS, "check_button_cast"},
{"check_button_create_ex", wrap_check_button_create_ex, METH_VARARGS, "check_button_create_ex"},
...
{"color_tile_get_bg_color", wrap_color_tile_get_bg_color, METH_VARARGS, "color_tile_get_bg_color"},
{"color_tile_get_border_color", wrap_color_tile_get_border_color, METH_VARARGS, "color_tile_get_border_color"},
...
{"edit_get_int64", wrap_edit_get_int64, METH_VARARGS, "edit_get_int64"},
...
{"edit_set_double_ex", wrap_edit_set_double_ex, METH_VARARGS, "edit_set_double_ex"},
...
{"edit_get_cursor", wrap_edit_get_cursor, METH_VARARGS, "edit_get_cursor"},
...
{"edit_t_get_prop_validator", wrap_edit_t_get_prop_validator, METH_VARARGS, "edit_t_get_prop_validator"},
...
{"grid_set_rows", wrap_grid_set_rows, METH_VARARGS, "grid_set_rows"},
{"grid_set_columns_definition", wrap_grid_set_columns_definition, METH_VARARGS, "grid_set_columns_definition"},
{"grid_set_show_grid", wrap_grid_set_show_grid, METH_VARARGS, "grid_set_show_grid"},
{"grid_t_get_prop_rows", wrap_grid_t_get_prop_rows, METH_VARARGS, "grid_t_get_prop_rows"},
{"grid_t_get_prop_columns_definition", wrap_grid_t_get_prop_columns_definition, METH_VARARGS, "grid_t_get_prop_columns_definition"},
{"grid_t_get_prop_show_grid", wrap_grid_t_get_prop_show_grid, METH_VARARGS, "grid_t_get_prop_show_grid"},
{"group_box_create", wrap_group_box_create, METH_VARARGS, "group_box_create"},
{"group_box_set_value", wrap_group_box_set_value, METH_VARARGS, "group_box_set_value"},
{"group_box_cast", wrap_group_box_cast, METH_VARARGS, "group_box_cast"},
{"group_box_t_get_prop_value", wrap_group_box_t_get_prop_value, METH_VARARGS, "group_box_t_get_prop_value"},
...
{"label_set_max_w", wrap_label_set_max_w, METH_VARARGS, "label_set_max_w"},
...
{"label_set_ellipses", wrap_label_set_ellipses, METH_VARARGS, "label_set_ellipses"},
...
{"label_t_get_prop_ellipses", wrap_label_t_get_prop_ellipses, METH_VARARGS, "label_t_get_prop_ellipses"},
{"label_t_get_prop_max_w", wrap_label_t_get_prop_max_w, METH_VARARGS, "label_t_get_prop_max_w"},
...
{"pages_set_auto_focused", wrap_pages_set_auto_focused, METH_VARARGS, "pages_set_auto_focused"},
...
{"pages_t_get_prop_auto_focused", wrap_pages_t_get_prop_auto_focused, METH_VARARGS, "pages_t_get_prop_auto_focused"},
...
{"slider_set_line_cap", wrap_slider_set_line_cap, METH_VARARGS, "slider_set_line_cap"},
...
{"slider_set_drag_threshold", wrap_slider_set_drag_threshold, METH_VARARGS, "slider_set_drag_threshold"},
...
{"slider_t_get_prop_drag_threshold", wrap_slider_t_get_prop_drag_threshold, METH_VARARGS, "slider_t_get_prop_drag_threshold"},
...
{"tab_button_group_t_get_prop_drag_child", wrap_tab_button_group_t_get_prop_drag_child, METH_VARARGS, "tab_button_group_t_get_prop_drag_child"},
...
{"tab_button_set_max_w", wrap_tab_button_set_max_w, METH_VARARGS, "tab_button_set_max_w"},
{"tab_button_restack", wrap_tab_button_restack, METH_VARARGS, "tab_button_restack"},
...
{"tab_button_t_get_prop_max_w", wrap_tab_button_t_get_prop_max_w, METH_VARARGS, "tab_button_t_get_prop_max_w"},
...
{"edit_ex_set_multiline", wrap_edit_ex_set_multiline, METH_VARARGS, "edit_ex_set_multiline"},
...
{"edit_ex_update_suggest_words_popup", wrap_edit_ex_update_suggest_words_popup, METH_VARARGS, "edit_ex_update_suggest_words_popup"},
...
{"edit_ex_t_get_prop_is_select_suggest_word", wrap_edit_ex_t_get_prop_is_select_suggest_word, METH_VARARGS, "edit_ex_t_get_prop_is_select_suggest_word"},
{"edit_ex_t_get_prop_multiline", wrap_edit_ex_t_get_prop_multiline, METH_VARARGS, "edit_ex_t_get_prop_multiline"},
...
{"gif_image_pause", wrap_gif_image_pause, METH_VARARGS, "gif_image_pause"},
{"gif_image_set_loop", wrap_gif_image_set_loop, METH_VARARGS, "gif_image_set_loop"},
{"gif_image_set_part_buffer_load_mode", wrap_gif_image_set_part_buffer_load_mode, METH_VARARGS, "gif_image_set_part_buffer_load_mode"},
{"gif_image_cast", wrap_gif_image_cast, METH_VARARGS, "gif_image_cast"},
{"gif_image_t_get_prop_loop", wrap_gif_image_t_get_prop_loop, METH_VARARGS, "gif_image_t_get_prop_loop"},
{"gif_image_t_get_prop_part_buffer_load_mode", wrap_gif_image_t_get_prop_part_buffer_load_mode, METH_VARARGS, "gif_image_t_get_prop_part_buffer_load_mode"},
...
{"mutable_image_create", wrap_mutable_image_create, METH_VARARGS, "mutable_image_create"},
{"list_item_seperator_create", wrap_list_item_seperator_create, METH_VARARGS, "list_item_seperator_create"},
{"list_item_seperator_cast", wrap_list_item_seperator_cast, METH_VARARGS, "list_item_seperator_cast"},
...
{"svg_image_set_cache_mode", wrap_svg_image_set_cache_mode, METH_VARARGS, "svg_image_set_cache_mode"},
{"svg_image_set_draw_type", wrap_svg_image_set_draw_type, METH_VARARGS, "svg_image_set_draw_type"},
{"svg_image_cast", wrap_svg_image_cast, METH_VARARGS, "svg_image_cast"},
{"svg_image_t_get_prop_is_cache_mode", wrap_svg_image_t_get_prop_is_cache_mode, METH_VARARGS, "svg_image_t_get_prop_is_cache_mode"},
{"svg_image_t_get_prop_draw_type", wrap_svg_image_t_get_prop_draw_type, METH_VARARGS, "svg_image_t_get_prop_draw_type"},
...
{"object_array_remove_value", wrap_object_array_remove_value, METH_VARARGS, "object_array_remove_value"},
...
{"object_hash_set_name_case_insensitive", wrap_object_hash_set_name_case_insensitive, METH_VARARGS, "object_hash_set_name_case_insensitive"},
...
{"calibration_win_create", wrap_calibration_win_create, METH_VARARGS, "calibration_win_create"},
...
{"combo_box_set_theme_of_popup", wrap_combo_box_set_theme_of_popup, METH_VARARGS, "combo_box_set_theme_of_popup"},
...
{"combo_box_set_selected_index_by_text", wrap_combo_box_set_selected_index_by_text, METH_VARARGS, "combo_box_set_selected_index_by_text"},
...
{"combo_box_remove_option_by_index", wrap_combo_box_remove_option_by_index, METH_VARARGS, "combo_box_remove_option_by_index"},
...
{"combo_box_has_option_text", wrap_combo_box_has_option_text, METH_VARARGS, "combo_box_has_option_text"},
{"combo_box_get_text", wrap_combo_box_get_text, METH_VARARGS, "combo_box_get_text"},
{"combo_box_get_text_of_selected", wrap_combo_box_get_text_of_selected, METH_VARARGS, "combo_box_get_text_of_selected"},
{"combo_box_t_get_prop_open_window", wrap_combo_box_t_get_prop_open_window, METH_VARARGS, "combo_box_t_get_prop_open_window"},
{"combo_box_t_get_prop_theme_of_popup", wrap_combo_box_t_get_prop_theme_of_popup, METH_VARARGS, "combo_box_t_get_prop_theme_of_popup"},
...
{"icon_create", wrap_icon_create, METH_VARARGS, "icon_create"},
...
{"overlay_set_modeless", wrap_overlay_set_modeless, METH_VARARGS, "overlay_set_modeless"},
...
{"overlay_t_get_prop_modeless", wrap_overlay_t_get_prop_modeless, METH_VARARGS, "overlay_t_get_prop_modeless"},
...
{"spin_box_set_easy_touch_mode", wrap_spin_box_set_easy_touch_mode, METH_VARARGS, "spin_box_set_easy_touch_mode"},
{"spin_box_set_button_position", wrap_spin_box_set_button_position, METH_VARARGS, "spin_box_set_button_position"},
{"spin_set_repeat", wrap_spin_set_repeat, METH_VARARGS, "spin_set_repeat"},
{"spin_box_t_get_prop_easy_touch_mode", wrap_spin_box_t_get_prop_easy_touch_mode, METH_VARARGS, "spin_box_t_get_prop_easy_touch_mode"},
{"spin_box_t_get_prop_button_position", wrap_spin_box_t_get_prop_button_position, METH_VARARGS, "spin_box_t_get_prop_button_position"},
