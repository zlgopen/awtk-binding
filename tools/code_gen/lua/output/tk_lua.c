...
static int wrap_widget_animator_event_t_get_prop(lua_State* L);
static int wrap_widget_animator_event_t_set_prop(lua_State* L);
static int wrap_model_event_t_get_prop(lua_State* L);
static int wrap_model_event_t_set_prop(lua_State* L);
...
static int wrap_offset_change_event_t_get_prop(lua_State* L);
static int wrap_offset_change_event_t_set_prop(lua_State* L);
...
static int wrap_theme_change_event_t_get_prop(lua_State* L);
static int wrap_theme_change_event_t_set_prop(lua_State* L);
static int wrap_drop_file_event_t_get_prop(lua_State* L);
static int wrap_drop_file_event_t_set_prop(lua_State* L);
static int wrap_system_event_t_get_prop(lua_State* L);
static int wrap_system_event_t_set_prop(lua_State* L);
static int wrap_touch_event_t_get_prop(lua_State* L);
static int wrap_touch_event_t_set_prop(lua_State* L);
static int wrap_ui_load_event_t_get_prop(lua_State* L);
static int wrap_ui_load_event_t_set_prop(lua_State* L);
...
static int wrap_locale_info_xml_t_get_prop(lua_State* L);
static int wrap_locale_info_xml_t_set_prop(lua_State* L);
...
static int wrap_gauge_pointer_t_get_prop(lua_State* L);
static int wrap_gauge_pointer_t_set_prop(lua_State* L);
static int wrap_gauge_t_get_prop(lua_State* L);
static int wrap_gauge_t_set_prop(lua_State* L);
...
static int wrap_serial_widget_t_get_prop(lua_State* L);
static int wrap_serial_widget_t_set_prop(lua_State* L);
...
static int wrap_timer_widget_t_get_prop(lua_State* L);
static int wrap_timer_widget_t_set_prop(lua_State* L);
static int wrap_vpage_t_get_prop(lua_State* L);
static int wrap_vpage_t_set_prop(lua_State* L);
...
static int wrap_log_message_event_t_get_prop(lua_State* L);
static int wrap_log_message_event_t_set_prop(lua_State* L);
static int wrap_named_value_t_get_prop(lua_State* L);
static int wrap_named_value_t_set_prop(lua_State* L);
static int wrap_object_fifo_set_event_t_get_prop(lua_State* L);
static int wrap_object_fifo_set_event_t_set_prop(lua_State* L);
static int wrap_object_fifo_push_event_t_get_prop(lua_State* L);
static int wrap_object_fifo_push_event_t_set_prop(lua_State* L);
static int wrap_object_fifo_push_head_event_t_get_prop(lua_State* L);
static int wrap_object_fifo_push_head_event_t_set_prop(lua_State* L);
static int wrap_object_fifo_pop_event_t_get_prop(lua_State* L);
static int wrap_object_fifo_pop_event_t_set_prop(lua_State* L);
static int wrap_object_fifo_pop_tail_event_t_get_prop(lua_State* L);
static int wrap_object_fifo_pop_tail_event_t_set_prop(lua_State* L);
static int wrap_object_fifo_value_change_event_t_get_prop(lua_State* L);
static int wrap_object_fifo_value_change_event_t_set_prop(lua_State* L);
...
static int wrap_edit_ex_t_get_prop(lua_State* L);
static int wrap_edit_ex_t_set_prop(lua_State* L);
...
static int wrap_list_item_seperator_t_get_prop(lua_State* L);
static int wrap_list_item_seperator_t_set_prop(lua_State* L);
...
static int wrap_named_value_hash_t_get_prop(lua_State* L);
static int wrap_named_value_hash_t_set_prop(lua_State* L);
...
static int wrap_object_hash_t_get_prop(lua_State* L);
static int wrap_object_hash_t_set_prop(lua_State* L);
...
static const struct luaL_Reg bitmap_t_member_funcs[] = {
  ...
  {"destroy", wrap_bitmap_destroy_with_self},
  {NULL, NULL}
};
...
static int wrap_tk_object_get_type(lua_State* L) {
  const char* ret = NULL;
  const tk_object_t* obj = (const tk_object_t*)tk_checkudata(L, 1, "const tk_object_t");
...
static int wrap_tk_object_compare(lua_State* L) {
  ...
  ret = (int32_t)tk_object_compare(obj, other);
...
static int wrap_tk_object_clear_props(lua_State* L) {
  ret_t ret = 0;
  tk_object_t* obj = (tk_object_t*)tk_checkudata(L, 1, "tk_object_t");
  ret = (ret_t)tk_object_clear_props(obj);
...
static const struct luaL_Reg tk_object_t_member_funcs[] = {
  ...
  {"clear_props", wrap_tk_object_clear_props},
  {NULL, NULL}
};
...
static int wrap_tk_object_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "ref_count") == 0) {
...
static int wrap_value_is_null(lua_State* L) {
  bool_t ret = 0;
  const value_t* value = (const value_t*)tk_checkudata(L, 1, "const value_t");
...
static int wrap_tk_pre_init(lua_State* L) {
  ret_t ret = 0;
...
static int wrap_tk_quit_ex(lua_State* L) {
  ret_t ret = 0;
  uint32_t delay = (uint32_t)luaL_checkinteger(L, 1);
...
static void global_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"pre_init", wrap_tk_pre_init},
    {"init", wrap_tk_init},
    {"run", wrap_tk_run},
    {"quit", wrap_tk_quit},
    {"quit_ex", wrap_tk_quit_ex},
...
static void image_draw_type_t_init(lua_State* L) {
  ...
  lua_pushinteger(L, IMAGE_DRAW_FILL);
  lua_settable(L, -3); 
...
static const struct luaL_Reg canvas_offline_t_member_funcs[] = {
  {NULL, NULL}
};
...
static void canvas_offline_t_init(lua_State* L) {
  ...
  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_canvas_offline_t_get_prop},
...
static int wrap_canvas_reset_font(lua_State* L) {
  ret_t ret = 0;
  canvas_t* c = (canvas_t*)tk_checkudata(L, 1, "canvas_t");
...
static int wrap_canvas_reset_cache(lua_State* L) {
  ret_t ret = 0;
  canvas_t* c = (canvas_t*)tk_checkudata(L, 1, "canvas_t");
...
static const struct luaL_Reg canvas_t_member_funcs[] = {
  ...
  {"reset_font", wrap_canvas_reset_font},
  ...
  {"reset_cache", wrap_canvas_reset_cache},
  {NULL, NULL}
};
...
static void event_type_t_init(lua_State* L) {
  ...
  lua_pushstring(L, "MOUSE_EXTRA_BUTTON_DOWN");
  lua_pushinteger(L, EVT_MOUSE_EXTRA_BUTTON_DOWN);
  lua_settable(L, -3); 

  lua_pushstring(L, "MOUSE_EXTRA_BUTTON_UP");
  lua_pushinteger(L, EVT_MOUSE_EXTRA_BUTTON_UP);
  lua_settable(L, -3); 
  ...
  lua_pushinteger(L, EVT_DOUBLE_CLICK);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "THEME_WILL_CHANGE");
  lua_pushinteger(L, EVT_THEME_WILL_CHANGE);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "WIDGET_WILL_UPDATE_STYLE");
  lua_pushinteger(L, EVT_WIDGET_WILL_UPDATE_STYLE);
  lua_settable(L, -3); 

  lua_pushstring(L, "WIDGET_UPDATE_STYLE");
  lua_pushinteger(L, EVT_WIDGET_UPDATE_STYLE);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "PAGE_CHANGING");
  lua_pushinteger(L, EVT_PAGE_CHANGING);
  lua_settable(L, -3); 
  ...
  lua_pushinteger(L, EVT_CONNECT);
  lua_settable(L, -3); 

  lua_pushstring(L, "MODEL_CHANGE");
  lua_pushinteger(L, EVT_MODEL_CHANGE);
  lua_settable(L, -3); 

  lua_pushstring(L, "SYSTEM");
  lua_pushinteger(L, EVT_SYSTEM);
  lua_settable(L, -3); 

  lua_pushstring(L, "DROP_FILE");
  lua_pushinteger(L, EVT_DROP_FILE);
  lua_settable(L, -3); 

  lua_pushstring(L, "LOCALE_INFOS_LOAD_INFO");
  lua_pushinteger(L, EVT_LOCALE_INFOS_LOAD_INFO);
  lua_settable(L, -3); 

  lua_pushstring(L, "LOCALE_INFOS_UNLOAD_INFO");
  lua_pushinteger(L, EVT_LOCALE_INFOS_UNLOAD_INFO);
  lua_settable(L, -3); 

  lua_pushstring(L, "ACTIVATED");
  lua_pushinteger(L, EVT_ACTIVATED);
  lua_settable(L, -3); 

  lua_pushstring(L, "UNACTIVATED");
  lua_pushinteger(L, EVT_UNACTIVATED);
  lua_settable(L, -3); 

  lua_pushstring(L, "UI_LOAD");
  lua_pushinteger(L, EVT_UI_LOAD);
  lua_settable(L, -3); 

  lua_pushstring(L, "TOUCH_DOWN");
  lua_pushinteger(L, EVT_TOUCH_DOWN);
  lua_settable(L, -3); 

  lua_pushstring(L, "TOUCH_MOVE");
  lua_pushinteger(L, EVT_TOUCH_MOVE);
  lua_settable(L, -3); 

  lua_pushstring(L, "TOUCH_UP");
  lua_pushinteger(L, EVT_TOUCH_UP);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "LOG_MESSAGE");
  lua_pushinteger(L, EVT_LOG_MESSAGE);
  lua_settable(L, -3); 
...
static int wrap_event_register_custom_name(lua_State* L) {
  ret_t ret = 0;
  int32_t event_type = (int32_t)luaL_checkinteger(L, 1);
  const char* name = (const char*)luaL_checkstring(L, 2);
...
static int wrap_event_unregister_custom_name(lua_State* L) {
  ret_t ret = 0;
  const char* name = (const char*)luaL_checkstring(L, 1);
...
static void event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    ...
    {"register_custom_name", wrap_event_register_custom_name},
    {"unregister_custom_name", wrap_event_unregister_custom_name},
...
static void glyph_format_t_init(lua_State* L) {
  ...
  lua_pushinteger(L, GLYPH_FMT_ALPHA2);
  lua_settable(L, -3); 

  lua_pushstring(L, "ALPHA4");
  lua_pushinteger(L, GLYPH_FMT_ALPHA4);
  lua_settable(L, -3); 
...
static int wrap_input_method_dispatch_keys(lua_State* L) {
  ret_t ret = 0;
  input_method_t* im = (input_method_t*)tk_checkudata(L, 1, "input_method_t");
  const char* keys = (const char*)luaL_checkstring(L, 2);
...
static void key_code_t_init(lua_State* L) {
  ...
  lua_pushinteger(L, TK_KEY_KP_DIVIDE);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_MULTIPLY");
  lua_pushinteger(L, TK_KEY_KP_MULTIPLY);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_MINUS");
  lua_pushinteger(L, TK_KEY_KP_MINUS);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_PLUS");
  lua_pushinteger(L, TK_KEY_KP_PLUS);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_ENTER");
  lua_pushinteger(L, TK_KEY_KP_ENTER);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_1");
  lua_pushinteger(L, TK_KEY_KP_1);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_2");
  lua_pushinteger(L, TK_KEY_KP_2);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_3");
  lua_pushinteger(L, TK_KEY_KP_3);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_4");
  lua_pushinteger(L, TK_KEY_KP_4);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_5");
  lua_pushinteger(L, TK_KEY_KP_5);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_6");
  lua_pushinteger(L, TK_KEY_KP_6);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_7");
  lua_pushinteger(L, TK_KEY_KP_7);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_8");
  lua_pushinteger(L, TK_KEY_KP_8);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_9");
  lua_pushinteger(L, TK_KEY_KP_9);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_0");
  lua_pushinteger(L, TK_KEY_KP_0);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_KP_PERIOD");
  lua_pushinteger(L, TK_KEY_KP_PERIOD);
  lua_settable(L, -3); 

  lua_pushstring(L, "KEY_NUMLOCKCLEAR");
  lua_pushinteger(L, TK_KEY_NUMLOCKCLEAR);
  lua_settable(L, -3); 
...
static int wrap_locale_infos_ref(lua_State* L) {
  locale_info_t* ret = NULL;
  const char* name = (const char*)luaL_checkstring(L, 1);
  ret = (locale_info_t*)locale_infos_ref(name);

  return tk_newuserdata(L, (void*)ret, "/locale_infos_t", "awtk.locale_infos_t");
}

static int wrap_locale_infos_unref(lua_State* L) {
  ret_t ret = 0;
  locale_info_t* locale_info = (locale_info_t*)tk_checkudata(L, 1, "locale_info_t");
...
static int wrap_locale_infos_change(lua_State* L) {
  ret_t ret = 0;
  const char* language = (const char*)luaL_checkstring(L, 1);
  const char* country = (const char*)luaL_checkstring(L, 2);
...
static int wrap_locale_infos_off(lua_State* L) {
  ret_t ret = 0;
...
static int wrap_locale_infos_reload_all(lua_State* L) {
  ret_t ret = 0;
...
static void locale_infos_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    ...
    {"unref", wrap_locale_infos_unref},
    {"change", wrap_locale_infos_change},
    {"on", wrap_locale_infos_on},
    {"off", wrap_locale_infos_off},
    {"reload_all", wrap_locale_infos_reload_all},
    {NULL, NULL}
  };
...
static void style_id_t_init(lua_State* L) {
  ...
  lua_pushstring(L, "DRAGGER_COLOR");
  lua_pushstring(L, STYLE_ID_DRAGGER_COLOR);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "CLEAR_BG");
  lua_pushstring(L, STYLE_ID_CLEAR_BG);
  lua_settable(L, -3); 

  lua_pushstring(L, "GRID_COLOR");
  lua_pushstring(L, STYLE_ID_GRID_COLOR);
  lua_settable(L, -3); 

  lua_pushstring(L, "EVEN_BG_COLOR");
  lua_pushstring(L, STYLE_ID_EVEN_BG_COLOR);
  lua_settable(L, -3); 

  lua_pushstring(L, "ODD_BG_COLOR");
  lua_pushstring(L, STYLE_ID_ODD_BG_COLOR);
  lua_settable(L, -3); 
...
static int wrap_style_get(lua_State* L) {
  ret_t ret = 0;
  style_t* s = (style_t*)tk_checkudata(L, 1, "style_t");
  const char* state = (const char*)luaL_checkstring(L, 2);
  const char* name = (const char*)luaL_checkstring(L, 3);
  value_t* value = (value_t*)tk_checkudata(L, 4, "value_t");
...
static void system_info_flag_t_init(lua_State* L) {
  lua_newtable(L);
  lua_setglobal(L, "SystemInfoFlag");
  lua_getglobal(L, "SystemInfoFlag");

  lua_pushstring(L, "NONE");
  lua_pushinteger(L, SYSTEM_INFO_FLAG_NONE);
  lua_settable(L, -3); 

  lua_pushstring(L, "FAST_LCD_PORTRAIT");
  lua_pushinteger(L, SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT);
  lua_settable(L, -3); 
...
static int wrap_timer_modify_ex(lua_State* L) {
  ret_t ret = 0;
  uint32_t timer_id = (uint32_t)luaL_checkinteger(L, 1);
  uint32_t duration = (uint32_t)luaL_checkinteger(L, 2);
  bool_t reset_timer = (bool_t)lua_toboolean(L, 3);
...
static void timer_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    ...
    {"modify_ex", wrap_timer_modify_ex},
    {NULL, NULL}
  };
...
static void bitmap_flag_t_init(lua_State* L) {
  ...
  lua_pushstring(L, "LCD_ORIENTATION");
  lua_pushinteger(L, BITMAP_FLAG_LCD_ORIENTATION);
  lua_settable(L, -3); 

  lua_pushstring(L, "GPU_FBO_TEXTURE");
  lua_pushinteger(L, BITMAP_FLAG_GPU_FBO_TEXTURE);
  lua_settable(L, -3); 
...
static int wrap_vgcanvas_set_font_size(lua_State* L) {
  ret_t ret = 0;
  vgcanvas_t* vg = (vgcanvas_t*)tk_checkudata(L, 1, "vgcanvas_t");
  float_t size = (float_t)luaL_checknumber(L, 2);
...
static int wrap_vgcanvas_draw_image_repeat(lua_State* L) {
  ret_t ret = 0;
  vgcanvas_t* vg = (vgcanvas_t*)tk_checkudata(L, 1, "vgcanvas_t");
  bitmap_t* img = (bitmap_t*)tk_checkudata(L, 2, "bitmap_t");
  float_t sx = (float_t)luaL_checknumber(L, 3);
  ...
  float_t dw = (float_t)luaL_checknumber(L, 9);
  float_t dh = (float_t)luaL_checknumber(L, 10);
  float_t dst_w = (float_t)luaL_checknumber(L, 11);
  float_t dst_h = (float_t)luaL_checknumber(L, 12);
...
static int wrap_vgcanvas_t_get_prop(lua_State* L) {
  ...
  if(strcmp(name, "w") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->w));

  return 1;
  }
  else if(strcmp(name, "h") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->h));
...
static void widget_prop_t_init(lua_State* L) {
  ...
  lua_pushstring(L, WIDGET_PROP_MAX_H);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "LINE_HEIGHT");
  lua_pushstring(L, WIDGET_PROP_LINE_HEIGHT);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, WIDGET_PROP_LOADING);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "EASY_TOUCH_MODE");
  lua_pushstring(L, WIDGET_PROP_EASY_TOUCH_MODE);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, WIDGET_PROP_STATE);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "APPLET_NAME");
  lua_pushstring(L, WIDGET_PROP_APPLET_NAME);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, WIDGET_PROP_RUNNING);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "ENABLE_PREVIEW");
  lua_pushstring(L, WIDGET_PROP_ENABLE_PREVIEW);
  lua_settable(L, -3); 

  lua_pushstring(L, "IS_ACCEPT_STATUS");
  lua_pushstring(L, WIDGET_PROP_IS_ACCEPT_STATUS);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "AUTO_HIDE");
  lua_pushstring(L, WIDGET_PROP_AUTO_HIDE);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "THEME_OF_POPUP");
  lua_pushstring(L, WIDGET_PROP_THEME_OF_POPUP);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "ACCEPT_BUTTON");
  lua_pushstring(L, WIDGET_PROP_ACCEPT_BUTTON);
  lua_settable(L, -3); 

  lua_pushstring(L, "CANCEL_BUTTON");
  lua_pushstring(L, WIDGET_PROP_CANCEL_BUTTON);
  lua_settable(L, -3); 

  lua_pushstring(L, "ACCEPT_RETRUN");
  lua_pushstring(L, WIDGET_PROP_ACCEPT_RETRUN);
  lua_settable(L, -3); 

  lua_pushstring(L, "ACCEPT_TAB");
  lua_pushstring(L, WIDGET_PROP_ACCEPT_TAB);
  lua_settable(L, -3); 

  lua_pushstring(L, "ROWS");
  lua_pushstring(L, WIDGET_PROP_ROWS);
  lua_settable(L, -3); 

  lua_pushstring(L, "SHOW_GRID");
  lua_pushstring(L, WIDGET_PROP_SHOW_GRID);
  lua_settable(L, -3); 

  lua_pushstring(L, "COLUMNS_DEFINITION");
  lua_pushstring(L, WIDGET_PROP_COLUMNS_DEFINITION);
  lua_settable(L, -3); 

  lua_pushstring(L, "DRAG_THRESHOLD");
  lua_pushstring(L, WIDGET_PROP_DRAG_THRESHOLD);
  lua_settable(L, -3); 

  lua_pushstring(L, "ANIMATING_TIME");
  lua_pushstring(L, WIDGET_PROP_ANIMATING_TIME);
  lua_settable(L, -3); 

  lua_pushstring(L, "ANIMATE_PREFIX");
  lua_pushstring(L, WIDGET_PROP_ANIMATE_PREFIX);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "SCREEN_SAVER_TIME");
  lua_pushstring(L, WIDGET_PROP_SCREEN_SAVER_TIME);
  lua_settable(L, -3); 

  lua_pushstring(L, "SHOW_FPS");
  lua_pushstring(L, WIDGET_PROP_SHOW_FPS);
  lua_settable(L, -3); 

  lua_pushstring(L, "MAX_FPS");
  lua_pushstring(L, WIDGET_PROP_MAX_FPS);
  lua_settable(L, -3); 

  lua_pushstring(L, "VALIDATOR");
  lua_pushstring(L, WIDGET_PROP_VALIDATOR);
  lua_settable(L, -3); 

  lua_pushstring(L, "SYNC_STATE_TO_CHILDREN");
  lua_pushstring(L, WIDGET_PROP_SYNC_STATE_TO_CHILDREN);
  lua_settable(L, -3); 

  lua_pushstring(L, "STATE_FROM_PARENT_SYNC");
  lua_pushstring(L, WIDGET_PROP_STATE_FROM_PARENT_SYNC);
  lua_settable(L, -3); 
...
static void widget_type_t_init(lua_State* L) {
  ...
  lua_pushstring(L, "ICON");
  lua_pushstring(L, WIDGET_TYPE_ICON);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, WIDGET_TYPE_PAGE);
  lua_settable(L, -3); 
...
static void window_stage_t_init(lua_State* L) {
  ...
  lua_pushinteger(L, WINDOW_STAGE_LOADED);
  lua_settable(L, -3); 
...
static void widget_state_t_init(lua_State* L) {
  ...
  lua_pushstring(L, "ACTIVATED");
  lua_pushstring(L, WIDGET_STATE_ACTIVATED);
  lua_settable(L, -3); 
  ...
  lua_pushstring(L, "EMPTY_OVER");
  lua_pushstring(L, WIDGET_STATE_EMPTY_OVER);
  lua_settable(L, -3); 
...
static int wrap_widget_count_children(lua_State* L) {
  int32_t ret = 0;
  const widget_t* widget = (const widget_t*)tk_checkudata(L, 1, "const widget_t");
...
static int wrap_widget_find_parent_by_name(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
...
static int wrap_widget_find_parent_by_type(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_move_to_center(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_move_resize_ex(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  wh_t w = (wh_t)luaL_checkinteger(L, 4);
  wh_t h = (wh_t)luaL_checkinteger(L, 5);
  bool_t update_layout = (bool_t)lua_toboolean(L, 6);
...
static int wrap_widget_add_value(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  float_t delta = (float_t)luaL_checknumber(L, 2);
...
static int wrap_widget_get_value_int(lua_State* L) {
  int32_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_set_value_int(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  int32_t value = (int32_t)luaL_checkinteger(L, 2);
...
static int wrap_widget_add_value_int(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_is_support_highlighter(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_has_highlighter(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_set_text_utf8_ex(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* text = (const char*)luaL_checkstring(L, 2);
  bool_t check_diff = (bool_t)lua_toboolean(L, 3);
...
static int wrap_widget_get_enable(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_get_floating(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_get_auto_adjust_size(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_get_with_focus_state(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_get_focusable(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_get_sensitive(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_get_visible(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_get_feedback(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_get_theme_name(lua_State* L) {
  const char* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_set_sync_state_to_children(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t sync_state_to_children = (bool_t)lua_toboolean(L, 2);
...
static int wrap_widget_set_state_from_parent_sync(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t state_from_parent_sync = (bool_t)lua_toboolean(L, 2);
...
static int wrap_widget_set_props(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_set_prop_float(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  float_t v = (float_t)luaL_checknumber(L, 3);
...
static int wrap_widget_get_prop_float(lua_State* L) {
  float_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  float_t defval = (float_t)luaL_checknumber(L, 3);
...
static int wrap_widget_is_window_created(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_is_parent_of(lua_State* L) {
  bool_t ret = 0;
  const widget_t* widget = (const widget_t*)tk_checkudata(L, 1, "const widget_t");
  const widget_t* child = (const widget_t*)tk_checkudata(L, 2, "const widget_t");
...
static int wrap_widget_is_fullscreen_window(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_is_always_on_top(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_is_suspend_dialog(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_is_suspend_popup(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_ref(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_widget_add_child_default(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  widget_t* child = (widget_t*)tk_checkudata(L, 2, "widget_t");
...
static const struct luaL_Reg widget_t_member_funcs[] = {
  ...
  {"find_parent_by_name", wrap_widget_find_parent_by_name},
  {"find_parent_by_type", wrap_widget_find_parent_by_type},
  ...
  {"set_text_ex", wrap_widget_set_text_utf8_ex},
  ...
  {"get_enable", wrap_widget_get_enable},
  {"get_floating", wrap_widget_get_floating},
  {"get_auto_adjust_size", wrap_widget_get_auto_adjust_size},
  {"get_with_focus_state", wrap_widget_get_with_focus_state},
  {"get_focusable", wrap_widget_get_focusable},
  {"get_sensitive", wrap_widget_get_sensitive},
  {"get_visible", wrap_widget_get_visible},
  {"get_feedback", wrap_widget_get_feedback},
  {"get_text", wrap_widget_get_text},
  {"set_name", wrap_widget_set_name},
  {"set_theme", wrap_widget_set_theme},
  {"get_theme_name", wrap_widget_get_theme_name},
  ...
  {"set_sync_state_to_children", wrap_widget_set_sync_state_to_children},
  {"set_state_from_parent_sync", wrap_widget_set_state_from_parent_sync},
  ...
  {"is_window_created", wrap_widget_is_window_created},
  ...
  {"is_fullscreen_window", wrap_widget_is_fullscreen_window},
  {"is_dialog", wrap_widget_is_dialog},
  {"is_popup", wrap_widget_is_popup},
  {"is_overlay", wrap_widget_is_overlay},
  {"is_always_on_top", wrap_widget_is_always_on_top},
  {"is_suspend_dialog", wrap_widget_is_suspend_dialog},
  {"is_suspend_popup", wrap_widget_is_suspend_popup},
  ...
  {"add_child_default", wrap_widget_add_child_default},
  {NULL, NULL}
};
...
static int wrap_widget_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "sync_state_to_children") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->sync_state_to_children));

  return 1;
  }
  else if(strcmp(name, "state_from_parent_sync") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->state_from_parent_sync));

  return 1;
  }
  else if(strcmp(name, "opacity") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->opacity));
...
static int wrap_object_load_conf(lua_State* L) {
  ret_t ret = 0;
  tk_object_t* obj = (tk_object_t*)tk_checkudata(L, 1, "tk_object_t");
  const char* url = (const char*)luaL_checkstring(L, 2);
  const char* type = (const char*)luaL_checkstring(L, 3);
...
static void conf_utils_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"object_load_conf", wrap_object_load_conf},
    {NULL, NULL}
  };

  luaL_openlib(L, "ConfUtils", static_funcs, 0);
  lua_settop(L, 0);
}
static void edit_ex_prop_t_init(lua_State* L) {
  lua_newtable(L);
  lua_setglobal(L, "EditExProp");
  lua_getglobal(L, "EditExProp");

  lua_pushstring(L, "MULTILINE");
  lua_pushstring(L, EDIT_EX_PROP_MULTILINE);
  lua_settable(L, -3); 

  lua_pushstring(L, "SUGGEST_WORDS");
  lua_pushstring(L, EDIT_EX_PROP_SUGGEST_WORDS);
  lua_settable(L, -3); 

  lua_pushstring(L, "SUGGEST_WORDS_UI_PROPS");
  lua_pushstring(L, EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS);
  lua_settable(L, -3); 

  lua_pushstring(L, "SUGGEST_WORDS_ITEM_ODD_STYLE");
  lua_pushstring(L, EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE);
  lua_settable(L, -3); 

  lua_pushstring(L, "SUGGEST_WORDS_ITEM_EVEN_STYLE");
  lua_pushstring(L, EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE);
  lua_settable(L, -3); 

  lua_pushstring(L, "SUGGEST_WORDS_ITEM_SEPARATE_STYLE");
  lua_pushstring(L, EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE);
  lua_settable(L, -3); 

  lua_pushstring(L, "SUGGEST_WORDS_INPUT_NAME");
  lua_pushstring(L, EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME);
  lua_settable(L, -3); 

  lua_pushstring(L, "IS_SELECT_SUGGEST_WORD");
  lua_pushstring(L, EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD);
  lua_settable(L, -3); 

  lua_pushstring(L, "SUGGEST_WORDS_ITEM_FORMATS");
  lua_pushstring(L, EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS);
  lua_settable(L, -3); 

}

static void edit_ex_suggest_words_prop_t_init(lua_State* L) {
  lua_newtable(L);
  lua_setglobal(L, "EditExSuggestWordsProp");
  lua_getglobal(L, "EditExSuggestWordsProp");

  lua_pushstring(L, "FORMAT_NAME");
  lua_pushstring(L, EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME);
  lua_settable(L, -3); 
...
static void vpage_event_t_init(lua_State* L) {
  lua_newtable(L);
  lua_setglobal(L, "VpageEvent");
  lua_getglobal(L, "VpageEvent");

  lua_pushstring(L, "VPAGE_WILL_OPEN");
  lua_pushinteger(L, EVT_VPAGE_WILL_OPEN);
  lua_settable(L, -3); 

  lua_pushstring(L, "VPAGE_OPEN");
  lua_pushinteger(L, EVT_VPAGE_OPEN);
  lua_settable(L, -3); 

  lua_pushstring(L, "VPAGE_CLOSE");
  lua_pushinteger(L, EVT_VPAGE_CLOSE);
  lua_settable(L, -3); 
...
static int wrap_asset_info_get_type(lua_State* L) {
  uint16_t ret = 0;
...
static int wrap_asset_info_get_name(lua_State* L) {
  const char* ret = NULL;
  const asset_info_t* info = (const asset_info_t*)tk_checkudata(L, 1, "const asset_info_t");
...
static int wrap_asset_info_is_in_rom(lua_State* L) {
  bool_t ret = 0;
  const asset_info_t* info = (const asset_info_t*)tk_checkudata(L, 1, "const asset_info_t");
...
static const struct luaL_Reg asset_info_t_member_funcs[] = {
  {"get_type", wrap_asset_info_get_type},
  {"get_name", wrap_asset_info_get_name},
  {"is_in_rom", wrap_asset_info_is_in_rom},
  {"set_is_in_rom", wrap_asset_info_set_is_in_rom},
  {NULL, NULL}
};
...
static int wrap_color_get_color(lua_State* L) {
  uint32_t ret = 0;
  color_t* c = (color_t*)tk_checkudata(L, 1, "color_t");
...
static const struct luaL_Reg color_t_member_funcs[] = {
  ...
  {"b", wrap_color_b},
  {"a", wrap_color_a},
  {"get_color", wrap_color_get_color},
...
static int wrap_date_time_from_time(lua_State* L) {
  ret_t ret = 0;
  date_time_t* dt = (date_time_t*)tk_checkudata(L, 1, "date_time_t");
  int64_t time = (int64_t)luaL_checkinteger(L, 2);
...
static void object_cmd_t_init(lua_State* L) {
  ...
  lua_pushstring(L, "EXEC");
  lua_pushstring(L, TK_OBJECT_CMD_EXEC);
  lua_settable(L, -3); 

  lua_pushstring(L, "UNDO");
  lua_pushstring(L, TK_OBJECT_CMD_UNDO);
  lua_settable(L, -3); 
...
static void object_prop_t_init(lua_State* L) {
  ...
  lua_pushstring(L, "TK_DISABLE_PATH");
  lua_pushstring(L, TK_OBJECT_PROP_DISABLE_PATH);
  lua_settable(L, -3); 

  lua_pushstring(L, "TK_KEEP_PROPS_ORDER");
  lua_pushstring(L, TK_OBJECT_PROP_KEEP_PROPS_ORDER);
  lua_settable(L, -3); 
...
static const struct luaL_Reg rlog_t_member_funcs[] = {
  {"write", wrap_rlog_write},
  {NULL, NULL}
};
...
static void rlog_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_rlog_create},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_rlog_t_get_prop},
    {"__newindex", wrap_rlog_t_set_prop},
    {NULL, NULL}
  };
...
static void ret_t_init(lua_State* L) {
  ...
  lua_pushstring(L, "NO_PERMISSION");
  lua_pushinteger(L, RET_NO_PERMISSION);
  lua_settable(L, -3); 

  lua_pushstring(L, "INVALID_ADDR");
  lua_pushinteger(L, RET_INVALID_ADDR);
  lua_settable(L, -3); 

  lua_pushstring(L, "EXCEED_RANGE");
  lua_pushinteger(L, RET_EXCEED_RANGE);
  lua_settable(L, -3); 

  lua_pushstring(L, "MAX_NR");
  lua_pushinteger(L, RET_MAX_NR);
  lua_settable(L, -3); 
...
static void value_type_t_init(lua_State* L) {
  ...
  lua_pushstring(L, "ID");
  lua_pushinteger(L, VALUE_TYPE_ID);
  lua_settable(L, -3); 

  lua_pushstring(L, "FUNC");
  lua_pushinteger(L, VALUE_TYPE_FUNC);
  lua_settable(L, -3); 

  lua_pushstring(L, "FUNC_DEF");
  lua_pushinteger(L, VALUE_TYPE_FUNC_DEF);
  lua_settable(L, -3); 

  lua_pushstring(L, "POINTER_REF");
  lua_pushinteger(L, VALUE_TYPE_POINTER_REF);
  lua_settable(L, -3); 
...
static int wrap_widget_animator_event_cast(lua_State* L) {
  widget_animator_event_t* ret = NULL;
  event_t* event = (event_t*)tk_checkudata(L, 1, "event_t");
  ret = (widget_animator_event_t*)widget_animator_event_cast(event);

  return tk_newuserdata(L, (void*)ret, "/widget_animator_event_t/event_t", "awtk.widget_animator_event_t");
}


static const struct luaL_Reg widget_animator_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_widget_animator_event_t_set_prop(lua_State* L) {
  widget_animator_event_t* obj = (widget_animator_event_t*)tk_checkudata(L, 1, "widget_animator_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
...
static int wrap_widget_animator_event_t_get_prop(lua_State* L) {
  widget_animator_event_t* obj = (widget_animator_event_t*)tk_checkudata(L, 1, "widget_animator_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(widget_animator_event_t_member_funcs, name);
  ...
  if(strcmp(name, "widget") == 0) {
    return tk_newuserdata(L, (void*)obj->widget, "/widget_t", "awtk.widget_t");
  }
  else if(strcmp(name, "animator") == 0) {
    return tk_newuserdata(L, (void*)obj->animator, "", "awtk.void");
  }
  else {
...
static void widget_animator_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_widget_animator_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_widget_animator_event_t_get_prop},
    {"__newindex", wrap_widget_animator_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.widget_animator_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "WidgetAnimatorEvent", static_funcs, 0);
  lua_settop(L, 0);
}
static int wrap_model_event_cast(lua_State* L) {
  model_event_t* ret = NULL;
  event_t* event = (event_t*)tk_checkudata(L, 1, "event_t");
  ret = (model_event_t*)model_event_cast(event);

  return tk_newuserdata(L, (void*)ret, "/model_event_t/event_t", "awtk.model_event_t");
}


static const struct luaL_Reg model_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_model_event_t_set_prop(lua_State* L) {
  model_event_t* obj = (model_event_t*)tk_checkudata(L, 1, "model_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_model_event_t_get_prop(lua_State* L) {
  model_event_t* obj = (model_event_t*)tk_checkudata(L, 1, "model_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(model_event_t_member_funcs, name);
  ...
  else if(strcmp(name, "change_type") == 0) {
    lua_pushstring(L,(char*)(obj->change_type));

  return 1;
  }
  else if(strcmp(name, "model") == 0) {
    return tk_newuserdata(L, (void*)obj->model, "/tk_object_t/emitter_t", "awtk.tk_object_t");
  }
  else {
    return wrap_event_t_get_prop(L);
  }
...
static void model_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_model_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_model_event_t_get_prop},
    {"__newindex", wrap_model_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.model_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "ModelEvent", static_funcs, 0);
  lua_settop(L, 0);
}
...
static int wrap_orientation_event_t_get_prop(lua_State* L) {
  ...
  if(strcmp(name, "orientation") == 0) {
    lua_pushnumber(L,(lua_Number)(obj->orientation));

  return 1;
  }
  else if(strcmp(name, "old_orientation") == 0) {
    lua_pushnumber(L,(lua_Number)(obj->old_orientation));
...
static int wrap_offset_change_event_cast(lua_State* L) {
  offset_change_event_t* ret = NULL;
  event_t* event = (event_t*)tk_checkudata(L, 1, "event_t");
  ret = (offset_change_event_t*)offset_change_event_cast(event);

  return tk_newuserdata(L, (void*)ret, "/offset_change_event_t/event_t", "awtk.offset_change_event_t");
}


static const struct luaL_Reg offset_change_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_offset_change_event_t_set_prop(lua_State* L) {
  offset_change_event_t* obj = (offset_change_event_t*)tk_checkudata(L, 1, "offset_change_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_offset_change_event_t_get_prop(lua_State* L) {
  offset_change_event_t* obj = (offset_change_event_t*)tk_checkudata(L, 1, "offset_change_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(offset_change_event_t_member_funcs, name);
...
static void offset_change_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_offset_change_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_offset_change_event_t_get_prop},
    {"__newindex", wrap_offset_change_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.offset_change_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "OffsetChangeEvent", static_funcs, 0);
  lua_settop(L, 0);
}
...
static int wrap_pointer_event_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "finger_id") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->finger_id));
...
static int wrap_key_event_t_get_prop(lua_State* L) {
  ...
  return 1;
    ...
    lua_pushboolean(L,(lua_Integer)(obj->numlock));
...
static int wrap_multi_gesture_event_cast(lua_State* L) {
  ...
  return tk_newuserdata(L, (void*)ret, "/multi_gesture_event_t/event_t", "awtk.multi_gesture_event_t");
}


static const struct luaL_Reg multi_gesture_event_t_member_funcs[] = {
  {NULL, NULL}
};
...
static void multi_gesture_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_multi_gesture_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_multi_gesture_event_t_get_prop},
...
static int wrap_theme_change_event_cast(lua_State* L) {
  theme_change_event_t* ret = NULL;
  event_t* event = (event_t*)tk_checkudata(L, 1, "event_t");
  ret = (theme_change_event_t*)theme_change_event_cast(event);

  return tk_newuserdata(L, (void*)ret, "/theme_change_event_t/event_t", "awtk.theme_change_event_t");
}


static const struct luaL_Reg theme_change_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_theme_change_event_t_set_prop(lua_State* L) {
  theme_change_event_t* obj = (theme_change_event_t*)tk_checkudata(L, 1, "theme_change_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_theme_change_event_t_get_prop(lua_State* L) {
  theme_change_event_t* obj = (theme_change_event_t*)tk_checkudata(L, 1, "theme_change_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(theme_change_event_t_member_funcs, name);
...
static void theme_change_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_theme_change_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_theme_change_event_t_get_prop},
    {"__newindex", wrap_theme_change_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.theme_change_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "ThemeChangeEvent", static_funcs, 0);
  lua_settop(L, 0);
}
static int wrap_drop_file_event_cast(lua_State* L) {
  drop_file_event_t* ret = NULL;
  event_t* event = (event_t*)tk_checkudata(L, 1, "event_t");
  ret = (drop_file_event_t*)drop_file_event_cast(event);

  return tk_newuserdata(L, (void*)ret, "/drop_file_event_t/event_t", "awtk.drop_file_event_t");
}


static const struct luaL_Reg drop_file_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_drop_file_event_t_set_prop(lua_State* L) {
  drop_file_event_t* obj = (drop_file_event_t*)tk_checkudata(L, 1, "drop_file_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_drop_file_event_t_get_prop(lua_State* L) {
  drop_file_event_t* obj = (drop_file_event_t*)tk_checkudata(L, 1, "drop_file_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(drop_file_event_t_member_funcs, name);
  ...
  if(strcmp(name, "filename") == 0) {
    lua_pushstring(L,(char*)(obj->filename));
...
static void drop_file_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_drop_file_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_drop_file_event_t_get_prop},
    {"__newindex", wrap_drop_file_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.drop_file_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "DropFileEvent", static_funcs, 0);
  lua_settop(L, 0);
}
static int wrap_system_event_cast(lua_State* L) {
  system_event_t* ret = NULL;
  event_t* event = (event_t*)tk_checkudata(L, 1, "event_t");
  ret = (system_event_t*)system_event_cast(event);

  return tk_newuserdata(L, (void*)ret, "/system_event_t/event_t", "awtk.system_event_t");
}


static const struct luaL_Reg system_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_system_event_t_set_prop(lua_State* L) {
  system_event_t* obj = (system_event_t*)tk_checkudata(L, 1, "system_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_system_event_t_get_prop(lua_State* L) {
  system_event_t* obj = (system_event_t*)tk_checkudata(L, 1, "system_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(system_event_t_member_funcs, name);
  ...
  if(strcmp(name, "sdl_event") == 0) {
    return tk_newuserdata(L, (void*)obj->sdl_event, "", "awtk.void");
  }
  else {
    return wrap_event_t_get_prop(L);
  }
...
static void system_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_system_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_system_event_t_get_prop},
    {"__newindex", wrap_system_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.system_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "SystemEvent", static_funcs, 0);
  lua_settop(L, 0);
}
static int wrap_touch_event_cast(lua_State* L) {
  touch_event_t* ret = NULL;
  event_t* event = (event_t*)tk_checkudata(L, 1, "event_t");
  ret = (touch_event_t*)touch_event_cast(event);

  return tk_newuserdata(L, (void*)ret, "/touch_event_t/event_t", "awtk.touch_event_t");
}


static const struct luaL_Reg touch_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_touch_event_t_set_prop(lua_State* L) {
  touch_event_t* obj = (touch_event_t*)tk_checkudata(L, 1, "touch_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_touch_event_t_get_prop(lua_State* L) {
  touch_event_t* obj = (touch_event_t*)tk_checkudata(L, 1, "touch_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(touch_event_t_member_funcs, name);
  ...
  if(strcmp(name, "touch_id") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->touch_id));
  ...
  return 1;
    ...
    lua_pushnumber(L,(lua_Number)(obj->pressure));
...
static void touch_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_touch_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_touch_event_t_get_prop},
    {"__newindex", wrap_touch_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.touch_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "TouchEvent", static_funcs, 0);
  lua_settop(L, 0);
}
static int wrap_ui_load_event_cast(lua_State* L) {
  ui_load_event_t* ret = NULL;
  event_t* event = (event_t*)tk_checkudata(L, 1, "event_t");
  ret = (ui_load_event_t*)ui_load_event_cast(event);

  return tk_newuserdata(L, (void*)ret, "/ui_load_event_t/event_t", "awtk.ui_load_event_t");
}


static const struct luaL_Reg ui_load_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_ui_load_event_t_set_prop(lua_State* L) {
  ui_load_event_t* obj = (ui_load_event_t*)tk_checkudata(L, 1, "ui_load_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_ui_load_event_t_get_prop(lua_State* L) {
  ui_load_event_t* obj = (ui_load_event_t*)tk_checkudata(L, 1, "ui_load_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(ui_load_event_t_member_funcs, name);
  ...
  if(strcmp(name, "root") == 0) {
    return tk_newuserdata(L, (void*)obj->root, "/widget_t", "awtk.widget_t");
  }
  else if(strcmp(name, "name") == 0) {
    lua_pushstring(L,(char*)(obj->name));
...
static void ui_load_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_ui_load_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_ui_load_event_t_get_prop},
    {"__newindex", wrap_ui_load_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.ui_load_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "UiLoadEvent", static_funcs, 0);
  lua_settop(L, 0);
}
static int wrap_font_manager_set_standard_font_size(lua_State* L) {
  ret_t ret = 0;
  font_manager_t* fm = (font_manager_t*)tk_checkudata(L, 1, "font_manager_t");
  bool_t is_standard = (bool_t)lua_toboolean(L, 2);
...
static int wrap_font_manager_get_standard_font_size(lua_State* L) {
  bool_t ret = 0;
  font_manager_t* fm = (font_manager_t*)tk_checkudata(L, 1, "font_manager_t");
...
static const struct luaL_Reg font_manager_t_member_funcs[] = {
  {"set_standard_font_size", wrap_font_manager_set_standard_font_size},
  {"get_standard_font_size", wrap_font_manager_get_standard_font_size},
...
static const struct luaL_Reg locale_info_xml_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_locale_info_xml_t_set_prop(lua_State* L) {
  locale_info_xml_t* obj = (locale_info_xml_t*)tk_checkudata(L, 1, "locale_info_xml_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_locale_info_t_set_prop(L);
}

static int wrap_locale_info_xml_t_get_prop(lua_State* L) {
  locale_info_xml_t* obj = (locale_info_xml_t*)tk_checkudata(L, 1, "locale_info_xml_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(locale_info_xml_t_member_funcs, name);
  ...
  if(ret) {
    ...
    return wrap_locale_info_t_get_prop(L);
  }
}

static void locale_info_xml_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_locale_info_xml_t_get_prop},
    {"__newindex", wrap_locale_info_xml_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.locale_info_xml_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "LocaleInfoXml", static_funcs, 0);
  lua_settop(L, 0);
}
...
static int wrap_window_base_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "accept_button") == 0) {
    lua_pushstring(L,(char*)(obj->accept_button));

  return 1;
  }
  else if(strcmp(name, "cancel_button") == 0) {
    lua_pushstring(L,(char*)(obj->cancel_button));

  return 1;
  }
  else if(strcmp(name, "applet_name") == 0) {
    lua_pushstring(L,(char*)(obj->applet_name));
...
static int wrap_window_manager_set_show_fps_position(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
...
static int wrap_window_manager_set_ignore_input_events(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t ignore_input_events = (bool_t)lua_toboolean(L, 2);
...
static int wrap_window_manager_set_fullscreen(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static const struct luaL_Reg window_manager_t_member_funcs[] = {
  ...
  {"set_show_fps_position", wrap_window_manager_set_show_fps_position},
  ...
  {"set_fullscreen", wrap_window_manager_set_fullscreen},
...
static int wrap_color_component_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
...
static void color_component_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_color_component_create},
...
static int wrap_draggable_set_allow_out_of_screen(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t allow_out_of_screen = (bool_t)lua_toboolean(L, 2);
...
static int wrap_draggable_set_drag_native_window(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t drag_native_window = (bool_t)lua_toboolean(L, 2);
...
static int wrap_draggable_set_drag_parent(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t drag_parent = (uint32_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg draggable_t_member_funcs[] = {
  ...
  {"set_allow_out_of_screen", wrap_draggable_set_allow_out_of_screen},
  {"set_drag_window", wrap_draggable_set_drag_window},
  {"set_drag_native_window", wrap_draggable_set_drag_native_window},
  {"set_drag_parent", wrap_draggable_set_drag_parent},
  {NULL, NULL}
};
...
static int wrap_draggable_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "allow_out_of_screen") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->allow_out_of_screen));
  ...
  else if(strcmp(name, "drag_native_window") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->drag_native_window));

  return 1;
  }
  else if(strcmp(name, "drag_parent") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->drag_parent));
...
static int wrap_file_browser_view_set_top_dir(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* top_dir = (const char*)luaL_checkstring(L, 2);
...
static int wrap_file_browser_view_set_odd_item_style(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* odd_item_style = (const char*)luaL_checkstring(L, 2);
...
static int wrap_file_browser_view_set_even_item_style(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* even_item_style = (const char*)luaL_checkstring(L, 2);
...
static const struct luaL_Reg file_browser_view_t_member_funcs[] = {
  ...
  {"set_top_dir", wrap_file_browser_view_set_top_dir},
  ...
  {"set_odd_item_style", wrap_file_browser_view_set_odd_item_style},
  {"set_even_item_style", wrap_file_browser_view_set_even_item_style},
...
static int wrap_file_browser_view_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "top_dir") == 0) {
    lua_pushstring(L,(char*)(obj->top_dir));
  ...
  else if(strcmp(name, "odd_item_style") == 0) {
    lua_pushstring(L,(char*)(obj->odd_item_style));

  return 1;
  }
  else if(strcmp(name, "even_item_style") == 0) {
    lua_pushstring(L,(char*)(obj->even_item_style));
...
static void file_browser_view_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_file_browser_view_create},
    {"cast", wrap_file_browser_view_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_file_browser_view_t_get_prop},
...
static int wrap_file_chooser_set_top_dir(lua_State* L) {
  ret_t ret = 0;
  file_chooser_t* chooser = (file_chooser_t*)tk_checkudata(L, 1, "file_chooser_t");
  const char* top_dir = (const char*)luaL_checkstring(L, 2);
...
static const struct luaL_Reg file_chooser_t_member_funcs[] = {
  ...
  {"set_top_dir", wrap_file_chooser_set_top_dir},
...
static void file_chooser_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_file_chooser_create},
    {"cast", wrap_file_chooser_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_file_chooser_t_get_prop},
...
static int wrap_gauge_pointer_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  ...
  return tk_newuserdata(L, (void*)ret, "/gauge_pointer_t/widget_t", "awtk.gauge_pointer_t");
}

static int wrap_gauge_pointer_cast(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_gauge_pointer_set_image(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_gauge_pointer_set_anchor(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static const struct luaL_Reg gauge_pointer_t_member_funcs[] = {
  {"set_angle", wrap_gauge_pointer_set_angle},
  {"set_image", wrap_gauge_pointer_set_image},
  {"set_anchor", wrap_gauge_pointer_set_anchor},
  {NULL, NULL}
};

static int wrap_gauge_pointer_t_set_prop(lua_State* L) {
  gauge_pointer_t* obj = (gauge_pointer_t*)tk_checkudata(L, 1, "gauge_pointer_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_widget_t_set_prop(L);
...
static int wrap_gauge_pointer_t_get_prop(lua_State* L) {
  gauge_pointer_t* obj = (gauge_pointer_t*)tk_checkudata(L, 1, "gauge_pointer_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(gauge_pointer_t_member_funcs, name);
...
static void gauge_pointer_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_gauge_pointer_create},
    {"cast", wrap_gauge_pointer_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_gauge_pointer_t_get_prop},
    {"__newindex", wrap_gauge_pointer_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.gauge_pointer_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "GaugePointer", static_funcs, 0);
  lua_settop(L, 0);
}
static int wrap_gauge_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  ...
  return tk_newuserdata(L, (void*)ret, "/gauge_t/widget_t", "awtk.gauge_t");
}

static int wrap_gauge_cast(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_gauge_set_draw_type(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static const struct luaL_Reg gauge_t_member_funcs[] = {
  {"set_image", wrap_gauge_set_image},
  {"set_draw_type", wrap_gauge_set_draw_type},
  {NULL, NULL}
};

static int wrap_gauge_t_set_prop(lua_State* L) {
  gauge_t* obj = (gauge_t*)tk_checkudata(L, 1, "gauge_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_widget_t_set_prop(L);
...
static int wrap_gauge_t_get_prop(lua_State* L) {
  gauge_t* obj = (gauge_t*)tk_checkudata(L, 1, "gauge_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(gauge_t_member_funcs, name);
...
static void gauge_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_gauge_create},
    {"cast", wrap_gauge_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_gauge_t_get_prop},
    {"__newindex", wrap_gauge_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.gauge_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "Gauge", static_funcs, 0);
  lua_settop(L, 0);
}
...
static int wrap_image_value_set_click_add_delta(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  double click_add_delta = (double)luaL_checknumber(L, 2);
...
static int wrap_candidates_set_visible_num(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t visible_num = (uint32_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg candidates_t_member_funcs[] = {
  ...
  {"set_visible_num", wrap_candidates_set_visible_num},
...
static int wrap_candidates_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "enable_preview") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->enable_preview));

  return 1;
  }
  else if(strcmp(name, "visible_num") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->visible_num));
...
static const struct luaL_Reg lang_indicator_t_member_funcs[] = {
  {"set_image", wrap_lang_indicator_set_image},
  {NULL, NULL}
};
...
static void lang_indicator_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_lang_indicator_create},
    {"cast", wrap_lang_indicator_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_lang_indicator_t_get_prop},
...
static int wrap_line_number_add_highlight_line(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  int32_t line = (int32_t)luaL_checkinteger(L, 2);
...
static int wrap_line_number_set_active_line(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  int32_t line = (int32_t)luaL_checkinteger(L, 2);
...
static int wrap_line_number_clear_highlight(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_line_number_is_highlight_line(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  int32_t line = (int32_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg line_number_t_member_funcs[] = {
  ...
  {"add_highlight_line", wrap_line_number_add_highlight_line},
  {"set_active_line", wrap_line_number_set_active_line},
  {"clear_highlight", wrap_line_number_clear_highlight},
  {"is_highlight_line", wrap_line_number_is_highlight_line},
  {NULL, NULL}
};
...
static int wrap_mledit_get_cursor(lua_State* L) {
  uint32_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_mledit_scroll_to_offset(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_mledit_set_select(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_mledit_get_selected_text(lua_State* L) {
  char* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_mledit_get_start_line_index(lua_State* L) {
  int32_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_mledit_get_start_row_index(lua_State* L) {
  int32_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_mledit_get_line_at(lua_State* L) {
  int32_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t offset = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_mledit_get_row_at(lua_State* L) {
  int32_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t offset = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_mledit_get_row_of_line(lua_State* L) {
  int32_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t line = (uint32_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg mledit_t_member_funcs[] = {
  ...
  {"get_cursor", wrap_mledit_get_cursor},
  {"scroll_to_offset", wrap_mledit_scroll_to_offset},
  ...
  {"get_start_line_index", wrap_mledit_get_start_line_index},
  {"get_start_row_index", wrap_mledit_get_start_row_index},
  {"get_line_at", wrap_mledit_get_line_at},
  {"get_row_at", wrap_mledit_get_row_at},
  {"get_row_of_line", wrap_mledit_get_row_of_line},
...
static int wrap_mledit_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "accept_return") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->accept_return));

  return 1;
  }
  else if(strcmp(name, "accept_tab") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->accept_tab));

  return 1;
  }
  else if(strcmp(name, "auto_adjust_height") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->auto_adjust_height));
...
static const struct luaL_Reg rich_text_view_t_member_funcs[] = {
  {NULL, NULL}
};
...
static void rich_text_view_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_rich_text_view_create},
    {"cast", wrap_rich_text_view_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_rich_text_view_t_get_prop},
...
static int wrap_rich_text_set_word_wrap(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static const struct luaL_Reg rich_text_t_member_funcs[] = {
  ...
  {"set_word_wrap", wrap_rich_text_set_word_wrap},
  {NULL, NULL}
};
...
static int wrap_hscroll_label_set_speed(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  float_t speed = (float_t)luaL_checknumber(L, 2);
...
static int wrap_hscroll_label_set_stop_at_begin(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t stop_at_begin = (bool_t)lua_toboolean(L, 2);
...
static int wrap_hscroll_label_set_delay(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t delay = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_hscroll_label_set_loop_interval_distance(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  int32_t loop_interval_distance = (int32_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg hscroll_label_t_member_funcs[] = {
  ...
  {"set_speed", wrap_hscroll_label_set_speed},
  ...
  {"set_stop_at_begin", wrap_hscroll_label_set_stop_at_begin},
  {"set_delay", wrap_hscroll_label_set_delay},
  {"set_loop_interval_distance", wrap_hscroll_label_set_loop_interval_distance},
...
static int wrap_hscroll_label_t_get_prop(lua_State* L) {
  ...
  return 1;
    ...
    lua_pushnumber(L,(lua_Number)(obj->speed));
  ...
  else if(strcmp(name, "stop_at_begin") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->stop_at_begin));

  return 1;
  }
  else if(strcmp(name, "loop_interval_distance") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->loop_interval_distance));
...
static int wrap_list_view_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "item_width") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->item_width));
...
static int wrap_scroll_bar_set_auto_hide(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t auto_hide = (bool_t)lua_toboolean(L, 2);
...
static int wrap_scroll_bar_set_animator_time(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t animator_time = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_scroll_bar_hide_by_opacity_animation(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  int32_t duration = (int32_t)luaL_checkinteger(L, 2);
  int32_t delay = (int32_t)luaL_checkinteger(L, 3);
...
static int wrap_scroll_bar_show_by_opacity_animation(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  int32_t duration = (int32_t)luaL_checkinteger(L, 2);
  int32_t delay = (int32_t)luaL_checkinteger(L, 3);
...
static int wrap_scroll_bar_set_wheel_scroll(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t scroll = (bool_t)lua_toboolean(L, 2);
...
static int wrap_scroll_bar_set_scroll_delta(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t scroll_delta = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_scroll_bar_set_scroll_rows(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint8_t scroll_rows = (uint8_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg scroll_bar_t_member_funcs[] = {
  ...
  {"set_auto_hide", wrap_scroll_bar_set_auto_hide},
  {"is_mobile", wrap_scroll_bar_is_mobile},
  {"set_animator_time", wrap_scroll_bar_set_animator_time},
  {"hide_by_opacity_animation", wrap_scroll_bar_hide_by_opacity_animation},
  {"show_by_opacity_animation", wrap_scroll_bar_show_by_opacity_animation},
  {"set_wheel_scroll", wrap_scroll_bar_set_wheel_scroll},
  {"set_scroll_delta", wrap_scroll_bar_set_scroll_delta},
  {"set_scroll_rows", wrap_scroll_bar_set_scroll_rows},
  {NULL, NULL}
};
...
static int wrap_scroll_bar_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "animator_time") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->animator_time));

  return 1;
  }
  else if(strcmp(name, "scroll_delta") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->scroll_delta));

  return 1;
  }
  else if(strcmp(name, "scroll_rows") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->scroll_rows));
  ...
  else if(strcmp(name, "wheel_scroll") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->wheel_scroll));

  return 1;
  }
  else if(strcmp(name, "wheel_modifier_key") == 0) {
    lua_pushstring(L,(char*)(obj->wheel_modifier_key));
...
static int wrap_scroll_view_set_slide_limit_ratio(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  float_t slide_limit_ratio = (float_t)luaL_checknumber(L, 2);
...
static const struct luaL_Reg scroll_view_t_member_funcs[] = {
  ...
  {"set_slide_limit_ratio", wrap_scroll_view_set_slide_limit_ratio},
...
static int wrap_scroll_view_t_get_prop(lua_State* L) {
  ...
  if(strcmp(name, "use_virtual_w") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->use_virtual_w));

  return 1;
  }
  else if(strcmp(name, "use_widget_w") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->use_widget_w));

  return 1;
  }
  else if(strcmp(name, "use_virtual_h") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->use_virtual_h));

  return 1;
  }
  else if(strcmp(name, "use_widget_h") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->use_widget_h));

  return 1;
  }
  else if(strcmp(name, "virtual_w") == 0) {
  ...
  else if(strcmp(name, "slide_limit_ratio") == 0) {
    lua_pushnumber(L,(lua_Number)(obj->slide_limit_ratio));
...
static int wrap_serial_widget_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  ...
  return tk_newuserdata(L, (void*)ret, "/serial_widget_t/widget_t", "awtk.serial_widget_t");
}

static int wrap_serial_widget_cast(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_serial_widget_set_baudrate(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t baudrate = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_serial_widget_set_device(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* device = (const char*)luaL_checkstring(L, 2);
...
static int wrap_serial_widget_set_bytesize(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t bytesize = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_serial_widget_set_parity(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t parity = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_serial_widget_set_stopbits(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t stopbits = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_serial_widget_set_flowcontrol(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t flowcontrol = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_serial_widget_set_check_interval(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t check_interval = (uint32_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg serial_widget_t_member_funcs[] = {
  {"set_baudrate", wrap_serial_widget_set_baudrate},
  {"set_device", wrap_serial_widget_set_device},
  {"set_bytesize", wrap_serial_widget_set_bytesize},
  {"set_parity", wrap_serial_widget_set_parity},
  {"set_stopbits", wrap_serial_widget_set_stopbits},
  {"set_flowcontrol", wrap_serial_widget_set_flowcontrol},
  {"set_check_interval", wrap_serial_widget_set_check_interval},
  {NULL, NULL}
};

static int wrap_serial_widget_t_set_prop(lua_State* L) {
  serial_widget_t* obj = (serial_widget_t*)tk_checkudata(L, 1, "serial_widget_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_widget_t_set_prop(L);
...
static int wrap_serial_widget_t_get_prop(lua_State* L) {
  serial_widget_t* obj = (serial_widget_t*)tk_checkudata(L, 1, "serial_widget_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(serial_widget_t_member_funcs, name);
  ...
  if(strcmp(name, "device") == 0) {
    lua_pushstring(L,(char*)(obj->device));

  return 1;
  }
  else if(strcmp(name, "baudrate") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->baudrate));

  return 1;
  }
  else if(strcmp(name, "bytesize") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->bytesize));

  return 1;
  }
  else if(strcmp(name, "parity") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->parity));

  return 1;
  }
  else if(strcmp(name, "stopbits") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->stopbits));

  return 1;
  }
  else if(strcmp(name, "flowcontrol") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->flowcontrol));
...
static void serial_widget_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_serial_widget_create},
    {"cast", wrap_serial_widget_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_serial_widget_t_get_prop},
    {"__newindex", wrap_serial_widget_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.serial_widget_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "SerialWidget", static_funcs, 0);
  lua_settop(L, 0);
}
...
static int wrap_slide_menu_set_spacer(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  int32_t spacer = (int32_t)luaL_checkinteger(L, 2);
...
static int wrap_slide_menu_set_menu_w(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* menu_w = (const char*)luaL_checkstring(L, 2);
...
static int wrap_slide_menu_set_clip(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t clip = (bool_t)lua_toboolean(L, 2);
...
static int wrap_slide_menu_scroll_to_prev(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_slide_menu_scroll_to_next(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static const struct luaL_Reg slide_menu_t_member_funcs[] = {
  ...
  {"set_spacer", wrap_slide_menu_set_spacer},
  {"set_menu_w", wrap_slide_menu_set_menu_w},
  {"set_clip", wrap_slide_menu_set_clip},
  {"scroll_to_prev", wrap_slide_menu_scroll_to_prev},
  {"scroll_to_next", wrap_slide_menu_scroll_to_next},
  {NULL, NULL}
};
...
static int wrap_slide_menu_t_get_prop(lua_State* L) {
  ...
  return 1;
    ...
    lua_pushinteger(L,(lua_Integer)(obj->spacer));

  return 1;
  }
  else if(strcmp(name, "menu_w") == 0) {
    lua_pushstring(L,(char*)(obj->menu_w));

  return 1;
  }
  else if(strcmp(name, "clip") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->clip));
...
static int wrap_slide_indicator_set_transition(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t transition = (bool_t)lua_toboolean(L, 2);
...
static const struct luaL_Reg slide_indicator_t_member_funcs[] = {
  ...
  {"set_transition", wrap_slide_indicator_set_transition},
  {NULL, NULL}
};
...
static int wrap_slide_indicator_t_get_prop(lua_State* L) {
  ...
  return 1;
    ...
    lua_pushboolean(L,(lua_Integer)(obj->transition));
...
static int wrap_slide_view_set_drag_threshold(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_slide_view_set_animating_time(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static const struct luaL_Reg slide_view_t_member_funcs[] = {
  ...
  {"set_drag_threshold", wrap_slide_view_set_drag_threshold},
  {"set_animating_time", wrap_slide_view_set_animating_time},
...
static int wrap_text_selector_set_enable_value_animator(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t enable_value_animator = (bool_t)lua_toboolean(L, 2);
...
static int wrap_text_selector_set_mask_easing(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  easing_type_t mask_easing = (easing_type_t)luaL_checkinteger(L, 2);
...
static int wrap_text_selector_set_mask_area_scale(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  float_t mask_area_scale = (float_t)luaL_checknumber(L, 2);
...
static int wrap_text_selector_set_ellipses(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t ellipses = (bool_t)lua_toboolean(L, 2);
...
static const struct luaL_Reg text_selector_t_member_funcs[] = {
  ...
  {"set_enable_value_animator", wrap_text_selector_set_enable_value_animator},
  {"set_mask_easing", wrap_text_selector_set_mask_easing},
  {"set_mask_area_scale", wrap_text_selector_set_mask_area_scale},
  {"set_ellipses", wrap_text_selector_set_ellipses},
  {NULL, NULL}
};
...
static int wrap_text_selector_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "enable_value_animator") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->enable_value_animator));
  ...
  else if(strcmp(name, "mask_easing") == 0) {
    lua_pushnumber(L,(lua_Number)(obj->mask_easing));

  return 1;
  }
  else if(strcmp(name, "mask_area_scale") == 0) {
    lua_pushnumber(L,(lua_Number)(obj->mask_area_scale));
...
static int wrap_timer_widget_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  ...
  return tk_newuserdata(L, (void*)ret, "/timer_widget_t/widget_t", "awtk.timer_widget_t");
}

static int wrap_timer_widget_cast(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_timer_widget_set_duration(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t duration = (uint32_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg timer_widget_t_member_funcs[] = {
  {"set_duration", wrap_timer_widget_set_duration},
  {NULL, NULL}
};

static int wrap_timer_widget_t_set_prop(lua_State* L) {
  timer_widget_t* obj = (timer_widget_t*)tk_checkudata(L, 1, "timer_widget_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_widget_t_set_prop(L);
...
static int wrap_timer_widget_t_get_prop(lua_State* L) {
  timer_widget_t* obj = (timer_widget_t*)tk_checkudata(L, 1, "timer_widget_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(timer_widget_t_member_funcs, name);
...
static void timer_widget_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_timer_widget_create},
    {"cast", wrap_timer_widget_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_timer_widget_t_get_prop},
    {"__newindex", wrap_timer_widget_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.timer_widget_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "TimerWidget", static_funcs, 0);
  lua_settop(L, 0);
}
static int wrap_vpage_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  ...
  return tk_newuserdata(L, (void*)ret, "/vpage_t/widget_t", "awtk.vpage_t");
}

static int wrap_vpage_cast(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_vpage_set_ui_asset(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* ui_asset = (const char*)luaL_checkstring(L, 2);
...
static int wrap_vpage_set_anim_hint(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* anim_hint = (const char*)luaL_checkstring(L, 2);
...
static const struct luaL_Reg vpage_t_member_funcs[] = {
  {"set_ui_asset", wrap_vpage_set_ui_asset},
  {"set_anim_hint", wrap_vpage_set_anim_hint},
  {NULL, NULL}
};

static int wrap_vpage_t_set_prop(lua_State* L) {
  vpage_t* obj = (vpage_t*)tk_checkudata(L, 1, "vpage_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_widget_t_set_prop(L);
...
static int wrap_vpage_t_get_prop(lua_State* L) {
  vpage_t* obj = (vpage_t*)tk_checkudata(L, 1, "vpage_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(vpage_t_member_funcs, name);
  ...
  if(strcmp(name, "ui_asset") == 0) {
    lua_pushstring(L,(char*)(obj->ui_asset));
...
static void vpage_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_vpage_create},
    {"cast", wrap_vpage_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_vpage_t_get_prop},
    {"__newindex", wrap_vpage_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.vpage_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "Vpage", static_funcs, 0);
  lua_settop(L, 0);
}
...
static const struct luaL_Reg done_event_t_member_funcs[] = {
  {NULL, NULL}
};
...
static void done_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_done_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_done_event_t_get_prop},
...
static const struct luaL_Reg error_event_t_member_funcs[] = {
  {NULL, NULL}
};
...
static void error_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_error_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_error_event_t_get_prop},
...
static const struct luaL_Reg cmd_exec_event_t_member_funcs[] = {
  {NULL, NULL}
};
...
static void cmd_exec_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_cmd_exec_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_cmd_exec_event_t_get_prop},
...
static int wrap_value_change_event_cast(lua_State* L) {
  ...
  return tk_newuserdata(L, (void*)ret, "/value_change_event_t/event_t", "awtk.value_change_event_t");
}


static const struct luaL_Reg value_change_event_t_member_funcs[] = {
  {NULL, NULL}
};
...
static void value_change_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_value_change_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_value_change_event_t_get_prop},
...
static int wrap_log_message_event_cast(lua_State* L) {
  log_message_event_t* ret = NULL;
  event_t* event = (event_t*)tk_checkudata(L, 1, "event_t");
  ret = (log_message_event_t*)log_message_event_cast(event);

  return tk_newuserdata(L, (void*)ret, "/log_message_event_t/event_t", "awtk.log_message_event_t");
}


static const struct luaL_Reg log_message_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_log_message_event_t_set_prop(lua_State* L) {
  log_message_event_t* obj = (log_message_event_t*)tk_checkudata(L, 1, "log_message_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_log_message_event_t_get_prop(lua_State* L) {
  log_message_event_t* obj = (log_message_event_t*)tk_checkudata(L, 1, "log_message_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(log_message_event_t_member_funcs, name);
...
static void log_message_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"cast", wrap_log_message_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_log_message_event_t_get_prop},
    {"__newindex", wrap_log_message_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.log_message_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "LogMessageEvent", static_funcs, 0);
  lua_settop(L, 0);
}
static int wrap_named_value_create(lua_State* L) {
  ...
  return tk_newuserdata(L, (void*)ret, "/named_value_t/value_t", "awtk.named_value_t");
}
...
static int wrap_named_value_t_set_prop(lua_State* L) {
  ...
  (void)obj;
  (void)name;
    return wrap_value_t_set_prop(L);
}
...
static int wrap_named_value_t_get_prop(lua_State* L) {
  ...
  return 1;
    ...
    return wrap_value_t_get_prop(L);
  }
}
...
static const struct luaL_Reg object_fifo_set_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_object_fifo_set_event_t_set_prop(lua_State* L) {
  object_fifo_set_event_t* obj = (object_fifo_set_event_t*)tk_checkudata(L, 1, "object_fifo_set_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_object_fifo_set_event_t_get_prop(lua_State* L) {
  object_fifo_set_event_t* obj = (object_fifo_set_event_t*)tk_checkudata(L, 1, "object_fifo_set_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(object_fifo_set_event_t_member_funcs, name);
  ...
  return 1;
    ...
    lua_pushinteger(L,(lua_Integer)(obj->nr));

  return 1;
  }
  else if(strcmp(name, "data") == 0) {
    return tk_newuserdata(L, (void*)obj->data, "", "awtk.void");
  }
  else {
    return wrap_event_t_get_prop(L);
  }
...
static void object_fifo_set_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_object_fifo_set_event_t_get_prop},
    {"__newindex", wrap_object_fifo_set_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.object_fifo_set_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "ObjectFifoSetEvent", static_funcs, 0);
  lua_settop(L, 0);
}

static const struct luaL_Reg object_fifo_push_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_object_fifo_push_event_t_set_prop(lua_State* L) {
  object_fifo_push_event_t* obj = (object_fifo_push_event_t*)tk_checkudata(L, 1, "object_fifo_push_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_object_fifo_push_event_t_get_prop(lua_State* L) {
  object_fifo_push_event_t* obj = (object_fifo_push_event_t*)tk_checkudata(L, 1, "object_fifo_push_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(object_fifo_push_event_t_member_funcs, name);
...
static void object_fifo_push_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_object_fifo_push_event_t_get_prop},
    {"__newindex", wrap_object_fifo_push_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.object_fifo_push_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "ObjectFifoPushEvent", static_funcs, 0);
  lua_settop(L, 0);
}

static const struct luaL_Reg object_fifo_push_head_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_object_fifo_push_head_event_t_set_prop(lua_State* L) {
  object_fifo_push_head_event_t* obj = (object_fifo_push_head_event_t*)tk_checkudata(L, 1, "object_fifo_push_head_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_object_fifo_push_head_event_t_get_prop(lua_State* L) {
  object_fifo_push_head_event_t* obj = (object_fifo_push_head_event_t*)tk_checkudata(L, 1, "object_fifo_push_head_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(object_fifo_push_head_event_t_member_funcs, name);
...
static void object_fifo_push_head_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_object_fifo_push_head_event_t_get_prop},
    {"__newindex", wrap_object_fifo_push_head_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.object_fifo_push_head_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "ObjectFifoPushHeadEvent", static_funcs, 0);
  lua_settop(L, 0);
}

static const struct luaL_Reg object_fifo_pop_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_object_fifo_pop_event_t_set_prop(lua_State* L) {
  object_fifo_pop_event_t* obj = (object_fifo_pop_event_t*)tk_checkudata(L, 1, "object_fifo_pop_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_object_fifo_pop_event_t_get_prop(lua_State* L) {
  object_fifo_pop_event_t* obj = (object_fifo_pop_event_t*)tk_checkudata(L, 1, "object_fifo_pop_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(object_fifo_pop_event_t_member_funcs, name);
...
static void object_fifo_pop_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_object_fifo_pop_event_t_get_prop},
    {"__newindex", wrap_object_fifo_pop_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.object_fifo_pop_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "ObjectFifoPopEvent", static_funcs, 0);
  lua_settop(L, 0);
}

static const struct luaL_Reg object_fifo_pop_tail_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_object_fifo_pop_tail_event_t_set_prop(lua_State* L) {
  object_fifo_pop_tail_event_t* obj = (object_fifo_pop_tail_event_t*)tk_checkudata(L, 1, "object_fifo_pop_tail_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_object_fifo_pop_tail_event_t_get_prop(lua_State* L) {
  object_fifo_pop_tail_event_t* obj = (object_fifo_pop_tail_event_t*)tk_checkudata(L, 1, "object_fifo_pop_tail_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(object_fifo_pop_tail_event_t_member_funcs, name);
...
static void object_fifo_pop_tail_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_object_fifo_pop_tail_event_t_get_prop},
    {"__newindex", wrap_object_fifo_pop_tail_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.object_fifo_pop_tail_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "ObjectFifoPopTailEvent", static_funcs, 0);
  lua_settop(L, 0);
}
static int wrap_object_fifo_set_event_cast(lua_State* L) {
  object_fifo_set_event_t* ret = NULL;
  event_t* event = (event_t*)tk_checkudata(L, 1, "event_t");
  ret = (object_fifo_set_event_t*)object_fifo_set_event_cast(event);

  return tk_newuserdata(L, (void*)ret, "/object_fifo_value_change_event_t/event_t", "awtk.object_fifo_value_change_event_t");
}

static int wrap_object_fifo_push_event_cast(lua_State* L) {
...
static int wrap_object_fifo_push_head_event_cast(lua_State* L) {
...
static int wrap_object_fifo_pop_event_cast(lua_State* L) {
...
static int wrap_object_fifo_pop_tail_event_cast(lua_State* L) {
...
static int wrap_object_fifo_value_change_event_cast(lua_State* L) {
...
static const struct luaL_Reg object_fifo_value_change_event_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_object_fifo_value_change_event_t_set_prop(lua_State* L) {
  object_fifo_value_change_event_t* obj = (object_fifo_value_change_event_t*)tk_checkudata(L, 1, "object_fifo_value_change_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_event_t_set_prop(L);
...
static int wrap_object_fifo_value_change_event_t_get_prop(lua_State* L) {
  object_fifo_value_change_event_t* obj = (object_fifo_value_change_event_t*)tk_checkudata(L, 1, "object_fifo_value_change_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(object_fifo_value_change_event_t_member_funcs, name);
...
static void object_fifo_value_change_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"object_fifo_set_event_cast", wrap_object_fifo_set_event_cast},
    {"object_fifo_push_event_cast", wrap_object_fifo_push_event_cast},
    {"object_fifo_push_head_event_cast", wrap_object_fifo_push_head_event_cast},
    {"object_fifo_pop_event_cast", wrap_object_fifo_pop_event_cast},
    {"object_fifo_pop_tail_event_cast", wrap_object_fifo_pop_tail_event_cast},
    {"cast", wrap_object_fifo_value_change_event_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_object_fifo_value_change_event_t_get_prop},
    {"__newindex", wrap_object_fifo_value_change_event_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.object_fifo_value_change_event_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "ObjectFifoValueChangeEvent", static_funcs, 0);
  lua_settop(L, 0);
}
...
static int wrap_button_set_enable_preview(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t enable_preview = (bool_t)lua_toboolean(L, 2);
...
static const struct luaL_Reg button_t_member_funcs[] = {
  ...
  {"set_enable_preview", wrap_button_set_enable_preview},
  {NULL, NULL}
};
...
static int wrap_button_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "is_accept_status") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->is_accept_status));
...
static int wrap_check_button_create_ex(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  wh_t w = (wh_t)luaL_checkinteger(L, 4);
  wh_t h = (wh_t)luaL_checkinteger(L, 5);
  const char* type = (const char*)luaL_checkstring(L, 6);
  bool_t radio = (bool_t)lua_toboolean(L, 7);
...
static void check_button_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    ...
    {"create_ex", wrap_check_button_create_ex},
    {NULL, NULL}
  };
...
static const struct luaL_Reg clip_view_t_member_funcs[] = {
  {NULL, NULL}
};
...
static void clip_view_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_clip_view_create},
    {"cast", wrap_clip_view_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_clip_view_t_get_prop},
...
static int wrap_color_tile_get_bg_color(lua_State* L) {
  const char* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_color_tile_get_border_color(lua_State* L) {
  const char* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static const struct luaL_Reg color_tile_t_member_funcs[] = {
  ...
  {"get_bg_color", wrap_color_tile_get_bg_color},
  {"get_border_color", wrap_color_tile_get_border_color},
  {NULL, NULL}
};
...
static int wrap_edit_get_int64(lua_State* L) {
  int64_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_edit_set_double_ex(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* format = (const char*)luaL_checkstring(L, 2);
  double value = (double)luaL_checknumber(L, 3);
...
static int wrap_edit_set_select(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t start = (uint32_t)luaL_checkinteger(L, 2);
  uint32_t end = (uint32_t)luaL_checkinteger(L, 3);
...
static int wrap_edit_get_selected_text(lua_State* L) {
  char* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_edit_set_focus_next_when_enter(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t focus_next_when_enter = (bool_t)lua_toboolean(L, 2);
...
static const struct luaL_Reg edit_t_member_funcs[] = {
  ...
  {"set_double_ex", wrap_edit_set_double_ex},
  ...
  {"get_cursor", wrap_edit_get_cursor},
...
static int wrap_edit_t_get_prop(lua_State* L) {
  ...
  return 1;
    ...
    lua_pushstring(L,(char*)(obj->validator));
...
static int wrap_grid_set_rows(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t rows = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_grid_set_columns_definition(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* columns_definition = (const char*)luaL_checkstring(L, 2);
...
static int wrap_grid_set_show_grid(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t show_grid = (bool_t)lua_toboolean(L, 2);
...
static const struct luaL_Reg grid_t_member_funcs[] = {
  {"set_rows", wrap_grid_set_rows},
  {"set_columns_definition", wrap_grid_set_columns_definition},
  {"set_show_grid", wrap_grid_set_show_grid},
  {NULL, NULL}
};
...
static int wrap_grid_t_get_prop(lua_State* L) {
  ...
  if(strcmp(name, "rows") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->rows));

  return 1;
  }
  else if(strcmp(name, "columns_definition") == 0) {
    lua_pushstring(L,(char*)(obj->columns_definition));

  return 1;
  }
  else if(strcmp(name, "show_grid") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->show_grid));
...
static int wrap_group_box_set_value(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t value = (uint32_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg group_box_t_member_funcs[] = {
  {"set_value", wrap_group_box_set_value},
  {NULL, NULL}
};
...
static int wrap_label_set_max_w(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_label_set_ellipses(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t ellipses = (bool_t)lua_toboolean(L, 2);
...
static int wrap_pages_set_auto_focused(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t auto_focused = (bool_t)lua_toboolean(L, 2);
...
static const struct luaL_Reg pages_t_member_funcs[] = {
  ...
  {"set_auto_focused", wrap_pages_set_auto_focused},
...
static int wrap_pages_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "auto_focused") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->auto_focused));
...
static int wrap_slider_set_line_cap(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* line_cap = (const char*)luaL_checkstring(L, 2);
...
static const struct luaL_Reg slider_t_member_funcs[] = {
  ...
  {"set_line_cap", wrap_slider_set_line_cap},
...
static int wrap_tab_button_group_remove_index(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t index = (uint32_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg tab_button_group_t_member_funcs[] = {
  ...
  {"remove_index", wrap_tab_button_group_remove_index},
  {NULL, NULL}
};
...
static const struct luaL_Reg view_t_member_funcs[] = {
  {"set_default_focused_child", wrap_view_set_default_focused_child},
  {NULL, NULL}
};
...
static int wrap_native_window_set_window_hit_test(lua_State* L) {
  ret_t ret = 0;
  native_window_t* win = (native_window_t*)tk_checkudata(L, 1, "native_window_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
...
static int wrap_native_window_set_title(lua_State* L) {
  ret_t ret = 0;
  native_window_t* win = (native_window_t*)tk_checkudata(L, 1, "native_window_t");
  const char* app_name = (const char*)luaL_checkstring(L, 2);
...
static const struct luaL_Reg native_window_t_member_funcs[] = {
  ...
  {"set_window_hit_test", wrap_native_window_set_window_hit_test},
  {"set_fullscreen", wrap_native_window_set_fullscreen},
  {"set_cursor", wrap_native_window_set_cursor},
  {"set_title", wrap_native_window_set_title},
  {NULL, NULL}
};
...
static void window_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    ...
    {"create_default", wrap_window_create_default},
...
static int wrap_edit_ex_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  ...
  return tk_newuserdata(L, (void*)ret, "/edit_ex_t/edit_t/widget_t", "awtk.edit_ex_t");
}

static int wrap_edit_ex_set_multiline(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t multiline = (bool_t)lua_toboolean(L, 2);
...
static int wrap_edit_ex_set_suggest_words(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  tk_object_t* suggest_words = (tk_object_t*)tk_checkudata(L, 2, "tk_object_t");
...
static int wrap_edit_ex_set_suggest_words_item_formats(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* formats = (const char*)luaL_checkstring(L, 2);
...
static int wrap_edit_ex_set_suggest_words_input_name(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
...
static int wrap_edit_ex_update_suggest_words_popup(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static int wrap_edit_ex_cast(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static const struct luaL_Reg edit_ex_t_member_funcs[] = {
  {"set_multiline", wrap_edit_ex_set_multiline},
  {"set_suggest_words", wrap_edit_ex_set_suggest_words},
  {"set_suggest_words_item_formats", wrap_edit_ex_set_suggest_words_item_formats},
  {"set_suggest_words_input_name", wrap_edit_ex_set_suggest_words_input_name},
  {"update_suggest_words_popup", wrap_edit_ex_update_suggest_words_popup},
  {NULL, NULL}
};

static int wrap_edit_ex_t_set_prop(lua_State* L) {
  edit_ex_t* obj = (edit_ex_t*)tk_checkudata(L, 1, "edit_ex_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
...
static int wrap_edit_ex_t_get_prop(lua_State* L) {
  edit_ex_t* obj = (edit_ex_t*)tk_checkudata(L, 1, "edit_ex_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(edit_ex_t_member_funcs, name);
  ...
  if(strcmp(name, "suggest_words") == 0) {
    return tk_newuserdata(L, (void*)obj->suggest_words, "/tk_object_t/emitter_t", "awtk.tk_object_t");
  }
  else if(strcmp(name, "suggest_words_item_formats") == 0) {
    lua_pushstring(L,(char*)(obj->suggest_words_item_formats));

  return 1;
  }
  else if(strcmp(name, "suggest_words_input_name") == 0) {
    lua_pushstring(L,(char*)(obj->suggest_words_input_name));

  return 1;
  }
  else if(strcmp(name, "is_select_suggest_word") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->is_select_suggest_word));

  return 1;
  }
  else if(strcmp(name, "multiline") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->multiline));
...
static void edit_ex_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_edit_ex_create},
    {"cast", wrap_edit_ex_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_edit_ex_t_get_prop},
    {"__newindex", wrap_edit_ex_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.edit_ex_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "EditEx", static_funcs, 0);
  lua_settop(L, 0);
}
...
static int wrap_gif_image_set_loop(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t loop = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_gif_image_set_part_buffer_load_mode(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t part_buffer_load_mode = (bool_t)lua_toboolean(L, 2);
...
static const struct luaL_Reg gif_image_t_member_funcs[] = {
  ...
  {"set_loop", wrap_gif_image_set_loop},
  {"set_part_buffer_load_mode", wrap_gif_image_set_part_buffer_load_mode},
  {NULL, NULL}
};
...
static int wrap_gif_image_t_get_prop(lua_State* L) {
  ...
  if(strcmp(name, "loop") == 0) {
    lua_pushinteger(L,(lua_Integer)(obj->loop));

  return 1;
  }
  else if(strcmp(name, "part_buffer_load_mode") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->part_buffer_load_mode));
...
static int wrap_mutable_image_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  ...
  return tk_newuserdata(L, (void*)ret, "/mutable_image_t/image_base_t/widget_t", "awtk.mutable_image_t");
}
...
static void mutable_image_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_mutable_image_create},
    {NULL, NULL}
  };
...
static int wrap_list_item_seperator_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  ...
  return tk_newuserdata(L, (void*)ret, "/list_item_seperator_t/check_button_t/widget_t", "awtk.list_item_seperator_t");
}

static int wrap_list_item_seperator_cast(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static const struct luaL_Reg list_item_seperator_t_member_funcs[] = {
  {NULL, NULL}
};

static int wrap_list_item_seperator_t_set_prop(lua_State* L) {
  list_item_seperator_t* obj = (list_item_seperator_t*)tk_checkudata(L, 1, "list_item_seperator_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_check_button_t_set_prop(L);
}

static int wrap_list_item_seperator_t_get_prop(lua_State* L) {
  list_item_seperator_t* obj = (list_item_seperator_t*)tk_checkudata(L, 1, "list_item_seperator_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(list_item_seperator_t_member_funcs, name);
  ...
  if(ret) {
    ...
    return wrap_check_button_t_get_prop(L);
  }
}

static void list_item_seperator_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_list_item_seperator_create},
    {"cast", wrap_list_item_seperator_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_list_item_seperator_t_get_prop},
    {"__newindex", wrap_list_item_seperator_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.list_item_seperator_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "ListItemSeperator", static_funcs, 0);
  lua_settop(L, 0);
}
...
static int wrap_svg_image_set_cache_mode(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t is_cache_mode = (bool_t)lua_toboolean(L, 2);
...
static int wrap_svg_image_set_draw_type(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  image_draw_type_t draw_type = (image_draw_type_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg svg_image_t_member_funcs[] = {
  ...
  {"set_cache_mode", wrap_svg_image_set_cache_mode},
  {"set_draw_type", wrap_svg_image_set_draw_type},
  {NULL, NULL}
};
...
static int wrap_svg_image_t_get_prop(lua_State* L) {
  ...
  if(strcmp(name, "is_cache_mode") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->is_cache_mode));
...
static int wrap_idle_info_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "extra_ctx") == 0) {
    return tk_newuserdata(L, (void*)obj->extra_ctx, "", "awtk.void");
  }
...
static int wrap_named_value_hash_create(lua_State* L) {
  named_value_hash_t* ret = NULL;
  ret = (named_value_hash_t*)named_value_hash_create();

  return tk_newuserdata(L, (void*)ret, "/named_value_hash_t/named_value_t/value_t", "awtk.named_value_hash_t");
}

static int wrap_named_value_hash_set_name(lua_State* L) {
  ret_t ret = 0;
  named_value_hash_t* nvh = (named_value_hash_t*)tk_checkudata(L, 1, "named_value_hash_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
...
static int wrap_named_value_hash_destroy(lua_State* L) {
  ret_t ret = 0;
  named_value_hash_t* nvh = (named_value_hash_t*)tk_checkudata(L, 1, "named_value_hash_t");
  ret = (ret_t)named_value_hash_destroy(nvh);
...
static int wrap_named_value_hash_clone(lua_State* L) {
  named_value_hash_t* ret = NULL;
  named_value_hash_t* nvh = (named_value_hash_t*)tk_checkudata(L, 1, "named_value_hash_t");
...
static int wrap_named_value_hash_get_hash_from_str(lua_State* L) {
  uint64_t ret = 0;
...
static const struct luaL_Reg named_value_hash_t_member_funcs[] = {
  {"set_name", wrap_named_value_hash_set_name},
  {"destroy", wrap_named_value_hash_destroy},
  {"clone", wrap_named_value_hash_clone},
  {NULL, NULL}
};

static int wrap_named_value_hash_t_set_prop(lua_State* L) {
  named_value_hash_t* obj = (named_value_hash_t*)tk_checkudata(L, 1, "named_value_hash_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_named_value_t_set_prop(L);
}

static int wrap_named_value_hash_t_get_prop(lua_State* L) {
  named_value_hash_t* obj = (named_value_hash_t*)tk_checkudata(L, 1, "named_value_hash_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(named_value_hash_t_member_funcs, name);
  ...
  if(ret) {
    ...
    return wrap_named_value_t_get_prop(L);
  }
}

static void named_value_hash_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_named_value_hash_create},
    {"get_hash_from_str", wrap_named_value_hash_get_hash_from_str},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_named_value_hash_t_get_prop},
    {"__newindex", wrap_named_value_hash_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.named_value_hash_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "NamedValueHash", static_funcs, 0);
  lua_settop(L, 0);
}
...
static int wrap_object_array_remove_value(lua_State* L) {
  ret_t ret = 0;
  tk_object_t* obj = (tk_object_t*)tk_checkudata(L, 1, "tk_object_t");
  value_t* v = (value_t*)tk_checkudata(L, 2, "value_t");
...
static const struct luaL_Reg object_array_t_member_funcs[] = {
  ...
  {"remove_value", wrap_object_array_remove_value},
...
static int wrap_object_default_set_keep_prop_type(lua_State* L) {
  ret_t ret = 0;
  tk_object_t* obj = (tk_object_t*)tk_checkudata(L, 1, "tk_object_t");
  bool_t keep_prop_type = (bool_t)lua_toboolean(L, 2);
...
static int wrap_object_hash_create(lua_State* L) {
  tk_object_t* ret = NULL;
  ret = (tk_object_t*)object_hash_create();

  return tk_newuserdata(L, (void*)ret, "/object_hash_t/tk_object_t/emitter_t", "awtk.object_hash_t");
}

static int wrap_object_hash_create_ex(lua_State* L) {
  tk_object_t* ret = NULL;
  bool_t enable_path = (bool_t)lua_toboolean(L, 1);
  ret = (tk_object_t*)object_hash_create_ex(enable_path);

  return tk_newuserdata(L, (void*)ret, "/object_hash_t/tk_object_t/emitter_t", "awtk.object_hash_t");
}

static int wrap_object_hash_set_keep_prop_type(lua_State* L) {
  ret_t ret = 0;
  tk_object_t* obj = (tk_object_t*)tk_checkudata(L, 1, "tk_object_t");
  bool_t keep_prop_type = (bool_t)lua_toboolean(L, 2);
...
static int wrap_object_hash_set_name_case_insensitive(lua_State* L) {
  ret_t ret = 0;
  tk_object_t* obj = (tk_object_t*)tk_checkudata(L, 1, "tk_object_t");
  bool_t name_case_insensitive = (bool_t)lua_toboolean(L, 2);
...
static int wrap_object_hash_set_keep_props_order(lua_State* L) {
  ret_t ret = 0;
  tk_object_t* obj = (tk_object_t*)tk_checkudata(L, 1, "tk_object_t");
  bool_t keep_props_order = (bool_t)lua_toboolean(L, 2);
...
static const struct luaL_Reg object_hash_t_member_funcs[] = {
  {"set_keep_prop_type", wrap_object_hash_set_keep_prop_type},
  {"set_name_case_insensitive", wrap_object_hash_set_name_case_insensitive},
  {"set_keep_props_order", wrap_object_hash_set_keep_props_order},
  {NULL, NULL}
};

static int wrap_object_hash_t_set_prop(lua_State* L) {
  object_hash_t* obj = (object_hash_t*)tk_checkudata(L, 1, "object_hash_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
    return wrap_tk_object_t_set_prop(L);
...
static int wrap_object_hash_t_get_prop(lua_State* L) {
  object_hash_t* obj = (object_hash_t*)tk_checkudata(L, 1, "object_hash_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(object_hash_t_member_funcs, name);
...
static void object_hash_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_object_hash_create},
    {"create_ex", wrap_object_hash_create_ex},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_object_hash_t_get_prop},
    {"__newindex", wrap_object_hash_t_set_prop},
    {NULL, NULL}
  };

  luaL_newmetatable(L, "awtk.object_hash_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "ObjectHash", static_funcs, 0);
  lua_settop(L, 0);
}
...
static int wrap_calibration_win_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  ...
  return tk_newuserdata(L, (void*)ret, "/calibration_win_t/window_base_t/widget_t", "awtk.calibration_win_t");
}
...
static const struct luaL_Reg calibration_win_t_member_funcs[] = {
  {NULL, NULL}
};
...
static void calibration_win_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
    {"create", wrap_calibration_win_create},
    {"cast", wrap_calibration_win_cast},
    {NULL, NULL}
  };

  static const struct luaL_Reg index_funcs[] = {
    {"__index", wrap_calibration_win_t_get_prop},
...
static int wrap_combo_box_set_theme_of_popup(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* theme_of_popup = (const char*)luaL_checkstring(L, 2);
...
static int wrap_combo_box_set_selected_index_by_text(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* text = (const char*)luaL_checkstring(L, 2);
...
static int wrap_combo_box_remove_option_by_index(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t index = (uint32_t)luaL_checkinteger(L, 2);
...
static int wrap_combo_box_has_option_text(lua_State* L) {
  bool_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* text = (const char*)luaL_checkstring(L, 2);
...
static int wrap_combo_box_get_text_of_selected(lua_State* L) {
  const char* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
...
static const struct luaL_Reg combo_box_t_member_funcs[] = {
  ...
  {"set_theme_of_popup", wrap_combo_box_set_theme_of_popup},
  ...
  {"set_selected_index_by_text", wrap_combo_box_set_selected_index_by_text},
  ...
  {"remove_option_by_index", wrap_combo_box_remove_option_by_index},
  {"set_options", wrap_combo_box_set_options},
  {"get_value_int", wrap_combo_box_get_value},
  {"has_option_text", wrap_combo_box_has_option_text},
  {"get_text_value", wrap_combo_box_get_text},
  {"get_text_of_selected", wrap_combo_box_get_text_of_selected},
  {NULL, NULL}
};
...
static int wrap_combo_box_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "theme_of_popup") == 0) {
    lua_pushstring(L,(char*)(obj->theme_of_popup));
...
static int wrap_icon_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
...
static int wrap_overlay_set_modeless(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t modeless = (bool_t)lua_toboolean(L, 2);
...
static const struct luaL_Reg overlay_t_member_funcs[] = {
  ...
  {"set_modeless", wrap_overlay_set_modeless},
  {NULL, NULL}
};
...
static int wrap_overlay_t_get_prop(lua_State* L) {
  ...
  else if(strcmp(name, "modeless") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->modeless));
...
static int wrap_spin_box_set_easy_touch_mode(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  bool_t easy_touch_mode = (bool_t)lua_toboolean(L, 2);
...
static int wrap_spin_box_set_button_position(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* button_position = (const char*)luaL_checkstring(L, 2);
...
static int wrap_spin_set_repeat(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  int32_t repeat = (int32_t)luaL_checkinteger(L, 2);
...
static const struct luaL_Reg spin_box_t_member_funcs[] = {
  {"set_easy_touch_mode", wrap_spin_box_set_easy_touch_mode},
  {"set_button_position", wrap_spin_box_set_button_position},
  {"spin_set_repeat", wrap_spin_set_repeat},
  {NULL, NULL}
};
...
static int wrap_spin_box_t_get_prop(lua_State* L) {
  ...
  if(strcmp(name, "easy_touch_mode") == 0) {
    lua_pushboolean(L,(lua_Integer)(obj->easy_touch_mode));

  return 1;
  }
  else if(strcmp(name, "button_position") == 0) {
    lua_pushstring(L,(char*)(obj->button_position));
...
static int wrap_combo_box_ex_create(lua_State* L) {
  ...
  return tk_newuserdata(L, (void*)ret, "/combo_box_ex_t/combo_box_t/edit_t/widget_t", "awtk.combo_box_ex_t");
}
...
void luaL_openawtk(lua_State* L) {
  ...
  locale_infos_t_init(L);
  style_id_t_init(L);
  style_t_init(L);
  system_info_flag_t_init(L);
  theme_t_init(L);
  timer_t_init(L);
  align_v_t_init(L);
  align_h_t_init(L);
  ...
  app_conf_t_init(L);
  conf_utils_t_init(L);
  edit_ex_prop_t_init(L);
  edit_ex_suggest_words_prop_t_init(L);
  ...
  widget_animator_event_t_init(L);
  model_event_t_init(L);
  wheel_event_t_init(L);
  orientation_event_t_init(L);
  offset_change_event_t_init(L);
  pointer_event_t_init(L);
  key_event_t_init(L);
  paint_event_t_init(L);
  window_event_t_init(L);
  multi_gesture_event_t_init(L);
  theme_change_event_t_init(L);
  drop_file_event_t_init(L);
  system_event_t_init(L);
  touch_event_t_init(L);
  ui_load_event_t_init(L);
  font_manager_t_init(L);
  image_base_t_init(L);
  locale_info_xml_t_init(L);
  ...
  log_message_event_t_init(L);
  named_value_t_init(L);
  object_fifo_set_event_t_init(L);
  object_fifo_push_event_t_init(L);
  object_fifo_push_head_event_t_init(L);
  object_fifo_pop_event_t_init(L);
  object_fifo_pop_tail_event_t_init(L);
  object_fifo_value_change_event_t_init(L);
  app_bar_t_init(L);
  ...
  list_item_seperator_t_init(L);
  svg_image_t_init(L);
  idle_info_t_init(L);
  named_value_hash_t_init(L);
  object_array_t_init(L);
  object_default_t_init(L);
  object_hash_t_init(L);
  timer_info_t_init(L);
