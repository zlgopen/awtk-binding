 ...
 */
 ...
 public  TRet setFocusNextWhenEnter(boolean focus_next_when_enter)  {
   ...
   * @return 返回RET_OK表示成功，否则表示失败。
   */
 public  TRet setScrollToBeginOnBlur(boolean scroll_to_begin_on_blur)  {
   return TRet.from(edit_set_scroll_to_begin_on_blur(this != null ? (this.nativeObj) : 0, scroll_to_begin_on_blur));
 }
 ...
 public boolean getFocusNextWhenEnter() {
   ...
   *
   */
 public boolean getScrollToBeginOnBlur() {
...
static private native int edit_set_scroll_to_begin_on_blur(long widget, boolean scroll_to_begin_on_blur);
...
static private native boolean edit_t_get_prop_scroll_to_begin_on_blur(long nativeObj);
};