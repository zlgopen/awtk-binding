...
int awtk_TObject_object_get_type(Runtime *runtime, JClass *clazz) {
  ...
  const char* ret = NULL;
  const object_t* obj = (const object_t*)jni_ctx_get_object(&actx);
...
int awtk_TValue_value_equal(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TValue_value_id(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TValue_value_func(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TValue_value_func_def(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TGlobal_tk_pre_init(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TGlobal_tk_quit_ex(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TImageDrawType_IMAGE_DRAW_FILL(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(IMAGE_DRAW_FILL));
...
int awtk_TCanvas_canvas_reset_font(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TCanvas_canvas_reset_cache(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TEventType_EVT_MOUSE_EXTRA_BUTTON_DOWN(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_MOUSE_EXTRA_BUTTON_DOWN));

  return 0;
}

int awtk_TEventType_EVT_MOUSE_EXTRA_BUTTON_UP(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_MOUSE_EXTRA_BUTTON_UP));
...
int awtk_TEventType_EVT_DOUBLE_CLICK(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_DOUBLE_CLICK));
...
int awtk_TEventType_EVT_THEME_WILL_CHANGE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_THEME_WILL_CHANGE));
...
int awtk_TEventType_EVT_WIDGET_WILL_UPDATE_STYLE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_WIDGET_WILL_UPDATE_STYLE));

  return 0;
}

int awtk_TEventType_EVT_WIDGET_UPDATE_STYLE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_WIDGET_UPDATE_STYLE));
...
int awtk_TEventType_EVT_PAGE_CHANGING(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_PAGE_CHANGING));
...
int awtk_TEventType_EVT_DATA(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_DATA));

  return 0;
}

int awtk_TEventType_EVT_CONNECT(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_CONNECT));

  return 0;
}

int awtk_TEventType_EVT_MODEL_CHANGE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_MODEL_CHANGE));

  return 0;
}

int awtk_TEventType_EVT_SYSTEM(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_SYSTEM));

  return 0;
}

int awtk_TEventType_EVT_DROP_FILE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_DROP_FILE));

  return 0;
}

int awtk_TEventType_EVT_LOCALE_INFOS_LOAD_INFO(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_LOCALE_INFOS_LOAD_INFO));

  return 0;
}

int awtk_TEventType_EVT_LOCALE_INFOS_UNLOAD_INFO(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_LOCALE_INFOS_UNLOAD_INFO));

  return 0;
}

int awtk_TEventType_EVT_ACTIVATED(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_ACTIVATED));

  return 0;
}

int awtk_TEventType_EVT_UNACTIVATED(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_UNACTIVATED));

  return 0;
}

int awtk_TEventType_EVT_UI_LOAD(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_UI_LOAD));

  return 0;
}

int awtk_TEventType_EVT_TOUCH_DOWN(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_TOUCH_DOWN));

  return 0;
}

int awtk_TEventType_EVT_TOUCH_MOVE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_TOUCH_MOVE));

  return 0;
}

int awtk_TEventType_EVT_TOUCH_UP(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_TOUCH_UP));
...
int awtk_TEventType_EVT_LOG_MESSAGE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(EVT_LOG_MESSAGE));
...
int awtk_TFontBidiType_FONT_BIDI_TYPE_AUTO(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(FONT_BIDI_TYPE_AUTO));

  return 0;
}

int awtk_TFontBidiType_FONT_BIDI_TYPE_LTR(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(FONT_BIDI_TYPE_LTR));

  return 0;
}

int awtk_TFontBidiType_FONT_BIDI_TYPE_RTL(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(FONT_BIDI_TYPE_RTL));

  return 0;
}

int awtk_TFontBidiType_FONT_BIDI_TYPE_LRO(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(FONT_BIDI_TYPE_LRO));

  return 0;
}

int awtk_TFontBidiType_FONT_BIDI_TYPE_RLO(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(FONT_BIDI_TYPE_RLO));

  return 0;
}

int awtk_TFontBidiType_FONT_BIDI_TYPE_WLTR(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(FONT_BIDI_TYPE_WLTR));

  return 0;
}

int awtk_TFontBidiType_FONT_BIDI_TYPE_WRTL(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(FONT_BIDI_TYPE_WRTL));
...
int awtk_TGlyphFormat_GLYPH_FMT_ALPHA2(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(GLYPH_FMT_ALPHA2));

  return 0;
}

int awtk_TGlyphFormat_GLYPH_FMT_ALPHA4(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(GLYPH_FMT_ALPHA4));
...
int awtk_TInputMethod_input_method_dispatch_keys(Runtime *runtime, JClass *clazz) {
  ...
  ret_t ret = 0;
  input_method_t* im = (input_method_t*)jni_ctx_get_object(&actx);
  const char* keys = (const char*)jni_ctx_get_str(&actx);
...
int awtk_TKeyCode_TK_KEY_KP_DIVIDE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_DIVIDE));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_MULTIPLY(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_MULTIPLY));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_MINUS(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_MINUS));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_PLUS(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_PLUS));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_ENTER(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_ENTER));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_1(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_1));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_2(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_2));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_3(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_3));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_4(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_4));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_5(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_5));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_6(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_6));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_7(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_7));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_8(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_8));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_9(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_9));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_0(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_0));

  return 0;
}

int awtk_TKeyCode_TK_KEY_KP_PERIOD(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_KP_PERIOD));

  return 0;
}

int awtk_TKeyCode_TK_KEY_NUMLOCKCLEAR(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(TK_KEY_NUMLOCKCLEAR));
...
int awtk_TLocaleInfos_locale_infos_ref(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TLocaleInfos_locale_infos_unref(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TLocaleInfos_locale_infos_change(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TLocaleInfos_locale_infos_off(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TLocaleInfos_locale_infos_reload_all(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TStyleId_STYLE_ID_DRAGGER_COLOR(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(STYLE_ID_DRAGGER_COLOR));
...
int awtk_TStyleId_STYLE_ID_CLEAR_BG(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(STYLE_ID_CLEAR_BG));

  return 0;
}

int awtk_TStyleId_STYLE_ID_GRID_COLOR(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(STYLE_ID_GRID_COLOR));

  return 0;
}

int awtk_TStyleId_STYLE_ID_EVEN_BG_COLOR(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(STYLE_ID_EVEN_BG_COLOR));

  return 0;
}

int awtk_TStyleId_STYLE_ID_ODD_BG_COLOR(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(STYLE_ID_ODD_BG_COLOR));
...
int awtk_TStyle_style_get(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSystemInfoFlag_SYSTEM_INFO_FLAG_NONE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(SYSTEM_INFO_FLAG_NONE));

  return 0;
}

int awtk_TSystemInfoFlag_SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT));
...
int awtk_TTimer_timer_modify_ex(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  uint32_t timer_id = (uint32_t)jni_ctx_get_int(&actx);
  uint32_t duration = (uint32_t)jni_ctx_get_int(&actx);
  bool_t reset_timer = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TAppType_APP_CONSOLE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(APP_CONSOLE));
...
int awtk_TBitmapFlag_BITMAP_FLAG_LCD_ORIENTATION(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(BITMAP_FLAG_LCD_ORIENTATION));

  return 0;
}

int awtk_TBitmapFlag_BITMAP_FLAG_GPU_FBO_TEXTURE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(BITMAP_FLAG_GPU_FBO_TEXTURE));
...
int awtk_TVgcanvas_vgcanvas_is_rectf_in_clip_rect(Runtime *runtime, JClass *clazz) {
  ...
  bool_t ret = 0;
  vgcanvas_t* vg = (vgcanvas_t*)jni_ctx_get_object(&actx);
  float_t left = (float_t)jni_ctx_get_float(&actx);
...
int awtk_TVgcanvas_vgcanvas_set_font_size(Runtime *runtime, JClass *clazz) {
  ...
  ret_t ret = 0;
  vgcanvas_t* vg = (vgcanvas_t*)jni_ctx_get_object(&actx);
  float_t size = (float_t)jni_ctx_get_float(&actx);
...
int awtk_TVgcanvas_vgcanvas_fill_text_by_glyphs(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  vgcanvas_t* vg = (vgcanvas_t*)jni_ctx_get_object(&actx);
  glyphs_t* glyphs = (glyphs_t*)jni_ctx_get_int64(&actx);
  uint32_t start = (uint32_t)jni_ctx_get_int(&actx);
  uint32_t len = (uint32_t)jni_ctx_get_int(&actx);
  xy_t x = (xy_t)jni_ctx_get_int(&actx);
  xy_t y = (xy_t)jni_ctx_get_int(&actx);
  float_t max_width = (float_t)jni_ctx_get_float(&actx);
...
int awtk_TVgcanvas_vgcanvas_draw_image_repeat(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
  ...
  float_t dw = (float_t)jni_ctx_get_float(&actx);
  float_t dh = (float_t)jni_ctx_get_float(&actx);
  float_t dst_w = (float_t)jni_ctx_get_float(&actx);
  float_t dst_h = (float_t)jni_ctx_get_float(&actx);
...
int awtk_TWidgetProp_WIDGET_PROP_LINE_HEIGHT(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_LINE_HEIGHT));
...
int awtk_TWidgetProp_WIDGET_PROP_SHAPING(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_SHAPING));
...
int awtk_TWidgetProp_WIDGET_PROP_LOADING(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_LOADING));
...
int awtk_TWidgetProp_WIDGET_PROP_EASY_TOUCH_MODE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_EASY_TOUCH_MODE));
...
int awtk_TWidgetProp_WIDGET_PROP_ELLIPSES(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_ELLIPSES));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL));
...
int awtk_TWidgetProp_WIDGET_PROP_STATE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_STATE));
...
int awtk_TWidgetProp_WIDGET_PROP_APPLET_NAME(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_APPLET_NAME));
...
int awtk_TWidgetProp_WIDGET_PROP_RUNNING(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_RUNNING));
...
int awtk_TWidgetProp_WIDGET_PROP_ENABLE_PREVIEW(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_ENABLE_PREVIEW));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_IS_ACCEPT_STATUS(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_IS_ACCEPT_STATUS));
...
int awtk_TWidgetProp_WIDGET_PROP_THEME_OF_POPUP(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_THEME_OF_POPUP));
...
int awtk_TWidgetProp_WIDGET_PROP_ACCEPT_BUTTON(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_ACCEPT_BUTTON));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_CANCEL_BUTTON(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_CANCEL_BUTTON));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_ACCEPT_RETRUN(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_ACCEPT_RETRUN));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_ACCEPT_TAB(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_ACCEPT_TAB));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_ROWS(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_ROWS));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_SHOW_GRID(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_SHOW_GRID));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_COLUMNS_DEFINITION(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_COLUMNS_DEFINITION));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_DRAG_THRESHOLD(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_DRAG_THRESHOLD));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_ANIMATING_TIME(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_ANIMATING_TIME));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_ANIMATE_PREFIX(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_ANIMATE_PREFIX));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_ANIMATE_ANIMATING_TIME(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidgetProp_WIDGET_PROP_SCREEN_SAVER_TIME(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_SCREEN_SAVER_TIME));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_SHOW_FPS(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_SHOW_FPS));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_MAX_FPS(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_MAX_FPS));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_VALIDATOR(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_VALIDATOR));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_SYNC_STATE_TO_CHILDREN(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_SYNC_STATE_TO_CHILDREN));

  return 0;
}

int awtk_TWidgetProp_WIDGET_PROP_STATE_FROM_PARENT_SYNC(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_PROP_STATE_FROM_PARENT_SYNC));
...
int awtk_TWidgetType_WIDGET_TYPE_ICON(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_TYPE_ICON));
...
int awtk_TWidgetType_WIDGET_TYPE_PAGE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_TYPE_PAGE));
...
int awtk_TWidgetState_WIDGET_STATE_ACTIVATED(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_STATE_ACTIVATED));
...
int awtk_TWidgetState_WIDGET_STATE_EMPTY_OVER(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_STATE_EMPTY_OVER));
...
int awtk_TWidgetState_WIDGET_STATE_NORMAL_OF_INDETERMINATE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_STATE_NORMAL_OF_INDETERMINATE));

  return 0;
}

int awtk_TWidgetState_WIDGET_STATE_PRESSED_OF_INDETERMINATE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_STATE_PRESSED_OF_INDETERMINATE));

  return 0;
}

int awtk_TWidgetState_WIDGET_STATE_OVER_OF_INDETERMINATE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_STATE_OVER_OF_INDETERMINATE));

  return 0;
}

int awtk_TWidgetState_WIDGET_STATE_DISABLE_OF_INDETERMINATE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_STATE_DISABLE_OF_INDETERMINATE));

  return 0;
}

int awtk_TWidgetState_WIDGET_STATE_FOCUSED_OF_INDETERMINATE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(WIDGET_STATE_FOCUSED_OF_INDETERMINATE));
...
int awtk_TWidget_widget_count_children(Runtime *runtime, JClass *clazz) {
  ...
  int32_t ret = 0;
  const widget_t* widget = (const widget_t*)jni_ctx_get_object(&actx);
...
int awtk_TWidget_widget_find_parent_by_name(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_find_parent_by_type(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_move_to_center(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_move_resize_ex(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
  ...
  wh_t w = (wh_t)jni_ctx_get_int(&actx);
  wh_t h = (wh_t)jni_ctx_get_int(&actx);
  bool_t update_layout = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TWidget_widget_add_value(Runtime *runtime, JClass *clazz) {
  ...
  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  float_t delta = (float_t)jni_ctx_get_float(&actx);
...
int awtk_TWidget_widget_get_value_int(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_set_value_int(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_add_value_int(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_is_support_highlighter(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_has_highlighter(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_set_text_utf8_ex(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  const char* text = (const char*)jni_ctx_get_str(&actx);
  bool_t check_diff = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TWidget_widget_get_theme_name(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_set_sync_state_to_children(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t sync_state_to_children = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TWidget_widget_set_state_from_parent_sync(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t state_from_parent_sync = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TWidget_widget_get_prop(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_set_prop(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_set_props(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_set_prop_float(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  const char* name = (const char*)jni_ctx_get_str(&actx);
  float_t v = (float_t)jni_ctx_get_float(&actx);
...
int awtk_TWidget_widget_get_prop_float(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_is_parent_of(Runtime *runtime, JClass *clazz) {
  ...
  bool_t ret = 0;
  const widget_t* widget = (const widget_t*)jni_ctx_get_object(&actx);
  const widget_t* child = (const widget_t*)jni_ctx_get_object(&actx);
...
int awtk_TWidget_widget_is_fullscreen_window(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_is_always_on_top(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_is_suspend_dialog(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_is_suspend_popup(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_ref(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_add_child_default(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidget_widget_t_get_prop_sync_state_to_children(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  widget_t* obj = (widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->sync_state_to_children));

  return 0;
}

int awtk_TWidget_widget_t_get_prop_state_from_parent_sync(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  widget_t* obj = (widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->state_from_parent_sync));

  return 0;
}

int awtk_TWidget_widget_t_get_prop_opacity(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  widget_t* obj = (widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->opacity));
...
int awtk_TConfUtils_object_load_conf(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  object_t* obj = (object_t*)jni_ctx_get_object(&actx);
  const char* url = (const char*)jni_ctx_get_str(&actx);
  const char* type = (const char*)jni_ctx_get_str(&actx);
...
int awtk_TEditExProp_EDIT_EX_PROP_MULTILINE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(EDIT_EX_PROP_MULTILINE));

  return 0;
}

int awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(EDIT_EX_PROP_SUGGEST_WORDS));

  return 0;
}

int awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS));

  return 0;
}

int awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE));

  return 0;
}

int awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE));

  return 0;
}

int awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE));

  return 0;
}

int awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME));

  return 0;
}

int awtk_TEditExProp_EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD));

  return 0;
}

int awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS));

  return 0;
}

int awtk_TEditExSuggestWordsProp_EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME));
...
int awtk_TAssetInfo_asset_info_is_in_rom(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TAssetInfo_asset_info_t_get_prop_flags(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TDateTime_date_time_from_time(Runtime *runtime, JClass *clazz) {
  ...
  ret_t ret = 0;
  date_time_t* dt = (date_time_t*)jni_ctx_get_object(&actx);
  int64_t time = (int64_t)jni_ctx_get_int64(&actx);
...
int awtk_TObjectCmd_OBJECT_CMD_EXEC(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(OBJECT_CMD_EXEC));

  return 0;
}

int awtk_TObjectCmd_OBJECT_CMD_UNDO(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(OBJECT_CMD_UNDO));
...
int awtk_TObjectProp_OBJECT_PROP_DISABLE_PATH(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(OBJECT_PROP_DISABLE_PATH));

  return 0;
}

int awtk_TObjectProp_OBJECT_PROP_KEEP_PROPS_ORDER(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(OBJECT_PROP_KEEP_PROPS_ORDER));
...
int awtk_TObjectProp_OBJECT_PROP_SELECTED_INDEX(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_str(&actx, (char*)(OBJECT_PROP_SELECTED_INDEX));
...
int awtk_TRet_RET_NO_PERMISSION(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(RET_NO_PERMISSION));

  return 0;
}

int awtk_TRet_RET_INVALID_ADDR(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(RET_INVALID_ADDR));

  return 0;
}

int awtk_TRet_RET_EXCEED_RANGE(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(RET_EXCEED_RANGE));

  return 0;
}

int awtk_TRet_RET_MAX_NR(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(RET_MAX_NR));
...
int awtk_TValueType_VALUE_TYPE_ID(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(VALUE_TYPE_ID));

  return 0;
}

int awtk_TValueType_VALUE_TYPE_FUNC(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(VALUE_TYPE_FUNC));

  return 0;
}

int awtk_TValueType_VALUE_TYPE_FUNC_DEF(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(VALUE_TYPE_FUNC_DEF));

  return 0;
}

int awtk_TValueType_VALUE_TYPE_POINTER_REF(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(VALUE_TYPE_POINTER_REF));

  return 0;
}

int awtk_TValueType_VALUE_TYPE_BITMAP(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  jni_ctx_return_int(&actx, (int32_t)(VALUE_TYPE_BITMAP));
...
int awtk_TWidgetAnimatorEvent_widget_animator_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWidgetAnimatorEvent_widget_animator_event_t_get_prop_widget(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  widget_animator_event_t* obj = (widget_animator_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_object(&actx, (void*)(obj->widget));

  return 0;
}

int awtk_TWidgetAnimatorEvent_widget_animator_event_t_get_prop_animator(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  widget_animator_event_t* obj = (widget_animator_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int64(&actx, (int64_t)(obj->animator));

  return 0;
}

int awtk_TModelEvent_model_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TModelEvent_model_event_t_get_prop_name(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  model_event_t* obj = (model_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->name));

  return 0;
}

int awtk_TModelEvent_model_event_t_get_prop_change_type(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  model_event_t* obj = (model_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->change_type));

  return 0;
}

int awtk_TModelEvent_model_event_t_get_prop_model(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  model_event_t* obj = (model_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_object(&actx, (void*)(obj->model));
...
int awtk_TWheelEvent_wheel_event_t_get_prop_x(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWheelEvent_wheel_event_t_get_prop_y(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TOffsetChangeEvent_offset_change_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TPointerEvent_pointer_event_t_get_prop_finger_id(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  pointer_event_t* obj = (pointer_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->finger_id));
...
int awtk_TKeyEvent_key_event_t_get_prop_numlock(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  key_event_t* obj = (key_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->numlock));
...
int awtk_TThemeChangeEvent_theme_change_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TThemeChangeEvent_theme_change_event_t_get_prop_name(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  theme_change_event_t* obj = (theme_change_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->name));

  return 0;
}

int awtk_TDropFileEvent_drop_file_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TDropFileEvent_drop_file_event_t_get_prop_filename(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  drop_file_event_t* obj = (drop_file_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->filename));

  return 0;
}

int awtk_TSystemEvent_system_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSystemEvent_system_event_t_get_prop_sdl_event(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  system_event_t* obj = (system_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int64(&actx, (int64_t)(obj->sdl_event));

  return 0;
}

int awtk_TTouchEvent_touch_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTouchEvent_touch_event_t_get_prop_touch_id(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  touch_event_t* obj = (touch_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int64(&actx, (int64_t)(obj->touch_id));

  return 0;
}

int awtk_TTouchEvent_touch_event_t_get_prop_finger_id(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  touch_event_t* obj = (touch_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int64(&actx, (int64_t)(obj->finger_id));

  return 0;
}

int awtk_TTouchEvent_touch_event_t_get_prop_x(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTouchEvent_touch_event_t_get_prop_y(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTouchEvent_touch_event_t_get_prop_pressure(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  touch_event_t* obj = (touch_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_float(&actx, (float)(obj->pressure));

  return 0;
}

int awtk_TUiLoadEvent_ui_load_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TUiLoadEvent_ui_load_event_t_get_prop_root(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ui_load_event_t* obj = (ui_load_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_object(&actx, (void*)(obj->root));

  return 0;
}

int awtk_TUiLoadEvent_ui_load_event_t_get_prop_name(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWindowBase_window_base_t_get_prop_accept_button(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  window_base_t* obj = (window_base_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->accept_button));

  return 0;
}

int awtk_TWindowBase_window_base_t_get_prop_cancel_button(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  window_base_t* obj = (window_base_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->cancel_button));

  return 0;
}

int awtk_TWindowBase_window_base_t_get_prop_applet_name(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  window_base_t* obj = (window_base_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->applet_name));
...
int awtk_TWindowManager_window_manager_get_foreground_window(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWindowManager_window_manager_set_show_fps_position(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TWindowManager_window_manager_set_fullscreen(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TDraggable_draggable_set_allow_out_of_screen(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t allow_out_of_screen = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TDraggable_draggable_set_drag_native_window(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t drag_native_window = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TDraggable_draggable_set_drag_parent(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t drag_parent = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TDraggable_draggable_t_get_prop_allow_out_of_screen(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  draggable_t* obj = (draggable_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->allow_out_of_screen));
...
int awtk_TDraggable_draggable_t_get_prop_drag_native_window(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  draggable_t* obj = (draggable_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->drag_native_window));

  return 0;
}

int awtk_TDraggable_draggable_t_get_prop_drag_parent(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  draggable_t* obj = (draggable_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->drag_parent));
...
int awtk_TFileBrowserView_file_browser_view_set_odd_item_style(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  const char* odd_item_style = (const char*)jni_ctx_get_str(&actx);
...
int awtk_TFileBrowserView_file_browser_view_set_even_item_style(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  const char* even_item_style = (const char*)jni_ctx_get_str(&actx);
...
int awtk_TFileBrowserView_file_browser_view_t_get_prop_odd_item_style(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  file_browser_view_t* obj = (file_browser_view_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->odd_item_style));

  return 0;
}

int awtk_TFileBrowserView_file_browser_view_t_get_prop_even_item_style(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  file_browser_view_t* obj = (file_browser_view_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->even_item_style));
...
int awtk_TImageValue_image_value_set_click_add_delta(Runtime *runtime, JClass *clazz) {
  ...
  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  double click_add_delta = (double)jni_ctx_get_float(&actx);
...
int awtk_TCandidates_candidates_set_visible_num(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t visible_num = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TCandidates_candidates_t_get_prop_enable_preview(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  candidates_t* obj = (candidates_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->enable_preview));

  return 0;
}

int awtk_TCandidates_candidates_t_get_prop_visible_num(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  candidates_t* obj = (candidates_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->visible_num));
...
int awtk_TLineNumber_line_number_add_highlight_line(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  int32_t line = (int32_t)jni_ctx_get_int(&actx);
...
int awtk_TLineNumber_line_number_set_active_line(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TLineNumber_line_number_clear_highlight(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TLineNumber_line_number_is_highlight_line(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TMledit_mledit_get_current_line_index(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TMledit_mledit_get_current_row_index(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TMledit_mledit_get_start_line_index(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TMledit_mledit_get_start_row_index(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TMledit_mledit_get_line_at(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TMledit_mledit_get_row_at(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TMledit_mledit_get_row_of_line(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  int32_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t line = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TMledit_mledit_t_get_prop_accept_return(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  mledit_t* obj = (mledit_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->accept_return));

  return 0;
}

int awtk_TMledit_mledit_t_get_prop_accept_tab(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  mledit_t* obj = (mledit_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->accept_tab));

  return 0;
}

int awtk_TMledit_mledit_t_get_prop_auto_adjust_height(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  mledit_t* obj = (mledit_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->auto_adjust_height));
...
int awtk_TRichText_rich_text_set_word_wrap(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TRichText_rich_text_t_get_prop_word_wrap(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_THscrollLabel_hscroll_label_set_speed(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  float_t speed = (float_t)jni_ctx_get_float(&actx);
...
int awtk_THscrollLabel_hscroll_label_set_stop_at_begin(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t stop_at_begin = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_THscrollLabel_hscroll_label_set_delay(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_THscrollLabel_hscroll_label_set_loop_interval_distance(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  int32_t loop_interval_distance = (int32_t)jni_ctx_get_int(&actx);
...
int awtk_THscrollLabel_hscroll_label_t_get_prop_delay(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_THscrollLabel_hscroll_label_t_get_prop_speed(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  hscroll_label_t* obj = (hscroll_label_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_float(&actx, (float)(obj->speed));
...
int awtk_THscrollLabel_hscroll_label_t_get_prop_stop_at_begin(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  hscroll_label_t* obj = (hscroll_label_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->stop_at_begin));

  return 0;
}

int awtk_THscrollLabel_hscroll_label_t_get_prop_loop_interval_distance(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  hscroll_label_t* obj = (hscroll_label_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->loop_interval_distance));
...
int awtk_TListView_list_view_t_get_prop_item_width(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TScrollBar_scroll_bar_set_animator_time(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t animator_time = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TScrollBar_scroll_bar_hide_by_opacity_animation(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  int32_t duration = (int32_t)jni_ctx_get_int(&actx);
  int32_t delay = (int32_t)jni_ctx_get_int(&actx);
...
int awtk_TScrollBar_scroll_bar_show_by_opacity_animation(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TScrollBar_scroll_bar_set_wheel_scroll(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t scroll = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TScrollBar_scroll_bar_set_scroll_delta(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t scroll_delta = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TScrollBar_scroll_bar_set_scroll_rows(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint8_t scroll_rows = (uint8_t)jni_ctx_get_int(&actx);
...
int awtk_TScrollBar_scroll_bar_t_get_prop_animator_time(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  scroll_bar_t* obj = (scroll_bar_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->animator_time));

  return 0;
}

int awtk_TScrollBar_scroll_bar_t_get_prop_scroll_delta(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  scroll_bar_t* obj = (scroll_bar_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->scroll_delta));

  return 0;
}

int awtk_TScrollBar_scroll_bar_t_get_prop_scroll_rows(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  scroll_bar_t* obj = (scroll_bar_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->scroll_rows));
...
int awtk_TScrollBar_scroll_bar_t_get_prop_wheel_scroll(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  scroll_bar_t* obj = (scroll_bar_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->wheel_scroll));

  return 0;
}

int awtk_TScrollBar_scroll_bar_t_get_prop_wheel_modifier_key(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  scroll_bar_t* obj = (scroll_bar_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->wheel_modifier_key));
...
int awtk_TScrollView_scroll_view_set_slide_limit_ratio(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  float_t slide_limit_ratio = (float_t)jni_ctx_get_float(&actx);
...
int awtk_TScrollView_scroll_view_t_get_prop_use_virtual_w(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  scroll_view_t* obj = (scroll_view_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->use_virtual_w));

  return 0;
}

int awtk_TScrollView_scroll_view_t_get_prop_use_widget_w(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  scroll_view_t* obj = (scroll_view_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->use_widget_w));

  return 0;
}

int awtk_TScrollView_scroll_view_t_get_prop_use_virtual_h(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  scroll_view_t* obj = (scroll_view_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->use_virtual_h));

  return 0;
}

int awtk_TScrollView_scroll_view_t_get_prop_use_widget_h(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  scroll_view_t* obj = (scroll_view_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->use_widget_h));
...
int awtk_TScrollView_scroll_view_t_get_prop_slide_limit_ratio(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  scroll_view_t* obj = (scroll_view_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_float(&actx, (float)(obj->slide_limit_ratio));

  return 0;
}

int awtk_TSerialWidget_serial_widget_create(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSerialWidget_serial_widget_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSerialWidget_serial_widget_set_baudrate(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t baudrate = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TSerialWidget_serial_widget_set_device(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  const char* device = (const char*)jni_ctx_get_str(&actx);
...
int awtk_TSerialWidget_serial_widget_set_bytesize(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t bytesize = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TSerialWidget_serial_widget_set_parity(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t parity = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TSerialWidget_serial_widget_set_stopbits(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t stopbits = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TSerialWidget_serial_widget_set_flowcontrol(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t flowcontrol = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TSerialWidget_serial_widget_set_check_interval(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t check_interval = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TSerialWidget_serial_widget_t_get_prop_device(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  serial_widget_t* obj = (serial_widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->device));

  return 0;
}

int awtk_TSerialWidget_serial_widget_t_get_prop_baudrate(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  serial_widget_t* obj = (serial_widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->baudrate));

  return 0;
}

int awtk_TSerialWidget_serial_widget_t_get_prop_bytesize(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  serial_widget_t* obj = (serial_widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->bytesize));

  return 0;
}

int awtk_TSerialWidget_serial_widget_t_get_prop_parity(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  serial_widget_t* obj = (serial_widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->parity));

  return 0;
}

int awtk_TSerialWidget_serial_widget_t_get_prop_stopbits(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  serial_widget_t* obj = (serial_widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->stopbits));

  return 0;
}

int awtk_TSerialWidget_serial_widget_t_get_prop_flowcontrol(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  serial_widget_t* obj = (serial_widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->flowcontrol));
...
int awtk_TSerialWidget_serial_widget_t_get_prop_check_interval(Runtime *runtime, JClass *clazz) {
  ...
  serial_widget_t* obj = (serial_widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->check_interval));
...
int awtk_TSlideMenu_slide_menu_set_spacer(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  int32_t spacer = (int32_t)jni_ctx_get_int(&actx);
...
int awtk_TSlideMenu_slide_menu_set_menu_w(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  const char* menu_w = (const char*)jni_ctx_get_str(&actx);
...
int awtk_TSlideMenu_slide_menu_set_clip(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t clip = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TSlideMenu_slide_menu_scroll_to_prev(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSlideMenu_slide_menu_scroll_to_next(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSlideMenu_slide_menu_t_get_prop_spacer(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  slide_menu_t* obj = (slide_menu_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->spacer));

  return 0;
}

int awtk_TSlideMenu_slide_menu_t_get_prop_menu_w(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  slide_menu_t* obj = (slide_menu_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->menu_w));

  return 0;
}

int awtk_TSlideMenu_slide_menu_t_get_prop_clip(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  slide_menu_t* obj = (slide_menu_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->clip));
...
int awtk_TSlideIndicator_slide_indicator_set_transition(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t transition = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TSlideIndicator_slide_indicator_t_get_prop_transition(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  slide_indicator_t* obj = (slide_indicator_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->transition));
...
int awtk_TSlideView_slide_view_set_drag_threshold(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t drag_threshold = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TSlideView_slide_view_set_animating_time(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSlideView_slide_view_t_get_prop_drag_threshold(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  slide_view_t* obj = (slide_view_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->drag_threshold));

  return 0;
}

int awtk_TSlideView_slide_view_t_get_prop_animating_time(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSlideView_slide_view_t_get_prop_active(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTextSelector_text_selector_set_mask_easing(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  easing_type_t mask_easing = (easing_type_t)jni_ctx_get_int(&actx);
...
int awtk_TTextSelector_text_selector_set_mask_area_scale(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  float_t mask_area_scale = (float_t)jni_ctx_get_float(&actx);
...
int awtk_TTextSelector_text_selector_set_ellipses(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTextSelector_text_selector_t_get_prop_ellipses(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTextSelector_text_selector_t_get_prop_mask_easing(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  text_selector_t* obj = (text_selector_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->mask_easing));

  return 0;
}

int awtk_TTextSelector_text_selector_t_get_prop_mask_area_scale(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  text_selector_t* obj = (text_selector_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_float(&actx, (float)(obj->mask_area_scale));
...
int awtk_TTimerWidget_timer_widget_create(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTimerWidget_timer_widget_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTimerWidget_timer_widget_set_duration(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTimerWidget_timer_widget_t_get_prop_duration(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  timer_widget_t* obj = (timer_widget_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->duration));
...
int awtk_TLogMessageEvent_log_message_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectFifoSetEvent_object_fifo_set_event_t_get_prop_index(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  object_fifo_set_event_t* obj = (object_fifo_set_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->index));

  return 0;
}

int awtk_TObjectFifoSetEvent_object_fifo_set_event_t_get_prop_nr(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  object_fifo_set_event_t* obj = (object_fifo_set_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->nr));

  return 0;
}

int awtk_TObjectFifoSetEvent_object_fifo_set_event_t_get_prop_data(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  object_fifo_set_event_t* obj = (object_fifo_set_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int64(&actx, (int64_t)(obj->data));

  return 0;
}

int awtk_TObjectFifoPushEvent_object_fifo_push_event_t_get_prop_nr(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  object_fifo_push_event_t* obj = (object_fifo_push_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->nr));

  return 0;
}

int awtk_TObjectFifoPushEvent_object_fifo_push_event_t_get_prop_data(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectFifoPushHeadEvent_object_fifo_push_head_event_t_get_prop_nr(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  object_fifo_push_head_event_t* obj = (object_fifo_push_head_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->nr));

  return 0;
}

int awtk_TObjectFifoPushHeadEvent_object_fifo_push_head_event_t_get_prop_data(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectFifoPopEvent_object_fifo_pop_event_t_get_prop_nr(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  object_fifo_pop_event_t* obj = (object_fifo_pop_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->nr));

  return 0;
}

int awtk_TObjectFifoPopTailEvent_object_fifo_pop_tail_event_t_get_prop_nr(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  object_fifo_pop_tail_event_t* obj = (object_fifo_pop_tail_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->nr));

  return 0;
}

int awtk_TObjectFifoValueChangeEvent_object_fifo_set_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectFifoValueChangeEvent_object_fifo_push_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectFifoValueChangeEvent_object_fifo_push_head_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectFifoValueChangeEvent_object_fifo_pop_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectFifoValueChangeEvent_object_fifo_pop_tail_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectFifoValueChangeEvent_object_fifo_value_change_event_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectFifoValueChangeEvent_object_fifo_value_change_event_t_get_prop_type(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  object_fifo_value_change_event_t* obj = (object_fifo_value_change_event_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->type));
...
int awtk_TButton_button_set_enable_preview(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t enable_preview = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TButton_button_t_get_prop_enable_preview(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TButton_button_t_get_prop_is_accept_status(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  button_t* obj = (button_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->is_accept_status));

  return 0;
}

int awtk_TButton_button_t_get_prop_pressed(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TCheckButton_check_button_set_indeterminate(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t indeterminate = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TCheckButton_check_button_get_indeterminate(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TCheckButton_check_button_create_ex(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
  ...
  wh_t h = (wh_t)jni_ctx_get_int(&actx);
  const char* type = (const char*)jni_ctx_get_str(&actx);
  bool_t radio = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TEdit_edit_get_int64(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TEdit_edit_set_double_ex(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TEdit_edit_set_focus_next_when_enter(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t focus_next_when_enter = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TEdit_edit_set_scroll_to_begin_on_blur(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t scroll_to_begin_on_blur = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TEdit_edit_t_get_prop_validator(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  edit_t* obj = (edit_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->validator));
...
int awtk_TEdit_edit_t_get_prop_focus_next_when_enter(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  edit_t* obj = (edit_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->focus_next_when_enter));

  return 0;
}

int awtk_TEdit_edit_t_get_prop_scroll_to_begin_on_blur(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  edit_t* obj = (edit_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->scroll_to_begin_on_blur));
...
int awtk_TGrid_grid_set_rows(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t rows = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TGrid_grid_set_columns_definition(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  const char* columns_definition = (const char*)jni_ctx_get_str(&actx);
...
int awtk_TGrid_grid_set_show_grid(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t show_grid = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TGrid_grid_t_get_prop_rows(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  grid_t* obj = (grid_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->rows));

  return 0;
}

int awtk_TGrid_grid_t_get_prop_columns_definition(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  grid_t* obj = (grid_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->columns_definition));

  return 0;
}

int awtk_TGrid_grid_t_get_prop_show_grid(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  grid_t* obj = (grid_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->show_grid));
...
int awtk_TGroupBox_group_box_set_value(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TGroupBox_group_box_t_get_prop_value(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  group_box_t* obj = (group_box_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->value));
...
int awtk_TLabel_label_set_ellipses(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TLabel_label_t_get_prop_ellipses(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TPages_pages_set_auto_focused(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t auto_focused = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TPages_pages_t_get_prop_auto_focused(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  pages_t* obj = (pages_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->auto_focused));
...
int awtk_TSlider_slider_set_line_cap(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSlider_slider_set_drag_threshold(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSlider_slider_t_get_prop_drag_threshold(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTabButtonGroup_tab_button_group_set_drag_child(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t drag_child = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TTabButtonGroup_tab_button_group_remove_index(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTabButtonGroup_tab_button_group_t_get_prop_drag_child(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  tab_button_group_t* obj = (tab_button_group_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->drag_child));
...
int awtk_TTabButton_tab_button_set_max_w(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTabButton_tab_button_restack(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TTabButton_tab_button_t_get_prop_max_w(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TNativeWindow_native_window_set_window_hit_test(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TNativeWindow_native_window_set_title(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TEditEx_edit_ex_create(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TEditEx_edit_ex_set_multiline(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t multiline = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TEditEx_edit_ex_set_suggest_words(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  object_t* suggest_words = (object_t*)jni_ctx_get_object(&actx);
...
int awtk_TEditEx_edit_ex_set_suggest_words_item_formats(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  const char* formats = (const char*)jni_ctx_get_str(&actx);
...
int awtk_TEditEx_edit_ex_set_suggest_words_input_name(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TEditEx_edit_ex_update_suggest_words_popup(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TEditEx_edit_ex_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TEditEx_edit_ex_t_get_prop_suggest_words(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  edit_ex_t* obj = (edit_ex_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_object(&actx, (void*)(obj->suggest_words));

  return 0;
}

int awtk_TEditEx_edit_ex_t_get_prop_suggest_words_item_formats(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  edit_ex_t* obj = (edit_ex_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->suggest_words_item_formats));

  return 0;
}

int awtk_TEditEx_edit_ex_t_get_prop_suggest_words_input_name(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  edit_ex_t* obj = (edit_ex_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->suggest_words_input_name));

  return 0;
}

int awtk_TEditEx_edit_ex_t_get_prop_is_select_suggest_word(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  edit_ex_t* obj = (edit_ex_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->is_select_suggest_word));

  return 0;
}

int awtk_TEditEx_edit_ex_t_get_prop_multiline(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  edit_ex_t* obj = (edit_ex_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->multiline));
...
int awtk_TGifImage_gif_image_set_loop(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  uint32_t loop = (uint32_t)jni_ctx_get_int(&actx);
...
int awtk_TGifImage_gif_image_set_part_buffer_load_mode(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t part_buffer_load_mode = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TGifImage_gif_image_t_get_prop_loop(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  gif_image_t* obj = (gif_image_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->loop));

  return 0;
}

int awtk_TGifImage_gif_image_t_get_prop_part_buffer_load_mode(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  gif_image_t* obj = (gif_image_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->part_buffer_load_mode));
...
int awtk_TListItemSeperator_list_item_seperator_create(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TListItemSeperator_list_item_seperator_cast(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSvgImage_svg_image_set_cache_mode(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t is_cache_mode = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TSvgImage_svg_image_set_draw_type(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSvgImage_svg_image_t_get_prop_is_cache_mode(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  svg_image_t* obj = (svg_image_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->is_cache_mode));

  return 0;
}

int awtk_TSvgImage_svg_image_t_get_prop_draw_type(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectArray_object_array_remove_value(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectDefault_object_default_set_keep_prop_type(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectDefault_object_default_set_name_case_insensitive(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  object_t* obj = (object_t*)jni_ctx_get_object(&actx);
  bool_t name_case_insensitive = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TObjectHash_object_hash_set_name_case_insensitive(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TObjectHash_object_hash_set_keep_props_order(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  object_t* obj = (object_t*)jni_ctx_get_object(&actx);
  bool_t keep_props_order = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TComboBox_combo_box_set_theme_of_popup(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  const char* theme_of_popup = (const char*)jni_ctx_get_str(&actx);
...
int awtk_TComboBox_combo_box_set_selected_index_by_text(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TComboBox_combo_box_remove_option_by_index(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TComboBox_combo_box_has_option_text(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TComboBox_combo_box_get_text_of_selected(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TComboBox_combo_box_t_get_prop_theme_of_popup(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  combo_box_t* obj = (combo_box_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->theme_of_popup));
...
int awtk_TImage_icon_create(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TOverlay_overlay_set_modeless(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t modeless = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TOverlay_overlay_t_get_prop_modeless(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  overlay_t* obj = (overlay_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->modeless));
...
int awtk_TSpinBox_spin_box_set_easy_touch_mode(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  bool_t easy_touch_mode = (bool_t)jni_ctx_get_int(&actx);
...
int awtk_TSpinBox_spin_box_set_button_position(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&actx);
  const char* button_position = (const char*)jni_ctx_get_str(&actx);
...
int awtk_TSpinBox_spin_set_repeat(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);
...
int awtk_TSpinBox_spin_box_t_get_prop_easy_touch_mode(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  spin_box_t* obj = (spin_box_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_int(&actx, (int32_t)(obj->easy_touch_mode));

  return 0;
}

int awtk_TSpinBox_spin_box_t_get_prop_button_position(Runtime *runtime, JClass *clazz) {
  jni_ctx_t actx = jni_ctx_init(runtime, clazz);

  spin_box_t* obj = (spin_box_t*)jni_ctx_get_object(&actx);
  jni_ctx_return_str(&actx, (char*)(obj->button_position));
...
{"awtk/TValue",  "value_id",  "(J)Ljava/lang/String;",  awtk_TValue_value_id},
...
{"awtk/TGlobal",  "tk_quit_ex",  "(I)I",  awtk_TGlobal_tk_quit_ex},
...
{"awtk/TImageDrawType",  "IMAGE_DRAW_FILL",  "()I",  awtk_TImageDrawType_IMAGE_DRAW_FILL},
...
{"awtk/TCanvas",  "canvas_reset_font",  "(J)I",  awtk_TCanvas_canvas_reset_font},
...
{"awtk/TCanvas",  "canvas_reset_cache",  "(J)I",  awtk_TCanvas_canvas_reset_cache},
...
{"awtk/TEventType",  "EVT_MOUSE_EXTRA_BUTTON_DOWN",  "()I",  awtk_TEventType_EVT_MOUSE_EXTRA_BUTTON_DOWN},
{"awtk/TEventType",  "EVT_MOUSE_EXTRA_BUTTON_UP",  "()I",  awtk_TEventType_EVT_MOUSE_EXTRA_BUTTON_UP},
...
{"awtk/TEventType",  "EVT_DOUBLE_CLICK",  "()I",  awtk_TEventType_EVT_DOUBLE_CLICK},
...
{"awtk/TEventType",  "EVT_THEME_WILL_CHANGE",  "()I",  awtk_TEventType_EVT_THEME_WILL_CHANGE},
{"awtk/TEventType",  "EVT_THEME_CHANGED",  "()I",  awtk_TEventType_EVT_THEME_CHANGED},
{"awtk/TEventType",  "EVT_WIDGET_WILL_UPDATE_STYLE",  "()I",  awtk_TEventType_EVT_WIDGET_WILL_UPDATE_STYLE},
{"awtk/TEventType",  "EVT_WIDGET_UPDATE_STYLE",  "()I",  awtk_TEventType_EVT_WIDGET_UPDATE_STYLE},
...
{"awtk/TEventType",  "EVT_PAGE_CHANGING",  "()I",  awtk_TEventType_EVT_PAGE_CHANGING},
...
{"awtk/TEventType",  "EVT_DATA",  "()I",  awtk_TEventType_EVT_DATA},
{"awtk/TEventType",  "EVT_CONNECT",  "()I",  awtk_TEventType_EVT_CONNECT},
{"awtk/TEventType",  "EVT_MODEL_CHANGE",  "()I",  awtk_TEventType_EVT_MODEL_CHANGE},
{"awtk/TEventType",  "EVT_SYSTEM",  "()I",  awtk_TEventType_EVT_SYSTEM},
{"awtk/TEventType",  "EVT_DROP_FILE",  "()I",  awtk_TEventType_EVT_DROP_FILE},
{"awtk/TEventType",  "EVT_LOCALE_INFOS_LOAD_INFO",  "()I",  awtk_TEventType_EVT_LOCALE_INFOS_LOAD_INFO},
{"awtk/TEventType",  "EVT_LOCALE_INFOS_UNLOAD_INFO",  "()I",  awtk_TEventType_EVT_LOCALE_INFOS_UNLOAD_INFO},
{"awtk/TEventType",  "EVT_ACTIVATED",  "()I",  awtk_TEventType_EVT_ACTIVATED},
{"awtk/TEventType",  "EVT_UNACTIVATED",  "()I",  awtk_TEventType_EVT_UNACTIVATED},
{"awtk/TEventType",  "EVT_UI_LOAD",  "()I",  awtk_TEventType_EVT_UI_LOAD},
{"awtk/TEventType",  "EVT_TOUCH_DOWN",  "()I",  awtk_TEventType_EVT_TOUCH_DOWN},
{"awtk/TEventType",  "EVT_TOUCH_MOVE",  "()I",  awtk_TEventType_EVT_TOUCH_MOVE},
{"awtk/TEventType",  "EVT_TOUCH_UP",  "()I",  awtk_TEventType_EVT_TOUCH_UP},
...
{"awtk/TFontBidiType",  "FONT_BIDI_TYPE_AUTO",  "()I",  awtk_TFontBidiType_FONT_BIDI_TYPE_AUTO},
{"awtk/TFontBidiType",  "FONT_BIDI_TYPE_LTR",  "()I",  awtk_TFontBidiType_FONT_BIDI_TYPE_LTR},
{"awtk/TFontBidiType",  "FONT_BIDI_TYPE_RTL",  "()I",  awtk_TFontBidiType_FONT_BIDI_TYPE_RTL},
{"awtk/TFontBidiType",  "FONT_BIDI_TYPE_LRO",  "()I",  awtk_TFontBidiType_FONT_BIDI_TYPE_LRO},
{"awtk/TFontBidiType",  "FONT_BIDI_TYPE_RLO",  "()I",  awtk_TFontBidiType_FONT_BIDI_TYPE_RLO},
{"awtk/TFontBidiType",  "FONT_BIDI_TYPE_WLTR",  "()I",  awtk_TFontBidiType_FONT_BIDI_TYPE_WLTR},
{"awtk/TFontBidiType",  "FONT_BIDI_TYPE_WRTL",  "()I",  awtk_TFontBidiType_FONT_BIDI_TYPE_WRTL},
...
{"awtk/TGlyphFormat",  "GLYPH_FMT_ALPHA2",  "()I",  awtk_TGlyphFormat_GLYPH_FMT_ALPHA2},
{"awtk/TGlyphFormat",  "GLYPH_FMT_ALPHA4",  "()I",  awtk_TGlyphFormat_GLYPH_FMT_ALPHA4},
...
{"awtk/TKeyCode",  "TK_KEY_KP_DIVIDE",  "()I",  awtk_TKeyCode_TK_KEY_KP_DIVIDE},
{"awtk/TKeyCode",  "TK_KEY_KP_MULTIPLY",  "()I",  awtk_TKeyCode_TK_KEY_KP_MULTIPLY},
{"awtk/TKeyCode",  "TK_KEY_KP_MINUS",  "()I",  awtk_TKeyCode_TK_KEY_KP_MINUS},
{"awtk/TKeyCode",  "TK_KEY_KP_PLUS",  "()I",  awtk_TKeyCode_TK_KEY_KP_PLUS},
{"awtk/TKeyCode",  "TK_KEY_KP_ENTER",  "()I",  awtk_TKeyCode_TK_KEY_KP_ENTER},
{"awtk/TKeyCode",  "TK_KEY_KP_1",  "()I",  awtk_TKeyCode_TK_KEY_KP_1},
{"awtk/TKeyCode",  "TK_KEY_KP_2",  "()I",  awtk_TKeyCode_TK_KEY_KP_2},
{"awtk/TKeyCode",  "TK_KEY_KP_3",  "()I",  awtk_TKeyCode_TK_KEY_KP_3},
{"awtk/TKeyCode",  "TK_KEY_KP_4",  "()I",  awtk_TKeyCode_TK_KEY_KP_4},
{"awtk/TKeyCode",  "TK_KEY_KP_5",  "()I",  awtk_TKeyCode_TK_KEY_KP_5},
{"awtk/TKeyCode",  "TK_KEY_KP_6",  "()I",  awtk_TKeyCode_TK_KEY_KP_6},
{"awtk/TKeyCode",  "TK_KEY_KP_7",  "()I",  awtk_TKeyCode_TK_KEY_KP_7},
{"awtk/TKeyCode",  "TK_KEY_KP_8",  "()I",  awtk_TKeyCode_TK_KEY_KP_8},
{"awtk/TKeyCode",  "TK_KEY_KP_9",  "()I",  awtk_TKeyCode_TK_KEY_KP_9},
{"awtk/TKeyCode",  "TK_KEY_KP_0",  "()I",  awtk_TKeyCode_TK_KEY_KP_0},
{"awtk/TKeyCode",  "TK_KEY_KP_PERIOD",  "()I",  awtk_TKeyCode_TK_KEY_KP_PERIOD},
{"awtk/TKeyCode",  "TK_KEY_NUMLOCKCLEAR",  "()I",  awtk_TKeyCode_TK_KEY_NUMLOCKCLEAR},
...
{"awtk/TLocaleInfos",  "locale_infos_ref",  "(Ljava/lang/String;)J",  awtk_TLocaleInfos_locale_infos_ref},
{"awtk/TLocaleInfos",  "locale_infos_unref",  "(J)I",  awtk_TLocaleInfos_locale_infos_unref},
{"awtk/TLocaleInfos",  "locale_infos_change",  "(Ljava/lang/String;Ljava/lang/String;)I",  awtk_TLocaleInfos_locale_infos_change},
...
{"awtk/TStyleId",  "STYLE_ID_DRAGGER_COLOR",  "()Ljava/lang/String;",  awtk_TStyleId_STYLE_ID_DRAGGER_COLOR},
...
{"awtk/TStyleId",  "STYLE_ID_CLEAR_BG",  "()Ljava/lang/String;",  awtk_TStyleId_STYLE_ID_CLEAR_BG},
{"awtk/TStyleId",  "STYLE_ID_GRID_COLOR",  "()Ljava/lang/String;",  awtk_TStyleId_STYLE_ID_GRID_COLOR},
{"awtk/TStyleId",  "STYLE_ID_EVEN_BG_COLOR",  "()Ljava/lang/String;",  awtk_TStyleId_STYLE_ID_EVEN_BG_COLOR},
{"awtk/TStyleId",  "STYLE_ID_ODD_BG_COLOR",  "()Ljava/lang/String;",  awtk_TStyleId_STYLE_ID_ODD_BG_COLOR},
...
{"awtk/TStyle",  "style_get",  "(JLjava/lang/String;Ljava/lang/String;J)I",  awtk_TStyle_style_get},
...
{"awtk/TSystemInfoFlag",  "SYSTEM_INFO_FLAG_NONE",  "()I",  awtk_TSystemInfoFlag_SYSTEM_INFO_FLAG_NONE},
{"awtk/TSystemInfoFlag",  "SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT",  "()I",  awtk_TSystemInfoFlag_SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT},
...
{"awtk/TTimer",  "timer_modify_ex",  "(IIZ)I",  awtk_TTimer_timer_modify_ex},
...
{"awtk/TAppType",  "APP_CONSOLE",  "()I",  awtk_TAppType_APP_CONSOLE},
...
{"awtk/TVgcanvas",  "vgcanvas_fill_text_by_glyphs",  "(JJIIIIF)I",  awtk_TVgcanvas_vgcanvas_fill_text_by_glyphs},
...
{"awtk/TVgcanvas",  "vgcanvas_draw_image_repeat",  "(JJFFFFFFFFFF)I",  awtk_TVgcanvas_vgcanvas_draw_image_repeat},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_LINE_HEIGHT",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_LINE_HEIGHT},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_SHAPING",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_SHAPING},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_LOADING",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_LOADING},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_EASY_TOUCH_MODE",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_EASY_TOUCH_MODE},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_ELLIPSES",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_ELLIPSES},
{"awtk/TWidgetProp",  "WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_STATE",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_STATE},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_APPLET_NAME",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_APPLET_NAME},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_RUNNING",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_RUNNING},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_ENABLE_PREVIEW",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_ENABLE_PREVIEW},
{"awtk/TWidgetProp",  "WIDGET_PROP_IS_ACCEPT_STATUS",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_IS_ACCEPT_STATUS},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_THEME_OF_POPUP",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_THEME_OF_POPUP},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_ACCEPT_BUTTON",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_ACCEPT_BUTTON},
{"awtk/TWidgetProp",  "WIDGET_PROP_CANCEL_BUTTON",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_CANCEL_BUTTON},
{"awtk/TWidgetProp",  "WIDGET_PROP_ACCEPT_RETRUN",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_ACCEPT_RETRUN},
{"awtk/TWidgetProp",  "WIDGET_PROP_ACCEPT_TAB",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_ACCEPT_TAB},
{"awtk/TWidgetProp",  "WIDGET_PROP_ROWS",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_ROWS},
{"awtk/TWidgetProp",  "WIDGET_PROP_SHOW_GRID",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_SHOW_GRID},
{"awtk/TWidgetProp",  "WIDGET_PROP_COLUMNS_DEFINITION",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_COLUMNS_DEFINITION},
{"awtk/TWidgetProp",  "WIDGET_PROP_DRAG_THRESHOLD",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_DRAG_THRESHOLD},
...
{"awtk/TWidgetProp",  "WIDGET_PROP_SCREEN_SAVER_TIME",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_SCREEN_SAVER_TIME},
{"awtk/TWidgetProp",  "WIDGET_PROP_SHOW_FPS",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_SHOW_FPS},
{"awtk/TWidgetProp",  "WIDGET_PROP_MAX_FPS",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_MAX_FPS},
{"awtk/TWidgetProp",  "WIDGET_PROP_VALIDATOR",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_VALIDATOR},
{"awtk/TWidgetProp",  "WIDGET_PROP_SYNC_STATE_TO_CHILDREN",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_SYNC_STATE_TO_CHILDREN},
{"awtk/TWidgetProp",  "WIDGET_PROP_STATE_FROM_PARENT_SYNC",  "()Ljava/lang/String;",  awtk_TWidgetProp_WIDGET_PROP_STATE_FROM_PARENT_SYNC},
...
{"awtk/TWidgetType",  "WIDGET_TYPE_ICON",  "()Ljava/lang/String;",  awtk_TWidgetType_WIDGET_TYPE_ICON},
...
{"awtk/TWidgetType",  "WIDGET_TYPE_PAGE",  "()Ljava/lang/String;",  awtk_TWidgetType_WIDGET_TYPE_PAGE},
...
{"awtk/TWidgetState",  "WIDGET_STATE_ACTIVATED",  "()Ljava/lang/String;",  awtk_TWidgetState_WIDGET_STATE_ACTIVATED},
...
{"awtk/TWidgetState",  "WIDGET_STATE_EMPTY_OVER",  "()Ljava/lang/String;",  awtk_TWidgetState_WIDGET_STATE_EMPTY_OVER},
...
{"awtk/TWidgetState",  "WIDGET_STATE_NORMAL_OF_INDETERMINATE",  "()Ljava/lang/String;",  awtk_TWidgetState_WIDGET_STATE_NORMAL_OF_INDETERMINATE},
{"awtk/TWidgetState",  "WIDGET_STATE_PRESSED_OF_INDETERMINATE",  "()Ljava/lang/String;",  awtk_TWidgetState_WIDGET_STATE_PRESSED_OF_INDETERMINATE},
{"awtk/TWidgetState",  "WIDGET_STATE_OVER_OF_INDETERMINATE",  "()Ljava/lang/String;",  awtk_TWidgetState_WIDGET_STATE_OVER_OF_INDETERMINATE},
{"awtk/TWidgetState",  "WIDGET_STATE_DISABLE_OF_INDETERMINATE",  "()Ljava/lang/String;",  awtk_TWidgetState_WIDGET_STATE_DISABLE_OF_INDETERMINATE},
{"awtk/TWidgetState",  "WIDGET_STATE_FOCUSED_OF_INDETERMINATE",  "()Ljava/lang/String;",  awtk_TWidgetState_WIDGET_STATE_FOCUSED_OF_INDETERMINATE},
...
{"awtk/TWidget",  "widget_find_parent_by_name",  "(JLjava/lang/String;)J",  awtk_TWidget_widget_find_parent_by_name},
{"awtk/TWidget",  "widget_find_parent_by_type",  "(JLjava/lang/String;)J",  awtk_TWidget_widget_find_parent_by_type},
...
{"awtk/TWidget",  "widget_move_to_center",  "(J)I",  awtk_TWidget_widget_move_to_center},
...
{"awtk/TWidget",  "widget_move_resize_ex",  "(JIIIIZ)I",  awtk_TWidget_widget_move_resize_ex},
{"awtk/TWidget",  "widget_get_value",  "(J)F",  awtk_TWidget_widget_get_value},
{"awtk/TWidget",  "widget_set_value",  "(JF)I",  awtk_TWidget_widget_set_value},
{"awtk/TWidget",  "widget_add_value",  "(JF)I",  awtk_TWidget_widget_add_value},
{"awtk/TWidget",  "widget_get_value_int",  "(J)I",  awtk_TWidget_widget_get_value_int},
...
{"awtk/TWidget",  "widget_set_text_utf8_ex",  "(JLjava/lang/String;Z)I",  awtk_TWidget_widget_set_text_utf8_ex},
...
{"awtk/TWidget",  "widget_get_theme_name",  "(J)Ljava/lang/String;",  awtk_TWidget_widget_get_theme_name},
...
{"awtk/TWidget",  "widget_set_sync_state_to_children",  "(JZ)I",  awtk_TWidget_widget_set_sync_state_to_children},
{"awtk/TWidget",  "widget_set_state_from_parent_sync",  "(JZ)I",  awtk_TWidget_widget_set_state_from_parent_sync},
...
{"awtk/TWidget",  "widget_get_prop",  "(JLjava/lang/String;J)I",  awtk_TWidget_widget_get_prop},
{"awtk/TWidget",  "widget_set_prop",  "(JLjava/lang/String;J)I",  awtk_TWidget_widget_set_prop},
...
{"awtk/TWidget",  "widget_is_fullscreen_window",  "(J)Z",  awtk_TWidget_widget_is_fullscreen_window},
...
{"awtk/TWidget",  "widget_is_always_on_top",  "(J)Z",  awtk_TWidget_widget_is_always_on_top},
{"awtk/TWidget",  "widget_is_suspend_dialog",  "(J)Z",  awtk_TWidget_widget_is_suspend_dialog},
{"awtk/TWidget",  "widget_is_suspend_popup",  "(J)Z",  awtk_TWidget_widget_is_suspend_popup},
...
{"awtk/TWidget",  "widget_ref",  "(J)J",  awtk_TWidget_widget_ref},
...
{"awtk/TWidget",  "widget_add_child_default",  "(JJ)I",  awtk_TWidget_widget_add_child_default},
...
{"awtk/TWidget",  "widget_t_get_prop_sync_state_to_children",  "(J)Z",  awtk_TWidget_widget_t_get_prop_sync_state_to_children},
{"awtk/TWidget",  "widget_t_get_prop_state_from_parent_sync",  "(J)Z",  awtk_TWidget_widget_t_get_prop_state_from_parent_sync},
{"awtk/TWidget",  "widget_t_get_prop_opacity",  "(J)I",  awtk_TWidget_widget_t_get_prop_opacity},
...
{"awtk/TConfUtils",  "object_load_conf",  "(JLjava/lang/String;Ljava/lang/String;)I",  awtk_TConfUtils_object_load_conf},
{"awtk/TEditExProp",  "EDIT_EX_PROP_MULTILINE",  "()Ljava/lang/String;",  awtk_TEditExProp_EDIT_EX_PROP_MULTILINE},
{"awtk/TEditExProp",  "EDIT_EX_PROP_SUGGEST_WORDS",  "()Ljava/lang/String;",  awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS},
{"awtk/TEditExProp",  "EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS",  "()Ljava/lang/String;",  awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS},
{"awtk/TEditExProp",  "EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE",  "()Ljava/lang/String;",  awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE},
{"awtk/TEditExProp",  "EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE",  "()Ljava/lang/String;",  awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE},
{"awtk/TEditExProp",  "EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE",  "()Ljava/lang/String;",  awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE},
{"awtk/TEditExProp",  "EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME",  "()Ljava/lang/String;",  awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME},
{"awtk/TEditExProp",  "EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD",  "()Ljava/lang/String;",  awtk_TEditExProp_EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD},
{"awtk/TEditExProp",  "EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS",  "()Ljava/lang/String;",  awtk_TEditExProp_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS},
{"awtk/TEditExSuggestWordsProp",  "EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME",  "()Ljava/lang/String;",  awtk_TEditExSuggestWordsProp_EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME},
...
{"awtk/TObjectCmd",  "OBJECT_CMD_EXEC",  "()Ljava/lang/String;",  awtk_TObjectCmd_OBJECT_CMD_EXEC},
{"awtk/TObjectCmd",  "OBJECT_CMD_UNDO",  "()Ljava/lang/String;",  awtk_TObjectCmd_OBJECT_CMD_UNDO},
{"awtk/TObjectProp",  "OBJECT_PROP_SIZE",  "()Ljava/lang/String;",  awtk_TObjectProp_OBJECT_PROP_SIZE},
{"awtk/TObjectProp",  "OBJECT_PROP_DISABLE_PATH",  "()Ljava/lang/String;",  awtk_TObjectProp_OBJECT_PROP_DISABLE_PATH},
{"awtk/TObjectProp",  "OBJECT_PROP_KEEP_PROPS_ORDER",  "()Ljava/lang/String;",  awtk_TObjectProp_OBJECT_PROP_KEEP_PROPS_ORDER},
...
{"awtk/TRet",  "RET_NO_PERMISSION",  "()I",  awtk_TRet_RET_NO_PERMISSION},
{"awtk/TRet",  "RET_INVALID_ADDR",  "()I",  awtk_TRet_RET_INVALID_ADDR},
{"awtk/TRet",  "RET_EXCEED_RANGE",  "()I",  awtk_TRet_RET_EXCEED_RANGE},
{"awtk/TRet",  "RET_MAX_NR",  "()I",  awtk_TRet_RET_MAX_NR},
...
{"awtk/TValueType",  "VALUE_TYPE_ID",  "()I",  awtk_TValueType_VALUE_TYPE_ID},
{"awtk/TValueType",  "VALUE_TYPE_FUNC",  "()I",  awtk_TValueType_VALUE_TYPE_FUNC},
...
{"awtk/TWidgetAnimatorEvent",  "widget_animator_event_cast",  "(J)J",  awtk_TWidgetAnimatorEvent_widget_animator_event_cast},
{"awtk/TWidgetAnimatorEvent",  "widget_animator_event_t_get_prop_widget",  "(J)J",  awtk_TWidgetAnimatorEvent_widget_animator_event_t_get_prop_widget},
{"awtk/TWidgetAnimatorEvent",  "widget_animator_event_t_get_prop_animator",  "(J)J",  awtk_TWidgetAnimatorEvent_widget_animator_event_t_get_prop_animator},
{"awtk/TModelEvent",  "model_event_cast",  "(J)J",  awtk_TModelEvent_model_event_cast},
{"awtk/TModelEvent",  "model_event_t_get_prop_name",  "(J)Ljava/lang/String;",  awtk_TModelEvent_model_event_t_get_prop_name},
{"awtk/TModelEvent",  "model_event_t_get_prop_change_type",  "(J)Ljava/lang/String;",  awtk_TModelEvent_model_event_t_get_prop_change_type},
{"awtk/TModelEvent",  "model_event_t_get_prop_model",  "(J)J",  awtk_TModelEvent_model_event_t_get_prop_model},
{"awtk/TWheelEvent",  "wheel_event_cast",  "(J)J",  awtk_TWheelEvent_wheel_event_cast},
{"awtk/TWheelEvent",  "wheel_event_t_get_prop_x",  "(J)I",  awtk_TWheelEvent_wheel_event_t_get_prop_x},
{"awtk/TWheelEvent",  "wheel_event_t_get_prop_y",  "(J)I",  awtk_TWheelEvent_wheel_event_t_get_prop_y},
...
{"awtk/TOffsetChangeEvent",  "offset_change_event_cast",  "(J)J",  awtk_TOffsetChangeEvent_offset_change_event_cast},
...
{"awtk/TPointerEvent",  "pointer_event_t_get_prop_finger_id",  "(J)I",  awtk_TPointerEvent_pointer_event_t_get_prop_finger_id},
...
{"awtk/TKeyEvent",  "key_event_t_get_prop_numlock",  "(J)Z",  awtk_TKeyEvent_key_event_t_get_prop_numlock},
...
{"awtk/TThemeChangeEvent",  "theme_change_event_cast",  "(J)J",  awtk_TThemeChangeEvent_theme_change_event_cast},
{"awtk/TThemeChangeEvent",  "theme_change_event_t_get_prop_name",  "(J)Ljava/lang/String;",  awtk_TThemeChangeEvent_theme_change_event_t_get_prop_name},
{"awtk/TDropFileEvent",  "drop_file_event_cast",  "(J)J",  awtk_TDropFileEvent_drop_file_event_cast},
{"awtk/TDropFileEvent",  "drop_file_event_t_get_prop_filename",  "(J)Ljava/lang/String;",  awtk_TDropFileEvent_drop_file_event_t_get_prop_filename},
{"awtk/TSystemEvent",  "system_event_cast",  "(J)J",  awtk_TSystemEvent_system_event_cast},
{"awtk/TSystemEvent",  "system_event_t_get_prop_sdl_event",  "(J)J",  awtk_TSystemEvent_system_event_t_get_prop_sdl_event},
{"awtk/TTouchEvent",  "touch_event_cast",  "(J)J",  awtk_TTouchEvent_touch_event_cast},
{"awtk/TTouchEvent",  "touch_event_t_get_prop_touch_id",  "(J)J",  awtk_TTouchEvent_touch_event_t_get_prop_touch_id},
{"awtk/TTouchEvent",  "touch_event_t_get_prop_finger_id",  "(J)J",  awtk_TTouchEvent_touch_event_t_get_prop_finger_id},
{"awtk/TTouchEvent",  "touch_event_t_get_prop_x",  "(J)F",  awtk_TTouchEvent_touch_event_t_get_prop_x},
{"awtk/TTouchEvent",  "touch_event_t_get_prop_y",  "(J)F",  awtk_TTouchEvent_touch_event_t_get_prop_y},
{"awtk/TTouchEvent",  "touch_event_t_get_prop_pressure",  "(J)F",  awtk_TTouchEvent_touch_event_t_get_prop_pressure},
...
{"awtk/TWindowBase",  "window_base_t_get_prop_accept_button",  "(J)Ljava/lang/String;",  awtk_TWindowBase_window_base_t_get_prop_accept_button},
{"awtk/TWindowBase",  "window_base_t_get_prop_cancel_button",  "(J)Ljava/lang/String;",  awtk_TWindowBase_window_base_t_get_prop_cancel_button},
{"awtk/TWindowBase",  "window_base_t_get_prop_applet_name",  "(J)Ljava/lang/String;",  awtk_TWindowBase_window_base_t_get_prop_applet_name},
...
{"awtk/TWindowManager",  "window_manager_get_foreground_window",  "(J)J",  awtk_TWindowManager_window_manager_get_foreground_window},
...
{"awtk/TWindowManager",  "window_manager_set_show_fps_position",  "(JII)I",  awtk_TWindowManager_window_manager_set_show_fps_position},
...
{"awtk/TWindowManager",  "window_manager_set_fullscreen",  "(JZ)I",  awtk_TWindowManager_window_manager_set_fullscreen},
...
{"awtk/TDraggable",  "draggable_set_allow_out_of_screen",  "(JZ)I",  awtk_TDraggable_draggable_set_allow_out_of_screen},
{"awtk/TDraggable",  "draggable_set_drag_window",  "(JZ)I",  awtk_TDraggable_draggable_set_drag_window},
{"awtk/TDraggable",  "draggable_set_drag_native_window",  "(JZ)I",  awtk_TDraggable_draggable_set_drag_native_window},
{"awtk/TDraggable",  "draggable_set_drag_parent",  "(JI)I",  awtk_TDraggable_draggable_set_drag_parent},
...
{"awtk/TDraggable",  "draggable_t_get_prop_allow_out_of_screen",  "(J)Z",  awtk_TDraggable_draggable_t_get_prop_allow_out_of_screen},
...
{"awtk/TDraggable",  "draggable_t_get_prop_drag_native_window",  "(J)Z",  awtk_TDraggable_draggable_t_get_prop_drag_native_window},
{"awtk/TDraggable",  "draggable_t_get_prop_drag_parent",  "(J)I",  awtk_TDraggable_draggable_t_get_prop_drag_parent},
...
{"awtk/TFileBrowserView",  "file_browser_view_set_odd_item_style",  "(JLjava/lang/String;)I",  awtk_TFileBrowserView_file_browser_view_set_odd_item_style},
{"awtk/TFileBrowserView",  "file_browser_view_set_even_item_style",  "(JLjava/lang/String;)I",  awtk_TFileBrowserView_file_browser_view_set_even_item_style},
...
{"awtk/TFileBrowserView",  "file_browser_view_t_get_prop_odd_item_style",  "(J)Ljava/lang/String;",  awtk_TFileBrowserView_file_browser_view_t_get_prop_odd_item_style},
{"awtk/TFileBrowserView",  "file_browser_view_t_get_prop_even_item_style",  "(J)Ljava/lang/String;",  awtk_TFileBrowserView_file_browser_view_t_get_prop_even_item_style},
...
{"awtk/TCandidates",  "candidates_set_visible_num",  "(JI)I",  awtk_TCandidates_candidates_set_visible_num},
...
{"awtk/TCandidates",  "candidates_t_get_prop_enable_preview",  "(J)Z",  awtk_TCandidates_candidates_t_get_prop_enable_preview},
{"awtk/TCandidates",  "candidates_t_get_prop_visible_num",  "(J)I",  awtk_TCandidates_candidates_t_get_prop_visible_num},
...
{"awtk/TLineNumber",  "line_number_add_highlight_line",  "(JI)I",  awtk_TLineNumber_line_number_add_highlight_line},
{"awtk/TLineNumber",  "line_number_set_active_line",  "(JI)I",  awtk_TLineNumber_line_number_set_active_line},
{"awtk/TLineNumber",  "line_number_clear_highlight",  "(J)I",  awtk_TLineNumber_line_number_clear_highlight},
{"awtk/TLineNumber",  "line_number_is_highlight_line",  "(JI)Z",  awtk_TLineNumber_line_number_is_highlight_line},
...
{"awtk/TMledit",  "mledit_get_current_line_index",  "(J)I",  awtk_TMledit_mledit_get_current_line_index},
{"awtk/TMledit",  "mledit_get_current_row_index",  "(J)I",  awtk_TMledit_mledit_get_current_row_index},
{"awtk/TMledit",  "mledit_get_start_line_index",  "(J)I",  awtk_TMledit_mledit_get_start_line_index},
{"awtk/TMledit",  "mledit_get_start_row_index",  "(J)I",  awtk_TMledit_mledit_get_start_row_index},
{"awtk/TMledit",  "mledit_get_line_at",  "(JI)I",  awtk_TMledit_mledit_get_line_at},
{"awtk/TMledit",  "mledit_get_row_at",  "(JI)I",  awtk_TMledit_mledit_get_row_at},
{"awtk/TMledit",  "mledit_get_row_of_line",  "(JI)I",  awtk_TMledit_mledit_get_row_of_line},
...
{"awtk/TMledit",  "mledit_t_get_prop_accept_return",  "(J)Z",  awtk_TMledit_mledit_t_get_prop_accept_return},
{"awtk/TMledit",  "mledit_t_get_prop_accept_tab",  "(J)Z",  awtk_TMledit_mledit_t_get_prop_accept_tab},
{"awtk/TMledit",  "mledit_t_get_prop_auto_adjust_height",  "(J)Z",  awtk_TMledit_mledit_t_get_prop_auto_adjust_height},
...
{"awtk/TRichText",  "rich_text_set_word_wrap",  "(JZ)I",  awtk_TRichText_rich_text_set_word_wrap},
...
{"awtk/TRichText",  "rich_text_t_get_prop_word_wrap",  "(J)Z",  awtk_TRichText_rich_text_t_get_prop_word_wrap},
...
{"awtk/THscrollLabel",  "hscroll_label_set_speed",  "(JF)I",  awtk_THscrollLabel_hscroll_label_set_speed},
...
{"awtk/THscrollLabel",  "hscroll_label_set_stop_at_begin",  "(JZ)I",  awtk_THscrollLabel_hscroll_label_set_stop_at_begin},
{"awtk/THscrollLabel",  "hscroll_label_set_delay",  "(JI)I",  awtk_THscrollLabel_hscroll_label_set_delay},
{"awtk/THscrollLabel",  "hscroll_label_set_loop_interval_distance",  "(JI)I",  awtk_THscrollLabel_hscroll_label_set_loop_interval_distance},
...
{"awtk/THscrollLabel",  "hscroll_label_t_get_prop_delay",  "(J)I",  awtk_THscrollLabel_hscroll_label_t_get_prop_delay},
{"awtk/THscrollLabel",  "hscroll_label_t_get_prop_speed",  "(J)F",  awtk_THscrollLabel_hscroll_label_t_get_prop_speed},
...
{"awtk/THscrollLabel",  "hscroll_label_t_get_prop_stop_at_begin",  "(J)Z",  awtk_THscrollLabel_hscroll_label_t_get_prop_stop_at_begin},
{"awtk/THscrollLabel",  "hscroll_label_t_get_prop_loop_interval_distance",  "(J)I",  awtk_THscrollLabel_hscroll_label_t_get_prop_loop_interval_distance},
...
{"awtk/TListView",  "list_view_t_get_prop_item_width",  "(J)I",  awtk_TListView_list_view_t_get_prop_item_width},
...
{"awtk/TScrollBar",  "scroll_bar_set_animator_time",  "(JI)I",  awtk_TScrollBar_scroll_bar_set_animator_time},
{"awtk/TScrollBar",  "scroll_bar_hide_by_opacity_animation",  "(JII)I",  awtk_TScrollBar_scroll_bar_hide_by_opacity_animation},
{"awtk/TScrollBar",  "scroll_bar_show_by_opacity_animation",  "(JII)I",  awtk_TScrollBar_scroll_bar_show_by_opacity_animation},
{"awtk/TScrollBar",  "scroll_bar_set_wheel_scroll",  "(JZ)I",  awtk_TScrollBar_scroll_bar_set_wheel_scroll},
{"awtk/TScrollBar",  "scroll_bar_set_scroll_delta",  "(JI)I",  awtk_TScrollBar_scroll_bar_set_scroll_delta},
{"awtk/TScrollBar",  "scroll_bar_set_scroll_rows",  "(JI)I",  awtk_TScrollBar_scroll_bar_set_scroll_rows},
...
{"awtk/TScrollBar",  "scroll_bar_t_get_prop_animator_time",  "(J)I",  awtk_TScrollBar_scroll_bar_t_get_prop_animator_time},
{"awtk/TScrollBar",  "scroll_bar_t_get_prop_scroll_delta",  "(J)I",  awtk_TScrollBar_scroll_bar_t_get_prop_scroll_delta},
{"awtk/TScrollBar",  "scroll_bar_t_get_prop_scroll_rows",  "(J)I",  awtk_TScrollBar_scroll_bar_t_get_prop_scroll_rows},
...
{"awtk/TScrollBar",  "scroll_bar_t_get_prop_wheel_scroll",  "(J)Z",  awtk_TScrollBar_scroll_bar_t_get_prop_wheel_scroll},
{"awtk/TScrollBar",  "scroll_bar_t_get_prop_wheel_modifier_key",  "(J)Ljava/lang/String;",  awtk_TScrollBar_scroll_bar_t_get_prop_wheel_modifier_key},
...
{"awtk/TScrollView",  "scroll_view_set_slide_limit_ratio",  "(JF)I",  awtk_TScrollView_scroll_view_set_slide_limit_ratio},
...
{"awtk/TScrollView",  "scroll_view_t_get_prop_use_virtual_w",  "(J)Z",  awtk_TScrollView_scroll_view_t_get_prop_use_virtual_w},
{"awtk/TScrollView",  "scroll_view_t_get_prop_use_widget_w",  "(J)Z",  awtk_TScrollView_scroll_view_t_get_prop_use_widget_w},
{"awtk/TScrollView",  "scroll_view_t_get_prop_use_virtual_h",  "(J)Z",  awtk_TScrollView_scroll_view_t_get_prop_use_virtual_h},
{"awtk/TScrollView",  "scroll_view_t_get_prop_use_widget_h",  "(J)Z",  awtk_TScrollView_scroll_view_t_get_prop_use_widget_h},
...
{"awtk/TScrollView",  "scroll_view_t_get_prop_slide_limit_ratio",  "(J)F",  awtk_TScrollView_scroll_view_t_get_prop_slide_limit_ratio},
{"awtk/TSerialWidget",  "serial_widget_create",  "(JIIII)J",  awtk_TSerialWidget_serial_widget_create},
{"awtk/TSerialWidget",  "serial_widget_cast",  "(J)J",  awtk_TSerialWidget_serial_widget_cast},
{"awtk/TSerialWidget",  "serial_widget_set_baudrate",  "(JI)I",  awtk_TSerialWidget_serial_widget_set_baudrate},
{"awtk/TSerialWidget",  "serial_widget_set_device",  "(JLjava/lang/String;)I",  awtk_TSerialWidget_serial_widget_set_device},
{"awtk/TSerialWidget",  "serial_widget_set_bytesize",  "(JI)I",  awtk_TSerialWidget_serial_widget_set_bytesize},
{"awtk/TSerialWidget",  "serial_widget_set_parity",  "(JI)I",  awtk_TSerialWidget_serial_widget_set_parity},
{"awtk/TSerialWidget",  "serial_widget_set_stopbits",  "(JI)I",  awtk_TSerialWidget_serial_widget_set_stopbits},
{"awtk/TSerialWidget",  "serial_widget_set_flowcontrol",  "(JI)I",  awtk_TSerialWidget_serial_widget_set_flowcontrol},
{"awtk/TSerialWidget",  "serial_widget_set_check_interval",  "(JI)I",  awtk_TSerialWidget_serial_widget_set_check_interval},
{"awtk/TSerialWidget",  "serial_widget_t_get_prop_device",  "(J)Ljava/lang/String;",  awtk_TSerialWidget_serial_widget_t_get_prop_device},
{"awtk/TSerialWidget",  "serial_widget_t_get_prop_baudrate",  "(J)I",  awtk_TSerialWidget_serial_widget_t_get_prop_baudrate},
{"awtk/TSerialWidget",  "serial_widget_t_get_prop_bytesize",  "(J)I",  awtk_TSerialWidget_serial_widget_t_get_prop_bytesize},
...
{"awtk/TSlideMenu",  "slide_menu_set_spacer",  "(JI)I",  awtk_TSlideMenu_slide_menu_set_spacer},
{"awtk/TSlideMenu",  "slide_menu_set_menu_w",  "(JLjava/lang/String;)I",  awtk_TSlideMenu_slide_menu_set_menu_w},
{"awtk/TSlideMenu",  "slide_menu_set_clip",  "(JZ)I",  awtk_TSlideMenu_slide_menu_set_clip},
{"awtk/TSlideMenu",  "slide_menu_scroll_to_prev",  "(J)I",  awtk_TSlideMenu_slide_menu_scroll_to_prev},
{"awtk/TSlideMenu",  "slide_menu_scroll_to_next",  "(J)I",  awtk_TSlideMenu_slide_menu_scroll_to_next},
...
{"awtk/TSlideMenu",  "slide_menu_t_get_prop_spacer",  "(J)I",  awtk_TSlideMenu_slide_menu_t_get_prop_spacer},
{"awtk/TSlideMenu",  "slide_menu_t_get_prop_menu_w",  "(J)Ljava/lang/String;",  awtk_TSlideMenu_slide_menu_t_get_prop_menu_w},
{"awtk/TSlideMenu",  "slide_menu_t_get_prop_clip",  "(J)Z",  awtk_TSlideMenu_slide_menu_t_get_prop_clip},
...
{"awtk/TSlideIndicator",  "slide_indicator_set_transition",  "(JZ)I",  awtk_TSlideIndicator_slide_indicator_set_transition},
...
{"awtk/TSlideIndicator",  "slide_indicator_t_get_prop_anchor_x",  "(J)Ljava/lang/String;",  awtk_TSlideIndicator_slide_indicator_t_get_prop_anchor_x},
{"awtk/TSlideIndicator",  "slide_indicator_t_get_prop_anchor_y",  "(J)Ljava/lang/String;",  awtk_TSlideIndicator_slide_indicator_t_get_prop_anchor_y},
...
{"awtk/TSlideIndicator",  "slide_indicator_t_get_prop_transition",  "(J)Z",  awtk_TSlideIndicator_slide_indicator_t_get_prop_transition},
...
{"awtk/TSlideView",  "slide_view_set_drag_threshold",  "(JI)I",  awtk_TSlideView_slide_view_set_drag_threshold},
{"awtk/TSlideView",  "slide_view_set_animating_time",  "(JI)I",  awtk_TSlideView_slide_view_set_animating_time},
...
{"awtk/TSlideView",  "slide_view_t_get_prop_drag_threshold",  "(J)I",  awtk_TSlideView_slide_view_t_get_prop_drag_threshold},
{"awtk/TSlideView",  "slide_view_t_get_prop_animating_time",  "(J)I",  awtk_TSlideView_slide_view_t_get_prop_animating_time},
{"awtk/TSlideView",  "slide_view_t_get_prop_active",  "(J)I",  awtk_TSlideView_slide_view_t_get_prop_active},
...
{"awtk/TTextSelector",  "text_selector_set_mask_easing",  "(JI)I",  awtk_TTextSelector_text_selector_set_mask_easing},
{"awtk/TTextSelector",  "text_selector_set_mask_area_scale",  "(JF)I",  awtk_TTextSelector_text_selector_set_mask_area_scale},
{"awtk/TTextSelector",  "text_selector_set_ellipses",  "(JZ)I",  awtk_TTextSelector_text_selector_set_ellipses},
...
{"awtk/TTextSelector",  "text_selector_t_get_prop_ellipses",  "(J)Z",  awtk_TTextSelector_text_selector_t_get_prop_ellipses},
{"awtk/TTextSelector",  "text_selector_t_get_prop_mask_easing",  "(J)I",  awtk_TTextSelector_text_selector_t_get_prop_mask_easing},
{"awtk/TTextSelector",  "text_selector_t_get_prop_mask_area_scale",  "(J)F",  awtk_TTextSelector_text_selector_t_get_prop_mask_area_scale},
...
{"awtk/TTimerWidget",  "timer_widget_create",  "(JIIII)J",  awtk_TTimerWidget_timer_widget_create},
{"awtk/TTimerWidget",  "timer_widget_cast",  "(J)J",  awtk_TTimerWidget_timer_widget_cast},
{"awtk/TTimerWidget",  "timer_widget_set_duration",  "(JI)I",  awtk_TTimerWidget_timer_widget_set_duration},
{"awtk/TTimerWidget",  "timer_widget_t_get_prop_duration",  "(J)I",  awtk_TTimerWidget_timer_widget_t_get_prop_duration},
...
{"awtk/TObjectFifoSetEvent",  "object_fifo_set_event_t_get_prop_index",  "(J)I",  awtk_TObjectFifoSetEvent_object_fifo_set_event_t_get_prop_index},
{"awtk/TObjectFifoSetEvent",  "object_fifo_set_event_t_get_prop_nr",  "(J)I",  awtk_TObjectFifoSetEvent_object_fifo_set_event_t_get_prop_nr},
{"awtk/TObjectFifoSetEvent",  "object_fifo_set_event_t_get_prop_data",  "(J)J",  awtk_TObjectFifoSetEvent_object_fifo_set_event_t_get_prop_data},
{"awtk/TObjectFifoPushEvent",  "object_fifo_push_event_t_get_prop_nr",  "(J)I",  awtk_TObjectFifoPushEvent_object_fifo_push_event_t_get_prop_nr},
{"awtk/TObjectFifoPushEvent",  "object_fifo_push_event_t_get_prop_data",  "(J)J",  awtk_TObjectFifoPushEvent_object_fifo_push_event_t_get_prop_data},
{"awtk/TObjectFifoPushHeadEvent",  "object_fifo_push_head_event_t_get_prop_nr",  "(J)I",  awtk_TObjectFifoPushHeadEvent_object_fifo_push_head_event_t_get_prop_nr},
{"awtk/TObjectFifoPushHeadEvent",  "object_fifo_push_head_event_t_get_prop_data",  "(J)J",  awtk_TObjectFifoPushHeadEvent_object_fifo_push_head_event_t_get_prop_data},
{"awtk/TObjectFifoPopEvent",  "object_fifo_pop_event_t_get_prop_nr",  "(J)I",  awtk_TObjectFifoPopEvent_object_fifo_pop_event_t_get_prop_nr},
{"awtk/TObjectFifoPopTailEvent",  "object_fifo_pop_tail_event_t_get_prop_nr",  "(J)I",  awtk_TObjectFifoPopTailEvent_object_fifo_pop_tail_event_t_get_prop_nr},
{"awtk/TObjectFifoValueChangeEvent",  "object_fifo_set_event_cast",  "(J)J",  awtk_TObjectFifoValueChangeEvent_object_fifo_set_event_cast},
{"awtk/TObjectFifoValueChangeEvent",  "object_fifo_push_event_cast",  "(J)J",  awtk_TObjectFifoValueChangeEvent_object_fifo_push_event_cast},
{"awtk/TObjectFifoValueChangeEvent",  "object_fifo_push_head_event_cast",  "(J)J",  awtk_TObjectFifoValueChangeEvent_object_fifo_push_head_event_cast},
{"awtk/TObjectFifoValueChangeEvent",  "object_fifo_pop_event_cast",  "(J)J",  awtk_TObjectFifoValueChangeEvent_object_fifo_pop_event_cast},
{"awtk/TObjectFifoValueChangeEvent",  "object_fifo_pop_tail_event_cast",  "(J)J",  awtk_TObjectFifoValueChangeEvent_object_fifo_pop_tail_event_cast},
{"awtk/TObjectFifoValueChangeEvent",  "object_fifo_value_change_event_cast",  "(J)J",  awtk_TObjectFifoValueChangeEvent_object_fifo_value_change_event_cast},
{"awtk/TObjectFifoValueChangeEvent",  "object_fifo_value_change_event_t_get_prop_type",  "(J)I",  awtk_TObjectFifoValueChangeEvent_object_fifo_value_change_event_t_get_prop_type},
...
{"awtk/TButton",  "button_set_enable_preview",  "(JZ)I",  awtk_TButton_button_set_enable_preview},
...
{"awtk/TButton",  "button_t_get_prop_enable_preview",  "(J)Z",  awtk_TButton_button_t_get_prop_enable_preview},
{"awtk/TButton",  "button_t_get_prop_is_accept_status",  "(J)Z",  awtk_TButton_button_t_get_prop_is_accept_status},
{"awtk/TButton",  "button_t_get_prop_pressed",  "(J)Z",  awtk_TButton_button_t_get_prop_pressed},
...
{"awtk/TCheckButton",  "check_button_set_indeterminate",  "(JZ)I",  awtk_TCheckButton_check_button_set_indeterminate},
{"awtk/TCheckButton",  "check_button_get_indeterminate",  "(J)Z",  awtk_TCheckButton_check_button_get_indeterminate},
{"awtk/TCheckButton",  "check_button_cast",  "(J)J",  awtk_TCheckButton_check_button_cast},
{"awtk/TCheckButton",  "check_button_create_ex",  "(JIIIILjava/lang/String;Z)J",  awtk_TCheckButton_check_button_create_ex},
...
{"awtk/TEdit",  "edit_get_int64",  "(J)J",  awtk_TEdit_edit_get_int64},
...
{"awtk/TEdit",  "edit_set_double_ex",  "(JLjava/lang/String;F)I",  awtk_TEdit_edit_set_double_ex},
...
{"awtk/TEdit",  "edit_set_focus_next_when_enter",  "(JZ)I",  awtk_TEdit_edit_set_focus_next_when_enter},
{"awtk/TEdit",  "edit_set_scroll_to_begin_on_blur",  "(JZ)I",  awtk_TEdit_edit_set_scroll_to_begin_on_blur},
...
{"awtk/TEdit",  "edit_t_get_prop_validator",  "(J)Ljava/lang/String;",  awtk_TEdit_edit_t_get_prop_validator},
...
{"awtk/TEdit",  "edit_t_get_prop_focus_next_when_enter",  "(J)Z",  awtk_TEdit_edit_t_get_prop_focus_next_when_enter},
{"awtk/TEdit",  "edit_t_get_prop_scroll_to_begin_on_blur",  "(J)Z",  awtk_TEdit_edit_t_get_prop_scroll_to_begin_on_blur},
...
{"awtk/TGrid",  "grid_set_rows",  "(JI)I",  awtk_TGrid_grid_set_rows},
{"awtk/TGrid",  "grid_set_columns_definition",  "(JLjava/lang/String;)I",  awtk_TGrid_grid_set_columns_definition},
{"awtk/TGrid",  "grid_set_show_grid",  "(JZ)I",  awtk_TGrid_grid_set_show_grid},
{"awtk/TGrid",  "grid_t_get_prop_rows",  "(J)I",  awtk_TGrid_grid_t_get_prop_rows},
{"awtk/TGrid",  "grid_t_get_prop_columns_definition",  "(J)Ljava/lang/String;",  awtk_TGrid_grid_t_get_prop_columns_definition},
{"awtk/TGrid",  "grid_t_get_prop_show_grid",  "(J)Z",  awtk_TGrid_grid_t_get_prop_show_grid},
{"awtk/TGroupBox",  "group_box_create",  "(JIIII)J",  awtk_TGroupBox_group_box_create},
{"awtk/TGroupBox",  "group_box_set_value",  "(JI)I",  awtk_TGroupBox_group_box_set_value},
{"awtk/TGroupBox",  "group_box_cast",  "(J)J",  awtk_TGroupBox_group_box_cast},
{"awtk/TGroupBox",  "group_box_t_get_prop_value",  "(J)I",  awtk_TGroupBox_group_box_t_get_prop_value},
...
{"awtk/TLabel",  "label_set_ellipses",  "(JZ)I",  awtk_TLabel_label_set_ellipses},
...
{"awtk/TLabel",  "label_t_get_prop_ellipses",  "(J)Z",  awtk_TLabel_label_t_get_prop_ellipses},
...
{"awtk/TPages",  "pages_set_auto_focused",  "(JZ)I",  awtk_TPages_pages_set_auto_focused},
...
{"awtk/TPages",  "pages_t_get_prop_auto_focused",  "(J)Z",  awtk_TPages_pages_t_get_prop_auto_focused},
...
{"awtk/TSlider",  "slider_set_line_cap",  "(JLjava/lang/String;)I",  awtk_TSlider_slider_set_line_cap},
...
{"awtk/TSlider",  "slider_set_drag_threshold",  "(JI)I",  awtk_TSlider_slider_set_drag_threshold},
...
{"awtk/TSlider",  "slider_t_get_prop_drag_threshold",  "(J)I",  awtk_TSlider_slider_t_get_prop_drag_threshold},
...
{"awtk/TTabButtonGroup",  "tab_button_group_set_drag_child",  "(JZ)I",  awtk_TTabButtonGroup_tab_button_group_set_drag_child},
{"awtk/TTabButtonGroup",  "tab_button_group_remove_index",  "(JI)I",  awtk_TTabButtonGroup_tab_button_group_remove_index},
...
{"awtk/TTabButtonGroup",  "tab_button_group_t_get_prop_drag_child",  "(J)Z",  awtk_TTabButtonGroup_tab_button_group_t_get_prop_drag_child},
...
{"awtk/TTabButton",  "tab_button_set_max_w",  "(JI)I",  awtk_TTabButton_tab_button_set_max_w},
{"awtk/TTabButton",  "tab_button_restack",  "(JI)I",  awtk_TTabButton_tab_button_restack},
...
{"awtk/TTabButton",  "tab_button_t_get_prop_max_w",  "(J)I",  awtk_TTabButton_tab_button_t_get_prop_max_w},
...
{"awtk/TNativeWindow",  "native_window_set_window_hit_test",  "(JIIII)I",  awtk_TNativeWindow_native_window_set_window_hit_test},
...
{"awtk/TNativeWindow",  "native_window_set_title",  "(JLjava/lang/String;)I",  awtk_TNativeWindow_native_window_set_title},
...
{"awtk/TEditEx",  "edit_ex_create",  "(JIIII)J",  awtk_TEditEx_edit_ex_create},
{"awtk/TEditEx",  "edit_ex_set_multiline",  "(JZ)I",  awtk_TEditEx_edit_ex_set_multiline},
{"awtk/TEditEx",  "edit_ex_set_suggest_words",  "(JJ)I",  awtk_TEditEx_edit_ex_set_suggest_words},
{"awtk/TEditEx",  "edit_ex_set_suggest_words_item_formats",  "(JLjava/lang/String;)I",  awtk_TEditEx_edit_ex_set_suggest_words_item_formats},
{"awtk/TEditEx",  "edit_ex_set_suggest_words_input_name",  "(JLjava/lang/String;)I",  awtk_TEditEx_edit_ex_set_suggest_words_input_name},
{"awtk/TEditEx",  "edit_ex_update_suggest_words_popup",  "(J)I",  awtk_TEditEx_edit_ex_update_suggest_words_popup},
{"awtk/TEditEx",  "edit_ex_cast",  "(J)J",  awtk_TEditEx_edit_ex_cast},
{"awtk/TEditEx",  "edit_ex_t_get_prop_suggest_words",  "(J)J",  awtk_TEditEx_edit_ex_t_get_prop_suggest_words},
{"awtk/TEditEx",  "edit_ex_t_get_prop_suggest_words_item_formats",  "(J)Ljava/lang/String;",  awtk_TEditEx_edit_ex_t_get_prop_suggest_words_item_formats},
{"awtk/TEditEx",  "edit_ex_t_get_prop_suggest_words_input_name",  "(J)Ljava/lang/String;",  awtk_TEditEx_edit_ex_t_get_prop_suggest_words_input_name},
{"awtk/TEditEx",  "edit_ex_t_get_prop_is_select_suggest_word",  "(J)Z",  awtk_TEditEx_edit_ex_t_get_prop_is_select_suggest_word},
{"awtk/TEditEx",  "edit_ex_t_get_prop_multiline",  "(J)Z",  awtk_TEditEx_edit_ex_t_get_prop_multiline},
...
{"awtk/TGifImage",  "gif_image_set_loop",  "(JI)I",  awtk_TGifImage_gif_image_set_loop},
{"awtk/TGifImage",  "gif_image_set_part_buffer_load_mode",  "(JZ)I",  awtk_TGifImage_gif_image_set_part_buffer_load_mode},
{"awtk/TGifImage",  "gif_image_cast",  "(J)J",  awtk_TGifImage_gif_image_cast},
{"awtk/TGifImage",  "gif_image_t_get_prop_loop",  "(J)I",  awtk_TGifImage_gif_image_t_get_prop_loop},
{"awtk/TGifImage",  "gif_image_t_get_prop_part_buffer_load_mode",  "(J)Z",  awtk_TGifImage_gif_image_t_get_prop_part_buffer_load_mode},
...
{"awtk/TListItemSeperator",  "list_item_seperator_create",  "(JIIII)J",  awtk_TListItemSeperator_list_item_seperator_create},
{"awtk/TListItemSeperator",  "list_item_seperator_cast",  "(J)J",  awtk_TListItemSeperator_list_item_seperator_cast},
...
{"awtk/TSvgImage",  "svg_image_set_cache_mode",  "(JZ)I",  awtk_TSvgImage_svg_image_set_cache_mode},
{"awtk/TSvgImage",  "svg_image_set_draw_type",  "(JI)I",  awtk_TSvgImage_svg_image_set_draw_type},
{"awtk/TSvgImage",  "svg_image_cast",  "(J)J",  awtk_TSvgImage_svg_image_cast},
{"awtk/TSvgImage",  "svg_image_t_get_prop_is_cache_mode",  "(J)Z",  awtk_TSvgImage_svg_image_t_get_prop_is_cache_mode},
{"awtk/TSvgImage",  "svg_image_t_get_prop_draw_type",  "(J)I",  awtk_TSvgImage_svg_image_t_get_prop_draw_type},
...
{"awtk/TObjectArray",  "object_array_remove_value",  "(JJ)I",  awtk_TObjectArray_object_array_remove_value},
...
{"awtk/TObjectHash",  "object_hash_set_name_case_insensitive",  "(JZ)I",  awtk_TObjectHash_object_hash_set_name_case_insensitive},
{"awtk/TObjectHash",  "object_hash_set_keep_props_order",  "(JZ)I",  awtk_TObjectHash_object_hash_set_keep_props_order},
...
{"awtk/TComboBox",  "combo_box_set_theme_of_popup",  "(JLjava/lang/String;)I",  awtk_TComboBox_combo_box_set_theme_of_popup},
...
{"awtk/TComboBox",  "combo_box_set_selected_index_by_text",  "(JLjava/lang/String;)I",  awtk_TComboBox_combo_box_set_selected_index_by_text},
...
{"awtk/TComboBox",  "combo_box_remove_option_by_index",  "(JI)I",  awtk_TComboBox_combo_box_remove_option_by_index},
...
{"awtk/TComboBox",  "combo_box_has_option_text",  "(JLjava/lang/String;)Z",  awtk_TComboBox_combo_box_has_option_text},
{"awtk/TComboBox",  "combo_box_get_text",  "(J)Ljava/lang/String;",  awtk_TComboBox_combo_box_get_text},
{"awtk/TComboBox",  "combo_box_get_text_of_selected",  "(J)Ljava/lang/String;",  awtk_TComboBox_combo_box_get_text_of_selected},
{"awtk/TComboBox",  "combo_box_t_get_prop_open_window",  "(J)Ljava/lang/String;",  awtk_TComboBox_combo_box_t_get_prop_open_window},
{"awtk/TComboBox",  "combo_box_t_get_prop_theme_of_popup",  "(J)Ljava/lang/String;",  awtk_TComboBox_combo_box_t_get_prop_theme_of_popup},
...
{"awtk/TImage",  "icon_create",  "(JIIII)J",  awtk_TImage_icon_create},
...
{"awtk/TOverlay",  "overlay_set_modeless",  "(JZ)I",  awtk_TOverlay_overlay_set_modeless},
...
{"awtk/TOverlay",  "overlay_t_get_prop_modeless",  "(J)Z",  awtk_TOverlay_overlay_t_get_prop_modeless},
...
{"awtk/TSpinBox",  "spin_box_set_easy_touch_mode",  "(JZ)I",  awtk_TSpinBox_spin_box_set_easy_touch_mode},
{"awtk/TSpinBox",  "spin_box_set_button_position",  "(JLjava/lang/String;)I",  awtk_TSpinBox_spin_box_set_button_position},
{"awtk/TSpinBox",  "spin_set_repeat",  "(JI)I",  awtk_TSpinBox_spin_set_repeat},
{"awtk/TSpinBox",  "spin_box_t_get_prop_easy_touch_mode",  "(J)Z",  awtk_TSpinBox_spin_box_t_get_prop_easy_touch_mode},
{"awtk/TSpinBox",  "spin_box_t_get_prop_button_position",  "(J)Ljava/lang/String;",  awtk_TSpinBox_spin_box_t_get_prop_button_position},
