...
int awtk_TListViewH_list_view_h_set_spacing(Runtime *runtime, JClass *clazz) {
  ...
  ret_t ret = 0;
  widget_t* widget = (widget_t*)jni_ctx_get_object(&ctx);
  bool_t spacing = (bool_t)jni_ctx_get_int(&ctx);
...
int awtk_TIdleInfo_idle_info_t_get_prop_extra_ctx(Runtime *runtime, JClass *clazz) {
  ...
  idle_info_t* obj = (idle_info_t*)jni_ctx_get_object(&ctx);
  jni_ctx_return_int64(&ctx, (int64_t)(obj->extra_ctx));
...
{"awtk/TListViewH",  "list_view_h_set_spacing",  "(JZ)I",  awtk_TListViewH_list_view_h_set_spacing},
