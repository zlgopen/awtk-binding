...
ret_t multi_gesture_event_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "multi_gesture_event_t_get_prop_touch_id",
                      JS_NewCFunction(ctx, wrap_multi_gesture_event_t_get_prop_touch_id, "multi_gesture_event_t_get_prop_touch_id", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "multi_gesture_event_t_get_prop_fingers",
                      JS_NewCFunction(ctx, wrap_multi_gesture_event_t_get_prop_fingers, "multi_gesture_event_t_get_prop_fingers", 1));
