...
ret_t object_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "object_has_prop_by_path",
                      JS_NewCFunction(ctx, wrap_object_has_prop_by_path, "object_has_prop_by_path", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "object_set_prop_by_path",
                      JS_NewCFunction(ctx, wrap_object_set_prop_by_path, "object_set_prop_by_path", 1));
  JS_SetPropertyStr(ctx, global_obj, "object_set_prop_str_by_path",
                      JS_NewCFunction(ctx, wrap_object_set_prop_str_by_path, "object_set_prop_str_by_path", 1));
  JS_SetPropertyStr(ctx, global_obj, "object_set_prop_object_by_path",
                      JS_NewCFunction(ctx, wrap_object_set_prop_object_by_path, "object_set_prop_object_by_path", 1));
  JS_SetPropertyStr(ctx, global_obj, "object_set_prop_int_by_path",
                      JS_NewCFunction(ctx, wrap_object_set_prop_int_by_path, "object_set_prop_int_by_path", 1));
  JS_SetPropertyStr(ctx, global_obj, "object_set_prop_bool_by_path",
                      JS_NewCFunction(ctx, wrap_object_set_prop_bool_by_path, "object_set_prop_bool_by_path", 1));
  JS_SetPropertyStr(ctx, global_obj, "object_set_prop_float_by_path",
                      JS_NewCFunction(ctx, wrap_object_set_prop_float_by_path, "object_set_prop_float_by_path", 1));
  JS_SetPropertyStr(ctx, global_obj, "object_can_exec_by_path",
                      JS_NewCFunction(ctx, wrap_object_can_exec_by_path, "object_can_exec_by_path", 1));
  JS_SetPropertyStr(ctx, global_obj, "object_exec_by_path",
                      JS_NewCFunction(ctx, wrap_object_exec_by_path, "object_exec_by_path", 1));
...
ret_t value_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "value_str_ex",
                      JS_NewCFunction(ctx, wrap_value_str_ex, "value_str_ex", 1));
...
ret_t global_t_init(JSContext *ctx) {
  jsvalue_t global_obj = JS_GetGlobalObject(ctx);
  JS_SetPropertyStr(ctx, global_obj, "tk_init",
                      JS_NewCFunction(ctx, wrap_tk_init, "tk_init", 1));
  JS_SetPropertyStr(ctx, global_obj, "tk_run",
                      JS_NewCFunction(ctx, wrap_tk_run, "tk_run", 1));
...
ret_t canvas_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "canvas_clear_rect",
                      JS_NewCFunction(ctx, wrap_canvas_clear_rect, "canvas_clear_rect", 1));
...
ret_t event_type_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "EVT_IM_SHOW_PRE_CANDIDATES",
  ...
  JS_SetPropertyStr(ctx, global_obj, "EVT_WIDGET_REMOVE_CHILD",
  ...
  JS_SetPropertyStr(ctx, global_obj, "EVT_PAGE_CHANGED",
                      JS_NewCFunction(ctx, get_EVT_PAGE_CHANGED, "EVT_PAGE_CHANGED", 1));
  JS_SetPropertyStr(ctx, global_obj, "EVT_ASSET_MANAGER_LOAD_ASSET",
                      JS_NewCFunction(ctx, get_EVT_ASSET_MANAGER_LOAD_ASSET, "EVT_ASSET_MANAGER_LOAD_ASSET", 1));
  JS_SetPropertyStr(ctx, global_obj, "EVT_ASSET_MANAGER_UNLOAD_ASSET",
  ...
  JS_SetPropertyStr(ctx, global_obj, "EVT_DONE",
                      JS_NewCFunction(ctx, get_EVT_DONE, "EVT_DONE", 1));
...
ret_t input_method_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "input_method_dispatch_keys",
                      JS_NewCFunction(ctx, wrap_input_method_dispatch_keys, "input_method_dispatch_keys", 1));
  JS_SetPropertyStr(ctx, global_obj, "input_method_dispatch_preedit",
  ...
  JS_SetPropertyStr(ctx, global_obj, "input_method_dispatch_preedit_confirm",
                      JS_NewCFunction(ctx, wrap_input_method_dispatch_preedit_confirm, "input_method_dispatch_preedit_confirm", 1));
  JS_SetPropertyStr(ctx, global_obj, "input_method_dispatch_preedit_abort",
                      JS_NewCFunction(ctx, wrap_input_method_dispatch_preedit_abort, "input_method_dispatch_preedit_abort", 1));
...
ret_t style_id_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "STYLE_ID_HIGHLIGHT_FONT_NAME",
                      JS_NewCFunction(ctx, get_STYLE_ID_HIGHLIGHT_FONT_NAME, "STYLE_ID_HIGHLIGHT_FONT_NAME", 1));
  JS_SetPropertyStr(ctx, global_obj, "STYLE_ID_HIGHLIGHT_FONT_SIZE",
                      JS_NewCFunction(ctx, get_STYLE_ID_HIGHLIGHT_FONT_SIZE, "STYLE_ID_HIGHLIGHT_FONT_SIZE", 1));
  JS_SetPropertyStr(ctx, global_obj, "STYLE_ID_HIGHLIGHT_TEXT_COLOR",
  ...
  JS_SetPropertyStr(ctx, global_obj, "STYLE_ID_ROUND_RADIUS_TOP_LETF",
                      JS_NewCFunction(ctx, get_STYLE_ID_ROUND_RADIUS_TOP_LETF, "STYLE_ID_ROUND_RADIUS_TOP_LETF", 1));
  JS_SetPropertyStr(ctx, global_obj, "STYLE_ID_ROUND_RADIUS_TOP_RIGHT",
                      JS_NewCFunction(ctx, get_STYLE_ID_ROUND_RADIUS_TOP_RIGHT, "STYLE_ID_ROUND_RADIUS_TOP_RIGHT", 1));
  JS_SetPropertyStr(ctx, global_obj, "STYLE_ID_ROUND_RADIUS_BOTTOM_LETF",
                      JS_NewCFunction(ctx, get_STYLE_ID_ROUND_RADIUS_BOTTOM_LETF, "STYLE_ID_ROUND_RADIUS_BOTTOM_LETF", 1));
  JS_SetPropertyStr(ctx, global_obj, "STYLE_ID_ROUND_RADIUS_BOTTOM_RIGHT",
                      JS_NewCFunction(ctx, get_STYLE_ID_ROUND_RADIUS_BOTTOM_RIGHT, "STYLE_ID_ROUND_RADIUS_BOTTOM_RIGHT", 1));
...
ret_t timer_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "timer_suspend",
                      JS_NewCFunction(ctx, wrap_timer_suspend, "timer_suspend", 1));
  JS_SetPropertyStr(ctx, global_obj, "timer_resume",
...
ret_t vgcanvas_line_cap_t_init(JSContext *ctx) {
  jsvalue_t global_obj = JS_GetGlobalObject(ctx);
  JS_SetPropertyStr(ctx, global_obj, "VGCANVAS_LINE_CAP_ROUND",
                      JS_NewCFunction(ctx, get_VGCANVAS_LINE_CAP_ROUND, "VGCANVAS_LINE_CAP_ROUND", 1));
  JS_SetPropertyStr(ctx, global_obj, "VGCANVAS_LINE_CAP_SQUARE",
...
ret_t vgcanvas_line_join_t_init(JSContext *ctx) {
  jsvalue_t global_obj = JS_GetGlobalObject(ctx);
  JS_SetPropertyStr(ctx, global_obj, "VGCANVAS_LINE_JOIN_ROUND",
                      JS_NewCFunction(ctx, get_VGCANVAS_LINE_JOIN_ROUND, "VGCANVAS_LINE_JOIN_ROUND", 1));
  JS_SetPropertyStr(ctx, global_obj, "VGCANVAS_LINE_JOIN_BEVEL",
                      JS_NewCFunction(ctx, get_VGCANVAS_LINE_JOIN_BEVEL, "VGCANVAS_LINE_JOIN_BEVEL", 1));
  JS_SetPropertyStr(ctx, global_obj, "VGCANVAS_LINE_JOIN_MITTER",
...
ret_t widget_prop_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_ALWAYS_ON_TOP",
                      JS_NewCFunction(ctx, get_WIDGET_PROP_ALWAYS_ON_TOP, "WIDGET_PROP_ALWAYS_ON_TOP", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_AUTO_ADJUST_SIZE",
                      JS_NewCFunction(ctx, get_WIDGET_PROP_AUTO_ADJUST_SIZE, "WIDGET_PROP_AUTO_ADJUST_SIZE", 1));
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_SINGLE_INSTANCE",
                      JS_NewCFunction(ctx, get_WIDGET_PROP_SINGLE_INSTANCE, "WIDGET_PROP_SINGLE_INSTANCE", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_LINE_WRAP",
                      JS_NewCFunction(ctx, get_WIDGET_PROP_LINE_WRAP, "WIDGET_PROP_LINE_WRAP", 1));
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_WORD_WRAP",
                      JS_NewCFunction(ctx, get_WIDGET_PROP_WORD_WRAP, "WIDGET_PROP_WORD_WRAP", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_DISABLE_ANIM",
  ...
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_DEFAULT_FOCUSED_CHILD",
                      JS_NewCFunction(ctx, get_WIDGET_PROP_DEFAULT_FOCUSED_CHILD, "WIDGET_PROP_DEFAULT_FOCUSED_CHILD", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_CURR_PAGE",
                      JS_NewCFunction(ctx, get_WIDGET_PROP_CURR_PAGE, "WIDGET_PROP_CURR_PAGE", 1));
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_PAGE_MAX_NUMBER",
                      JS_NewCFunction(ctx, get_WIDGET_PROP_PAGE_MAX_NUMBER, "WIDGET_PROP_PAGE_MAX_NUMBER", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_CLOSE_IM_WHEN_BLURED",
                      JS_NewCFunction(ctx, get_WIDGET_PROP_CLOSE_IM_WHEN_BLURED, "WIDGET_PROP_CLOSE_IM_WHEN_BLURED", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_LONG_PRESS_TIME",
  ...
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_CLICK_THROUGH",
  ...
  JS_SetPropertyStr(ctx, global_obj, "WIDGET_PROP_CLOSE_WHEN_TIMEOUT",
                      JS_NewCFunction(ctx, get_WIDGET_PROP_CLOSE_WHEN_TIMEOUT, "WIDGET_PROP_CLOSE_WHEN_TIMEOUT", 1));
...
ret_t widget_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "widget_get_native_window",
  ...
  JS_SetPropertyStr(ctx, global_obj, "widget_set_child_text_with_int",
                      JS_NewCFunction(ctx, wrap_widget_set_child_text_with_int, "widget_set_child_text_with_int", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "widget_set_auto_adjust_size",
                      JS_NewCFunction(ctx, wrap_widget_set_auto_adjust_size, "widget_set_auto_adjust_size", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "widget_is_normal_window",
  ...
  JS_SetPropertyStr(ctx, global_obj, "widget_stroke_border_rect",
  ...
  JS_SetPropertyStr(ctx, global_obj, "widget_dispatch_to_target",
                      JS_NewCFunction(ctx, wrap_widget_dispatch_to_target, "widget_dispatch_to_target", 1));
  JS_SetPropertyStr(ctx, global_obj, "widget_dispatch_to_key_target",
  ...
  JS_SetPropertyStr(ctx, global_obj, "widget_update_style_recursive",
                      JS_NewCFunction(ctx, wrap_widget_update_style_recursive, "widget_update_style_recursive", 1));
  JS_SetPropertyStr(ctx, global_obj, "widget_set_as_key_target",
  ...
  JS_SetPropertyStr(ctx, global_obj, "widget_get_state_for_style",
  ...
  JS_SetPropertyStr(ctx, global_obj, "widget_t_get_prop_auto_adjust_size",
                      JS_NewCFunction(ctx, wrap_widget_t_get_prop_auto_adjust_size, "widget_t_get_prop_auto_adjust_size", 1));
...
ret_t asset_type_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "ASSET_TYPE_FLOW",
                      JS_NewCFunction(ctx, get_ASSET_TYPE_FLOW, "ASSET_TYPE_FLOW", 1));
...
ret_t date_time_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "date_time_get_month_name",
                      JS_NewCFunction(ctx, wrap_date_time_get_month_name, "date_time_get_month_name", 1));
  JS_SetPropertyStr(ctx, global_obj, "date_time_get_wday_name",
...
ret_t object_cmd_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "OBJECT_CMD_REMOVE_CHECKED",
...
ret_t rlog_t_init(JSContext *ctx) {
  jsvalue_t global_obj = JS_GetGlobalObject(ctx);
  JS_SetPropertyStr(ctx, global_obj, "rlog_create",
                      JS_NewCFunction(ctx, wrap_rlog_create, "rlog_create", 1));
  JS_SetPropertyStr(ctx, global_obj, "rlog_write",
                      JS_NewCFunction(ctx, wrap_rlog_write, "rlog_write", 1));
...
ret_t time_now_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "time_now_us",
                      JS_NewCFunction(ctx, wrap_time_now_us, "time_now_us", 1));
...
ret_t ret_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "RET_NOT_MODIFIED",
                      JS_NewCFunction(ctx, get_RET_NOT_MODIFIED, "RET_NOT_MODIFIED", 1));
...
ret_t assets_manager_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "assets_manager_set_theme",
...
ret_t value_change_event_t_init(JSContext *ctx) {
  jsvalue_t global_obj = JS_GetGlobalObject(ctx);
  JS_SetPropertyStr(ctx, global_obj, "value_change_event_cast",
                      JS_NewCFunction(ctx, wrap_value_change_event_cast, "value_change_event_cast", 1));
...
ret_t multi_gesture_event_t_init(JSContext *ctx) {
  jsvalue_t global_obj = JS_GetGlobalObject(ctx);
  JS_SetPropertyStr(ctx, global_obj, "multi_gesture_event_cast",
  ...
  JS_SetPropertyStr(ctx, global_obj, "multi_gesture_event_t_get_prop_x",
                      JS_NewCFunction(ctx, wrap_multi_gesture_event_t_get_prop_x, "multi_gesture_event_t_get_prop_x", 1));
  JS_SetPropertyStr(ctx, global_obj, "multi_gesture_event_t_get_prop_y",
                      JS_NewCFunction(ctx, wrap_multi_gesture_event_t_get_prop_y, "multi_gesture_event_t_get_prop_y", 1));
  JS_SetPropertyStr(ctx, global_obj, "multi_gesture_event_t_get_prop_rotation",
                      JS_NewCFunction(ctx, wrap_multi_gesture_event_t_get_prop_rotation, "multi_gesture_event_t_get_prop_rotation", 1));
  JS_SetPropertyStr(ctx, global_obj, "multi_gesture_event_t_get_prop_distance",
                      JS_NewCFunction(ctx, wrap_multi_gesture_event_t_get_prop_distance, "multi_gesture_event_t_get_prop_distance", 1));
...
ret_t assets_event_t_init(JSContext *ctx) {
  jsvalue_t global_obj = JS_GetGlobalObject(ctx);
  JS_SetPropertyStr(ctx, global_obj, "assets_event_t_get_prop_type",
                      JS_NewCFunction(ctx, wrap_assets_event_t_get_prop_type, "assets_event_t_get_prop_type", 1));
  JS_SetPropertyStr(ctx, global_obj, "assets_event_t_get_prop_asset_info",
                      JS_NewCFunction(ctx, wrap_assets_event_t_get_prop_asset_info, "assets_event_t_get_prop_asset_info", 1));
...
ret_t window_base_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "window_base_t_get_prop_disable_anim",
                      JS_NewCFunction(ctx, wrap_window_base_t_get_prop_disable_anim, "window_base_t_get_prop_disable_anim", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "window_base_t_get_prop_open_anim_hint",
                      JS_NewCFunction(ctx, wrap_window_base_t_get_prop_open_anim_hint, "window_base_t_get_prop_open_anim_hint", 1));
  JS_SetPropertyStr(ctx, global_obj, "window_base_t_get_prop_close_anim_hint",
                      JS_NewCFunction(ctx, wrap_window_base_t_get_prop_close_anim_hint, "window_base_t_get_prop_close_anim_hint", 1));
  JS_SetPropertyStr(ctx, global_obj, "window_base_t_get_prop_move_focus_prev_key",
                      JS_NewCFunction(ctx, wrap_window_base_t_get_prop_move_focus_prev_key, "window_base_t_get_prop_move_focus_prev_key", 1));
  JS_SetPropertyStr(ctx, global_obj, "window_base_t_get_prop_move_focus_next_key",
                      JS_NewCFunction(ctx, wrap_window_base_t_get_prop_move_focus_next_key, "window_base_t_get_prop_move_focus_next_key", 1));
  JS_SetPropertyStr(ctx, global_obj, "window_base_t_get_prop_move_focus_up_key",
                      JS_NewCFunction(ctx, wrap_window_base_t_get_prop_move_focus_up_key, "window_base_t_get_prop_move_focus_up_key", 1));
  JS_SetPropertyStr(ctx, global_obj, "window_base_t_get_prop_move_focus_down_key",
                      JS_NewCFunction(ctx, wrap_window_base_t_get_prop_move_focus_down_key, "window_base_t_get_prop_move_focus_down_key", 1));
  JS_SetPropertyStr(ctx, global_obj, "window_base_t_get_prop_move_focus_left_key",
                      JS_NewCFunction(ctx, wrap_window_base_t_get_prop_move_focus_left_key, "window_base_t_get_prop_move_focus_left_key", 1));
  JS_SetPropertyStr(ctx, global_obj, "window_base_t_get_prop_move_focus_right_key",
                      JS_NewCFunction(ctx, wrap_window_base_t_get_prop_move_focus_right_key, "window_base_t_get_prop_move_focus_right_key", 1));
  JS_SetPropertyStr(ctx, global_obj, "window_base_t_get_prop_single_instance",
                      JS_NewCFunction(ctx, wrap_window_base_t_get_prop_single_instance, "window_base_t_get_prop_single_instance", 1));
...
ret_t window_manager_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "window_manager_close_all",
                      JS_NewCFunction(ctx, wrap_window_manager_close_all, "window_manager_close_all", 1));
...
ret_t file_browser_view_t_init(JSContext *ctx) {
  jsvalue_t global_obj = JS_GetGlobalObject(ctx);
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_create",
  ...
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_set_init_dir",
                      JS_NewCFunction(ctx, wrap_file_browser_view_set_init_dir, "file_browser_view_set_init_dir", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_set_filter",
                      JS_NewCFunction(ctx, wrap_file_browser_view_set_filter, "file_browser_view_set_filter", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_reload",
  ...
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_set_ignore_hidden_files",
                      JS_NewCFunction(ctx, wrap_file_browser_view_set_ignore_hidden_files, "file_browser_view_set_ignore_hidden_files", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_set_sort_ascending",
                      JS_NewCFunction(ctx, wrap_file_browser_view_set_sort_ascending, "file_browser_view_set_sort_ascending", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_set_show_check_button",
                      JS_NewCFunction(ctx, wrap_file_browser_view_set_show_check_button, "file_browser_view_set_show_check_button", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_set_sort_by",
                      JS_NewCFunction(ctx, wrap_file_browser_view_set_sort_by, "file_browser_view_set_sort_by", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_get_cwd",
                      JS_NewCFunction(ctx, wrap_file_browser_view_get_cwd, "file_browser_view_get_cwd", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_create_dir",
                      JS_NewCFunction(ctx, wrap_file_browser_view_create_dir, "file_browser_view_create_dir", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_create_file",
  ...
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_t_get_prop_init_dir",
                      JS_NewCFunction(ctx, wrap_file_browser_view_t_get_prop_init_dir, "file_browser_view_t_get_prop_init_dir", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_t_get_prop_filter",
                      JS_NewCFunction(ctx, wrap_file_browser_view_t_get_prop_filter, "file_browser_view_t_get_prop_filter", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_t_get_prop_ignore_hidden_files",
                      JS_NewCFunction(ctx, wrap_file_browser_view_t_get_prop_ignore_hidden_files, "file_browser_view_t_get_prop_ignore_hidden_files", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_t_get_prop_sort_ascending",
                      JS_NewCFunction(ctx, wrap_file_browser_view_t_get_prop_sort_ascending, "file_browser_view_t_get_prop_sort_ascending", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_t_get_prop_show_check_button",
                      JS_NewCFunction(ctx, wrap_file_browser_view_t_get_prop_show_check_button, "file_browser_view_t_get_prop_show_check_button", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_t_get_prop_sort_by",
                      JS_NewCFunction(ctx, wrap_file_browser_view_t_get_prop_sort_by, "file_browser_view_t_get_prop_sort_by", 1));
...
ret_t file_chooser_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "file_chooser_choose_file_for_save",
                      JS_NewCFunction(ctx, wrap_file_chooser_choose_file_for_save, "file_chooser_choose_file_for_save", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_chooser_choose_file_for_open",
                      JS_NewCFunction(ctx, wrap_file_chooser_choose_file_for_open, "file_chooser_choose_file_for_open", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_chooser_choose_folder",
  ...
  JS_SetPropertyStr(ctx, global_obj, "file_chooser_get_filename",
                      JS_NewCFunction(ctx, wrap_file_chooser_get_filename, "file_chooser_get_filename", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_chooser_is_aborted",
...
ret_t image_animation_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "image_animation_is_playing",
                      JS_NewCFunction(ctx, wrap_image_animation_is_playing, "image_animation_is_playing", 1));
...
ret_t image_value_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "image_value_set_click_add_delta",
                      JS_NewCFunction(ctx, wrap_image_value_set_click_add_delta, "image_value_set_click_add_delta", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "image_value_t_get_prop_click_add_delta",
                      JS_NewCFunction(ctx, wrap_image_value_t_get_prop_click_add_delta, "image_value_t_get_prop_click_add_delta", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "image_value_t_get_prop_min",
                      JS_NewCFunction(ctx, wrap_image_value_t_get_prop_min, "image_value_t_get_prop_min", 1));
  JS_SetPropertyStr(ctx, global_obj, "image_value_t_get_prop_max",
...
ret_t candidates_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "candidates_t_get_prop_select_by_num",
                      JS_NewCFunction(ctx, wrap_candidates_t_get_prop_select_by_num, "candidates_t_get_prop_select_by_num", 1));
  JS_SetPropertyStr(ctx, global_obj, "candidates_t_get_prop_auto_hide",
                      JS_NewCFunction(ctx, wrap_candidates_t_get_prop_auto_hide, "candidates_t_get_prop_auto_hide", 1));
  JS_SetPropertyStr(ctx, global_obj, "candidates_t_get_prop_button_style",
                      JS_NewCFunction(ctx, wrap_candidates_t_get_prop_button_style, "candidates_t_get_prop_button_style", 1));
...
ret_t lang_indicator_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "lang_indicator_set_image",
  ...
  JS_SetPropertyStr(ctx, global_obj, "lang_indicator_t_get_prop_image",
                      JS_NewCFunction(ctx, wrap_lang_indicator_t_get_prop_image, "lang_indicator_t_get_prop_image", 1));
...
ret_t mledit_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "mledit_set_open_im_when_focused",
                      JS_NewCFunction(ctx, wrap_mledit_set_open_im_when_focused, "mledit_set_open_im_when_focused", 1));
  JS_SetPropertyStr(ctx, global_obj, "mledit_set_close_im_when_blured",
                      JS_NewCFunction(ctx, wrap_mledit_set_close_im_when_blured, "mledit_set_close_im_when_blured", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "mledit_t_get_prop_tr_tips",
                      JS_NewCFunction(ctx, wrap_mledit_t_get_prop_tr_tips, "mledit_t_get_prop_tr_tips", 1));
  JS_SetPropertyStr(ctx, global_obj, "mledit_t_get_prop_keyboard",
  ...
  JS_SetPropertyStr(ctx, global_obj, "mledit_t_get_prop_cancelable",
                      JS_NewCFunction(ctx, wrap_mledit_t_get_prop_cancelable, "mledit_t_get_prop_cancelable", 1));
  JS_SetPropertyStr(ctx, global_obj, "mledit_t_get_prop_open_im_when_focused",
                      JS_NewCFunction(ctx, wrap_mledit_t_get_prop_open_im_when_focused, "mledit_t_get_prop_open_im_when_focused", 1));
  JS_SetPropertyStr(ctx, global_obj, "mledit_t_get_prop_close_im_when_blured",
                      JS_NewCFunction(ctx, wrap_mledit_t_get_prop_close_im_when_blured, "mledit_t_get_prop_close_im_when_blured", 1));
...
ret_t rich_text_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "rich_text_set_yslidable",
  ...
  JS_SetPropertyStr(ctx, global_obj, "rich_text_t_get_prop_yslidable",
                      JS_NewCFunction(ctx, wrap_rich_text_t_get_prop_yslidable, "rich_text_t_get_prop_yslidable", 1));
...
ret_t slide_view_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "slide_view_set_active_ex",
                      JS_NewCFunction(ctx, wrap_slide_view_set_active_ex, "slide_view_set_active_ex", 1));
...
ret_t text_selector_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "text_selector_set_localize_options",
                      JS_NewCFunction(ctx, wrap_text_selector_set_localize_options, "text_selector_set_localize_options", 1));
  JS_SetPropertyStr(ctx, global_obj, "text_selector_set_loop_options",
  ...
  JS_SetPropertyStr(ctx, global_obj, "text_selector_t_get_prop_loop_options",
                      JS_NewCFunction(ctx, wrap_text_selector_t_get_prop_loop_options, "text_selector_t_get_prop_loop_options", 1));
...
ret_t done_event_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "done_event_t_get_prop_result",
...
ret_t error_event_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "error_event_t_get_prop_code",
  ...
  JS_SetPropertyStr(ctx, global_obj, "error_event_t_get_prop_message",
                      JS_NewCFunction(ctx, wrap_error_event_t_get_prop_message, "error_event_t_get_prop_message", 1));
...
ret_t cmd_exec_event_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "cmd_exec_event_t_get_prop_name",
                      JS_NewCFunction(ctx, wrap_cmd_exec_event_t_get_prop_name, "cmd_exec_event_t_get_prop_name", 1));
...
ret_t button_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "button_set_long_press_time",
  ...
  JS_SetPropertyStr(ctx, global_obj, "button_t_get_prop_long_press_time",
                      JS_NewCFunction(ctx, wrap_button_t_get_prop_long_press_time, "button_t_get_prop_long_press_time", 1));
...
ret_t edit_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "edit_set_close_im_when_blured",
  ...
  JS_SetPropertyStr(ctx, global_obj, "edit_t_get_prop_close_im_when_blured",
                      JS_NewCFunction(ctx, wrap_edit_t_get_prop_close_im_when_blured, "edit_t_get_prop_close_im_when_blured", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "edit_t_get_prop_cancelable",
...
ret_t label_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "label_set_line_wrap",
                      JS_NewCFunction(ctx, wrap_label_set_line_wrap, "label_set_line_wrap", 1));
  JS_SetPropertyStr(ctx, global_obj, "label_set_word_wrap",
                      JS_NewCFunction(ctx, wrap_label_set_word_wrap, "label_set_word_wrap", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "label_t_get_prop_line_wrap",
                      JS_NewCFunction(ctx, wrap_label_t_get_prop_line_wrap, "label_t_get_prop_line_wrap", 1));
  JS_SetPropertyStr(ctx, global_obj, "label_t_get_prop_word_wrap",
                      JS_NewCFunction(ctx, wrap_label_t_get_prop_word_wrap, "label_t_get_prop_word_wrap", 1));
...
ret_t tab_button_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "tab_button_t_get_prop_load_ui",
...
ret_t view_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "view_set_default_focused_child",
                      JS_NewCFunction(ctx, wrap_view_set_default_focused_child, "view_set_default_focused_child", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "view_t_get_prop_default_focused_child",
                      JS_NewCFunction(ctx, wrap_view_t_get_prop_default_focused_child, "view_t_get_prop_default_focused_child", 1));
...
ret_t native_window_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "native_window_show_border",
...
ret_t overlay_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "overlay_set_click_through",
                      JS_NewCFunction(ctx, wrap_overlay_set_click_through, "overlay_set_click_through", 1));
  JS_SetPropertyStr(ctx, global_obj, "overlay_set_always_on_top",
                      JS_NewCFunction(ctx, wrap_overlay_set_always_on_top, "overlay_set_always_on_top", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "overlay_t_get_prop_click_through",
                      JS_NewCFunction(ctx, wrap_overlay_t_get_prop_click_through, "overlay_t_get_prop_click_through", 1));
  JS_SetPropertyStr(ctx, global_obj, "overlay_t_get_prop_always_on_top",
                      JS_NewCFunction(ctx, wrap_overlay_t_get_prop_always_on_top, "overlay_t_get_prop_always_on_top", 1));
...
ret_t popup_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "popup_set_close_when_timeout",
                      JS_NewCFunction(ctx, wrap_popup_set_close_when_timeout, "popup_set_close_when_timeout", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "popup_t_get_prop_close_when_timeout",
                      JS_NewCFunction(ctx, wrap_popup_t_get_prop_close_when_timeout, "popup_t_get_prop_close_when_timeout", 1));
