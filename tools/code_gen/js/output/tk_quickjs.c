...
ret_t file_browser_view_t_init(JSContext *ctx) {
  ...
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_set_file_icon",
                      JS_NewCFunction(ctx, wrap_file_browser_view_set_file_icon, "file_browser_view_set_file_icon", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_set_folder_icon",
                      JS_NewCFunction(ctx, wrap_file_browser_view_set_folder_icon, "file_browser_view_set_folder_icon", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_set_return_up_icon",
                      JS_NewCFunction(ctx, wrap_file_browser_view_set_return_up_icon, "file_browser_view_set_return_up_icon", 1));
  ...
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_t_get_prop_file_icon",
                      JS_NewCFunction(ctx, wrap_file_browser_view_t_get_prop_file_icon, "file_browser_view_t_get_prop_file_icon", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_t_get_prop_folder_icon",
                      JS_NewCFunction(ctx, wrap_file_browser_view_t_get_prop_folder_icon, "file_browser_view_t_get_prop_folder_icon", 1));
  JS_SetPropertyStr(ctx, global_obj, "file_browser_view_t_get_prop_return_up_icon",
                      JS_NewCFunction(ctx, wrap_file_browser_view_t_get_prop_return_up_icon, "file_browser_view_t_get_prop_return_up_icon", 1));
