...
const EVT_CONTEXT_MENU = Module.cwrap("get_EVT_CONTEXT_MENU", 
    "number", []);
const EVT_MOUSE_EXTRA_BUTTON_DOWN = Module.cwrap("get_EVT_MOUSE_EXTRA_BUTTON_DOWN", 
    "number", []);
const EVT_MOUSE_EXTRA_BUTTON_UP = Module.cwrap("get_EVT_MOUSE_EXTRA_BUTTON_UP", 
    "number", []);
...
const timer_modify = Module.cwrap("timer_modify", 
    "number", ["number","number"]);
const timer_modify_ex = Module.cwrap("timer_modify_ex", 
    "number", ["number","number","number"]);
...
const widget_is_always_on_top = Module.cwrap("widget_is_always_on_top", 
    "number", ["number"]);
const widget_is_suspend_dialog = Module.cwrap("widget_is_suspend_dialog", 
    "number", ["number"]);
const widget_is_suspend_popup = Module.cwrap("widget_is_suspend_popup", 
    "number", ["number"]);
...
const widget_destroy_async = Module.cwrap("widget_destroy_async", 
    "number", ["number"]);
const widget_ref = Module.cwrap("widget_ref", 
    "number", ["number"]);
...
const app_conf_remove = Module.cwrap("app_conf_remove", 
    "number", ["string"]);
const object_load_conf = Module.cwrap("object_load_conf", 
    "number", ["number","string","string"]);
const EDIT_EX_PROP_MULTILINE = Module.cwrap("get_EDIT_EX_PROP_MULTILINE", 
    "string", []);
const EDIT_EX_PROP_SUGGEST_WORDS = Module.cwrap("get_EDIT_EX_PROP_SUGGEST_WORDS", 
    "string", []);
const EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS = Module.cwrap("get_EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS", 
    "string", []);
const EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE = Module.cwrap("get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE", 
    "string", []);
const EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE = Module.cwrap("get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE", 
    "string", []);
const EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE = Module.cwrap("get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE", 
    "string", []);
const EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME = Module.cwrap("get_EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME", 
    "string", []);
const EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD = Module.cwrap("get_EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD", 
    "string", []);
const EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS = Module.cwrap("get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS", 
    "string", []);
const EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME = Module.cwrap("get_EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME", 
    "string", []);
...
const TK_OBJECT_CMD_EDIT = Module.cwrap("get_TK_OBJECT_CMD_EDIT", 
    "string", []);
const TK_OBJECT_CMD_EXEC = Module.cwrap("get_TK_OBJECT_CMD_EXEC", 
    "string", []);
const TK_OBJECT_CMD_UNDO = Module.cwrap("get_TK_OBJECT_CMD_UNDO", 
    "string", []);
const TK_OBJECT_PROP_SIZE = Module.cwrap("get_TK_OBJECT_PROP_SIZE", 
    "string", []);
const TK_OBJECT_PROP_DISABLE_PATH = Module.cwrap("get_TK_OBJECT_PROP_DISABLE_PATH", 
    "string", []);
const TK_OBJECT_PROP_KEEP_PROPS_ORDER = Module.cwrap("get_TK_OBJECT_PROP_KEEP_PROPS_ORDER", 
    "string", []);
...
const mledit_get_current_row_index = Module.cwrap("mledit_get_current_row_index", 
    "number", ["number"]);
const mledit_get_start_line_index = Module.cwrap("mledit_get_start_line_index", 
    "number", ["number"]);
const mledit_get_start_row_index = Module.cwrap("mledit_get_start_row_index", 
    "number", ["number"]);
const mledit_get_line_at = Module.cwrap("mledit_get_line_at", 
    "number", ["number","number"]);
const mledit_get_row_at = Module.cwrap("mledit_get_row_at", 
    "number", ["number","number"]);
const mledit_get_row_of_line = Module.cwrap("mledit_get_row_of_line", 
    "number", ["number","number"]);
...
const mledit_t_get_prop_accept_tab = Module.cwrap("mledit_t_get_prop_accept_tab", 
    "number", ["number"]);
const mledit_t_get_prop_auto_adjust_height = Module.cwrap("mledit_t_get_prop_auto_adjust_height", 
    "number", ["number"]);
...
const rich_text_set_yslidable = Module.cwrap("rich_text_set_yslidable", 
    "number", ["number","number"]);
const rich_text_set_word_wrap = Module.cwrap("rich_text_set_word_wrap", 
    "number", ["number","number"]);
...
const rich_text_t_get_prop_yslidable = Module.cwrap("rich_text_t_get_prop_yslidable", 
    "number", ["number"]);
const rich_text_t_get_prop_word_wrap = Module.cwrap("rich_text_t_get_prop_word_wrap", 
    "number", ["number"]);
...
const scroll_bar_set_scroll_delta = Module.cwrap("scroll_bar_set_scroll_delta", 
    "number", ["number","number"]);
const scroll_bar_set_scroll_rows = Module.cwrap("scroll_bar_set_scroll_rows", 
    "number", ["number","number"]);
...
const scroll_bar_t_get_prop_scroll_delta = Module.cwrap("scroll_bar_t_get_prop_scroll_delta", 
    "number", ["number"]);
const scroll_bar_t_get_prop_scroll_rows = Module.cwrap("scroll_bar_t_get_prop_scroll_rows", 
    "number", ["number"]);
...
const scroll_bar_t_get_prop_wheel_scroll = Module.cwrap("scroll_bar_t_get_prop_wheel_scroll", 
    "number", ["number"]);
const scroll_bar_t_get_prop_wheel_modifier_key = Module.cwrap("scroll_bar_t_get_prop_wheel_modifier_key", 
    "string", ["number"]);
...
const scroll_view_scroll_delta_to = Module.cwrap("scroll_view_scroll_delta_to", 
    "number", ["number","number","number","number"]);
const scroll_view_t_get_prop_use_virtual_w = Module.cwrap("scroll_view_t_get_prop_use_virtual_w", 
    "number", ["number"]);
const scroll_view_t_get_prop_use_widget_w = Module.cwrap("scroll_view_t_get_prop_use_widget_w", 
    "number", ["number"]);
const scroll_view_t_get_prop_use_virtual_h = Module.cwrap("scroll_view_t_get_prop_use_virtual_h", 
    "number", ["number"]);
const scroll_view_t_get_prop_use_widget_h = Module.cwrap("scroll_view_t_get_prop_use_widget_h", 
    "number", ["number"]);
...
const named_value_t_get_prop_name = Module.cwrap("named_value_t_get_prop_name", 
    "string", ["number"]);
const object_fifo_set_event_t_get_prop_index = Module.cwrap("object_fifo_set_event_t_get_prop_index", 
    "number", ["number"]);
const object_fifo_set_event_t_get_prop_nr = Module.cwrap("object_fifo_set_event_t_get_prop_nr", 
    "number", ["number"]);
const object_fifo_set_event_t_get_prop_data = Module.cwrap("object_fifo_set_event_t_get_prop_data", 
    "number", ["number"]);
const object_fifo_push_event_t_get_prop_nr = Module.cwrap("object_fifo_push_event_t_get_prop_nr", 
    "number", ["number"]);
const object_fifo_push_event_t_get_prop_data = Module.cwrap("object_fifo_push_event_t_get_prop_data", 
    "number", ["number"]);
const object_fifo_push_head_event_t_get_prop_nr = Module.cwrap("object_fifo_push_head_event_t_get_prop_nr", 
    "number", ["number"]);
const object_fifo_push_head_event_t_get_prop_data = Module.cwrap("object_fifo_push_head_event_t_get_prop_data", 
    "number", ["number"]);
const object_fifo_pop_event_t_get_prop_nr = Module.cwrap("object_fifo_pop_event_t_get_prop_nr", 
    "number", ["number"]);
const object_fifo_pop_tail_event_t_get_prop_nr = Module.cwrap("object_fifo_pop_tail_event_t_get_prop_nr", 
    "number", ["number"]);
const object_fifo_set_event_cast = Module.cwrap("object_fifo_set_event_cast", 
    "number", ["number"]);
const object_fifo_push_event_cast = Module.cwrap("object_fifo_push_event_cast", 
    "number", ["number"]);
const object_fifo_push_head_event_cast = Module.cwrap("object_fifo_push_head_event_cast", 
    "number", ["number"]);
const object_fifo_pop_event_cast = Module.cwrap("object_fifo_pop_event_cast", 
    "number", ["number"]);
const object_fifo_pop_tail_event_cast = Module.cwrap("object_fifo_pop_tail_event_cast", 
    "number", ["number"]);
const object_fifo_value_change_event_cast = Module.cwrap("object_fifo_value_change_event_cast", 
    "number", ["number"]);
const object_fifo_value_change_event_t_get_prop_type = Module.cwrap("object_fifo_value_change_event_t_get_prop_type", 
    "number", ["number"]);
...
const edit_get_int = Module.cwrap("edit_get_int", 
    "number", ["number"]);
const edit_get_int64 = Module.cwrap("edit_get_int64", 
    "number", ["number"]);
...
const edit_ex_create = Module.cwrap("edit_ex_create", 
    "number", ["number","number","number","number","number"]);
const edit_ex_set_multiline = Module.cwrap("edit_ex_set_multiline", 
    "number", ["number","number"]);
...
const edit_ex_set_suggest_words_input_name = Module.cwrap("edit_ex_set_suggest_words_input_name", 
    "number", ["number","string"]);
const edit_ex_update_suggest_words_popup = Module.cwrap("edit_ex_update_suggest_words_popup", 
    "number", ["number"]);
...
const edit_ex_t_get_prop_suggest_words_input_name = Module.cwrap("edit_ex_t_get_prop_suggest_words_input_name", 
    "string", ["number"]);
const edit_ex_t_get_prop_is_select_suggest_word = Module.cwrap("edit_ex_t_get_prop_is_select_suggest_word", 
    "number", ["number"]);
const edit_ex_t_get_prop_multiline = Module.cwrap("edit_ex_t_get_prop_multiline", 
    "number", ["number"]);
...
const gif_image_set_loop = Module.cwrap("gif_image_set_loop", 
    "number", ["number","number"]);
const gif_image_set_part_buffer_load_mode = Module.cwrap("gif_image_set_part_buffer_load_mode", 
    "number", ["number","number"]);
const gif_image_cast = Module.cwrap("gif_image_cast", 
    "number", ["number"]);
const gif_image_t_get_prop_loop = Module.cwrap("gif_image_t_get_prop_loop", 
    "number", ["number"]);
const gif_image_t_get_prop_part_buffer_load_mode = Module.cwrap("gif_image_t_get_prop_part_buffer_load_mode", 
    "number", ["number"]);
...
const object_hash_set_keep_prop_type = Module.cwrap("object_hash_set_keep_prop_type", 
    "number", ["number","number"]);
const object_hash_set_name_case_insensitive = Module.cwrap("object_hash_set_name_case_insensitive", 
    "number", ["number","number"]);
...
export class TConfUtils { 
   ...
   * @returns 返回RET_OK表示成功，否则表示失败。
   */
 static objectLoadConf(obj : TTkObject, url : string, type : string) : TRet  {
...
export enum TObjectCmd {
 ...
 EDIT = TK_OBJECT_CMD_EDIT(),
   ...
   *
   */
 EXEC = TK_OBJECT_CMD_EXEC(),

  /**
   * 撤销
   *
   */
 UNDO = TK_OBJECT_CMD_UNDO(),
};
...
export enum TObjectProp {
 ...
 TK_SIZE = TK_OBJECT_PROP_SIZE(),
   ...
   *
   */
 TK_DISABLE_PATH = TK_OBJECT_PROP_DISABLE_PATH(),

  /**
   * 是否保持属性间的顺序。
   *
   */
 TK_KEEP_PROPS_ORDER = TK_OBJECT_PROP_KEEP_PROPS_ORDER(),
