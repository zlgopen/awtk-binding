...
declare function widget_set_focusable(widget : TWidget, focusable : boolean) : TRet;
...
declare function tab_button_set_load_ui(widget : TWidget, name : string) : TRet;
declare function tab_button_t_get_prop_value(nativeObj : any);
declare function tab_button_t_get_prop_load_ui(nativeObj : any);
...
declare function window_create_default() : TWidget;
