...
ret_t serial_widget_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_istream", wrap_serial_widget_t_get_prop_istream);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_ostream", wrap_serial_widget_t_get_prop_ostream);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_iostream", wrap_serial_widget_t_get_prop_iostream);
