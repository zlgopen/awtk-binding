...
jsvalue_t wrap_app_conf_on_changed(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
...
jsvalue_t wrap_app_conf_off_changed(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
...
ret_t app_conf_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"app_conf_on_changed", wrap_app_conf_on_changed);
  jerryx_handler_register_global((const jerry_char_t*)"app_conf_off_changed", wrap_app_conf_off_changed);
