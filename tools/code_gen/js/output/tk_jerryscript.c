...
jsvalue_t wrap_widget_get_enable(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_widget_get_floating(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_widget_get_auto_adjust_size(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_widget_get_with_focus_state(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_widget_get_focusable(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_widget_get_sensitive(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_widget_get_visible(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_widget_get_feedback(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_color_get_color(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_asset_info_get_type(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_asset_info_get_name(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_color_tile_get_bg_color(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_color_tile_get_border_color(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_file_browser_view_set_top_dir(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_file_browser_view_t_get_prop_top_dir(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_timer_info_t_get_prop_extra_ctx(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
...
jsvalue_t wrap_idle_info_t_get_prop_extra_ctx(
    const jerry_call_info_t *call_info_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
  )  {
