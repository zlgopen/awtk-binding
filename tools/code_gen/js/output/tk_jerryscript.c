...
jsvalue_t wrap_file_browser_view_set_file_icon(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
...
jsvalue_t wrap_file_browser_view_set_folder_icon(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
...
jsvalue_t wrap_file_browser_view_set_return_up_icon(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
...
jsvalue_t wrap_file_browser_view_t_get_prop_file_icon(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
...
jsvalue_t wrap_file_browser_view_t_get_prop_folder_icon(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
...
jsvalue_t wrap_file_browser_view_t_get_prop_return_up_icon(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t argv[], 
    const jerry_length_t argc 
...
ret_t file_browser_view_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_file_icon", wrap_file_browser_view_set_file_icon);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_folder_icon", wrap_file_browser_view_set_folder_icon);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_return_up_icon", wrap_file_browser_view_set_return_up_icon);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_file_icon", wrap_file_browser_view_t_get_prop_file_icon);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_folder_icon", wrap_file_browser_view_t_get_prop_folder_icon);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_return_up_icon", wrap_file_browser_view_t_get_prop_return_up_icon);
