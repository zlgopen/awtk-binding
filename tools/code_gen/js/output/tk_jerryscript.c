...
static jerry_object_native_info_t s_named_value_hash_destroy_info = {
  (jerry_object_native_free_callback_t)named_value_hash_destroy
};
...
ret_t bitmap_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"bitmap_get_bpp_of_format", wrap_bitmap_get_bpp_of_format);
...
static HANDLER_PROTO(wrap_object_set_prop)  {
  ...
  object_t* obj = (object_t*)jsvalue_get_pointer(ctx, argv[0], "object_t*");
  const char* name = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
  const value_t* value = (const value_t*)jsvalue_get_pointer(ctx, argv[2], "const value_t*");
...
static HANDLER_PROTO(wrap_object_clear_props)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
ret_t object_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"object_get_prop_double", wrap_object_get_prop_double);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"object_has_prop_by_path", wrap_object_has_prop_by_path);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_by_path", wrap_object_set_prop_by_path);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_str_by_path", wrap_object_set_prop_str_by_path);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_object_by_path", wrap_object_set_prop_object_by_path);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_int_by_path", wrap_object_set_prop_int_by_path);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_bool_by_path", wrap_object_set_prop_bool_by_path);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_float_by_path", wrap_object_set_prop_float_by_path);
  jerryx_handler_register_global((const jerry_char_t*)"object_can_exec_by_path", wrap_object_can_exec_by_path);
  jerryx_handler_register_global((const jerry_char_t*)"object_exec_by_path", wrap_object_exec_by_path);
  jerryx_handler_register_global((const jerry_char_t*)"object_get_prop_int8", wrap_object_get_prop_int8);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_int8", wrap_object_set_prop_int8);
  jerryx_handler_register_global((const jerry_char_t*)"object_get_prop_uint8", wrap_object_get_prop_uint8);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_uint8", wrap_object_set_prop_uint8);
  jerryx_handler_register_global((const jerry_char_t*)"object_get_prop_int16", wrap_object_get_prop_int16);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_int16", wrap_object_set_prop_int16);
  jerryx_handler_register_global((const jerry_char_t*)"object_get_prop_uint16", wrap_object_get_prop_uint16);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_uint16", wrap_object_set_prop_uint16);
  jerryx_handler_register_global((const jerry_char_t*)"object_get_prop_int32", wrap_object_get_prop_int32);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_int32", wrap_object_set_prop_int32);
  jerryx_handler_register_global((const jerry_char_t*)"object_get_prop_uint32", wrap_object_get_prop_uint32);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_uint32", wrap_object_set_prop_uint32);
  jerryx_handler_register_global((const jerry_char_t*)"object_get_prop_int64", wrap_object_get_prop_int64);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_int64", wrap_object_set_prop_int64);
  jerryx_handler_register_global((const jerry_char_t*)"object_get_prop_uint64", wrap_object_get_prop_uint64);
  jerryx_handler_register_global((const jerry_char_t*)"object_set_prop_uint64", wrap_object_set_prop_uint64);
  jerryx_handler_register_global((const jerry_char_t*)"object_clear_props", wrap_object_clear_props);
...
static HANDLER_PROTO(wrap_value_equal)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  bool_t ret = (bool_t)0;
...
static HANDLER_PROTO(wrap_value_id)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  const char* ret = NULL;
...
static HANDLER_PROTO(wrap_value_func)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  void* ret = NULL;
...
static HANDLER_PROTO(wrap_value_func_def)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  void* ret = NULL;
...
static HANDLER_PROTO(wrap_value_bitmap)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  void* ret = NULL;
...
static HANDLER_PROTO(wrap_value_rect)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  rect_t* ret = NULL;
...
ret_t value_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"value_id", wrap_value_id);
  jerryx_handler_register_global((const jerry_char_t*)"value_func", wrap_value_func);
  jerryx_handler_register_global((const jerry_char_t*)"value_func_def", wrap_value_func_def);
  jerryx_handler_register_global((const jerry_char_t*)"value_bitmap", wrap_value_bitmap);
  jerryx_handler_register_global((const jerry_char_t*)"value_rect", wrap_value_rect);

 return RET_OK;
}

static HANDLER_PROTO(wrap_tk_pre_init)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 0) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_tk_quit_ex)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
ret_t global_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"tk_pre_init", wrap_tk_pre_init);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"tk_quit_ex", wrap_tk_quit_ex);
...
static HANDLER_PROTO(get_IMAGE_DRAW_FILL)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, IMAGE_DRAW_FILL);
}
...
ret_t image_draw_type_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"IMAGE_DRAW_FILL", get_IMAGE_DRAW_FILL);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"IMAGE_DRAW_REPEAT3_X", get_IMAGE_DRAW_REPEAT3_X);
  jerryx_handler_register_global((const jerry_char_t*)"IMAGE_DRAW_REPEAT3_Y", get_IMAGE_DRAW_REPEAT3_Y);
...
static HANDLER_PROTO(wrap_canvas_reset_font)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_canvas_reset_cache)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
ret_t canvas_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"canvas_reset_font", wrap_canvas_reset_font);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"canvas_draw_image_ex2", wrap_canvas_draw_image_ex2);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"canvas_reset_cache", wrap_canvas_reset_cache);
...
static HANDLER_PROTO(get_EVT_DATA)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_DATA);
}

static HANDLER_PROTO(get_EVT_CONNECT)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_CONNECT);
}

static HANDLER_PROTO(get_EVT_MODEL_CHANGE)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_MODEL_CHANGE);
}

static HANDLER_PROTO(get_EVT_SYSTEM)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_SYSTEM);
}

static HANDLER_PROTO(get_EVT_DROP_FILE)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_DROP_FILE);
}

static HANDLER_PROTO(get_EVT_LOCALE_INFOS_LOAD_INFO)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_LOCALE_INFOS_LOAD_INFO);
}

static HANDLER_PROTO(get_EVT_LOCALE_INFOS_UNLOAD_INFO)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_LOCALE_INFOS_UNLOAD_INFO);
}

static HANDLER_PROTO(get_EVT_ACTIVATED)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_ACTIVATED);
}
...
static HANDLER_PROTO(get_EVT_TOUCH_DOWN)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_TOUCH_DOWN);
}

static HANDLER_PROTO(get_EVT_TOUCH_MOVE)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_TOUCH_MOVE);
}

static HANDLER_PROTO(get_EVT_TOUCH_UP)  {
  void* ctx = NULL;
...
static HANDLER_PROTO(get_EVT_LOG_MESSAGE)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, EVT_LOG_MESSAGE);
}
...
ret_t event_type_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"EVT_MOUSE_EXTRA_BUTTON_DOWN", get_EVT_MOUSE_EXTRA_BUTTON_DOWN);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_MOUSE_EXTRA_BUTTON_UP", get_EVT_MOUSE_EXTRA_BUTTON_UP);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"EVT_IM_PREEDIT_CONFIRM", get_EVT_IM_PREEDIT_CONFIRM);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_IM_PREEDIT_ABORT", get_EVT_IM_PREEDIT_ABORT);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_IM_SHOW_CANDIDATES", get_EVT_IM_SHOW_CANDIDATES);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_IM_SHOW_PRE_CANDIDATES", get_EVT_IM_SHOW_PRE_CANDIDATES);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_IM_LANG_CHANGED", get_EVT_IM_LANG_CHANGED);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"EVT_THEME_WILL_CHANGE", get_EVT_THEME_WILL_CHANGE);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_THEME_CHANGED", get_EVT_THEME_CHANGED);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_WIDGET_WILL_UPDATE_STYLE", get_EVT_WIDGET_WILL_UPDATE_STYLE);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_WIDGET_UPDATE_STYLE", get_EVT_WIDGET_UPDATE_STYLE);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"EVT_ASSET_MANAGER_LOAD_ASSET", get_EVT_ASSET_MANAGER_LOAD_ASSET);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_ASSET_MANAGER_UNLOAD_ASSET", get_EVT_ASSET_MANAGER_UNLOAD_ASSET);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_ASSET_MANAGER_CLEAR_CACHE", get_EVT_ASSET_MANAGER_CLEAR_CACHE);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_TIMER", get_EVT_TIMER);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_DATA", get_EVT_DATA);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_CONNECT", get_EVT_CONNECT);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_MODEL_CHANGE", get_EVT_MODEL_CHANGE);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_SYSTEM", get_EVT_SYSTEM);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_DROP_FILE", get_EVT_DROP_FILE);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_LOCALE_INFOS_LOAD_INFO", get_EVT_LOCALE_INFOS_LOAD_INFO);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_LOCALE_INFOS_UNLOAD_INFO", get_EVT_LOCALE_INFOS_UNLOAD_INFO);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"EVT_TOUCH_DOWN", get_EVT_TOUCH_DOWN);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_TOUCH_MOVE", get_EVT_TOUCH_MOVE);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_TOUCH_UP", get_EVT_TOUCH_UP);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"EVT_LOG_MESSAGE", get_EVT_LOG_MESSAGE);
...
static HANDLER_PROTO(wrap_event_register_custom_name)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_event_unregister_custom_name)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
ret_t event_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"event_register_custom_name", wrap_event_register_custom_name);
  jerryx_handler_register_global((const jerry_char_t*)"event_unregister_custom_name", wrap_event_unregister_custom_name);
...
static HANDLER_PROTO(get_GLYPH_FMT_ALPHA2)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, GLYPH_FMT_ALPHA2);
}

static HANDLER_PROTO(get_GLYPH_FMT_ALPHA4)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, GLYPH_FMT_ALPHA4);
}
...
ret_t glyph_format_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"GLYPH_FMT_ALPHA2", get_GLYPH_FMT_ALPHA2);
  jerryx_handler_register_global((const jerry_char_t*)"GLYPH_FMT_ALPHA4", get_GLYPH_FMT_ALPHA4);
...
ret_t image_manager_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"image_manager_preload", wrap_image_manager_preload);
...
static HANDLER_PROTO(wrap_input_method_dispatch_keys)  {
  ...
  ret_t ret = (ret_t)0;
  input_method_t* im = (input_method_t*)jsvalue_get_pointer(ctx, argv[0], "input_method_t*");
  const char* keys = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
...
ret_t input_method_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"input_method_set_lang", wrap_input_method_set_lang);
  jerryx_handler_register_global((const jerry_char_t*)"input_method_get_lang", wrap_input_method_get_lang);
  jerryx_handler_register_global((const jerry_char_t*)"input_method_dispatch_key", wrap_input_method_dispatch_key);
  jerryx_handler_register_global((const jerry_char_t*)"input_method_dispatch_keys", wrap_input_method_dispatch_keys);
  jerryx_handler_register_global((const jerry_char_t*)"input_method_dispatch_preedit", wrap_input_method_dispatch_preedit);
  jerryx_handler_register_global((const jerry_char_t*)"input_method_dispatch_preedit_confirm", wrap_input_method_dispatch_preedit_confirm);
  jerryx_handler_register_global((const jerry_char_t*)"input_method_dispatch_preedit_abort", wrap_input_method_dispatch_preedit_abort);
...
ret_t key_code_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_DIVIDE", get_TK_KEY_KP_DIVIDE);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_MULTIPLY", get_TK_KEY_KP_MULTIPLY);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_MINUS", get_TK_KEY_KP_MINUS);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_PLUS", get_TK_KEY_KP_PLUS);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_ENTER", get_TK_KEY_KP_ENTER);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_1", get_TK_KEY_KP_1);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_2", get_TK_KEY_KP_2);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_3", get_TK_KEY_KP_3);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_4", get_TK_KEY_KP_4);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_5", get_TK_KEY_KP_5);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_6", get_TK_KEY_KP_6);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_7", get_TK_KEY_KP_7);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_8", get_TK_KEY_KP_8);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_9", get_TK_KEY_KP_9);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_0", get_TK_KEY_KP_0);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_KP_PERIOD", get_TK_KEY_KP_PERIOD);
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_NUMLOCKCLEAR", get_TK_KEY_NUMLOCKCLEAR);
...
static HANDLER_PROTO(wrap_locale_info_change)  {
  ...
  ret_t ret = (ret_t)0;
  locale_info_t* locale_info = (locale_info_t*)jsvalue_get_pointer(ctx, argv[0], "locale_info_t*");
  const char* language = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
  const char* country = (const char*)jsvalue_get_utf8_string(ctx, argv[2]);
...
static HANDLER_PROTO(wrap_locale_infos_ref)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  locale_info_t* ret = NULL;
  ...
  jret = jsvalue_create_pointer(ctx, ret, "locale_infos_t*");
  }
  return jret;
}

static HANDLER_PROTO(wrap_locale_infos_unref)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_locale_infos_change)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  const char* language = (const char*)jsvalue_get_utf8_string(ctx, argv[0]);
  const char* country = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_locale_infos_off)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_locale_infos_reload_all)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 0) {
  ret_t ret = (ret_t)0;
...
ret_t locale_infos_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"locale_infos_change", wrap_locale_infos_change);
...
static HANDLER_PROTO(get_STYLE_ID_CLEAR_BG)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, STYLE_ID_CLEAR_BG);
}

static HANDLER_PROTO(get_STYLE_ID_GRID_COLOR)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, STYLE_ID_GRID_COLOR);
}

static HANDLER_PROTO(get_STYLE_ID_EVEN_BG_COLOR)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, STYLE_ID_EVEN_BG_COLOR);
}

static HANDLER_PROTO(get_STYLE_ID_ODD_BG_COLOR)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, STYLE_ID_ODD_BG_COLOR);
}
...
ret_t style_id_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_DRAGGER_COLOR", get_STYLE_ID_DRAGGER_COLOR);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_HIGHLIGHT_FONT_NAME", get_STYLE_ID_HIGHLIGHT_FONT_NAME);
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_HIGHLIGHT_FONT_SIZE", get_STYLE_ID_HIGHLIGHT_FONT_SIZE);
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_HIGHLIGHT_TEXT_COLOR", get_STYLE_ID_HIGHLIGHT_TEXT_COLOR);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_CLEAR_BG", get_STYLE_ID_CLEAR_BG);
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_GRID_COLOR", get_STYLE_ID_GRID_COLOR);
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_EVEN_BG_COLOR", get_STYLE_ID_EVEN_BG_COLOR);
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_ODD_BG_COLOR", get_STYLE_ID_ODD_BG_COLOR);
...
static HANDLER_PROTO(wrap_style_get)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 4) {
  ret_t ret = (ret_t)0;
  ...
  const char* name = (const char*)jsvalue_get_utf8_string(ctx, argv[2]);
  value_t* value = (value_t*)jsvalue_get_pointer(ctx, argv[3], "value_t*");
...
ret_t style_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"style_get", wrap_style_get);
  jerryx_handler_register_global((const jerry_char_t*)"style_set", wrap_style_set);
  jerryx_handler_register_global((const jerry_char_t*)"style_update_state", wrap_style_update_state);
  jerryx_handler_register_global((const jerry_char_t*)"style_get_style_state", wrap_style_get_style_state);
  jerryx_handler_register_global((const jerry_char_t*)"style_is_mutable", wrap_style_is_mutable);
  jerryx_handler_register_global((const jerry_char_t*)"style_get_style_type", wrap_style_get_style_type);

 return RET_OK;
}

static HANDLER_PROTO(get_SYSTEM_INFO_FLAG_NONE)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, SYSTEM_INFO_FLAG_NONE);
}

static HANDLER_PROTO(get_SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT);
}

ret_t system_info_flag_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"SYSTEM_INFO_FLAG_NONE", get_SYSTEM_INFO_FLAG_NONE);
  jerryx_handler_register_global((const jerry_char_t*)"SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT", get_SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT);
...
static HANDLER_PROTO(get_APP_CONSOLE)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, APP_CONSOLE);
}
...
ret_t app_type_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"APP_CONSOLE", get_APP_CONSOLE);
...
static HANDLER_PROTO(get_BITMAP_FLAG_LCD_ORIENTATION)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, BITMAP_FLAG_LCD_ORIENTATION);
}

static HANDLER_PROTO(get_BITMAP_FLAG_GPU_FBO_TEXTURE)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, BITMAP_FLAG_GPU_FBO_TEXTURE);
}
...
ret_t bitmap_flag_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"BITMAP_FLAG_LCD_ORIENTATION", get_BITMAP_FLAG_LCD_ORIENTATION);
  jerryx_handler_register_global((const jerry_char_t*)"BITMAP_FLAG_GPU_FBO_TEXTURE", get_BITMAP_FLAG_GPU_FBO_TEXTURE);
...
ret_t vgcanvas_fill_mode_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"VGCANVAS_FILL_MODE_ALL_FILL", get_VGCANVAS_FILL_MODE_ALL_FILL);
  jerryx_handler_register_global((const jerry_char_t*)"VGCANVAS_FILL_MODE_NON_ZERO", get_VGCANVAS_FILL_MODE_NON_ZERO);
  jerryx_handler_register_global((const jerry_char_t*)"VGCANVAS_FILL_MODE_EVEN_ODD", get_VGCANVAS_FILL_MODE_EVEN_ODD);
...
static HANDLER_PROTO(wrap_vgcanvas_set_font)  {
  ...
  ret_t ret = (ret_t)0;
  vgcanvas_t* vg = (vgcanvas_t*)jsvalue_get_pointer(ctx, argv[0], "vgcanvas_t*");
  const char* font = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_vgcanvas_set_font_size)  {
  ...
  ret_t ret = (ret_t)0;
  vgcanvas_t* vg = (vgcanvas_t*)jsvalue_get_pointer(ctx, argv[0], "vgcanvas_t*");
  float_t size = (float_t)jsvalue_get_number_value(ctx, argv[1]);
...
ret_t vgcanvas_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"vgcanvas_set_fill_mode", wrap_vgcanvas_set_fill_mode);
...
ret_t vgcanvas_line_cap_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"VGCANVAS_LINE_CAP_ROUND", get_VGCANVAS_LINE_CAP_ROUND);
  jerryx_handler_register_global((const jerry_char_t*)"VGCANVAS_LINE_CAP_SQUARE", get_VGCANVAS_LINE_CAP_SQUARE);
  jerryx_handler_register_global((const jerry_char_t*)"VGCANVAS_LINE_CAP_BUTT", get_VGCANVAS_LINE_CAP_BUTT);
...
ret_t vgcanvas_line_join_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"VGCANVAS_LINE_JOIN_ROUND", get_VGCANVAS_LINE_JOIN_ROUND);
  jerryx_handler_register_global((const jerry_char_t*)"VGCANVAS_LINE_JOIN_BEVEL", get_VGCANVAS_LINE_JOIN_BEVEL);
  jerryx_handler_register_global((const jerry_char_t*)"VGCANVAS_LINE_JOIN_MITTER", get_VGCANVAS_LINE_JOIN_MITTER);
...
static HANDLER_PROTO(get_WIDGET_PROP_LINE_HEIGHT)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_LINE_HEIGHT);
}
...
static HANDLER_PROTO(get_WIDGET_PROP_LOADING)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_LOADING);
}
...
static HANDLER_PROTO(get_WIDGET_PROP_EASY_TOUCH_MODE)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_EASY_TOUCH_MODE);
}
...
static HANDLER_PROTO(get_WIDGET_PROP_ELLIPSES)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_ELLIPSES);
}

static HANDLER_PROTO(get_WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL);
}
...
static HANDLER_PROTO(get_WIDGET_PROP_APPLET_NAME)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_APPLET_NAME);
}
...
static HANDLER_PROTO(get_WIDGET_PROP_RUNNING)  {
  void* ctx = NULL;
...
static HANDLER_PROTO(get_WIDGET_PROP_ENABLE_PREVIEW)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_ENABLE_PREVIEW);
}

static HANDLER_PROTO(get_WIDGET_PROP_IS_ACCEPT_STATUS)  {
  void* ctx = NULL;
...
static HANDLER_PROTO(get_WIDGET_PROP_THEME_OF_POPUP)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_THEME_OF_POPUP);
}
...
static HANDLER_PROTO(get_WIDGET_PROP_ACCEPT_BUTTON)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_ACCEPT_BUTTON);
}

static HANDLER_PROTO(get_WIDGET_PROP_CANCEL_BUTTON)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_CANCEL_BUTTON);
}

static HANDLER_PROTO(get_WIDGET_PROP_ACCEPT_RETRUN)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_ACCEPT_RETRUN);
}

static HANDLER_PROTO(get_WIDGET_PROP_ACCEPT_TAB)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_ACCEPT_TAB);
}

static HANDLER_PROTO(get_WIDGET_PROP_ROWS)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_ROWS);
}

static HANDLER_PROTO(get_WIDGET_PROP_SHOW_GRID)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_SHOW_GRID);
}

static HANDLER_PROTO(get_WIDGET_PROP_COLUMNS_DEFINITION)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_COLUMNS_DEFINITION);
}

static HANDLER_PROTO(get_WIDGET_PROP_DRAG_THRESHOLD)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_DRAG_THRESHOLD);
}

static HANDLER_PROTO(get_WIDGET_PROP_ANIMATING_TIME)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_ANIMATING_TIME);
}

static HANDLER_PROTO(get_WIDGET_PROP_ANIMATE_PREFIX)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_ANIMATE_PREFIX);
}

static HANDLER_PROTO(get_WIDGET_PROP_ANIMATE_ANIMATING_TIME)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_ANIMATE_ANIMATING_TIME);
}

static HANDLER_PROTO(get_WIDGET_PROP_DIRTY_RECT)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_DIRTY_RECT);
}

static HANDLER_PROTO(get_WIDGET_PROP_SCREEN_SAVER_TIME)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_SCREEN_SAVER_TIME);
}

static HANDLER_PROTO(get_WIDGET_PROP_SHOW_FPS)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_SHOW_FPS);
}

static HANDLER_PROTO(get_WIDGET_PROP_MAX_FPS)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_MAX_FPS);
}

static HANDLER_PROTO(get_WIDGET_PROP_VALIDATOR)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_VALIDATOR);
}

static HANDLER_PROTO(get_WIDGET_PROP_SYNC_STATE_TO_CHILDREN)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_PROP_SYNC_STATE_TO_CHILDREN);
}

static HANDLER_PROTO(get_WIDGET_PROP_STATE_FROM_PARENT_SYNC)  {
  void* ctx = NULL;
...
ret_t widget_prop_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_DESIGN_W", get_WIDGET_PROP_DESIGN_W);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_DESIGN_H", get_WIDGET_PROP_DESIGN_H);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_AUTO_SCALE_CHILDREN_X", get_WIDGET_PROP_AUTO_SCALE_CHILDREN_X);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_AUTO_SCALE_CHILDREN_Y", get_WIDGET_PROP_AUTO_SCALE_CHILDREN_Y);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_AUTO_SCALE_CHILDREN_W", get_WIDGET_PROP_AUTO_SCALE_CHILDREN_W);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_AUTO_SCALE_CHILDREN_H", get_WIDGET_PROP_AUTO_SCALE_CHILDREN_H);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_INPUTING", get_WIDGET_PROP_INPUTING);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ALWAYS_ON_TOP", get_WIDGET_PROP_ALWAYS_ON_TOP);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_LOADING", get_WIDGET_PROP_LOADING);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_EASY_TOUCH_MODE", get_WIDGET_PROP_EASY_TOUCH_MODE);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ELLIPSES", get_WIDGET_PROP_ELLIPSES);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL", get_WIDGET_PROP_VISIBLE_REVEAL_IN_SCROLL);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_APPLET_NAME", get_WIDGET_PROP_APPLET_NAME);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_DISABLE_ANIM", get_WIDGET_PROP_DISABLE_ANIM);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ACTION_TEXT", get_WIDGET_PROP_ACTION_TEXT);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_TIPS", get_WIDGET_PROP_TIPS);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_TR_TIPS", get_WIDGET_PROP_TR_TIPS);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_INPUT_TYPE", get_WIDGET_PROP_INPUT_TYPE);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_KEYBOARD", get_WIDGET_PROP_KEYBOARD);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_DEFAULT_FOCUSED_CHILD", get_WIDGET_PROP_DEFAULT_FOCUSED_CHILD);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_READONLY", get_WIDGET_PROP_READONLY);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_CANCELABLE", get_WIDGET_PROP_CANCELABLE);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_CURR_PAGE", get_WIDGET_PROP_CURR_PAGE);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_PAGE_MAX_NUMBER", get_WIDGET_PROP_PAGE_MAX_NUMBER);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_RUNNING", get_WIDGET_PROP_RUNNING);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_CLOSE_IM_WHEN_BLURED", get_WIDGET_PROP_CLOSE_IM_WHEN_BLURED);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_LONG_PRESS_TIME", get_WIDGET_PROP_LONG_PRESS_TIME);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ENABLE_LONG_PRESS", get_WIDGET_PROP_ENABLE_LONG_PRESS);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ENABLE_PREVIEW", get_WIDGET_PROP_ENABLE_PREVIEW);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_IS_ACCEPT_STATUS", get_WIDGET_PROP_IS_ACCEPT_STATUS);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_THEME_OF_POPUP", get_WIDGET_PROP_THEME_OF_POPUP);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_CLOSE_WHEN_TIMEOUT", get_WIDGET_PROP_CLOSE_WHEN_TIMEOUT);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ACCEPT_BUTTON", get_WIDGET_PROP_ACCEPT_BUTTON);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_CANCEL_BUTTON", get_WIDGET_PROP_CANCEL_BUTTON);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ACCEPT_RETRUN", get_WIDGET_PROP_ACCEPT_RETRUN);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ACCEPT_TAB", get_WIDGET_PROP_ACCEPT_TAB);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ROWS", get_WIDGET_PROP_ROWS);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_SHOW_GRID", get_WIDGET_PROP_SHOW_GRID);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_COLUMNS_DEFINITION", get_WIDGET_PROP_COLUMNS_DEFINITION);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_DRAG_THRESHOLD", get_WIDGET_PROP_DRAG_THRESHOLD);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ANIMATING_TIME", get_WIDGET_PROP_ANIMATING_TIME);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ANIMATE_PREFIX", get_WIDGET_PROP_ANIMATE_PREFIX);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ANIMATE_ANIMATING_TIME", get_WIDGET_PROP_ANIMATE_ANIMATING_TIME);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_DIRTY_RECT", get_WIDGET_PROP_DIRTY_RECT);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_SCREEN_SAVER_TIME", get_WIDGET_PROP_SCREEN_SAVER_TIME);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_SHOW_FPS", get_WIDGET_PROP_SHOW_FPS);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_MAX_FPS", get_WIDGET_PROP_MAX_FPS);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_VALIDATOR", get_WIDGET_PROP_VALIDATOR);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_SYNC_STATE_TO_CHILDREN", get_WIDGET_PROP_SYNC_STATE_TO_CHILDREN);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_STATE_FROM_PARENT_SYNC", get_WIDGET_PROP_STATE_FROM_PARENT_SYNC);
...
static HANDLER_PROTO(get_WIDGET_TYPE_ICON)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_TYPE_ICON);
}
...
static HANDLER_PROTO(get_WIDGET_TYPE_PAGE)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_TYPE_PAGE);
}
...
ret_t widget_type_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_TYPE_ICON", get_WIDGET_TYPE_ICON);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_TYPE_PAGE", get_WIDGET_TYPE_PAGE);
...
ret_t window_stage_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WINDOW_STAGE_LOADED", get_WINDOW_STAGE_LOADED);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WINDOW_STAGE_SUSPEND", get_WINDOW_STAGE_SUSPEND);
...
static HANDLER_PROTO(get_WIDGET_STATE_EMPTY_OVER)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_STATE_EMPTY_OVER);
}
...
static HANDLER_PROTO(get_WIDGET_STATE_NORMAL_OF_INDETERMINATE)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_STATE_NORMAL_OF_INDETERMINATE);
}

static HANDLER_PROTO(get_WIDGET_STATE_PRESSED_OF_INDETERMINATE)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_STATE_PRESSED_OF_INDETERMINATE);
}

static HANDLER_PROTO(get_WIDGET_STATE_OVER_OF_INDETERMINATE)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_STATE_OVER_OF_INDETERMINATE);
}

static HANDLER_PROTO(get_WIDGET_STATE_DISABLE_OF_INDETERMINATE)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_STATE_DISABLE_OF_INDETERMINATE);
}

static HANDLER_PROTO(get_WIDGET_STATE_FOCUSED_OF_INDETERMINATE)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, WIDGET_STATE_FOCUSED_OF_INDETERMINATE);
}
...
ret_t widget_state_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_ACTIVATED", get_WIDGET_STATE_ACTIVATED);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_CHANGED", get_WIDGET_STATE_CHANGED);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_EMPTY_OVER", get_WIDGET_STATE_EMPTY_OVER);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_DISABLE_OF_CHECKED", get_WIDGET_STATE_DISABLE_OF_CHECKED);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_DISABLE_OF_ACTIVE", get_WIDGET_STATE_DISABLE_OF_ACTIVE);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_FOCUSED_OF_ACTIVE", get_WIDGET_STATE_FOCUSED_OF_ACTIVE);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_NORMAL_OF_INDETERMINATE", get_WIDGET_STATE_NORMAL_OF_INDETERMINATE);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_PRESSED_OF_INDETERMINATE", get_WIDGET_STATE_PRESSED_OF_INDETERMINATE);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_OVER_OF_INDETERMINATE", get_WIDGET_STATE_OVER_OF_INDETERMINATE);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_DISABLE_OF_INDETERMINATE", get_WIDGET_STATE_DISABLE_OF_INDETERMINATE);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_FOCUSED_OF_INDETERMINATE", get_WIDGET_STATE_FOCUSED_OF_INDETERMINATE);
...
ret_t widget_cursor_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_CURSOR_DEFAULT", get_WIDGET_CURSOR_DEFAULT);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_CURSOR_CROSS", get_WIDGET_CURSOR_CROSS);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_CURSOR_NO", get_WIDGET_CURSOR_NO);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_CURSOR_SIZENWSE", get_WIDGET_CURSOR_SIZENWSE);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_CURSOR_SIZENESW", get_WIDGET_CURSOR_SIZENESW);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_CURSOR_SIZEWE", get_WIDGET_CURSOR_SIZEWE);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_CURSOR_SIZENS", get_WIDGET_CURSOR_SIZENS);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_CURSOR_SIZEALL", get_WIDGET_CURSOR_SIZEALL);
...
static HANDLER_PROTO(wrap_widget_find_parent_by_name)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  widget_t* ret = NULL;
...
static HANDLER_PROTO(wrap_widget_find_parent_by_type)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  widget_t* ret = NULL;
...
static HANDLER_PROTO(wrap_widget_move_to_center)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_widget_move_resize_ex)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 6) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_widget_is_support_highlighter)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  bool_t ret = (bool_t)0;
...
static HANDLER_PROTO(wrap_widget_has_highlighter)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  bool_t ret = (bool_t)0;
...
static HANDLER_PROTO(wrap_widget_set_text_utf8_ex)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 3) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  const char* text = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
  bool_t check_diff = (bool_t)jsvalue_get_boolean_value(ctx, argv[2]);
...
static HANDLER_PROTO(wrap_widget_get_theme_name)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  const char* ret = NULL;
...
static HANDLER_PROTO(wrap_widget_set_sync_state_to_children)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_widget_set_state_from_parent_sync)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_widget_get_prop)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 3) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_widget_set_prop)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 3) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_widget_set_props)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_widget_is_fullscreen_window)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  bool_t ret = (bool_t)0;
...
static HANDLER_PROTO(wrap_widget_is_always_on_top)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  bool_t ret = (bool_t)0;
...
static HANDLER_PROTO(wrap_widget_add_child_default)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_widget_t_get_prop_sync_state_to_children)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  widget_t* obj = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
...
static HANDLER_PROTO(wrap_widget_t_get_prop_state_from_parent_sync)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  widget_t* obj = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
...
static HANDLER_PROTO(wrap_widget_t_get_prop_opacity)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  widget_t* obj = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");

  jret = jsvalue_create_int(ctx, obj->opacity);
  return jret;
}
...
ret_t widget_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_find_parent_by_name", wrap_widget_find_parent_by_name);
  jerryx_handler_register_global((const jerry_char_t*)"widget_find_parent_by_type", wrap_widget_find_parent_by_type);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_move_to_center", wrap_widget_move_to_center);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_move_resize_ex", wrap_widget_move_resize_ex);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_value_int", wrap_widget_get_value_int);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_text_utf8_ex", wrap_widget_set_text_utf8_ex);
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_child_text_utf8", wrap_widget_set_child_text_utf8);
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_child_text_with_double", wrap_widget_set_child_text_with_double);
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_child_text_with_int", wrap_widget_set_child_text_with_int);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_floating", wrap_widget_get_floating);
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_auto_adjust_size", wrap_widget_get_auto_adjust_size);
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_with_focus_state", wrap_widget_get_with_focus_state);
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_focusable", wrap_widget_get_focusable);
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_sensitive", wrap_widget_get_sensitive);
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_visible", wrap_widget_get_visible);
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_feedback", wrap_widget_get_feedback);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_theme_name", wrap_widget_get_theme_name);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_auto_adjust_size", wrap_widget_set_auto_adjust_size);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_sync_state_to_children", wrap_widget_set_sync_state_to_children);
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_state_from_parent_sync", wrap_widget_set_state_from_parent_sync);
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_opacity", wrap_widget_set_opacity);
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_dirty_rect_tolerance", wrap_widget_set_dirty_rect_tolerance);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_prop", wrap_widget_get_prop);
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_prop", wrap_widget_set_prop);
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_props", wrap_widget_set_props);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_prop_pointer", wrap_widget_set_prop_pointer);
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_prop_pointer", wrap_widget_get_prop_pointer);
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_prop_float", wrap_widget_set_prop_float);
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_prop_float", wrap_widget_get_prop_float);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_window_created", wrap_widget_is_window_created);
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_parent_of", wrap_widget_is_parent_of);
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_direct_parent_of", wrap_widget_is_direct_parent_of);
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_window", wrap_widget_is_window);
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_system_bar", wrap_widget_is_system_bar);
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_normal_window", wrap_widget_is_normal_window);
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_fullscreen_window", wrap_widget_is_fullscreen_window);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_always_on_top", wrap_widget_is_always_on_top);
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_suspend_dialog", wrap_widget_is_suspend_dialog);
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_suspend_popup", wrap_widget_is_suspend_popup);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_destroy_async", wrap_widget_destroy_async);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_stroke_border_rect", wrap_widget_stroke_border_rect);
  jerryx_handler_register_global((const jerry_char_t*)"widget_fill_bg_rect", wrap_widget_fill_bg_rect);
  jerryx_handler_register_global((const jerry_char_t*)"widget_fill_fg_rect", wrap_widget_fill_fg_rect);
  jerryx_handler_register_global((const jerry_char_t*)"widget_dispatch_to_target", wrap_widget_dispatch_to_target);
  jerryx_handler_register_global((const jerry_char_t*)"widget_dispatch_to_key_target", wrap_widget_dispatch_to_key_target);
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_style_type", wrap_widget_get_style_type);
  jerryx_handler_register_global((const jerry_char_t*)"widget_update_style", wrap_widget_update_style);
  jerryx_handler_register_global((const jerry_char_t*)"widget_update_style_recursive", wrap_widget_update_style_recursive);
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_as_key_target", wrap_widget_set_as_key_target);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_state_for_style", wrap_widget_get_state_for_style);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_add_child_default", wrap_widget_add_child_default);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_t_get_prop_pointer_cursor", wrap_widget_t_get_prop_pointer_cursor);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_t_get_prop_auto_adjust_size", wrap_widget_t_get_prop_auto_adjust_size);
  jerryx_handler_register_global((const jerry_char_t*)"widget_t_get_prop_floating", wrap_widget_t_get_prop_floating);
  jerryx_handler_register_global((const jerry_char_t*)"widget_t_get_prop_sync_state_to_children", wrap_widget_t_get_prop_sync_state_to_children);
  jerryx_handler_register_global((const jerry_char_t*)"widget_t_get_prop_state_from_parent_sync", wrap_widget_t_get_prop_state_from_parent_sync);
  jerryx_handler_register_global((const jerry_char_t*)"widget_t_get_prop_opacity", wrap_widget_t_get_prop_opacity);
  jerryx_handler_register_global((const jerry_char_t*)"widget_t_get_prop_dirty_rect_tolerance", wrap_widget_t_get_prop_dirty_rect_tolerance);
...
ret_t app_conf_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"app_conf_set_int64", wrap_app_conf_set_int64);
  jerryx_handler_register_global((const jerry_char_t*)"app_conf_set_bool", wrap_app_conf_set_bool);
  jerryx_handler_register_global((const jerry_char_t*)"app_conf_set_double", wrap_app_conf_set_double);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"app_conf_get_int64", wrap_app_conf_get_int64);
...
ret_t edit_ex_prop_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"EDIT_EX_PROP_MULTILINE", get_EDIT_EX_PROP_MULTILINE);
  jerryx_handler_register_global((const jerry_char_t*)"EDIT_EX_PROP_SUGGEST_WORDS", get_EDIT_EX_PROP_SUGGEST_WORDS);
  jerryx_handler_register_global((const jerry_char_t*)"EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS", get_EDIT_EX_PROP_SUGGEST_WORDS_UI_PROPS);
  jerryx_handler_register_global((const jerry_char_t*)"EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE", get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_ODD_STYLE);
  jerryx_handler_register_global((const jerry_char_t*)"EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE", get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_EVEN_STYLE);
  jerryx_handler_register_global((const jerry_char_t*)"EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE", get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_SEPARATE_STYLE);
  jerryx_handler_register_global((const jerry_char_t*)"EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME", get_EDIT_EX_PROP_SUGGEST_WORDS_INPUT_NAME);
  jerryx_handler_register_global((const jerry_char_t*)"EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD", get_EDIT_EX_PROP_IS_SELECT_SUGGEST_WORD);
  jerryx_handler_register_global((const jerry_char_t*)"EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS", get_EDIT_EX_PROP_SUGGEST_WORDS_ITEM_FORMATS);
...
ret_t edit_ex_suggest_words_prop_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME", get_EDIT_EX_SUGGEST_WORDS_PROP_FORMAT_NAME);
...
static HANDLER_PROTO(wrap_asset_info_get_name)  {
  ...
  if(argc >= 1) {
  const char* ret = NULL;
  const asset_info_t* info = (const asset_info_t*)jsvalue_get_pointer(ctx, argv[0], "const asset_info_t*");
...
static HANDLER_PROTO(wrap_asset_info_is_in_rom)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  bool_t ret = (bool_t)0;
...
static HANDLER_PROTO(wrap_asset_info_set_is_in_rom)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_asset_info_t_get_prop_flags)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  asset_info_t* obj = (asset_info_t*)jsvalue_get_pointer(ctx, argv[0], "asset_info_t*");
...
ret_t asset_info_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"asset_info_get_type", wrap_asset_info_get_type);
  jerryx_handler_register_global((const jerry_char_t*)"asset_info_get_name", wrap_asset_info_get_name);
  jerryx_handler_register_global((const jerry_char_t*)"asset_info_is_in_rom", wrap_asset_info_is_in_rom);
  jerryx_handler_register_global((const jerry_char_t*)"asset_info_set_is_in_rom", wrap_asset_info_set_is_in_rom);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"asset_info_t_get_prop_flags", wrap_asset_info_t_get_prop_flags);
...
static HANDLER_PROTO(wrap_color_create)  {
  ...
  uint8_t g = (uint8_t)jsvalue_get_int_value(ctx, argv[1]);
  uint8_t b = (uint8_t)jsvalue_get_int_value(ctx, argv[2]);
...
static HANDLER_PROTO(wrap_date_time_from_time)  {
  ...
  ret_t ret = (ret_t)0;
  date_time_t* dt = (date_time_t*)jsvalue_get_pointer(ctx, argv[0], "date_time_t*");
  int64_t time = (int64_t)jsvalue_get_int_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_date_time_get_month_name)  {
  ...
  if(argc >= 1) {
  const char* ret = NULL;
  uint32_t month = (uint32_t)jsvalue_get_int_value(ctx, argv[0]);
...
ret_t date_time_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"date_time_set_year", wrap_date_time_set_year);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_set_month", wrap_date_time_set_month);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_set_day", wrap_date_time_set_day);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_set_hour", wrap_date_time_set_hour);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_set_minute", wrap_date_time_set_minute);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_set_second", wrap_date_time_set_second);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_set", wrap_date_time_set);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_from_time", wrap_date_time_from_time);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_to_time", wrap_date_time_to_time);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_add_delta", wrap_date_time_add_delta);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_is_leap", wrap_date_time_is_leap);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_get_days", wrap_date_time_get_days);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_get_wday", wrap_date_time_get_wday);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_get_month_name", wrap_date_time_get_month_name);
  jerryx_handler_register_global((const jerry_char_t*)"date_time_get_wday_name", wrap_date_time_get_wday_name);
...
ret_t object_cmd_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"OBJECT_CMD_MOVE_DOWN", get_OBJECT_CMD_MOVE_DOWN);
  jerryx_handler_register_global((const jerry_char_t*)"OBJECT_CMD_REMOVE", get_OBJECT_CMD_REMOVE);
  jerryx_handler_register_global((const jerry_char_t*)"OBJECT_CMD_REMOVE_CHECKED", get_OBJECT_CMD_REMOVE_CHECKED);
...
static HANDLER_PROTO(get_OBJECT_PROP_SELECTED_INDEX)  {
  void* ctx = NULL;
  return jsvalue_create_string(ctx, OBJECT_PROP_SELECTED_INDEX);
}
...
ret_t object_prop_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"OBJECT_PROP_DISABLE_PATH", get_OBJECT_PROP_DISABLE_PATH);
  jerryx_handler_register_global((const jerry_char_t*)"OBJECT_PROP_KEEP_PROPS_ORDER", get_OBJECT_PROP_KEEP_PROPS_ORDER);
  jerryx_handler_register_global((const jerry_char_t*)"OBJECT_PROP_CHECKED", get_OBJECT_PROP_CHECKED);
  jerryx_handler_register_global((const jerry_char_t*)"OBJECT_PROP_SELECTED_INDEX", get_OBJECT_PROP_SELECTED_INDEX);
...
static HANDLER_PROTO(get_RET_NO_PERMISSION)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, RET_NO_PERMISSION);
}

static HANDLER_PROTO(get_RET_INVALID_ADDR)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, RET_INVALID_ADDR);
}

static HANDLER_PROTO(get_RET_EXCEED_RANGE)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, RET_EXCEED_RANGE);
}

static HANDLER_PROTO(get_RET_MAX_NR)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, RET_MAX_NR);
}
...
ret_t ret_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"RET_NO_PERMISSION", get_RET_NO_PERMISSION);
  jerryx_handler_register_global((const jerry_char_t*)"RET_INVALID_ADDR", get_RET_INVALID_ADDR);
  jerryx_handler_register_global((const jerry_char_t*)"RET_EXCEED_RANGE", get_RET_EXCEED_RANGE);
  jerryx_handler_register_global((const jerry_char_t*)"RET_MAX_NR", get_RET_MAX_NR);
...
static HANDLER_PROTO(get_VALUE_TYPE_ID)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, VALUE_TYPE_ID);
}

static HANDLER_PROTO(get_VALUE_TYPE_FUNC)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, VALUE_TYPE_FUNC);
}

static HANDLER_PROTO(get_VALUE_TYPE_FUNC_DEF)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, VALUE_TYPE_FUNC_DEF);
}

static HANDLER_PROTO(get_VALUE_TYPE_POINTER_REF)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, VALUE_TYPE_POINTER_REF);
}

static HANDLER_PROTO(get_VALUE_TYPE_BITMAP)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, VALUE_TYPE_BITMAP);
}

static HANDLER_PROTO(get_VALUE_TYPE_RECT)  {
  void* ctx = NULL;
  return jsvalue_create_int(ctx, VALUE_TYPE_RECT);
}
...
ret_t value_type_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"VALUE_TYPE_GRADIENT", get_VALUE_TYPE_GRADIENT);
  jerryx_handler_register_global((const jerry_char_t*)"VALUE_TYPE_ID", get_VALUE_TYPE_ID);
  jerryx_handler_register_global((const jerry_char_t*)"VALUE_TYPE_FUNC", get_VALUE_TYPE_FUNC);
  jerryx_handler_register_global((const jerry_char_t*)"VALUE_TYPE_FUNC_DEF", get_VALUE_TYPE_FUNC_DEF);
  jerryx_handler_register_global((const jerry_char_t*)"VALUE_TYPE_POINTER_REF", get_VALUE_TYPE_POINTER_REF);
  jerryx_handler_register_global((const jerry_char_t*)"VALUE_TYPE_BITMAP", get_VALUE_TYPE_BITMAP);
  jerryx_handler_register_global((const jerry_char_t*)"VALUE_TYPE_RECT", get_VALUE_TYPE_RECT);
...
static HANDLER_PROTO(wrap_assets_manager_ref_ex)  {
  ...
  const char* name = (const char*)jsvalue_get_utf8_string(ctx, argv[3]);
...
static HANDLER_PROTO(wrap_assets_manager_unref)  {
  ...
  ret_t ret = (ret_t)0;
  assets_manager_t* am = (assets_manager_t*)jsvalue_get_pointer(ctx, argv[0], "assets_manager_t*");
  const asset_info_t* info = (const asset_info_t*)jsvalue_get_pointer(ctx, argv[1], "const asset_info_t*");
...
ret_t assets_manager_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"assets_manager_set_theme", wrap_assets_manager_set_theme);
  jerryx_handler_register_global((const jerry_char_t*)"assets_manager_ref", wrap_assets_manager_ref);
  jerryx_handler_register_global((const jerry_char_t*)"assets_manager_ref_ex", wrap_assets_manager_ref_ex);
  jerryx_handler_register_global((const jerry_char_t*)"assets_manager_unref", wrap_assets_manager_unref);

 return RET_OK;
}

static HANDLER_PROTO(wrap_widget_animator_event_cast)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  widget_animator_event_t* ret = NULL;
  event_t* event = (event_t*)jsvalue_get_pointer(ctx, argv[0], "event_t*");
  ret = (widget_animator_event_t*)widget_animator_event_cast(event);

  jret = jsvalue_create_pointer(ctx, ret, "widget_animator_event_t*");
  }
  return jret;
}

static HANDLER_PROTO(wrap_widget_animator_event_t_get_prop_widget)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  widget_animator_event_t* obj = (widget_animator_event_t*)jsvalue_get_pointer(ctx, argv[0], "widget_animator_event_t*");

  jret = jsvalue_create_pointer(ctx, obj->widget, "widget_t*");
  return jret;
}

static HANDLER_PROTO(wrap_widget_animator_event_t_get_prop_animator)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  widget_animator_event_t* obj = (widget_animator_event_t*)jsvalue_get_pointer(ctx, argv[0], "widget_animator_event_t*");

  jret = jsvalue_create_pointer(ctx, obj->animator, "void*");
  return jret;
}

ret_t widget_animator_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"widget_animator_event_cast", wrap_widget_animator_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"widget_animator_event_t_get_prop_widget", wrap_widget_animator_event_t_get_prop_widget);
  jerryx_handler_register_global((const jerry_char_t*)"widget_animator_event_t_get_prop_animator", wrap_widget_animator_event_t_get_prop_animator);

 return RET_OK;
}

static HANDLER_PROTO(wrap_model_event_cast)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  model_event_t* ret = NULL;
  event_t* event = (event_t*)jsvalue_get_pointer(ctx, argv[0], "event_t*");
  ret = (model_event_t*)model_event_cast(event);

  jret = jsvalue_create_pointer(ctx, ret, "model_event_t*");
  }
  return jret;
}

static HANDLER_PROTO(wrap_model_event_t_get_prop_name)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  model_event_t* obj = (model_event_t*)jsvalue_get_pointer(ctx, argv[0], "model_event_t*");

  jret = jsvalue_create_string(ctx, obj->name);
  return jret;
}

static HANDLER_PROTO(wrap_model_event_t_get_prop_change_type)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  model_event_t* obj = (model_event_t*)jsvalue_get_pointer(ctx, argv[0], "model_event_t*");

  jret = jsvalue_create_string(ctx, obj->change_type);
  return jret;
}

static HANDLER_PROTO(wrap_model_event_t_get_prop_model)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  model_event_t* obj = (model_event_t*)jsvalue_get_pointer(ctx, argv[0], "model_event_t*");

  jret = jsvalue_create_pointer(ctx, obj->model, "object_t*");
  return jret;
}

ret_t model_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"model_event_cast", wrap_model_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"model_event_t_get_prop_name", wrap_model_event_t_get_prop_name);
  jerryx_handler_register_global((const jerry_char_t*)"model_event_t_get_prop_change_type", wrap_model_event_t_get_prop_change_type);
  jerryx_handler_register_global((const jerry_char_t*)"model_event_t_get_prop_model", wrap_model_event_t_get_prop_model);
...
ret_t wheel_event_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"wheel_event_t_get_prop_x", wrap_wheel_event_t_get_prop_x);
  jerryx_handler_register_global((const jerry_char_t*)"wheel_event_t_get_prop_y", wrap_wheel_event_t_get_prop_y);
...
static HANDLER_PROTO(wrap_orientation_event_t_get_prop_orientation)  {
  ...
  jret = jsvalue_create_number(ctx, obj->orientation);
  return jret;
}
...
static HANDLER_PROTO(wrap_orientation_event_t_get_prop_old_orientation)  {
  ...
  jret = jsvalue_create_number(ctx, obj->old_orientation);
  return jret;
}
...
ret_t orientation_event_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"orientation_event_t_get_prop_old_orientation", wrap_orientation_event_t_get_prop_old_orientation);
...
ret_t offset_change_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"offset_change_event_cast", wrap_offset_change_event_cast);
...
static HANDLER_PROTO(wrap_pointer_event_t_get_prop_finger_id)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  pointer_event_t* obj = (pointer_event_t*)jsvalue_get_pointer(ctx, argv[0], "pointer_event_t*");
...
ret_t pointer_event_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"pointer_event_t_get_prop_finger_id", wrap_pointer_event_t_get_prop_finger_id);
...
static HANDLER_PROTO(wrap_key_event_t_get_prop_numlock)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  key_event_t* obj = (key_event_t*)jsvalue_get_pointer(ctx, argv[0], "key_event_t*");
...
ret_t key_event_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"key_event_t_get_prop_numlock", wrap_key_event_t_get_prop_numlock);
...
ret_t multi_gesture_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"multi_gesture_event_cast", wrap_multi_gesture_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"multi_gesture_event_t_get_prop_x", wrap_multi_gesture_event_t_get_prop_x);
  jerryx_handler_register_global((const jerry_char_t*)"multi_gesture_event_t_get_prop_y", wrap_multi_gesture_event_t_get_prop_y);
  jerryx_handler_register_global((const jerry_char_t*)"multi_gesture_event_t_get_prop_rotation", wrap_multi_gesture_event_t_get_prop_rotation);
  jerryx_handler_register_global((const jerry_char_t*)"multi_gesture_event_t_get_prop_distance", wrap_multi_gesture_event_t_get_prop_distance);
...
static HANDLER_PROTO(wrap_theme_change_event_t_get_prop_name)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  theme_change_event_t* obj = (theme_change_event_t*)jsvalue_get_pointer(ctx, argv[0], "theme_change_event_t*");
...
ret_t theme_change_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"theme_change_event_cast", wrap_theme_change_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"theme_change_event_t_get_prop_name", wrap_theme_change_event_t_get_prop_name);

 return RET_OK;
}

static HANDLER_PROTO(wrap_drop_file_event_cast)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  drop_file_event_t* ret = NULL;
  event_t* event = (event_t*)jsvalue_get_pointer(ctx, argv[0], "event_t*");
  ret = (drop_file_event_t*)drop_file_event_cast(event);

  jret = jsvalue_create_pointer(ctx, ret, "drop_file_event_t*");
  }
  return jret;
}

static HANDLER_PROTO(wrap_drop_file_event_t_get_prop_filename)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  drop_file_event_t* obj = (drop_file_event_t*)jsvalue_get_pointer(ctx, argv[0], "drop_file_event_t*");

  jret = jsvalue_create_string(ctx, obj->filename);
  return jret;
}

ret_t drop_file_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"drop_file_event_cast", wrap_drop_file_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"drop_file_event_t_get_prop_filename", wrap_drop_file_event_t_get_prop_filename);

 return RET_OK;
}

static HANDLER_PROTO(wrap_system_event_cast)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
...
static HANDLER_PROTO(wrap_system_event_t_get_prop_sdl_event)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
...
ret_t system_event_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"system_event_t_get_prop_sdl_event", wrap_system_event_t_get_prop_sdl_event);

 return RET_OK;
}

static HANDLER_PROTO(wrap_touch_event_cast)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
...
static HANDLER_PROTO(wrap_touch_event_t_get_prop_touch_id)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
...
static HANDLER_PROTO(wrap_touch_event_t_get_prop_finger_id)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  touch_event_t* obj = (touch_event_t*)jsvalue_get_pointer(ctx, argv[0], "touch_event_t*");
...
static HANDLER_PROTO(wrap_touch_event_t_get_prop_x)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  touch_event_t* obj = (touch_event_t*)jsvalue_get_pointer(ctx, argv[0], "touch_event_t*");
...
static HANDLER_PROTO(wrap_touch_event_t_get_prop_y)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  touch_event_t* obj = (touch_event_t*)jsvalue_get_pointer(ctx, argv[0], "touch_event_t*");
...
static HANDLER_PROTO(wrap_touch_event_t_get_prop_pressure)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  touch_event_t* obj = (touch_event_t*)jsvalue_get_pointer(ctx, argv[0], "touch_event_t*");
...
ret_t touch_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"touch_event_cast", wrap_touch_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"touch_event_t_get_prop_touch_id", wrap_touch_event_t_get_prop_touch_id);
  jerryx_handler_register_global((const jerry_char_t*)"touch_event_t_get_prop_finger_id", wrap_touch_event_t_get_prop_finger_id);
  jerryx_handler_register_global((const jerry_char_t*)"touch_event_t_get_prop_x", wrap_touch_event_t_get_prop_x);
  jerryx_handler_register_global((const jerry_char_t*)"touch_event_t_get_prop_y", wrap_touch_event_t_get_prop_y);
  jerryx_handler_register_global((const jerry_char_t*)"touch_event_t_get_prop_pressure", wrap_touch_event_t_get_prop_pressure);
...
ret_t ui_load_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"ui_load_event_cast", wrap_ui_load_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"ui_load_event_t_get_prop_root", wrap_ui_load_event_t_get_prop_root);
  jerryx_handler_register_global((const jerry_char_t*)"ui_load_event_t_get_prop_name", wrap_ui_load_event_t_get_prop_name);

 return RET_OK;
}

static HANDLER_PROTO(wrap_font_manager_set_standard_font_size)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_font_manager_get_standard_font_size)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  bool_t ret = (bool_t)0;
...
ret_t font_manager_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"font_manager_set_standard_font_size", wrap_font_manager_set_standard_font_size);
  jerryx_handler_register_global((const jerry_char_t*)"font_manager_get_standard_font_size", wrap_font_manager_get_standard_font_size);
  jerryx_handler_register_global((const jerry_char_t*)"font_manager_unload_font", wrap_font_manager_unload_font);
  jerryx_handler_register_global((const jerry_char_t*)"font_manager_shrink_cache", wrap_font_manager_shrink_cache);
...
static HANDLER_PROTO(wrap_window_base_t_get_prop_accept_button)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  window_base_t* obj = (window_base_t*)jsvalue_get_pointer(ctx, argv[0], "window_base_t*");
...
static HANDLER_PROTO(wrap_window_base_t_get_prop_cancel_button)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  window_base_t* obj = (window_base_t*)jsvalue_get_pointer(ctx, argv[0], "window_base_t*");
...
static HANDLER_PROTO(wrap_window_base_t_get_prop_applet_name)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  window_base_t* obj = (window_base_t*)jsvalue_get_pointer(ctx, argv[0], "window_base_t*");

  jret = jsvalue_create_string(ctx, obj->applet_name);
  return jret;
}
...
ret_t window_base_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_design_w", wrap_window_base_t_get_prop_design_w);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_design_h", wrap_window_base_t_get_prop_design_h);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_auto_scale_children_x", wrap_window_base_t_get_prop_auto_scale_children_x);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_auto_scale_children_y", wrap_window_base_t_get_prop_auto_scale_children_y);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_auto_scale_children_w", wrap_window_base_t_get_prop_auto_scale_children_w);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_auto_scale_children_h", wrap_window_base_t_get_prop_auto_scale_children_h);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_disable_anim", wrap_window_base_t_get_prop_disable_anim);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_closable", wrap_window_base_t_get_prop_closable);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_open_anim_hint", wrap_window_base_t_get_prop_open_anim_hint);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_close_anim_hint", wrap_window_base_t_get_prop_close_anim_hint);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_move_focus_prev_key", wrap_window_base_t_get_prop_move_focus_prev_key);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_move_focus_next_key", wrap_window_base_t_get_prop_move_focus_next_key);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_move_focus_up_key", wrap_window_base_t_get_prop_move_focus_up_key);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_move_focus_down_key", wrap_window_base_t_get_prop_move_focus_down_key);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_accept_button", wrap_window_base_t_get_prop_accept_button);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_cancel_button", wrap_window_base_t_get_prop_cancel_button);
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_applet_name", wrap_window_base_t_get_prop_applet_name);
...
static HANDLER_PROTO(wrap_window_manager_get_foreground_window)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  widget_t* ret = NULL;
...
static HANDLER_PROTO(wrap_window_manager_set_fullscreen)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
ret_t window_manager_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"window_manager_get_foreground_window", wrap_window_manager_get_foreground_window);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"window_manager_set_show_fps_position", wrap_window_manager_set_show_fps_position);
  jerryx_handler_register_global((const jerry_char_t*)"window_manager_set_max_fps", wrap_window_manager_set_max_fps);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"window_manager_resize", wrap_window_manager_resize);
  jerryx_handler_register_global((const jerry_char_t*)"window_manager_set_fullscreen", wrap_window_manager_set_fullscreen);
  jerryx_handler_register_global((const jerry_char_t*)"window_manager_close_all", wrap_window_manager_close_all);
...
ret_t color_component_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"color_component_create", wrap_color_component_create);
...
static HANDLER_PROTO(wrap_draggable_set_allow_out_of_screen)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  bool_t allow_out_of_screen = (bool_t)jsvalue_get_boolean_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_draggable_set_drag_native_window)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  bool_t drag_native_window = (bool_t)jsvalue_get_boolean_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_draggable_t_get_prop_allow_out_of_screen)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  draggable_t* obj = (draggable_t*)jsvalue_get_pointer(ctx, argv[0], "draggable_t*");

  jret = jsvalue_create_bool(ctx, obj->allow_out_of_screen);
  return jret;
}
...
static HANDLER_PROTO(wrap_draggable_t_get_prop_drag_native_window)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  draggable_t* obj = (draggable_t*)jsvalue_get_pointer(ctx, argv[0], "draggable_t*");

  jret = jsvalue_create_bool(ctx, obj->drag_native_window);
  return jret;
}
...
ret_t draggable_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"draggable_set_allow_out_of_screen", wrap_draggable_set_allow_out_of_screen);
  jerryx_handler_register_global((const jerry_char_t*)"draggable_set_drag_window", wrap_draggable_set_drag_window);
  jerryx_handler_register_global((const jerry_char_t*)"draggable_set_drag_native_window", wrap_draggable_set_drag_native_window);
  jerryx_handler_register_global((const jerry_char_t*)"draggable_set_drag_parent", wrap_draggable_set_drag_parent);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"draggable_t_get_prop_allow_out_of_screen", wrap_draggable_t_get_prop_allow_out_of_screen);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"draggable_t_get_prop_drag_native_window", wrap_draggable_t_get_prop_drag_native_window);
  jerryx_handler_register_global((const jerry_char_t*)"draggable_t_get_prop_drag_parent", wrap_draggable_t_get_prop_drag_parent);
...
static HANDLER_PROTO(wrap_file_browser_view_set_odd_item_style)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_file_browser_view_set_even_item_style)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_file_browser_view_t_get_prop_odd_item_style)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  file_browser_view_t* obj = (file_browser_view_t*)jsvalue_get_pointer(ctx, argv[0], "file_browser_view_t*");
...
static HANDLER_PROTO(wrap_file_browser_view_t_get_prop_even_item_style)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  file_browser_view_t* obj = (file_browser_view_t*)jsvalue_get_pointer(ctx, argv[0], "file_browser_view_t*");
...
ret_t file_browser_view_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_create", wrap_file_browser_view_create);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_cast", wrap_file_browser_view_cast);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_init_dir", wrap_file_browser_view_set_init_dir);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_top_dir", wrap_file_browser_view_set_top_dir);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_filter", wrap_file_browser_view_set_filter);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_reload", wrap_file_browser_view_reload);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_ignore_hidden_files", wrap_file_browser_view_set_ignore_hidden_files);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_sort_ascending", wrap_file_browser_view_set_sort_ascending);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_show_check_button", wrap_file_browser_view_set_show_check_button);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_sort_by", wrap_file_browser_view_set_sort_by);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_odd_item_style", wrap_file_browser_view_set_odd_item_style);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_even_item_style", wrap_file_browser_view_set_even_item_style);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_get_cwd", wrap_file_browser_view_get_cwd);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_create_dir", wrap_file_browser_view_create_dir);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_create_file", wrap_file_browser_view_create_file);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_init_dir", wrap_file_browser_view_t_get_prop_init_dir);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_top_dir", wrap_file_browser_view_t_get_prop_top_dir);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_filter", wrap_file_browser_view_t_get_prop_filter);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_ignore_hidden_files", wrap_file_browser_view_t_get_prop_ignore_hidden_files);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_sort_ascending", wrap_file_browser_view_t_get_prop_sort_ascending);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_show_check_button", wrap_file_browser_view_t_get_prop_show_check_button);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_sort_by", wrap_file_browser_view_t_get_prop_sort_by);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_odd_item_style", wrap_file_browser_view_t_get_prop_odd_item_style);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_even_item_style", wrap_file_browser_view_t_get_prop_even_item_style);
...
ret_t file_chooser_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_create", wrap_file_chooser_create);
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_set_init_dir", wrap_file_chooser_set_init_dir);
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_set_top_dir", wrap_file_chooser_set_top_dir);
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_set_filter", wrap_file_chooser_set_filter);
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_cast", wrap_file_chooser_cast);
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_choose_file_for_save", wrap_file_chooser_choose_file_for_save);
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_choose_file_for_open", wrap_file_chooser_choose_file_for_open);
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_choose_folder", wrap_file_chooser_choose_folder);
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_get_dir", wrap_file_chooser_get_dir);
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_get_filename", wrap_file_chooser_get_filename);
  jerryx_handler_register_global((const jerry_char_t*)"file_chooser_is_aborted", wrap_file_chooser_is_aborted);
...
static HANDLER_PROTO(wrap_image_value_set_click_add_delta)  {
  ...
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  double click_add_delta = (double)jsvalue_get_number_value(ctx, argv[1]);
...
ret_t image_value_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"image_value_set_click_add_delta", wrap_image_value_set_click_add_delta);
  jerryx_handler_register_global((const jerry_char_t*)"image_value_set_value", wrap_image_value_set_value);
  jerryx_handler_register_global((const jerry_char_t*)"image_value_set_min", wrap_image_value_set_min);
  jerryx_handler_register_global((const jerry_char_t*)"image_value_set_max", wrap_image_value_set_max);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"image_value_t_get_prop_click_add_delta", wrap_image_value_t_get_prop_click_add_delta);
  jerryx_handler_register_global((const jerry_char_t*)"image_value_t_get_prop_value", wrap_image_value_t_get_prop_value);
  jerryx_handler_register_global((const jerry_char_t*)"image_value_t_get_prop_min", wrap_image_value_t_get_prop_min);
  jerryx_handler_register_global((const jerry_char_t*)"image_value_t_get_prop_max", wrap_image_value_t_get_prop_max);
...
static HANDLER_PROTO(wrap_candidates_set_visible_num)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_candidates_t_get_prop_enable_preview)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  candidates_t* obj = (candidates_t*)jsvalue_get_pointer(ctx, argv[0], "candidates_t*");
...
static HANDLER_PROTO(wrap_candidates_t_get_prop_visible_num)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  candidates_t* obj = (candidates_t*)jsvalue_get_pointer(ctx, argv[0], "candidates_t*");
...
ret_t candidates_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"candidates_set_pre", wrap_candidates_set_pre);
  jerryx_handler_register_global((const jerry_char_t*)"candidates_set_select_by_num", wrap_candidates_set_select_by_num);
  jerryx_handler_register_global((const jerry_char_t*)"candidates_set_auto_hide", wrap_candidates_set_auto_hide);
  jerryx_handler_register_global((const jerry_char_t*)"candidates_set_visible_num", wrap_candidates_set_visible_num);
  jerryx_handler_register_global((const jerry_char_t*)"candidates_set_button_style", wrap_candidates_set_button_style);
  jerryx_handler_register_global((const jerry_char_t*)"candidates_t_get_prop_pre", wrap_candidates_t_get_prop_pre);
  jerryx_handler_register_global((const jerry_char_t*)"candidates_t_get_prop_select_by_num", wrap_candidates_t_get_prop_select_by_num);
  jerryx_handler_register_global((const jerry_char_t*)"candidates_t_get_prop_auto_hide", wrap_candidates_t_get_prop_auto_hide);
  jerryx_handler_register_global((const jerry_char_t*)"candidates_t_get_prop_button_style", wrap_candidates_t_get_prop_button_style);
  jerryx_handler_register_global((const jerry_char_t*)"candidates_t_get_prop_enable_preview", wrap_candidates_t_get_prop_enable_preview);
  jerryx_handler_register_global((const jerry_char_t*)"candidates_t_get_prop_visible_num", wrap_candidates_t_get_prop_visible_num);
...
ret_t lang_indicator_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"lang_indicator_create", wrap_lang_indicator_create);
  jerryx_handler_register_global((const jerry_char_t*)"lang_indicator_set_image", wrap_lang_indicator_set_image);
  jerryx_handler_register_global((const jerry_char_t*)"lang_indicator_cast", wrap_lang_indicator_cast);
  jerryx_handler_register_global((const jerry_char_t*)"lang_indicator_t_get_prop_image", wrap_lang_indicator_t_get_prop_image);
...
static HANDLER_PROTO(wrap_line_number_add_highlight_line)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  int32_t line = (int32_t)jsvalue_get_int_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_line_number_set_active_line)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_line_number_clear_highlight)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_line_number_is_highlight_line)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  bool_t ret = (bool_t)0;
...
ret_t line_number_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"line_number_add_highlight_line", wrap_line_number_add_highlight_line);
  jerryx_handler_register_global((const jerry_char_t*)"line_number_set_active_line", wrap_line_number_set_active_line);
  jerryx_handler_register_global((const jerry_char_t*)"line_number_clear_highlight", wrap_line_number_clear_highlight);
  jerryx_handler_register_global((const jerry_char_t*)"line_number_is_highlight_line", wrap_line_number_is_highlight_line);
...
static HANDLER_PROTO(wrap_mledit_set_tips)  {
  ...
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  const char* tips = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_mledit_set_keyboard)  {
  ...
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  const char* keyboard = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_mledit_get_current_line_index)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  uint32_t ret = (uint32_t)0;
...
static HANDLER_PROTO(wrap_mledit_get_current_row_index)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  uint32_t ret = (uint32_t)0;
...
static HANDLER_PROTO(wrap_mledit_t_get_prop_accept_return)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  mledit_t* obj = (mledit_t*)jsvalue_get_pointer(ctx, argv[0], "mledit_t*");
...
static HANDLER_PROTO(wrap_mledit_t_get_prop_accept_tab)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  mledit_t* obj = (mledit_t*)jsvalue_get_pointer(ctx, argv[0], "mledit_t*");
...
ret_t mledit_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"mledit_set_cancelable", wrap_mledit_set_cancelable);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"mledit_set_overwrite", wrap_mledit_set_overwrite);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_set_max_lines", wrap_mledit_set_max_lines);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_set_max_chars", wrap_mledit_set_max_chars);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_set_tips", wrap_mledit_set_tips);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_set_tr_tips", wrap_mledit_set_tr_tips);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_set_keyboard", wrap_mledit_set_keyboard);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"mledit_scroll_to_offset", wrap_mledit_scroll_to_offset);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_set_open_im_when_focused", wrap_mledit_set_open_im_when_focused);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_set_close_im_when_blured", wrap_mledit_set_close_im_when_blured);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_set_select", wrap_mledit_set_select);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_get_selected_text", wrap_mledit_get_selected_text);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_get_current_line_index", wrap_mledit_get_current_line_index);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_get_current_row_index", wrap_mledit_get_current_row_index);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_get_start_line_index", wrap_mledit_get_start_line_index);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_get_start_row_index", wrap_mledit_get_start_row_index);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_get_line_at", wrap_mledit_get_line_at);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_get_row_at", wrap_mledit_get_row_at);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_get_row_of_line", wrap_mledit_get_row_of_line);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_insert_text", wrap_mledit_insert_text);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_tr_tips", wrap_mledit_t_get_prop_tr_tips);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_keyboard", wrap_mledit_t_get_prop_keyboard);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_max_lines", wrap_mledit_t_get_prop_max_lines);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_max_chars", wrap_mledit_t_get_prop_max_chars);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_overwrite", wrap_mledit_t_get_prop_overwrite);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_cancelable", wrap_mledit_t_get_prop_cancelable);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_open_im_when_focused", wrap_mledit_t_get_prop_open_im_when_focused);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_close_im_when_blured", wrap_mledit_t_get_prop_close_im_when_blured);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_accept_return", wrap_mledit_t_get_prop_accept_return);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_accept_tab", wrap_mledit_t_get_prop_accept_tab);
  jerryx_handler_register_global((const jerry_char_t*)"mledit_t_get_prop_auto_adjust_height", wrap_mledit_t_get_prop_auto_adjust_height);
...
ret_t rich_text_view_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"rich_text_view_create", wrap_rich_text_view_create);
  jerryx_handler_register_global((const jerry_char_t*)"rich_text_view_cast", wrap_rich_text_view_cast);
...
ret_t rich_text_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"rich_text_set_yslidable", wrap_rich_text_set_yslidable);
  jerryx_handler_register_global((const jerry_char_t*)"rich_text_set_word_wrap", wrap_rich_text_set_word_wrap);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"rich_text_t_get_prop_yslidable", wrap_rich_text_t_get_prop_yslidable);
  jerryx_handler_register_global((const jerry_char_t*)"rich_text_t_get_prop_word_wrap", wrap_rich_text_t_get_prop_word_wrap);
...
static HANDLER_PROTO(wrap_hscroll_label_set_stop_at_begin)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_hscroll_label_t_get_prop_stop_at_begin)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  hscroll_label_t* obj = (hscroll_label_t*)jsvalue_get_pointer(ctx, argv[0], "hscroll_label_t*");
...
ret_t hscroll_label_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"hscroll_label_set_speed", wrap_hscroll_label_set_speed);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"hscroll_label_set_stop_at_begin", wrap_hscroll_label_set_stop_at_begin);
  jerryx_handler_register_global((const jerry_char_t*)"hscroll_label_set_delay", wrap_hscroll_label_set_delay);
  jerryx_handler_register_global((const jerry_char_t*)"hscroll_label_set_loop_interval_distance", wrap_hscroll_label_set_loop_interval_distance);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"hscroll_label_t_get_prop_delay", wrap_hscroll_label_t_get_prop_delay);
  jerryx_handler_register_global((const jerry_char_t*)"hscroll_label_t_get_prop_speed", wrap_hscroll_label_t_get_prop_speed);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"hscroll_label_t_get_prop_stop_at_begin", wrap_hscroll_label_t_get_prop_stop_at_begin);
  jerryx_handler_register_global((const jerry_char_t*)"hscroll_label_t_get_prop_loop_interval_distance", wrap_hscroll_label_t_get_prop_loop_interval_distance);
...
static HANDLER_PROTO(wrap_list_view_t_get_prop_item_width)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  list_view_t* obj = (list_view_t*)jsvalue_get_pointer(ctx, argv[0], "list_view_t*");
...
ret_t list_view_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"list_view_set_floating_scroll_bar", wrap_list_view_set_floating_scroll_bar);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"list_view_t_get_prop_floating_scroll_bar", wrap_list_view_t_get_prop_floating_scroll_bar);
  jerryx_handler_register_global((const jerry_char_t*)"list_view_t_get_prop_item_width", wrap_list_view_t_get_prop_item_width);
...
static HANDLER_PROTO(wrap_scroll_bar_hide_by_opacity_animation)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 3) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_scroll_bar_show_by_opacity_animation)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 3) {
  ret_t ret = (ret_t)0;
...
ret_t scroll_bar_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_set_animator_time", wrap_scroll_bar_set_animator_time);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_hide_by_opacity_animation", wrap_scroll_bar_hide_by_opacity_animation);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_show_by_opacity_animation", wrap_scroll_bar_show_by_opacity_animation);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_set_wheel_scroll", wrap_scroll_bar_set_wheel_scroll);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_set_scroll_delta", wrap_scroll_bar_set_scroll_delta);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_set_scroll_rows", wrap_scroll_bar_set_scroll_rows);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_t_get_prop_animator_time", wrap_scroll_bar_t_get_prop_animator_time);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_t_get_prop_scroll_delta", wrap_scroll_bar_t_get_prop_scroll_delta);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_t_get_prop_scroll_rows", wrap_scroll_bar_t_get_prop_scroll_rows);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_t_get_prop_wheel_scroll", wrap_scroll_bar_t_get_prop_wheel_scroll);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_t_get_prop_wheel_modifier_key", wrap_scroll_bar_t_get_prop_wheel_modifier_key);
...
static HANDLER_PROTO(wrap_scroll_view_set_slide_limit_ratio)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_scroll_view_t_get_prop_slide_limit_ratio)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  scroll_view_t* obj = (scroll_view_t*)jsvalue_get_pointer(ctx, argv[0], "scroll_view_t*");
...
ret_t scroll_view_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_fix_offset", wrap_scroll_view_fix_offset);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_set_move_to_page", wrap_scroll_view_set_move_to_page);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_set_recursive", wrap_scroll_view_set_recursive);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_set_recursive_only", wrap_scroll_view_set_recursive_only);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_set_slide_limit_ratio", wrap_scroll_view_set_slide_limit_ratio);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_t_get_prop_use_virtual_w", wrap_scroll_view_t_get_prop_use_virtual_w);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_t_get_prop_use_widget_w", wrap_scroll_view_t_get_prop_use_widget_w);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_t_get_prop_use_virtual_h", wrap_scroll_view_t_get_prop_use_virtual_h);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_t_get_prop_use_widget_h", wrap_scroll_view_t_get_prop_use_widget_h);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_t_get_prop_move_to_page", wrap_scroll_view_t_get_prop_move_to_page);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_t_get_prop_recursive", wrap_scroll_view_t_get_prop_recursive);
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_t_get_prop_slide_limit_ratio", wrap_scroll_view_t_get_prop_slide_limit_ratio);

 return RET_OK;
}

static HANDLER_PROTO(wrap_serial_widget_create)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 5) {
  widget_t* ret = NULL;
  ...
  jret = jsvalue_create_pointer(ctx, ret, "serial_widget_t*");
  }
  return jret;
}

static HANDLER_PROTO(wrap_serial_widget_cast)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  widget_t* ret = NULL;
...
static HANDLER_PROTO(wrap_serial_widget_set_baudrate)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  uint32_t baudrate = (uint32_t)jsvalue_get_int_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_serial_widget_set_device)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  const char* device = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_serial_widget_set_bytesize)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  uint32_t bytesize = (uint32_t)jsvalue_get_int_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_serial_widget_set_parity)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  uint32_t parity = (uint32_t)jsvalue_get_int_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_serial_widget_set_stopbits)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  uint32_t stopbits = (uint32_t)jsvalue_get_int_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_serial_widget_set_flowcontrol)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  uint32_t flowcontrol = (uint32_t)jsvalue_get_int_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_serial_widget_set_check_interval)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  uint32_t check_interval = (uint32_t)jsvalue_get_int_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_serial_widget_t_get_prop_device)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  serial_widget_t* obj = (serial_widget_t*)jsvalue_get_pointer(ctx, argv[0], "serial_widget_t*");

  jret = jsvalue_create_string(ctx, obj->device);
  return jret;
}

static HANDLER_PROTO(wrap_serial_widget_t_get_prop_baudrate)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  serial_widget_t* obj = (serial_widget_t*)jsvalue_get_pointer(ctx, argv[0], "serial_widget_t*");

  jret = jsvalue_create_int(ctx, obj->baudrate);
  return jret;
}

static HANDLER_PROTO(wrap_serial_widget_t_get_prop_bytesize)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  serial_widget_t* obj = (serial_widget_t*)jsvalue_get_pointer(ctx, argv[0], "serial_widget_t*");

  jret = jsvalue_create_int(ctx, obj->bytesize);
  return jret;
}

static HANDLER_PROTO(wrap_serial_widget_t_get_prop_parity)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  serial_widget_t* obj = (serial_widget_t*)jsvalue_get_pointer(ctx, argv[0], "serial_widget_t*");

  jret = jsvalue_create_int(ctx, obj->parity);
  return jret;
}

static HANDLER_PROTO(wrap_serial_widget_t_get_prop_stopbits)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  serial_widget_t* obj = (serial_widget_t*)jsvalue_get_pointer(ctx, argv[0], "serial_widget_t*");

  jret = jsvalue_create_int(ctx, obj->stopbits);
  return jret;
}

static HANDLER_PROTO(wrap_serial_widget_t_get_prop_flowcontrol)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  serial_widget_t* obj = (serial_widget_t*)jsvalue_get_pointer(ctx, argv[0], "serial_widget_t*");

  jret = jsvalue_create_int(ctx, obj->flowcontrol);
  return jret;
}
...
static HANDLER_PROTO(wrap_serial_widget_t_get_prop_check_interval)  {
  ...
  jret = jsvalue_create_int(ctx, obj->check_interval);
  return jret;
}

ret_t serial_widget_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_create", wrap_serial_widget_create);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_cast", wrap_serial_widget_cast);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_baudrate", wrap_serial_widget_set_baudrate);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_device", wrap_serial_widget_set_device);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_bytesize", wrap_serial_widget_set_bytesize);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_parity", wrap_serial_widget_set_parity);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_stopbits", wrap_serial_widget_set_stopbits);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_flowcontrol", wrap_serial_widget_set_flowcontrol);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_check_interval", wrap_serial_widget_set_check_interval);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_device", wrap_serial_widget_t_get_prop_device);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_baudrate", wrap_serial_widget_t_get_prop_baudrate);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_bytesize", wrap_serial_widget_t_get_prop_bytesize);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_parity", wrap_serial_widget_t_get_prop_parity);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_stopbits", wrap_serial_widget_t_get_prop_stopbits);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_flowcontrol", wrap_serial_widget_t_get_prop_flowcontrol);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_check_interval", wrap_serial_widget_t_get_prop_check_interval);
...
static HANDLER_PROTO(wrap_slide_menu_set_spacer)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_slide_menu_set_menu_w)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_slide_menu_set_clip)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_slide_menu_scroll_to_prev)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_slide_menu_scroll_to_next)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_slide_menu_t_get_prop_spacer)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  slide_menu_t* obj = (slide_menu_t*)jsvalue_get_pointer(ctx, argv[0], "slide_menu_t*");
...
static HANDLER_PROTO(wrap_slide_menu_t_get_prop_menu_w)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  slide_menu_t* obj = (slide_menu_t*)jsvalue_get_pointer(ctx, argv[0], "slide_menu_t*");
...
static HANDLER_PROTO(wrap_slide_menu_t_get_prop_clip)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  slide_menu_t* obj = (slide_menu_t*)jsvalue_get_pointer(ctx, argv[0], "slide_menu_t*");
...
ret_t slide_menu_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_set_spacer", wrap_slide_menu_set_spacer);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_set_menu_w", wrap_slide_menu_set_menu_w);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_set_clip", wrap_slide_menu_set_clip);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_scroll_to_prev", wrap_slide_menu_scroll_to_prev);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_scroll_to_next", wrap_slide_menu_scroll_to_next);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_t_get_prop_spacer", wrap_slide_menu_t_get_prop_spacer);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_t_get_prop_menu_w", wrap_slide_menu_t_get_prop_menu_w);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_t_get_prop_clip", wrap_slide_menu_t_get_prop_clip);
...
ret_t slide_indicator_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slide_indicator_set_transition", wrap_slide_indicator_set_transition);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slide_indicator_t_get_prop_transition", wrap_slide_indicator_t_get_prop_transition);
...
static HANDLER_PROTO(wrap_slide_view_set_drag_threshold)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  uint32_t drag_threshold = (uint32_t)jsvalue_get_int_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_slide_view_set_animating_time)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_slide_view_t_get_prop_drag_threshold)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  slide_view_t* obj = (slide_view_t*)jsvalue_get_pointer(ctx, argv[0], "slide_view_t*");

  jret = jsvalue_create_int(ctx, obj->drag_threshold);
  return jret;
}

static HANDLER_PROTO(wrap_slide_view_t_get_prop_animating_time)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  slide_view_t* obj = (slide_view_t*)jsvalue_get_pointer(ctx, argv[0], "slide_view_t*");
...
ret_t slide_view_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slide_view_set_active_ex", wrap_slide_view_set_active_ex);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slide_view_set_drag_threshold", wrap_slide_view_set_drag_threshold);
  jerryx_handler_register_global((const jerry_char_t*)"slide_view_set_animating_time", wrap_slide_view_set_animating_time);
...
static HANDLER_PROTO(wrap_text_selector_set_mask_easing)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_text_selector_set_mask_area_scale)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_text_selector_set_ellipses)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_text_selector_t_get_prop_ellipses)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  text_selector_t* obj = (text_selector_t*)jsvalue_get_pointer(ctx, argv[0], "text_selector_t*");
...
static HANDLER_PROTO(wrap_text_selector_t_get_prop_mask_easing)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  text_selector_t* obj = (text_selector_t*)jsvalue_get_pointer(ctx, argv[0], "text_selector_t*");
...
static HANDLER_PROTO(wrap_text_selector_t_get_prop_mask_area_scale)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  text_selector_t* obj = (text_selector_t*)jsvalue_get_pointer(ctx, argv[0], "text_selector_t*");
...
ret_t text_selector_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_range_options_ex", wrap_text_selector_set_range_options_ex);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_localize_options", wrap_text_selector_set_localize_options);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_loop_options", wrap_text_selector_set_loop_options);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_yspeed_scale", wrap_text_selector_set_yspeed_scale);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_animating_time", wrap_text_selector_set_animating_time);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_enable_value_animator", wrap_text_selector_set_enable_value_animator);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_mask_easing", wrap_text_selector_set_mask_easing);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_mask_area_scale", wrap_text_selector_set_mask_area_scale);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_ellipses", wrap_text_selector_set_ellipses);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_yspeed_scale", wrap_text_selector_t_get_prop_yspeed_scale);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_animating_time", wrap_text_selector_t_get_prop_animating_time);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_localize_options", wrap_text_selector_t_get_prop_localize_options);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_loop_options", wrap_text_selector_t_get_prop_loop_options);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_enable_value_animator", wrap_text_selector_t_get_prop_enable_value_animator);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_ellipses", wrap_text_selector_t_get_prop_ellipses);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_mask_easing", wrap_text_selector_t_get_prop_mask_easing);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_mask_area_scale", wrap_text_selector_t_get_prop_mask_area_scale);
...
static HANDLER_PROTO(wrap_timer_widget_create)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 5) {
  widget_t* ret = NULL;
  ...
  jret = jsvalue_create_pointer(ctx, ret, "timer_widget_t*");
  }
  return jret;
}

static HANDLER_PROTO(wrap_timer_widget_cast)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  widget_t* ret = NULL;
...
static HANDLER_PROTO(wrap_timer_widget_set_duration)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_timer_widget_t_get_prop_duration)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  timer_widget_t* obj = (timer_widget_t*)jsvalue_get_pointer(ctx, argv[0], "timer_widget_t*");

  jret = jsvalue_create_int(ctx, obj->duration);
  return jret;
}

ret_t timer_widget_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"timer_widget_create", wrap_timer_widget_create);
  jerryx_handler_register_global((const jerry_char_t*)"timer_widget_cast", wrap_timer_widget_cast);
  jerryx_handler_register_global((const jerry_char_t*)"timer_widget_set_duration", wrap_timer_widget_set_duration);
  jerryx_handler_register_global((const jerry_char_t*)"timer_widget_t_get_prop_duration", wrap_timer_widget_t_get_prop_duration);
...
ret_t done_event_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"done_event_t_get_prop_result", wrap_done_event_t_get_prop_result);
...
ret_t error_event_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"error_event_t_get_prop_code", wrap_error_event_t_get_prop_code);
  jerryx_handler_register_global((const jerry_char_t*)"error_event_t_get_prop_message", wrap_error_event_t_get_prop_message);
...
ret_t cmd_exec_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"cmd_exec_event_cast", wrap_cmd_exec_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"cmd_exec_event_t_get_prop_name", wrap_cmd_exec_event_t_get_prop_name);
  jerryx_handler_register_global((const jerry_char_t*)"cmd_exec_event_t_get_prop_args", wrap_cmd_exec_event_t_get_prop_args);
  jerryx_handler_register_global((const jerry_char_t*)"cmd_exec_event_t_get_prop_result", wrap_cmd_exec_event_t_get_prop_result);
  jerryx_handler_register_global((const jerry_char_t*)"cmd_exec_event_t_get_prop_can_exec", wrap_cmd_exec_event_t_get_prop_can_exec);
...
ret_t value_change_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"value_change_event_cast", wrap_value_change_event_cast);

 return RET_OK;
}

static HANDLER_PROTO(wrap_log_message_event_cast)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  log_message_event_t* ret = NULL;
  event_t* event = (event_t*)jsvalue_get_pointer(ctx, argv[0], "event_t*");
  ret = (log_message_event_t*)log_message_event_cast(event);

  jret = jsvalue_create_pointer(ctx, ret, "log_message_event_t*");
  }
  return jret;
}

ret_t log_message_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"log_message_event_cast", wrap_log_message_event_cast);
...
ret_t object_fifo_set_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_set_event_t_get_prop_index", wrap_object_fifo_set_event_t_get_prop_index);
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_set_event_t_get_prop_nr", wrap_object_fifo_set_event_t_get_prop_nr);
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_set_event_t_get_prop_data", wrap_object_fifo_set_event_t_get_prop_data);
...
ret_t object_fifo_push_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_push_event_t_get_prop_nr", wrap_object_fifo_push_event_t_get_prop_nr);
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_push_event_t_get_prop_data", wrap_object_fifo_push_event_t_get_prop_data);
...
ret_t object_fifo_push_head_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_push_head_event_t_get_prop_nr", wrap_object_fifo_push_head_event_t_get_prop_nr);
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_push_head_event_t_get_prop_data", wrap_object_fifo_push_head_event_t_get_prop_data);
...
ret_t object_fifo_pop_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_pop_event_t_get_prop_nr", wrap_object_fifo_pop_event_t_get_prop_nr);
...
ret_t object_fifo_pop_tail_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_pop_tail_event_t_get_prop_nr", wrap_object_fifo_pop_tail_event_t_get_prop_nr);
...
ret_t object_fifo_value_change_event_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_set_event_cast", wrap_object_fifo_set_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_push_event_cast", wrap_object_fifo_push_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_push_head_event_cast", wrap_object_fifo_push_head_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_pop_event_cast", wrap_object_fifo_pop_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_pop_tail_event_cast", wrap_object_fifo_pop_tail_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_value_change_event_cast", wrap_object_fifo_value_change_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"object_fifo_value_change_event_t_get_prop_type", wrap_object_fifo_value_change_event_t_get_prop_type);
...
static HANDLER_PROTO(wrap_button_set_enable_preview)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_button_t_get_prop_enable_preview)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  button_t* obj = (button_t*)jsvalue_get_pointer(ctx, argv[0], "button_t*");
...
static HANDLER_PROTO(wrap_button_t_get_prop_is_accept_status)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  button_t* obj = (button_t*)jsvalue_get_pointer(ctx, argv[0], "button_t*");
...
static HANDLER_PROTO(wrap_button_t_get_prop_pressed)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  button_t* obj = (button_t*)jsvalue_get_pointer(ctx, argv[0], "button_t*");
...
ret_t button_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"button_set_long_press_time", wrap_button_set_long_press_time);
  jerryx_handler_register_global((const jerry_char_t*)"button_set_enable_long_press", wrap_button_set_enable_long_press);
  jerryx_handler_register_global((const jerry_char_t*)"button_set_enable_preview", wrap_button_set_enable_preview);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"button_t_get_prop_enable_preview", wrap_button_t_get_prop_enable_preview);
  jerryx_handler_register_global((const jerry_char_t*)"button_t_get_prop_is_accept_status", wrap_button_t_get_prop_is_accept_status);
  jerryx_handler_register_global((const jerry_char_t*)"button_t_get_prop_pressed", wrap_button_t_get_prop_pressed);
  jerryx_handler_register_global((const jerry_char_t*)"button_t_get_prop_long_press_time", wrap_button_t_get_prop_long_press_time);
...
static HANDLER_PROTO(wrap_check_button_set_indeterminate)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  bool_t indeterminate = (bool_t)jsvalue_get_boolean_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_check_button_get_indeterminate)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  bool_t ret = (bool_t)0;
...
static HANDLER_PROTO(wrap_check_button_create_ex)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 7) {
  widget_t* ret = NULL;
  ...
  wh_t w = (wh_t)jsvalue_get_int_value(ctx, argv[3]);
  wh_t h = (wh_t)jsvalue_get_int_value(ctx, argv[4]);
  const char* type = (const char*)jsvalue_get_utf8_string(ctx, argv[5]);
  bool_t radio = (bool_t)jsvalue_get_boolean_value(ctx, argv[6]);
...
ret_t check_button_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"check_button_set_indeterminate", wrap_check_button_set_indeterminate);
  jerryx_handler_register_global((const jerry_char_t*)"check_button_get_indeterminate", wrap_check_button_get_indeterminate);
  jerryx_handler_register_global((const jerry_char_t*)"check_button_cast", wrap_check_button_cast);
  jerryx_handler_register_global((const jerry_char_t*)"check_button_create_ex", wrap_check_button_create_ex);
...
ret_t color_tile_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"color_tile_get_bg_color", wrap_color_tile_get_bg_color);
  jerryx_handler_register_global((const jerry_char_t*)"color_tile_get_border_color", wrap_color_tile_get_border_color);
...
static HANDLER_PROTO(wrap_edit_set_double_ex)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 3) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_edit_set_action_text)  {
  ...
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  const char* action_text = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_edit_t_get_prop_validator)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  edit_t* obj = (edit_t*)jsvalue_get_pointer(ctx, argv[0], "edit_t*");

  jret = jsvalue_create_string(ctx, obj->validator);
  return jret;
}
...
ret_t edit_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"edit_set_double_ex", wrap_edit_set_double_ex);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"edit_set_cancelable", wrap_edit_set_cancelable);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"edit_set_close_im_when_blured", wrap_edit_set_close_im_when_blured);
  jerryx_handler_register_global((const jerry_char_t*)"edit_set_input_type", wrap_edit_set_input_type);
  jerryx_handler_register_global((const jerry_char_t*)"edit_set_action_text", wrap_edit_set_action_text);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"edit_t_get_prop_validator", wrap_edit_t_get_prop_validator);
  jerryx_handler_register_global((const jerry_char_t*)"edit_t_get_prop_keyboard", wrap_edit_t_get_prop_keyboard);
...
static HANDLER_PROTO(wrap_grid_set_rows)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  uint32_t rows = (uint32_t)jsvalue_get_int_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_grid_set_columns_definition)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  const char* columns_definition = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
  ret = (ret_t)grid_set_columns_definition(widget, columns_definition);
  TKMEM_FREE(columns_definition);
...
static HANDLER_PROTO(wrap_grid_set_show_grid)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  bool_t show_grid = (bool_t)jsvalue_get_boolean_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_grid_t_get_prop_rows)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  grid_t* obj = (grid_t*)jsvalue_get_pointer(ctx, argv[0], "grid_t*");

  jret = jsvalue_create_int(ctx, obj->rows);
  return jret;
}

static HANDLER_PROTO(wrap_grid_t_get_prop_columns_definition)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  grid_t* obj = (grid_t*)jsvalue_get_pointer(ctx, argv[0], "grid_t*");

  jret = jsvalue_create_string(ctx, obj->columns_definition);
  return jret;
}

static HANDLER_PROTO(wrap_grid_t_get_prop_show_grid)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  grid_t* obj = (grid_t*)jsvalue_get_pointer(ctx, argv[0], "grid_t*");

  jret = jsvalue_create_bool(ctx, obj->show_grid);
  return jret;
}
...
ret_t grid_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"grid_set_rows", wrap_grid_set_rows);
  jerryx_handler_register_global((const jerry_char_t*)"grid_set_columns_definition", wrap_grid_set_columns_definition);
  jerryx_handler_register_global((const jerry_char_t*)"grid_set_show_grid", wrap_grid_set_show_grid);
  jerryx_handler_register_global((const jerry_char_t*)"grid_t_get_prop_rows", wrap_grid_t_get_prop_rows);
  jerryx_handler_register_global((const jerry_char_t*)"grid_t_get_prop_columns_definition", wrap_grid_t_get_prop_columns_definition);
  jerryx_handler_register_global((const jerry_char_t*)"grid_t_get_prop_show_grid", wrap_grid_t_get_prop_show_grid);
...
static HANDLER_PROTO(wrap_group_box_set_value)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_group_box_t_get_prop_value)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  group_box_t* obj = (group_box_t*)jsvalue_get_pointer(ctx, argv[0], "group_box_t*");
...
ret_t group_box_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"group_box_set_value", wrap_group_box_set_value);
  jerryx_handler_register_global((const jerry_char_t*)"group_box_cast", wrap_group_box_cast);
  jerryx_handler_register_global((const jerry_char_t*)"group_box_t_get_prop_value", wrap_group_box_t_get_prop_value);
...
static HANDLER_PROTO(wrap_label_set_ellipses)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_label_t_get_prop_ellipses)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  label_t* obj = (label_t*)jsvalue_get_pointer(ctx, argv[0], "label_t*");
...
ret_t label_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"label_set_line_wrap", wrap_label_set_line_wrap);
  jerryx_handler_register_global((const jerry_char_t*)"label_set_word_wrap", wrap_label_set_word_wrap);
  jerryx_handler_register_global((const jerry_char_t*)"label_set_ellipses", wrap_label_set_ellipses);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"label_t_get_prop_line_wrap", wrap_label_t_get_prop_line_wrap);
  jerryx_handler_register_global((const jerry_char_t*)"label_t_get_prop_word_wrap", wrap_label_t_get_prop_word_wrap);
  jerryx_handler_register_global((const jerry_char_t*)"label_t_get_prop_ellipses", wrap_label_t_get_prop_ellipses);
  jerryx_handler_register_global((const jerry_char_t*)"label_t_get_prop_max_w", wrap_label_t_get_prop_max_w);
...
static HANDLER_PROTO(wrap_pages_set_auto_focused)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_pages_t_get_prop_auto_focused)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  pages_t* obj = (pages_t*)jsvalue_get_pointer(ctx, argv[0], "pages_t*");
...
ret_t pages_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"pages_set_auto_focused", wrap_pages_set_auto_focused);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"pages_t_get_prop_auto_focused", wrap_pages_t_get_prop_auto_focused);
...
static HANDLER_PROTO(wrap_slider_set_line_cap)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_slider_set_drag_threshold)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_slider_t_get_prop_drag_threshold)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  slider_t* obj = (slider_t*)jsvalue_get_pointer(ctx, argv[0], "slider_t*");
...
ret_t slider_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slider_set_line_cap", wrap_slider_set_line_cap);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slider_set_drag_threshold", wrap_slider_set_drag_threshold);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slider_t_get_prop_drag_threshold", wrap_slider_t_get_prop_drag_threshold);
...
static HANDLER_PROTO(wrap_tab_button_group_set_drag_child)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  bool_t drag_child = (bool_t)jsvalue_get_boolean_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_tab_button_group_remove_index)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_tab_button_group_t_get_prop_drag_child)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  tab_button_group_t* obj = (tab_button_group_t*)jsvalue_get_pointer(ctx, argv[0], "tab_button_group_t*");

  jret = jsvalue_create_bool(ctx, obj->drag_child);
  return jret;
}
...
ret_t tab_button_group_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"tab_button_group_set_drag_child", wrap_tab_button_group_set_drag_child);
  jerryx_handler_register_global((const jerry_char_t*)"tab_button_group_remove_index", wrap_tab_button_group_remove_index);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"tab_button_group_t_get_prop_drag_child", wrap_tab_button_group_t_get_prop_drag_child);
...
static HANDLER_PROTO(wrap_tab_button_set_max_w)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_tab_button_restack)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_tab_button_t_get_prop_max_w)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  tab_button_t* obj = (tab_button_t*)jsvalue_get_pointer(ctx, argv[0], "tab_button_t*");
...
ret_t tab_button_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"tab_button_set_max_w", wrap_tab_button_set_max_w);
  jerryx_handler_register_global((const jerry_char_t*)"tab_button_restack", wrap_tab_button_restack);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"tab_button_t_get_prop_max_w", wrap_tab_button_t_get_prop_max_w);
...
ret_t view_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"view_set_default_focused_child", wrap_view_set_default_focused_child);
  jerryx_handler_register_global((const jerry_char_t*)"view_cast", wrap_view_cast);
  jerryx_handler_register_global((const jerry_char_t*)"view_t_get_prop_default_focused_child", wrap_view_t_get_prop_default_focused_child);
...
static HANDLER_PROTO(wrap_dialog_set_title)  {
  ...
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  const char* title = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_native_window_set_window_hit_test)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 5) {
  ret_t ret = (ret_t)0;
...
ret_t native_window_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"native_window_move", wrap_native_window_move);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_resize", wrap_native_window_resize);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_set_orientation", wrap_native_window_set_orientation);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_minimize", wrap_native_window_minimize);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_maximize", wrap_native_window_maximize);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_restore", wrap_native_window_restore);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_center", wrap_native_window_center);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_show_border", wrap_native_window_show_border);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_set_window_hit_test", wrap_native_window_set_window_hit_test);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_set_fullscreen", wrap_native_window_set_fullscreen);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_set_cursor", wrap_native_window_set_cursor);
  jerryx_handler_register_global((const jerry_char_t*)"native_window_set_title", wrap_native_window_set_title);
...
ret_t window_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"window_set_auto_scale_children", wrap_window_set_auto_scale_children);
...
static HANDLER_PROTO(wrap_edit_ex_create)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 5) {
  widget_t* ret = NULL;
...
static HANDLER_PROTO(wrap_edit_ex_set_suggest_words_item_formats)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_edit_ex_set_suggest_words_input_name)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_edit_ex_cast)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  widget_t* ret = NULL;
...
static HANDLER_PROTO(wrap_edit_ex_t_get_prop_suggest_words)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
...
static HANDLER_PROTO(wrap_edit_ex_t_get_prop_suggest_words_item_formats)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  edit_ex_t* obj = (edit_ex_t*)jsvalue_get_pointer(ctx, argv[0], "edit_ex_t*");
...
static HANDLER_PROTO(wrap_edit_ex_t_get_prop_suggest_words_input_name)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  edit_ex_t* obj = (edit_ex_t*)jsvalue_get_pointer(ctx, argv[0], "edit_ex_t*");
...
ret_t edit_ex_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_set_multiline", wrap_edit_ex_set_multiline);
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_set_suggest_words", wrap_edit_ex_set_suggest_words);
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_set_suggest_words_item_formats", wrap_edit_ex_set_suggest_words_item_formats);
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_set_suggest_words_input_name", wrap_edit_ex_set_suggest_words_input_name);
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_update_suggest_words_popup", wrap_edit_ex_update_suggest_words_popup);
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_cast", wrap_edit_ex_cast);
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_t_get_prop_suggest_words", wrap_edit_ex_t_get_prop_suggest_words);
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_t_get_prop_suggest_words_item_formats", wrap_edit_ex_t_get_prop_suggest_words_item_formats);
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_t_get_prop_suggest_words_input_name", wrap_edit_ex_t_get_prop_suggest_words_input_name);
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_t_get_prop_is_select_suggest_word", wrap_edit_ex_t_get_prop_is_select_suggest_word);
  jerryx_handler_register_global((const jerry_char_t*)"edit_ex_t_get_prop_multiline", wrap_edit_ex_t_get_prop_multiline);
...
ret_t gif_image_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"gif_image_set_loop", wrap_gif_image_set_loop);
  jerryx_handler_register_global((const jerry_char_t*)"gif_image_set_part_buffer_load_mode", wrap_gif_image_set_part_buffer_load_mode);
  jerryx_handler_register_global((const jerry_char_t*)"gif_image_cast", wrap_gif_image_cast);
  jerryx_handler_register_global((const jerry_char_t*)"gif_image_t_get_prop_loop", wrap_gif_image_t_get_prop_loop);
  jerryx_handler_register_global((const jerry_char_t*)"gif_image_t_get_prop_part_buffer_load_mode", wrap_gif_image_t_get_prop_part_buffer_load_mode);
...
ret_t mutable_image_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"mutable_image_create", wrap_mutable_image_create);

 return RET_OK;
}

static HANDLER_PROTO(wrap_list_item_seperator_create)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 5) {
  widget_t* ret = NULL;
  ...
  jret = jsvalue_create_pointer(ctx, ret, "list_item_seperator_t*");
  }
  return jret;
}

static HANDLER_PROTO(wrap_list_item_seperator_cast)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  widget_t* ret = NULL;
...
ret_t list_item_seperator_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"list_item_seperator_create", wrap_list_item_seperator_create);
  jerryx_handler_register_global((const jerry_char_t*)"list_item_seperator_cast", wrap_list_item_seperator_cast);
...
static HANDLER_PROTO(wrap_svg_image_set_cache_mode)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  bool_t is_cache_mode = (bool_t)jsvalue_get_boolean_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_svg_image_set_draw_type)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_svg_image_t_get_prop_is_cache_mode)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  svg_image_t* obj = (svg_image_t*)jsvalue_get_pointer(ctx, argv[0], "svg_image_t*");

  jret = jsvalue_create_bool(ctx, obj->is_cache_mode);
  return jret;
}

static HANDLER_PROTO(wrap_svg_image_t_get_prop_draw_type)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  svg_image_t* obj = (svg_image_t*)jsvalue_get_pointer(ctx, argv[0], "svg_image_t*");
...
ret_t svg_image_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"svg_image_set_cache_mode", wrap_svg_image_set_cache_mode);
  jerryx_handler_register_global((const jerry_char_t*)"svg_image_set_draw_type", wrap_svg_image_set_draw_type);
  jerryx_handler_register_global((const jerry_char_t*)"svg_image_cast", wrap_svg_image_cast);
  jerryx_handler_register_global((const jerry_char_t*)"svg_image_t_get_prop_is_cache_mode", wrap_svg_image_t_get_prop_is_cache_mode);
  jerryx_handler_register_global((const jerry_char_t*)"svg_image_t_get_prop_draw_type", wrap_svg_image_t_get_prop_draw_type);
...
ret_t idle_info_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"idle_info_t_get_prop_extra_ctx", wrap_idle_info_t_get_prop_extra_ctx);
  jerryx_handler_register_global((const jerry_char_t*)"idle_info_t_get_prop_id", wrap_idle_info_t_get_prop_id);

 return RET_OK;
}

static HANDLER_PROTO(wrap_named_value_hash_create)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 0) {
  ...
  jret = jsvalue_create_object(ctx, ret, "named_value_hash_t*", &s_named_value_hash_destroy_info);
  }
  return jret;
}

static HANDLER_PROTO(wrap_named_value_hash_set_name)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  named_value_hash_t* nvh = (named_value_hash_t*)jsvalue_get_pointer(ctx, argv[0], "named_value_hash_t*");
  const char* name = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_named_value_hash_clone)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  named_value_hash_t* ret = NULL;
...
static HANDLER_PROTO(wrap_named_value_hash_get_hash_from_str)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  uint64_t ret = (uint64_t)0;
...
ret_t named_value_hash_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"named_value_hash_create", wrap_named_value_hash_create);
  jerryx_handler_register_global((const jerry_char_t*)"named_value_hash_set_name", wrap_named_value_hash_set_name);
  jerryx_handler_register_global((const jerry_char_t*)"named_value_hash_clone", wrap_named_value_hash_clone);
  jerryx_handler_register_global((const jerry_char_t*)"named_value_hash_get_hash_from_str", wrap_named_value_hash_get_hash_from_str);
...
static HANDLER_PROTO(wrap_object_array_remove_value)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  object_t* obj = (object_t*)jsvalue_get_pointer(ctx, argv[0], "object_t*");
  value_t* v = (value_t*)jsvalue_get_pointer(ctx, argv[1], "value_t*");
...
ret_t object_array_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"object_array_remove_value", wrap_object_array_remove_value);
...
static HANDLER_PROTO(wrap_object_default_set_keep_prop_type)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_object_default_set_name_case_insensitive)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
ret_t object_default_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"object_default_create_ex", wrap_object_default_create_ex);
  jerryx_handler_register_global((const jerry_char_t*)"object_default_clear_props", wrap_object_default_clear_props);
  jerryx_handler_register_global((const jerry_char_t*)"object_default_set_keep_prop_type", wrap_object_default_set_keep_prop_type);
  jerryx_handler_register_global((const jerry_char_t*)"object_default_set_name_case_insensitive", wrap_object_default_set_name_case_insensitive);

 return RET_OK;
}

static HANDLER_PROTO(wrap_object_hash_create)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 0) {
  object_t* ret = NULL;
...
static HANDLER_PROTO(wrap_object_hash_create_ex)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  object_t* ret = NULL;
...
static HANDLER_PROTO(wrap_object_hash_set_keep_prop_type)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
ret_t object_hash_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"object_hash_create", wrap_object_hash_create);
  jerryx_handler_register_global((const jerry_char_t*)"object_hash_create_ex", wrap_object_hash_create_ex);
  jerryx_handler_register_global((const jerry_char_t*)"object_hash_set_keep_prop_type", wrap_object_hash_set_keep_prop_type);
  jerryx_handler_register_global((const jerry_char_t*)"object_hash_set_name_case_insensitive", wrap_object_hash_set_name_case_insensitive);
  jerryx_handler_register_global((const jerry_char_t*)"object_hash_set_keep_props_order", wrap_object_hash_set_keep_props_order);
...
ret_t timer_info_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"timer_info_t_get_prop_extra_ctx", wrap_timer_info_t_get_prop_extra_ctx);
...
ret_t calibration_win_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"calibration_win_create", wrap_calibration_win_create);
  jerryx_handler_register_global((const jerry_char_t*)"calibration_win_cast", wrap_calibration_win_cast);
...
static HANDLER_PROTO(wrap_combo_box_set_theme_of_popup)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  const char* theme_of_popup = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
  ret = (ret_t)combo_box_set_theme_of_popup(widget, theme_of_popup);
  TKMEM_FREE(theme_of_popup);
...
static HANDLER_PROTO(wrap_combo_box_set_selected_index_by_text)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_combo_box_remove_option_by_index)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_combo_box_has_option_text)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  bool_t ret = (bool_t)0;
...
static HANDLER_PROTO(wrap_combo_box_get_text_of_selected)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 1) {
  const char* ret = NULL;
...
static HANDLER_PROTO(wrap_combo_box_t_get_prop_theme_of_popup)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  combo_box_t* obj = (combo_box_t*)jsvalue_get_pointer(ctx, argv[0], "combo_box_t*");

  jret = jsvalue_create_string(ctx, obj->theme_of_popup);
  return jret;
}
...
ret_t combo_box_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_set_theme_of_popup", wrap_combo_box_set_theme_of_popup);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_set_selected_index_by_text", wrap_combo_box_set_selected_index_by_text);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_remove_option_by_index", wrap_combo_box_remove_option_by_index);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_has_option_text", wrap_combo_box_has_option_text);
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_get_text", wrap_combo_box_get_text);
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_get_text_of_selected", wrap_combo_box_get_text_of_selected);
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_t_get_prop_open_window", wrap_combo_box_t_get_prop_open_window);
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_t_get_prop_theme_of_popup", wrap_combo_box_t_get_prop_theme_of_popup);
...
static HANDLER_PROTO(wrap_icon_create)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 5) {
  widget_t* ret = NULL;
...
ret_t image_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"icon_create", wrap_icon_create);
...
static HANDLER_PROTO(wrap_overlay_set_modeless)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  bool_t modeless = (bool_t)jsvalue_get_boolean_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_overlay_t_get_prop_modeless)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  overlay_t* obj = (overlay_t*)jsvalue_get_pointer(ctx, argv[0], "overlay_t*");

  jret = jsvalue_create_bool(ctx, obj->modeless);
  return jret;
}

ret_t overlay_t_init(JSContext *ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"overlay_create", wrap_overlay_create);
  jerryx_handler_register_global((const jerry_char_t*)"overlay_set_click_through", wrap_overlay_set_click_through);
  jerryx_handler_register_global((const jerry_char_t*)"overlay_set_always_on_top", wrap_overlay_set_always_on_top);
  jerryx_handler_register_global((const jerry_char_t*)"overlay_set_modeless", wrap_overlay_set_modeless);
  jerryx_handler_register_global((const jerry_char_t*)"overlay_cast", wrap_overlay_cast);
  jerryx_handler_register_global((const jerry_char_t*)"overlay_t_get_prop_click_through", wrap_overlay_t_get_prop_click_through);
  jerryx_handler_register_global((const jerry_char_t*)"overlay_t_get_prop_always_on_top", wrap_overlay_t_get_prop_always_on_top);
  jerryx_handler_register_global((const jerry_char_t*)"overlay_t_get_prop_modeless", wrap_overlay_t_get_prop_modeless);
...
ret_t popup_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"popup_set_close_when_timeout", wrap_popup_set_close_when_timeout);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"popup_t_get_prop_close_when_timeout", wrap_popup_t_get_prop_close_when_timeout);
...
static HANDLER_PROTO(wrap_spin_box_set_easy_touch_mode)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
  widget_t* widget = (widget_t*)jsvalue_get_pointer(ctx, argv[0], "widget_t*");
  bool_t easy_touch_mode = (bool_t)jsvalue_get_boolean_value(ctx, argv[1]);
...
static HANDLER_PROTO(wrap_spin_box_set_button_position)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_spin_set_repeat)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if(argc >= 2) {
  ret_t ret = (ret_t)0;
...
static HANDLER_PROTO(wrap_spin_box_t_get_prop_easy_touch_mode)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  spin_box_t* obj = (spin_box_t*)jsvalue_get_pointer(ctx, argv[0], "spin_box_t*");

  jret = jsvalue_create_bool(ctx, obj->easy_touch_mode);
  return jret;
}

static HANDLER_PROTO(wrap_spin_box_t_get_prop_button_position)  {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  spin_box_t* obj = (spin_box_t*)jsvalue_get_pointer(ctx, argv[0], "spin_box_t*");
...
ret_t spin_box_t_init(JSContext *ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"spin_box_set_easy_touch_mode", wrap_spin_box_set_easy_touch_mode);
  jerryx_handler_register_global((const jerry_char_t*)"spin_box_set_button_position", wrap_spin_box_set_button_position);
  jerryx_handler_register_global((const jerry_char_t*)"spin_set_repeat", wrap_spin_set_repeat);
  jerryx_handler_register_global((const jerry_char_t*)"spin_box_t_get_prop_easy_touch_mode", wrap_spin_box_t_get_prop_easy_touch_mode);
  jerryx_handler_register_global((const jerry_char_t*)"spin_box_t_get_prop_button_position", wrap_spin_box_t_get_prop_button_position);
...
ret_t awtk_js_init(JSContext *ctx) {
  ...
  locale_infos_t_init(ctx);
  style_id_t_init(ctx);
  style_t_init(ctx);
  system_info_flag_t_init(ctx);
  theme_t_init(ctx);
  timer_t_init(ctx);
  align_v_t_init(ctx);
  align_h_t_init(ctx);
  ...
  widget_animator_event_t_init(ctx);
  model_event_t_init(ctx);
